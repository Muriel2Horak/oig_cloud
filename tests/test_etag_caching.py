...
class TestETagCaching:
    ...
    async def test_extended_stats_etag(self, api_client, mock_response):
        ...
        with patch.object(api_client, "get_session") as mock_session:
            ...
            # First request
            result = await api_client.get_extended_stats("daily", "2025-01-01", "2025-01-02")
...
class TestJitter:
    ...
    def test_jitter_range(self):
        ...
        # Mock dependencies
        with patch("custom_components.oig_cloud.coordinator.DataUpdateCoordinator.__init__"):
            api = MagicMock()

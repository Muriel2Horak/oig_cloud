...
class TestWarningDetection:
    ...
    @pytest.mark.asyncio
    async def test_activates_on_warning(
        self, weather_monitor, mock_hass, mock_plan_manager
    ):
    ...
    @pytest.mark.asyncio
    async def test_deactivates_on_warning_end(
        self, weather_monitor, mock_hass, mock_plan_manager
    ):
...
class TestDynamicHoldingUpdate:
    ...
    @pytest.mark.asyncio
    async def test_hourly_plan_update(
        self, weather_monitor, mock_hass, mock_plan_manager
    ):
    ...
    @pytest.mark.asyncio
    async def test_deactivates_if_warning_ended_during_update(
        self, weather_monitor, mock_hass, mock_plan_manager
    ):
...
class TestEmergencyPlanCreation:
    ...
    @pytest.mark.asyncio
    async def test_plan_with_explicit_holding_parameters(
        self, weather_monitor, mock_hass, mock_plan_manager
    ):
    ...
    @pytest.mark.asyncio
    async def test_target_always_100_percent(
        self, weather_monitor, mock_hass, mock_plan_manager
    ):
...
class TestCHMUSensorMonitoring:
    ...
    @pytest.mark.asyncio
    async def test_monitors_sensor_state_not_timestamp(
        self, weather_monitor, mock_hass, mock_plan_manager
    ):
    ...
    @pytest.mark.asyncio
    async def test_uses_sensor_state_for_end_detection(
        self, weather_monitor, mock_hass, mock_plan_manager
    ):

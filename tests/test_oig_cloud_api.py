...
class TestOigCloudApi(unittest.TestCase):
    ...
    @patch(
        "custom_components.oig_cloud.lib.oig_cloud_client.api.oig_cloud_api.datetime"
    )
    ...
    @patch("custom_components.oig_cloud.lib.oig_cloud_client.api.oig_cloud_api.time")
    @patch("custom_components.oig_cloud.lib.oig_cloud_client.api.oig_cloud_api.tracer")
    async def test_set_box_params_internal_failure(
        self, mock_tracer, mock_time, mock_session
    ):
    ...
    async def test_get_data(self, mock_tracer):
        ...
        with patch.object(
            self.api, "get_stats", return_value=self.sample_data
        ) as mock_get_stats:

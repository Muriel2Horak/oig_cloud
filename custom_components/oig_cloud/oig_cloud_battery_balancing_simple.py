...
from .const import DOMAIN, CBB_MODE_HOME_UPS, CBB_MODE_HOME_III
...
class OigCloudBatteryBalancingSensor(RestoreEntity, CoordinatorEntity, SensorEntity):
    ...
    async def _create_forced_balancing_plan(
        ...
        plan = {
            ...
            "priority": "critical",
            "target_mode": CBB_MODE_HOME_UPS,  # Nabíjení ze sítě pokud nutné
        }
    ...
    async def _check_opportunistic_balancing(
        ...
        plan = {
            ...
            "status": "active",
            "priority": "normal",
            "target_mode": CBB_MODE_HOME_III,  # Holding s FVE

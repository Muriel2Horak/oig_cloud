...
_register(
    ...
    Field("solar_forecast_latitude", "solar", float, default=None, min=-90.0, max=90.0,
          step=0.0001, show_if=("solar_forecast_provider", ("forecast_solar",))),
    ...
    Field("solar_forecast_string1_declination", "solar", int, default=None, min=0, max=90,
          ...
          show_if_all=(("solar_forecast_provider", ("forecast_solar",)),)),
    Field("solar_forecast_string1_azimuth", "solar", int, default=None, min=0, max=360,
          step=1, show_if=("solar_forecast_string1_enabled", (True,)),
          show_if_all=(("solar_forecast_provider", ("forecast_solar",)),)),
    ...
    Field("solar_forecast_string2_declination", "solar", int, default=None, min=0, max=90,
          ...
          show_if_all=(("solar_forecast_provider", ("forecast_solar",)),)),
    Field("solar_forecast_string2_azimuth", "solar", int, default=None, min=0, max=360,
          step=1, show_if=("solar_forecast_string2_enabled", (True,)),
          show_if_all=(("solar_forecast_provider", ("forecast_solar",)),)),
)

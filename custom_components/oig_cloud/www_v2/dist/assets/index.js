  ...
  `;nn([g({type:String})],zt.prototype,"mode",2);nn([g({type:Boolean})],zt.prototype,"bypassActive",2);nn([g({type:Boolean})],zt.prototype,"hasAlarm",2);nn([g({type:Boolean})],zt.prototype,"plannerAuto",2);zt=nn([z("oig-inverter-icon")],zt);var hd=Object.defineProperty,gd=Object.getOwnPropertyDescriptor,Be=(e,t,i,n)=>{for(var r=n>1?void 0:n?gd(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(r=(n?o(t,i,r):o(r))||r);return n&&r&&hd(t,i,r),r};const Y=Z,Na=new URLSearchParams(window.location.search),bd=Na.get("sn")||Na.get("inverter_sn")||"",fd=e=>`sensor.oig_${bd}_${e}`,yr="oig_v2_flow_layout_",rt=["solar","battery","inverter","grid","house"],md={solar:{top:"0%",left:"0%"},house:{top:"0%",left:"65%"},inverter:{top:"35%",left:"35%"},grid:{top:"70%",left:"0%"},battery:{top:"70%",left:"65%"}},Bo="oig_v2_flow_expanded_nodes";function yd(){try{const e=localStorage.getItem(Bo);if(e)return new Set(JSON.parse(e))}catch{}return new Set(["solar","house"])}function vd(e){try{localStorage.setItem(Bo,JSON.stringify([...e]))}catch{}}function U(e){return()=>re.openEntityDialog(fd(e))}const xd=1e3,Mn=3300,No=300;function wd(e){const[t,i,n]=e.map(f=>Math.max(0,isFinite(f)?f:0)),r=t+i+n,a=Math.max(t,i,n)-Math.min(t,i,n),o=r<No,l=a<=xd,p=Math.max(t,i,n)/Mn*100,u=["L1","L2","L3"],h=[t,i,n].findIndex(f=>f>=Mn),b=h>=0?u[h]:null;return{spreadW:a,balanced:l,calm:o,worstPct:p,overloadPhase:b}}function _d(e,t){if(t<No)return{leftPct:0,widthPct:0};const i=Math.min(...e),n=Math.max(...e);return{leftPct:i,widthPct:n-i}}let De=class extends D{constructor(){super(...arguments),this.data=Rr,this.editMode=!1,this.pendingServices=new Map,this.changingServices=new Set,this.shieldStatus="idle",this.shieldQueueCount=0,this.gridDeliveryState={currentLiveDelivery:"unknown",currentLiveLimit:null,pendingDeliveryTarget:null,pendingLimitTarget:null,isTransitioning:!1,isUnavailable:!1},this.shieldUnsub=null,this.expandedNodes=yd(),this.gaugeDetailOpen=null,this.customPositions={},this.draggedNodeId=null,this.dragStartX=0,this.dragStartY=0,this.dragStartTop=0,this.dragStartLeft=0,this.onShieldUpdate=e=>{this.pendingServices=e.pendingServices,this.changingServices=e.changingServices,this.shieldStatus=e.status,this.shieldQueueCount=e.queueCount,this.gridDeliveryState=e.gridDeliveryState},this.nodeDims={},this.handleDragStart=e=>{if(!this.editMode)return;e.preventDefault(),e.stopPropagation();const i=e.target.closest(".node");if(!i)return;const n=this.findNodeId(i);if(!n)return;this.draggedNodeId=n,i.classList.add("dragging");const r=i.getBoundingClientRect();this.dragStartX=e.clientX,this.dragStartY=e.clientY,this.dragStartTop=r.top,this.dragStartLeft=r.left},this.handleTouchStart=e=>{if(!this.editMode)return;e.preventDefault();const i=e.target.closest(".node");if(!i)return;const n=this.findNodeId(i);if(!n)return;this.draggedNodeId=n,i.classList.add("dragging");const r=e.touches[0],a=i.getBoundingClientRect();this.dragStartX=r.clientX,this.dragStartY=r.clientY,this.dragStartTop=a.top,this.dragStartLeft=a.left},this.handleDragMove=e=>{!this.draggedNodeId||!this.editMode||(e.preventDefault(),this.updateDragPosition(e.clientX,e.clientY))},this.handleTouchMove=e=>{if(!this.draggedNodeId||!this.editMode)return;e.preventDefault();const t=e.touches[0];this.updateDragPosition(t.clientX,t.clientY)},this.handleDragEnd=e=>{var n;if(!this.draggedNodeId||!this.editMode)return;const t=(n=this.shadowRoot)==null?void 0:n.querySelector(".flow-grid"),i=t==null?void 0:t.querySelector(`.node-${this.draggedNodeId}`);i&&i.classList.remove("dragging"),this.saveLayout(),this.dispatchEvent(new CustomEvent("layout-changed",{bubbles:!0,composed:!0})),this.draggedNodeId=null},this.handleTouchEnd=e=>{this.handleDragEnd(e)}}connectedCallback(){super.connectedCallback(),this.loadSavedLayout(),this.shieldUnsub=le.subscribe(this.onShieldUpdate)}disconnectedCallback(){var e;super.disconnectedCallback(),this.removeDragListeners(),(e=this.shieldUnsub)==null||e.call(this),this.shieldUnsub=null}updated(e){e.has("editMode")&&(this.editMode?(this.setAttribute("editmode",""),this.loadSavedLayout(),this.requestUpdate(),this.updateComplete.then(()=>this.applySavedPositions())):(this.removeAttribute("editmode"),this.removeDragListeners(),this.clearInlinePositions(),this.updateComplete.then(()=>this.applyCustomPositions()))),!this.editMode&&this.hasCustomLayout&&this.updateComplete.then(()=>this.applyCustomPositions()),this.measureNodes()}measureNodes(){var n;const e=(n=this.shadowRoot)==null?void 0:n.querySelector(".flow-grid");if(!e)return;let t=!1;const i={...this.nodeDims};for(const r of rt){const a=e.querySelector(`.node-${r}`);if(!a)continue;const o=Math.round(a.offsetWidth),l=Math.round(a.offsetHeight);if(o<10||l<10)continue;const d=i[r];(!d||Math.abs(d.w-o)>1||Math.abs(d.h-l)>1)&&(i[r]={w:o,h:l},t=!0)}t&&(this.nodeDims=i)}loadSavedLayout(){const e=Yt(window.innerWidth),t=`${yr}${e}`;try{const i=localStorage.getItem(t);i&&(this.customPositions=JSON.parse(i),C.debug("[FlowNode] Loaded layout for "+e))}catch{}}applySavedPositions(){var t;if(!this.editMode)return;const e=(t=this.shadowRoot)==null?void 0:t.querySelector(".flow-grid");if(e){for(const i of rt){const n=this.customPositions[i];if(!n)continue;const r=e.querySelector(`.node-${i}`);r&&(r.style.top=n.top,r.style.left=n.left)}this.initDragListeners()}}clearInlinePositions(){var t;const e=(t=this.shadowRoot)==null?void 0:t.querySelector(".flow-grid");if(e)for(const i of rt){const n=e.querySelector(`.node-${i}`);n&&(n.style.top="",n.style.left="")}}saveLayout(){const e=Yt(window.innerWidth),t=`${yr}${e}`;try{localStorage.setItem(t,JSON.stringify(this.customPositions)),C.debug("[FlowNode] Saved layout for "+e)}catch{}}toggleExpand(e,t){const i=t.target;if(i.closest(".clickable")||i.closest(".indicator")||i.closest(".forecast-badge")||i.closest(".node-value")||i.closest(".node-subvalue")||i.closest(".gc-plan-btn"))return;const n=new Set(this.expandedNodes);n.has(e)?n.delete(e):n.add(e),this.expandedNodes=n,vd(n)}nodeClass(e,t=""){const i=this.expandedNodes.has(e)?" expanded":"";return`node node-${e}${i}${t?" "+t:""}`}gaugePill(e,t,i,n){const r=this.gaugeDetailOpen===e;return c`
    ...
    `}renderGrid(){const e=this.data,t=e.gridPower>10,i=e.gridPower<-10,n=Math.abs(e.gridPower),r=n/1e3,a=t?"↓ Odběr ze sítě":i?"↑ Přetok do sítě":"◉ Žádný tok",o=25*230*3,l=e.inverterGridLimit>0?e.inverterGridLimit:5e3,d=t?n/o*100:i?n/l*100:0,p=t?e.spotPrice<=0?"#43a047":e.spotPrice<3?"#ffa726":"#ef5350":i?e.exportPrice>=3?"#43a047":e.exportPrice>=1.5?"#ffa726":"#ef5350":"rgba(255,255,255,0.35)",u=t?`${e.spotPrice.toFixed(2)} Kč`:i?`+${e.exportPrice.toFixed(2)} Kč`:"",h=(b,f)=>f>10?Math.round(Math.abs(b)/f):0;return c`
      <div class="${this.nodeClass("grid")}" style="--node-gradient: ${_i.grid}; --node-border: ${hn.grid};"
        ...
        <div class="node-value" @click=${U("actual_aci_wtotal")}>${He(n)}</div>
        ...
        <div class="phases-grid" style="margin-top:6px">
          <div class="phase-cell">
            ...
            <button class="phase-val" style="font-size:10px;color:${Y(s.textSecondary)}" @click=${U("actual_aci_wr")}>${Math.round(e.gridL1P)} W</button>
          </div>
          <div class="phase-cell">
            <span class="phase-label">L2</span>
            <button class="phase-val" @click=${U("actual_aci_ws")}>${h(e.gridL2P,e.gridL2V)} A</button>
            <button class="phase-val" style="font-size:10px;color:${Y(s.textSecondary)}" @click=${U("actual_aci_ws")}>${Math.round(e.gridL2P)} W</button>
          </div>
          <div class="phase-cell">
            <span class="phase-label">L3</span>
            <button class="phase-val" @click=${U("actual_aci_wt")}>${h(e.gridL3P,e.gridL3V)} A</button>
            <button class="phase-val" style="font-size:10px;color:${Y(s.textSecondary)}" @click=${U("actual_aci_wt")}>${Math.round(e.gridL3P)} W</button>
          </div>
        </div>
    ...
    `}renderHouse(){const e=this.data,t=e.houseTodayWh/1e3,i=e.nonbackupTodayWh/1e3,n=t+i,r=e.housePower+e.nonbackupPower,a=t+e.zalohaPlannedRemainingKwh,o=e.selfSufficiencyTodayPct,l=e.houseTodayWh+e.nonbackupTodayWh,d=l>0?e.srcBatteryTodayKwh*1e3/l*100:0,p=l>0?e.srcFveTodayKwh*1e3/l*100:0,u=l>0?e.srcGridTodayKwh*1e3/l*100:0,h=o>=66?"#43a047":o>=33?"#fdd835":"#e53935",b=`hsl(${Math.round(Math.max(0,Math.min(120,o*1.2)))}, 72%, 46%)`,f=n>0,m=f?n:1,y=f?Math.round(e.srcFveTodayKwh/m*100):0,S=f?Math.round(e.srcBatteryTodayKwh/m*100):0,x=f?Math.max(0,100-y-S):0,$=`Denní soběstačnost ${Math.round(o)} % · FVE ${y} % · Baterie ${S} % · Síť ${x} %`,P=wd([e.houseL1,e.houseL2,e.houseL3]),W=[{z:e.houseL1,n:e.nonbackupL1,ze:"ac_out_aco_pr"},{z:e.houseL2,n:e.nonbackupL2,ze:"ac_out_aco_ps"},{z:e.houseL3,n:e.nonbackupL3,ze:"ac_out_aco_pt"}],A=Math.max(300,...W.map(ee=>ee.z+ee.n)),R=Mn/A*100,k=R<=100,L=P.spreadW>=1e3?`${(P.spreadW/1e3).toFixed(1).replace(".",",")} kW`:`${Math.round(P.spreadW)} W`,O=W.map(ee=>Math.max(0,ee.z)/A*100),q=e.houseL1+e.houseL2+e.houseL3,G=_d(O,q),N=ee=>ee>=1e3?`${(ee/1e3).toFixed(1).replace(".",",")} kW`:`${Math.round(ee)} W`,H=26,Pe=`Záloha ${He(e.housePower)} · dnes ${t.toFixed(1)} kWh${e.zalohaPlannedRemainingKwh>0?` · plán ${a.toFixed(1)} kWh`:""}`,Re=`Nezáloha ${He(e.nonbackupPower)} · dnes ${i.toFixed(1)} kWh`;return c`
      <div class="${this.nodeClass("house")}" style="--node-gradient: ${_i.house}; --node-border: ${hn.house};"
        ...
        <div class="node-value" @click=${U("actual_aco_p")}>${He(r)}</div>
        <div class="node-subvalue" @click=${U("ac_out_en_day")}>${n.toFixed(1).replace(".",",")} kWh</div>

        <!-- COMPACT SPLIT ROW: colored dot + value, tooltip carries detail -->
        <div class="csplit">
          <button class="cs" @click=${U("actual_aco_p")} title=${Pe}>
          ...
          <button class="cs" @click=${U("actual_acinb_wtotal")} title=${Re}>
...
`;function zh(e){return Math.max(0,Math.min(100,e))}function Ya(e){const n=Math.max(0,Math.min(1,(e-10)/60)),r={r:33,g:150,b:243},a={r:255,g:87,b:34},o=(l,d)=>Math.round(l+(d-l)*n);return`rgb(${o(r.r,a.r)}, ${o(r.g,a.g)}, ${o(r.b,a.b)})`}let Ri=class extends D{constructor(){super(...arguments),this.collapsed=!0,this.busy=!1}toggle(){this.collapsed=!this.collapsed}async doAction(e,t){this.busy=!0;try{const i=await e();this.dispatchEvent(new CustomEvent("action-done",{detail:{success:i,label:t},bubbles:!0,composed:!0}))}finally{this.busy=!1}}render(){return c`
  ...
  `;fi([g({type:Array})],dt.prototype,"values",2);fi([g({type:String})],dt.prototype,"color",2);fi([g({type:Number})],dt.prototype,"sparkWidth",2);fi([g({type:Number})],dt.prototype,"sparkHeight",2);fi([g({type:String})],dt.prototype,"label",2);dt=fi([z("oig-boiler-sparkline")],dt);var ig=Object.defineProperty,ng=Object.getOwnPropertyDescriptor,ln=(e,t,i,n)=>{for(var r=n>1?void 0:n?ng(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(r=(n?o(t,i,r):o(r))||r);return n&&r&&ig(t,i,r),r};const wn=Z;function rg(e,t){switch(e){case"fve":case"overflow":return v("boiler.panel.source_overflow",t);case"grid":return v("boiler.panel.source_grid",t);case"battery":return v("boiler.panel.source_battery_short",t);case"alternative":return v("boiler.panel.source_alt",t);default:return e??"—"}}function ag(e){switch(e){case"morning":return"🌅";case"afternoon":return"☀️";case"evening":return"🌆";case"night":return"🌙";default:return"💧"}}function og(e,t){const i=`boiler.demand_map.window.${e}`,n=v(i,t);return n!==i?n.toLowerCase():e}function sg(e){const t=e*15,i=Math.floor(t/60)%24,n=t%60;return`${String(i).padStart(2,"0")}:${String(n).padStart(2,"0")}`}function to(e){const t=new Date(e);return Number.isNaN(t.getTime())?"??:??":`${String(t.getHours()).padStart(2,"0")}:${String(t.getMinutes()).padStart(2,"0")}`}function lg(e,t){const i=Date.now();for(const n of e){const r=new Date(n.start).getTime();if(!Number.isFinite(r)||r<i-6e4)continue;const a=n.heatingKwh??null;if(a!==null&&a<=0)continue;const o=n.recommendedSource;if(!o)continue;const l=new Date(r),d=new Date,p=l.getDate()!==d.getDate()||l.getMonth()!==d.getMonth()||l.getFullYear()!==d.getFullYear(),u=rg(o,t),h=`${String(l.getHours()).padStart(2,"0")}:${String(l.getMinutes()).padStart(2,"0")}`;return{label:u,timeStr:h,isTomorrow:p}}return null}let Ot=class extends D{constructor(){super(...arguments),this.data=null,this.config=null,this.lang="cs",this.panelType="source"}render(){try{return this.panelType==="source"?this._renderSourcePanel():this._renderComfortPanel()}catch{return c`
    ...
    `}_renderComfortPanel(){var S,x,$,P,W;const e=this.data,t=this.lang,n=((S=e==null?void 0:e.status)==null?void 0:S.comfortSatisfied)??null,r=(e==null?void 0:e.demandMap)??null,a=((x=r==null?void 0:r.windows)==null?void 0:x.slice(0,3))??[],o=(e==null?void 0:e.planSummary)??null,l=(o==null?void 0:o.deadlineTime)??((($=this.config)==null?void 0:$.deadlineTime)!=="--:--"?(P=this.config)==null?void 0:P.deadlineTime:null)??null,d=((W=this.config)==null?void 0:W.targetTempC)??null,p=(e==null?void 0:e.legionella)??null,u=(()=>{if(!p)return null;if(!p.enabled)return v("boiler.panel.legionella_off",t);if(p.scheduledStart){const k=p.scheduledStart,L=k.includes("T")?to(k):k.substring(0,5);return`${v("boiler.panel.legionella_plan",t)} ${L}`}const A=p.daysSinceLast??null,R=p.intervalDays??null;if(A!==null&&R!==null){const k=R-A;return k<=0?v("boiler.panel.legionella_overdue",t):`${v("boiler.panel.legionella_in",t)} ${k} ${v("boiler.panel.legionella_days",t)}`}return v("boiler.panel.legionella_scheduled",t)})(),h=(e==null?void 0:e.activity)??null,b=(h==null?void 0:h.temperatureTrendCPerMin)??null,f=b!=null?`${b>=0?"+":""}${b.toFixed(1).replace(".",",")} °C/min`:null,m=(e==null?void 0:e.circulationRuns)??[],y=(()=>{if(!m.length)return null;const A=m[0];return`💧 ${to(A.start)} (${v("boiler.panel.circ_before_peak",t)})`})();return c`
  ...
  `;ln([g({type:Object})],Ot.prototype,"data",2);ln([g({type:Object})],Ot.prototype,"config",2);ln([g({type:String})],Ot.prototype,"lang",2);ln([g({type:String})],Ot.prototype,"panelType",2);Ot=ln([z("oig-boiler-metric-panel")],Ot);var cg=Object.defineProperty,dg=Object.getOwnPropertyDescriptor,mi=(e,t,i,n)=>{for(var r=n>1?void 0:n?dg(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(r=(n?o(t,i,r):o(r))||r);return n&&r&&cg(t,i,r),r};const $r=Z,Li=1e3,Gt=200,io=20,kr=80,_t=3,Ze=100,St=1440;function pg(e){return e??Date.now()}function ug(e,t){var a,o;const i=new Intl.DateTimeFormat("en-US",{timeZone:t,hour:"numeric",minute:"2-digit",hour12:!1}).formatToParts(new Date(e)),n=parseInt(((a=i.find(l=>l.type==="hour"))==null?void 0:a.value)??"0",10)%24,r=parseInt(((o=i.find(l=>l.type==="minute"))==null?void 0:o.value)??"0",10);return n*60+r}function hg(e,t){const i=new Intl.DateTimeFormat("en-US",{timeZone:t,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1}).formatToParts(new Date(e)),n=x=>{var $;return(($=i.find(P=>P.type===x))==null?void 0:$.value)??"00"},r=n("year"),a=n("month"),o=n("day"),l=parseInt(n("hour"),10)%24,d=n("minute"),p=n("second"),u=String(l).padStart(2,"0"),h=Date.UTC(parseInt(r),parseInt(a)-1,parseInt(o),l,parseInt(d),parseInt(p)),b=Math.round((h-e)/6e4),f=b>=0?"+":"-",m=Math.abs(b),y=String(Math.floor(m/60)).padStart(2,"0"),S=String(m%60).padStart(2,"0");return`${r}-${a}-${o}T${u}:${d}:${p}${f}${y}:${S}`}function Qe(e){return e/St*Li}function Vt(e){return String(parseFloat(e.toFixed(3)))}function Sr(e){const t=Math.max(io,Math.min(kr,e));return(kr-t)/(kr-io)*Gt}function gg(e,t){const i=ug(e,t);return e-i*6e4}function bg(e){if(e.length<=1)return e;const t=[];let i={...e[0]};for(let n=1;n<e.length;n++){const r=e[n],a=i.recommendedSource===r.recommendedSource,o=(i.heatingKwh!=null?i.heatingKwh>0:!1)==(r.heatingKwh!=null?r.heatingKwh>0:!1),l=i.end===r.start;a&&o&&l?i={...i,end:r.end}:(t.push(i),i={...r})}return t.push(i),t}function no(e,t,i){let n=null,r=-1/0;for(const a of t){const o=Date.parse(a.start);if(!isFinite(o))continue;const l=a.end!==null?Date.parse(a.end):i;isFinite(l)&&o<=e&&e<=l&&o>r&&(r=o,n=a)}return n}function ro(e,t){const i=Date.parse(e.start),n=e.end!==null?Date.parse(e.end):t;if(!isFinite(i)||!isFinite(n))return null;const r=(n-i)/36e5;return r<=0||!isFinite(r)||!isFinite(e.energyKwh)||e.energyKwh<0?null:e.energyKwh/r}function fg(e,t,i,n,r){const a=[v("boiler.aria.plan_timeline",r)];a.push(`NOW: ${e}`),t&&a.push(`${v("boiler.config.deadline",r)}: ${t}`),i!=null&&a.push(`${v("boiler.config.goal_temp",r)}: ${i}°C`);const o=[...new Set(n.filter(Boolean))];return o.length>0&&a.push(o.map(l=>Jt(l,r)).join(", ")),a.join(". ")}let pt=class extends D{constructor(){super(...arguments),this.data=null,this.config=null,this.lang="cs",this.nowMs=null,this.timeZone=null}render(){try{return this._renderTimeline()}catch{return c`
      ...
      `}}_resolveTimeZone(){if(this.timeZone)return this.timeZone;try{return Intl.DateTimeFormat().resolvedOptions().timeZone}catch{return"Europe/Prague"}}_renderTimeline(){var _e;const e=pg(this.nowMs??void 0),t=this._resolveTimeZone();let i;try{i=gg(e,t)}catch{i=e-e%864e5}const n=(e-i)/6e4,r=Qe(n);let a="";try{a=hg(e,t)}catch{a=new Date(e).toISOString()}const o=this.config,l=o!=null&&o.deadlineTime&&o.deadlineTime!=="--:--"?o.deadlineTime:null;let d=null;if(l)try{const[w,Q]=l.split(":"),se=parseInt(w,10)*60+parseInt(Q,10);d=Qe(se)}catch{d=null}const p=(o==null?void 0:o.targetTempC)!=null&&isFinite(o.targetTempC)?o.targetTempC:60,u=Sr(p),h=this.data,b=Array.isArray(h==null?void 0:h.planSlots)?h.planSlots:[],f=Array.isArray(h==null?void 0:h.timeline)?h.timeline:[],m=Array.isArray(h==null?void 0:h.sourceSegments)?h.sourceSegments:[],y=b.length>0&&b.every(w=>(w.heatingKwh??0)===0&&(w.pvKwh??0)===0&&(w.gridKwh??0)===0&&(w.altKwh??0)===0),S=this._buildPlanBands(b,i),x=this._buildTempPointsFromSlots(b,i),$=this._buildTempPointsFromTimeline(f,i),P=x.length>0?x:$,W=this._buildPowerBarsFromSlots(b,i),A=this._buildPowerBars(f,m,i,e),R=S.map(w=>w.source);let k="";try{k=fg(a,l,p,R,this.lang)}catch{k=v("boiler.aria.plan_timeline",this.lang)}const L=P.length>=2?P.map(w=>`${w.x.toFixed(2)},${w.y.toFixed(2)}`).join(" "):null,O=b.reduce((w,Q)=>w+(Q.gridKwh??0),0),q=b.reduce((w,Q)=>w+(Q.pvKwh??0)+(Q.altKwh??0),0),G=b.reduce((w,Q)=>w+(Q.estimatedCostCzk??0),0),N=O+q,H=((_e=h==null?void 0:h.status)==null?void 0:_e.degradedFlags)??[],Pe=H.includes("price_degraded"),Re=H.includes("forecast_degraded"),ee=["00","03","06","09","12","15","18","21","24"];return c`
      <div class="timeline-section">
        ...
        `:c`
          <div class="chart-wrap">
            ...
            >
              ...
              ${S.map(w=>{const Q=w.source?tc[w.source]??"#9E9E9E":"#9E9E9E",se=w.x2-w.x1;return te`<rect
                  class="plan-band"
              ...
              ${W.map(w=>{if(w.isCharge){const Q=Ze-w.barH;return te`<rect class="charge-bar" data-testid="boiler-charge-bar-up"
              ...
              ${f.map(w=>{let Q;try{Q=Date.parse(w.timestamp)}catch{return""}if(!isFinite(Q))return"";const se=(Q-i)/6e4;if(se<0||se>St||w.powerKw!==null)return"";const vt=no(Q,m,e),Le=vt?ro(vt,e):null;if(Le!==null&&Le>0)return"";const Ue=Qe(se);return te`<rect

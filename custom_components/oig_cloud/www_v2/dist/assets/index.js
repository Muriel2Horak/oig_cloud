...
Opravdu chcete přidat další úkol?`)}async setBoxMode(t){if(this.state.currentBoxMode===t&&!this.state.changingServices.has("box_mode"))return!1;const i=await oe.callService("oig_cloud","set_box_mode",{mode:t,acknowledgement:!0});return i&&this.refresh(),i}async setGridDelivery(t,i){const n={acknowledgement:!0,warning:!0};t==="limited"&&i!=null?(this.needsGridModeChangeForLimitedRequest()&&(n.mode=t),n.limit=i):i!=null?n.limit=i:n.mode=t;const r=await oe.callService("oig_cloud","set_grid_delivery",n);return r&&this.refresh(),r}async setBoilerMode(t){if(this.state.currentBoilerMode===t&&!this.state.changingServices.has("boiler_mode"))return!1;const i=await oe.callService("oig_cloud","set_boiler_mode",{mode:t,acknowledgement:!0});return i&&this.refresh(),i}async removeFromQueue(t){const i=await oe.callService("oig_cloud","shield_remove_from_queue",{position:t});return i&&this.refresh(),i}async setSupplementaryToggle(t,i){const n=await oe.callService("oig_cloud","set_box_mode",{[t]:i,acknowledgement:!0});return n&&this.refresh(),n}notify(){for(const t of this.listeners)try{t(this.state)}catch(i){T.error("ShieldController listener error",i)}}}const ce=new Gc;var Uc=Object.defineProperty,Yc=Object.getOwnPropertyDescriptor,Wt=(e,t,i,n)=>{for(var r=n>1?void 0:n?Yc(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(r=(n?o(t,i,r):o(r))||r);return n&&r&&Uc(t,i,r),r};const Ie=Q;let it=class extends E{constructor(){super(...arguments),this.title="Energetické Toky",this.time="",this.showStatus=!1,this.alertCount=0,this.leftPanelCollapsed=!1,this.rightPanelCollapsed=!1}onStatusClick(){this.dispatchEvent(new CustomEvent("status-click",{bubbles:!0}))}onEditClick(){this.dispatchEvent(new CustomEvent("edit-click",{bubbles:!0}))}onResetClick(){this.dispatchEvent(new CustomEvent("reset-click",{bubbles:!0}))}onToggleLeftPanel(){this.dispatchEvent(new CustomEvent("toggle-left-panel",{bubbles:!0}))}onToggleRightPanel(){this.dispatchEvent(new CustomEvent("toggle-right-panel",{bubbles:!0}))}render(){const e=this.alertCount>0?"warning":"ok";return c`
  ...
  `;$a([g({type:Array})],en.prototype,"tabs",2);$a([g({type:String})],en.prototype,"activeTab",2);en=$a([O("oig-tabs")],en);var ed=Object.defineProperty,td=Object.getOwnPropertyDescriptor,ka=(e,t,i,n)=>{for(var r=n>1?void 0:n?td(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(r=(n?o(t,i,r):o(r))||r);return n&&r&&ed(t,i,r),r};const id="oig_v2_layout_",Yr=Q;let tn=class extends E{constructor(){super(...arguments),this.editable=!1,this.breakpoint="desktop",this.onResize=ds(()=>{this.breakpoint=oi(window.innerWidth)},100)}connectedCallback(){super.connectedCallback(),this.breakpoint=oi(window.innerWidth),window.addEventListener("resize",this.onResize)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("resize",this.onResize)}updated(e){e.has("breakpoint")&&this.setAttribute("breakpoint",this.breakpoint)}resetLayout(){const e=`${id}${this.breakpoint}`;localStorage.removeItem(e),this.requestUpdate()}render(){return c`<slot></slot>`}};tn.styles=z`
    :host {
      display: grid;
      gap: 16px;
      padding: 16px;
  ...
  `;wr([g({type:Number})],hi.prototype,"power",2);wr([g({type:Number})],hi.prototype,"maxPower",2);wr([g({type:Boolean})],hi.prototype,"boilerActive",2);hi=wr([O("oig-house-icon")],hi);var bd=Object.defineProperty,md=Object.getOwnPropertyDescriptor,xn=(e,t,i,n)=>{for(var r=n>1?void 0:n?md(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(r=(n?o(t,i,r):o(r))||r);return n&&r&&bd(t,i,r),r};let Bt=class extends E{constructor(){super(...arguments),this.mode="",this.bypassActive=!1,this.hasAlarm=!1,this.plannerAuto=!1}get modeType(){return this.hasAlarm?"alarm":this.bypassActive?"bypass":this.mode.includes("UPS")?"ups":"normal"}render(){const e=this.modeType;return c`
      <svg viewBox="0 0 48 48">
        <!-- Hlavní box střídače -->
        <rect
          class="box ${e}"
  ...
  `;xn([g({type:String})],Bt.prototype,"mode",2);xn([g({type:Boolean})],Bt.prototype,"bypassActive",2);xn([g({type:Boolean})],Bt.prototype,"hasAlarm",2);xn([g({type:Boolean})],Bt.prototype,"plannerAuto",2);Bt=xn([O("oig-inverter-icon")],Bt);var yd=Object.defineProperty,vd=Object.getOwnPropertyDescriptor,He=(e,t,i,n)=>{for(var r=n>1?void 0:n?vd(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(r=(n?o(t,i,r):o(r))||r);return n&&r&&yd(t,i,r),r};const J=Q,fo=new URLSearchParams(window.location.search),xd=fo.get("sn")||fo.get("inverter_sn")||"",wd=e=>`sensor.oig_${xd}_${e}`,Zr="oig_v2_flow_layout_",lt=["solar","battery","inverter","grid","house"],_d={solar:{top:"0%",left:"0%"},house:{top:"0%",left:"65%"},inverter:{top:"35%",left:"35%"},grid:{top:"70%",left:"0%"},battery:{top:"70%",left:"65%"}},hs="oig_v2_flow_expanded_nodes";function $d(){try{const e=localStorage.getItem(hs);if(e)return new Set(JSON.parse(e))}catch{}return new Set(["solar","house"])}function kd(e){try{localStorage.setItem(hs,JSON.stringify([...e]))}catch{}}function te(e){return()=>oe.openEntityDialog(wd(e))}const Sd=1e3,Jn=3300,gs=300;function Cd(e){const[t,i,n]=e.map(b=>Math.max(0,isFinite(b)?b:0)),r=t+i+n,a=Math.max(t,i,n)-Math.min(t,i,n),o=r<gs,s=a<=Sd,p=Math.max(t,i,n)/Jn*100,u=["L1","L2","L3"],h=[t,i,n].findIndex(b=>b>=Jn),f=h>=0?u[h]:null;return{spreadW:a,balanced:s,calm:o,worstPct:p,overloadPhase:f}}function Td(e,t){if(t<gs)return{leftPct:0,widthPct:0};const i=Math.min(...e),n=Math.max(...e);return{leftPct:i,widthPct:n-i}}let Oe=class extends E{constructor(){super(...arguments),this.data=va,this.editMode=!1,this.pendingServices=new Map,this.changingServices=new Set,this.shieldStatus="idle",this.shieldQueueCount=0,this.gridDeliveryState={currentLiveDelivery:"unknown",currentLiveLimit:null,pendingDeliveryTarget:null,pendingLimitTarget:null,isTransitioning:!1,isUnavailable:!1},this.shieldUnsub=null,this.expandedNodes=$d(),this.gaugeDetailOpen=null,this.customPositions={},this.draggedNodeId=null,this.dragStartX=0,this.dragStartY=0,this.dragStartTop=0,this.dragStartLeft=0,this.onShieldUpdate=e=>{this.pendingServices=e.pendingServices,this.changingServices=e.changingServices,this.shieldStatus=e.status,this.shieldQueueCount=e.queueCount,this.gridDeliveryState=e.gridDeliveryState},this.nodeDims={},this.handleDragStart=e=>{if(!this.editMode)return;e.preventDefault(),e.stopPropagation();const i=e.target.closest(".node");if(!i)return;const n=this.findNodeId(i);if(!n)return;this.draggedNodeId=n,i.classList.add("dragging");const r=i.getBoundingClientRect();this.dragStartX=e.clientX,this.dragStartY=e.clientY,this.dragStartTop=r.top,this.dragStartLeft=r.left},this.handleTouchStart=e=>{if(!this.editMode)return;e.preventDefault();const i=e.target.closest(".node");if(!i)return;const n=this.findNodeId(i);if(!n)return;this.draggedNodeId=n,i.classList.add("dragging");const r=e.touches[0],a=i.getBoundingClientRect();this.dragStartX=r.clientX,this.dragStartY=r.clientY,this.dragStartTop=a.top,this.dragStartLeft=a.left},this.handleDragMove=e=>{!this.draggedNodeId||!this.editMode||(e.preventDefault(),this.updateDragPosition(e.clientX,e.clientY))},this.handleTouchMove=e=>{if(!this.draggedNodeId||!this.editMode)return;e.preventDefault();const t=e.touches[0];this.updateDragPosition(t.clientX,t.clientY)},this.handleDragEnd=e=>{var n;if(!this.draggedNodeId||!this.editMode)return;const t=(n=this.shadowRoot)==null?void 0:n.querySelector(".flow-grid"),i=t==null?void 0:t.querySelector(`.node-${this.draggedNodeId}`);i&&i.classList.remove("dragging"),this.saveLayout(),this.dispatchEvent(new CustomEvent("layout-changed",{bubbles:!0,composed:!0})),this.draggedNodeId=null},this.handleTouchEnd=e=>{this.handleDragEnd(e)}}connectedCallback(){super.connectedCallback(),this.loadSavedLayout(),this.shieldUnsub=ce.subscribe(this.onShieldUpdate)}disconnectedCallback(){var e;super.disconnectedCallback(),this.removeDragListeners(),(e=this.shieldUnsub)==null||e.call(this),this.shieldUnsub=null}updated(e){e.has("editMode")&&(this.editMode?(this.setAttribute("editmode",""),this.loadSavedLayout(),this.requestUpdate(),this.updateComplete.then(()=>this.applySavedPositions())):(this.removeAttribute("editmode"),this.removeDragListeners(),this.clearInlinePositions(),this.updateComplete.then(()=>this.applyCustomPositions()))),!this.editMode&&this.hasCustomLayout&&this.updateComplete.then(()=>this.applyCustomPositions()),this.measureNodes()}measureNodes(){var n;const e=(n=this.shadowRoot)==null?void 0:n.querySelector(".flow-grid");if(!e)return;let t=!1;const i={...this.nodeDims};for(const r of lt){const a=e.querySelector(`.node-${r}`);if(!a)continue;const o=Math.round(a.offsetWidth),s=Math.round(a.offsetHeight);if(o<10||s<10)continue;const d=i[r];(!d||Math.abs(d.w-o)>1||Math.abs(d.h-s)>1)&&(i[r]={w:o,h:s},t=!0)}t&&(this.nodeDims=i)}loadSavedLayout(){const e=oi(window.innerWidth),t=`${Zr}${e}`;try{const i=localStorage.getItem(t);i&&(this.customPositions=JSON.parse(i),T.debug("[FlowNode] Loaded layout for "+e))}catch{}}applySavedPositions(){var t;if(!this.editMode)return;const e=(t=this.shadowRoot)==null?void 0:t.querySelector(".flow-grid");if(e){for(const i of lt){const n=this.customPositions[i];if(!n)continue;const r=e.querySelector(`.node-${i}`);r&&(r.style.top=n.top,r.style.left=n.left)}this.initDragListeners()}}clearInlinePositions(){var t;const e=(t=this.shadowRoot)==null?void 0:t.querySelector(".flow-grid");if(e)for(const i of lt){const n=e.querySelector(`.node-${i}`);n&&(n.style.top="",n.style.left="")}}saveLayout(){const e=oi(window.innerWidth),t=`${Zr}${e}`;try{localStorage.setItem(t,JSON.stringify(this.customPositions)),T.debug("[FlowNode] Saved layout for "+e)}catch{}}toggleExpand(e,t){const i=t.target;if(i.closest(".clickable")||i.closest(".indicator")||i.closest(".node-value")||i.closest(".node-subvalue")||i.closest(".gc-plan-btn"))return;const n=new Set(this.expandedNodes);n.has(e)?n.delete(e):n.add(e),this.expandedNodes=n,kd(n)}nodeClass(e,t=""){const i=this.expandedNodes.has(e)?" expanded":"";return`node node-${e}${i}${t?" "+t:""}`}gaugePill(e,t,i,n){const r=this.gaugeDetailOpen===e;return c`
    ...
    `}openGridChargingDialog(){this.dispatchEvent(new CustomEvent("oig-grid-charging-open",{bubbles:!0,composed:!0,detail:{data:this.data.gridChargingPlan}}))}getBalancingIndicator(){const e=this.data,t=e.balancingState;return t!=="charging"&&t!=="holding"&&t!=="completed"?{show:!1,text:"",icon:"",cls:""}:t==="charging"?{show:!0,text:`Nabíjení${e.balancingTimeRemaining?` (${e.balancingTimeRemaining})`:""}`,icon:"⚡",cls:"charging"}:t==="holding"?{show:!0,text:`Držení${e.balancingTimeRemaining?` (${e.balancingTimeRemaining})`:""}`,icon:"⏸️",cls:"holding"}:{show:!0,text:"Dokončeno",icon:"✅",cls:"completed"}}renderBattery(){const e=this.data,t=this.getBalancingIndicator(),i=e.batteryTemp>25?"🌡️":e.batteryTemp<15?"🧊":"🌡️",n=e.batteryTemp>25?"temp-hot":e.batteryTemp<15?"temp-cold":"",r=Math.abs(e.batteryPower)/1e3,a=Math.abs(e.batteryPower)>10,o=e.batteryPower>10,s=e.batteryPower<-10,d=o?"Nabíjí":s?"Vybíjí":"Klid",p=o?"st-charge":s?"st-discharge":"st-idle",u=`${o?"+":s?"−":""}${Tt(Math.abs(e.batteryPower))}`,h=y=>!!y&&/\d/.test(y),f=o&&h(e.timeToFull)?` · do plna ${e.timeToFull}`:s&&h(e.timeToEmpty)?` · do vybití ${e.timeToEmpty}`:"",b=e.batterySoC>=66?"rgba(67,160,71,0.13)":e.batterySoC>=33?"rgba(253,216,53,0.10)":"rgba(229,57,53,0.12)",m=e.batterySoC>=66?"#43a047":e.batterySoC>=33?"#fdd835":"#e53935";return c`
      <div class="${this.nodeClass("battery")}" style="--node-gradient: ${Ni.battery}; --node-border: ${In.battery};"
    ...
    `}getInverterModeDesc(){const e=this.data.inverterMode;return e.includes("Home 1")?"Max baterie + FVE":e.includes("Home 2")?"Šetří baterii":e.includes("Home 3")?"Priorita nabíjení":e.includes("UPS")?"Vše ze sítě":""}renderInverter(){const e=this.data,t=Hl(e.inverterMode),i=e.bypassStatus.toLowerCase()==="on"||e.bypassStatus==="1",n=e.inverterTemp>35?"🔥":"🌡️",r=Wl(e.inverterGridMode),a=ad(this.pendingServices,this.changingServices),o=rd(this.gridDeliveryState);let s="planner-unknown",d="Plánovač: N/A";e.plannerAutoMode===!0?(s="planner-auto",d="Plánovač: AUTO"):e.plannerAutoMode===!1&&(s="planner-off",d="Plánovač: VYPNUTO");const p=e.inverterMode,u=p.includes("UPS")?"#ff9800":p.includes("Home 2")?"#2196f3":p.includes("Home 3")?"#9c27b0":"#4caf50",h=e.inverterTemp>=45?"#e53935":e.inverterTemp>=35?"#ffa726":"#43a047",f=Math.max(0,Math.min(100,e.inverterTemp/55*100)),b=i?"#e53935":h;return c`
      <div class="${this.nodeClass("inverter",a.inverterModeChanging?"mode-changing":"")}" style="--node-gradient: ${Ni.inverter}; --node-border: ${In.inverter};"
    ...
    `}gridIconDefs(){return Y`
      ...
      </svg>`}iImp(){return Y`<svg class="gd-ic" viewBox="0 0 24 24"><use href="#gi-imp"/></svg>`}iExp(){return Y`<svg class="gd-ic" viewBox="0 0 24 24"><use href="#gi-exp"/></svg>`}fmtKwGrid(e){const t=Math.abs(e);return t>=1e3?`${(t/1e3).toFixed(1).replace(".",",")} kW`:`${Math.round(t)} W`}renderGrid(){var Yt,Zt;const e=this.data,t=[e.gridL1P,e.gridL2P,e.gridL3P],i=t.some(D=>D>10),n=t.some(D=>D<-10),r=i&&n,a=i&&!n,o=n&&!i,s=t.reduce((D,ye)=>D+ye,0),d=Math.abs(s),p=t.filter(D=>D>0).reduce((D,ye)=>D+ye,0),u=t.filter(D=>D<0).reduce((D,ye)=>D+Math.abs(ye),0),h=d/1e3,f=e.gridImportCostToday!==null||e.gridExportEarningsToday!==null,b=e.gridImportCostToday??0,m=e.gridExportEarningsToday??0,y=m-b,S=(e.gridExportEarningsMonth??0)-(e.gridImportCostMonth??0),v=y>=0?"#9fe6a8":"#ff8a80",_=D=>D.toFixed(2).replace(".",","),C=D=>(D>=0?"+":"−")+_(Math.abs(D)),H=25*230*3,F=e.inverterGridLimit>0?e.inverterGridLimit:5e3,R=o?d/F*100:d/H*100,k=D=>{const ye=D<0;return{txt:(ye?"−":"")+_(Math.abs(D)),cls:ye?"gd-col-imp":"gd-col-exp",earn:!ye}},A=D=>{const ye=D<0;return{txt:(ye?"+":"")+_(Math.abs(D)),cls:ye?"gd-col-exp":"gd-col-imp",earn:ye}},M=k(m),q=k(e.gridExportEarningsMonth??0),K=A(b),B=A(e.gridImportCostMonth??0),W=e.exportPrice>=0?"gd-col-exp":"gd-col-imp",Te=e.spotPrice<=0?"gd-col-exp":"gd-col-imp",Ae=207,X=253,ge=212,$=248,Z=[{v:e.gridL1V,label:"L1",entity:"ac_in_aci_vr"},{v:e.gridL2V,label:"L2",entity:"ac_in_aci_vs"},{v:e.gridL3V,label:"L3",entity:"ac_in_aci_vt"}],ee=Z.filter(D=>D.v>0),Fe=ee.length>0,De=Fe?ee.reduce((D,ye)=>D+ye.v,0)/ee.length:230,We=Fe?Math.min(...ee.map(D=>D.v)):230,Tr=Fe?Math.max(...ee.map(D=>D.v)):230,Tn=Math.max((Tr-We)/2+3,4),$t=De-Tn,Ut=De+Tn,Pr=Ut-$t,Mr=D=>D<Ae||D>X?"#e53935":D<ge||D>$?"#ffa726":"#66bb6a",Qe=D=>Math.max(0,Math.min(100,(D-$t)/Pr*100)),Ei=Z.map(D=>({...D,color:D.v>0?Mr(D.v):"rgba(0,0,0,0)",pct:D.v>0?Qe(D.v):50})),Dr=Ei.some(D=>D.v>0&&D.color==="#e53935"),Oi=Ut>$?Qe($):null,Li=$t<ge?Qe(ge):null,zr=$t<=230&&230<=Ut,Pn=Oi!==null?`limit ${X} V →`:Li!==null?`← limit ${Ae} V`:"norma 230 V ±10 %",Mn=e.gridFrequency>0?Math.abs(e.gridFrequency-50):0,Er=e.gridFrequency>0&&Mn>.5,Dn=e.gridFrequency>0&&Mn>.2,Or=Er?"gd-hz crit":Dn?"gd-hz warn":"gd-hz",Ai=e.currentTariff==="VT"||((Yt=e.currentTariff)==null?void 0:Yt.includes("vysoký")),zn=e.currentTariff==="NT"||((Zt=e.currentTariff)==null?void 0:Zt.includes("nízký")),Lr=Ai?"gd-tar vt":zn?"gd-tar nt":"gd-tar",Ar=Ai?"VT":zn?"NT":e.currentTariff||"--",Fi=Math.max(0,...t.filter(D=>D>0)),En=Math.max(0,...t.filter(D=>D<0).map(Math.abs)),On=Math.max(50,Fi+En),Ii=En/On*100,Fr=c`
      ...
      ${Fe?c`<div class="gp-r"><span>Napětí fází</span><b>${Z.map(D=>D.v>0?D.v.toFixed(0):"–").join(" · ")} V</b></div>`:w}
      <div class="gp-r"><span>Frekvence</span><b>${e.gridFrequency>0?e.gridFrequency.toFixed(2):"–"} Hz</b></div>
    `;return c`
      <div class="${this.nodeClass("grid")}" style="--node-gradient: ${Ni.grid}; --node-border: ${In.grid};"
        ...
        ${f?c`
          <div class="gd-cols">
            <div class="gd-col">
              <div class="gd-cprice ${W}">${_(e.exportPrice)} <small>Kč/kWh</small></div>
              <button class="gd-cmoney" @click=${te("computed_grid_export_earnings_today")}>
                ${Y`<svg class="gd-ic ${M.cls}" viewBox="0 0 24 24"><use href="#${M.earn?"gi-earn":"gi-cost"}"/></svg>`}
                <span class="gd-md ${M.cls}">${M.txt}<small> Kč</small></span>
                <span class="gd-mm ${q.cls}">${q.txt}</span>
              </button>
              <div class="gd-clbl gd-col-exp">${this.iExp()} dodávka</div>
            </div>
            <div class="gd-col">
              <div class="gd-cprice ${Te}">${_(e.spotPrice)} <small>Kč/kWh</small></div>
              <button class="gd-cmoney" @click=${te("computed_grid_import_cost_today")}>
                ${Y`<svg class="gd-ic ${K.cls}" viewBox="0 0 24 24"><use href="#${K.earn?"gi-earn":"gi-cost"}"/></svg>`}
        ...
        <div class="gd-ph">
          ${["L1","L2","L3"].map((D,ye)=>{const Ln=t[ye],Qt=Math.abs(Ln),kt=Math.min(100,Qt/On*100),Ir=Ln>10,Br=Ln<-10;return c`
              <div class="gd-phr">
                <span class="gd-pll">${D}</span>
                <div class="gd-ptr">
                  <div class="gd-zero" style="left:${Ii.toFixed(1)}%"></div>
                  ${Br?c`
                    <div class="gd-seg gd-sexp" style="left:${(Ii-kt).toFixed(1)}%;width:${kt.toFixed(1)}%">
                      ${kt>=22?c`${this.fmtKwGrid(Qt)}`:w}
                    </div>`:w}
                  ${Ir?c`
                    <div class="gd-seg gd-simp" style="left:${Ii.toFixed(1)}%;width:${kt.toFixed(1)}%">
                      ${kt>=22?c`${this.fmtKwGrid(Qt)}`:w}
                    </div>`:w}
                </div>
              </div>`})}
        ...
        ${Fe?c`
          <div class="gd-volt">
            <div class="gd-vnums">
              ${Ei.map((D,ye)=>c`
                <button class="gd-vval" style="${D.v>0&&D.color!=="#66bb6a"?`color:${D.color}`:""}" @click=${te(D.entity)}>
                  ${D.label} <b>${D.v>0?D.v.toFixed(0):"–"}</b>${ye===2?c` V`:w}
                </button>`)}
            </div>
            <div class="gd-vband">
              ${Oi!==null?c`<div class="gd-vwarn gd-vwarn-hi" style="left:${Oi.toFixed(1)}%;right:0"></div>`:w}
              ${Li!==null?c`<div class="gd-vwarn gd-vwarn-lo" style="left:0;width:${Li.toFixed(1)}%"></div>`:w}
              ${zr?c`<div class="gd-vnom" style="left:${Qe(230).toFixed(1)}%"></div>`:w}
              ${Ei.filter(D=>D.v>0).map(D=>c`
                <span class="gd-vdl" style="left:${D.pct.toFixed(1)}%">${D.label}</span>
                <div class="gd-vdot ${D.color==="#e53935"?"gd-vdot-crit":""}" style="left:${D.pct.toFixed(1)}%;background:${D.color}"></div>`)}
            </div>
            <div class="gd-vsc">
    ...
    `}renderHouse(){const e=this.data,t=e.houseTodayWh/1e3,i=e.nonbackupTodayWh/1e3,n=t+i,r=e.housePower+e.nonbackupPower,a=t+e.zalohaPlannedRemainingKwh,o=e.selfSufficiencyTodayPct,s=e.houseTodayWh+e.nonbackupTodayWh,d=s>0?e.srcBatteryTodayKwh*1e3/s*100:0,p=s>0?e.srcFveTodayKwh*1e3/s*100:0,u=s>0?e.srcGridTodayKwh*1e3/s*100:0,h=o>=66?"#43a047":o>=33?"#fdd835":"#e53935",f=`hsl(${Math.round(Math.max(0,Math.min(120,o*1.2)))}, 72%, 46%)`,b=n>0,m=b?n:1,y=b?Math.round(e.srcFveTodayKwh/m*100):0,S=b?Math.round(e.srcBatteryTodayKwh/m*100):0,v=b?Math.max(0,100-y-S):0,_=`Denní soběstačnost ${Math.round(o)} % · FVE ${y} % · Baterie ${S} % · Síť ${v} %`,C=Cd([e.houseL1,e.houseL2,e.houseL3]),H=[{z:e.houseL1,n:e.nonbackupL1,ze:"ac_out_aco_pr"},{z:e.houseL2,n:e.nonbackupL2,ze:"ac_out_aco_ps"},{z:e.houseL3,n:e.nonbackupL3,ze:"ac_out_aco_pt"}],F=Math.max(300,...H.map(X=>X.z+X.n)),R=Jn/F*100,k=R<=100,A=C.spreadW>=1e3?`${(C.spreadW/1e3).toFixed(1).replace(".",",")} kW`:`${Math.round(C.spreadW)} W`,M=H.map(X=>Math.max(0,X.z)/F*100),q=e.houseL1+e.houseL2+e.houseL3,K=Td(M,q),B=X=>X>=1e3?`${(X/1e3).toFixed(1).replace(".",",")} kW`:`${Math.round(X)} W`,W=26,Te=`Záloha ${Tt(e.housePower)} · dnes ${t.toFixed(1)} kWh${e.zalohaPlannedRemainingKwh>0?` · plán ${a.toFixed(1)} kWh`:""}`,Ae=`Nezáloha ${Tt(e.nonbackupPower)} · dnes ${i.toFixed(1)} kWh`;return c`
      <div class="${this.nodeClass("house")}" style="--node-gradient: ${Ni.house}; --node-border: ${In.house};"
        ...
        <div class="csplit">
          ...
          <button class="cs" @click=${te("actual_acinb_wtotal")} title=${Ae}>
        ...
        <div class="pg">
          ...
          ${H.map(X=>{const ge=X.z>=Jn,$=X.z+X.n,Z=Math.max(0,X.z)/F*100,ee=Math.max(0,X.n)/F*100,Fe=Z>=W&&X.z>100,De=ee>=W&&X.n>100;return c`
              <div class="pg-row">
                <div class="pg-track">
                  <div class="pg-z ${ge?"crit":""}" style="width:${Z.toFixed(1)}%">
                    ${Fe?B(X.z):w}
                  </div>
                  ${X.n>0?c`
  ...
  `;we([g({type:String})],Le.prototype,"title",2);we([g({type:String})],Le.prototype,"time",2);we([g({type:String})],Le.prototype,"valueText",2);we([g({type:Number})],Le.prototype,"value",2);we([g({type:String})],Le.prototype,"unit",2);we([g({type:String})],Le.prototype,"variant",2);we([g({type:Boolean})],Le.prototype,"clickable",2);we([g({type:String})],Le.prototype,"startTime",2);we([g({type:String})],Le.prototype,"endTime",2);we([g({type:Array})],Le.prototype,"sparklineValues",2);we([g({type:String})],Le.prototype,"sparklineColor",2);Le=we([O("oig-stats-card")],Le);function Fd(e){const t=new Date(e.start),i=new Date(e.end),n=t.toLocaleDateString("cs-CZ",{day:"2-digit",month:"2-digit"}),r=t.toLocaleTimeString("cs-CZ",{hour:"2-digit",minute:"2-digit"}),a=i.toLocaleTimeString("cs-CZ",{hour:"2-digit",minute:"2-digit"});return`${n} ${r} - ${a}`}let rn=class extends E{constructor(){super(...arguments),this.data=null,this.topOnly=!1}onCardClick(e){this.dispatchEvent(new CustomEvent("zoom-to-block",{detail:e.detail,bubbles:!0,composed:!0}))}renderPriceTiles(){if(!this.data)return w;const e=this.data.solarForecastTotal,t=this.data.solarForecastTomorrow,i=this.data.solarForecastStale,n=e>0||t>0,r=this.data.whatIf,a=(r==null?void 0:r.totalSavings)??null,o=(r==null?void 0:r.totalCost)??null,s=a==null?"":a>=.005?"pos":a<=-.005?"neg":"";return c`
    ...
    `}render(){return!this.data||this.data.timeline.length===0?this.topOnly?w:c`<div style="color: ${l.textSecondary}; padding: 16px;">Načítání cenových dat...</div>`:this.topOnly?c`
      ...
      `:c`${this.renderPlannedConsumption()}`}};rn.styles=z`
    :host {
      display: block;
      margin-bottom: 16px;
    }
...
`;function Fh(e){return Math.max(0,Math.min(100,e))}function So(e){const n=Math.max(0,Math.min(1,(e-10)/60)),r={r:33,g:150,b:243},a={r:255,g:87,b:34},o=(s,d)=>Math.round(s+(d-s)*n);return`rgb(${o(r.r,a.r)}, ${o(r.g,a.g)}, ${o(r.b,a.b)})`}let an=class extends E{constructor(){super(...arguments),this.collapsed=!0,this.busy=!1}toggle(){this.collapsed=!this.collapsed}async doAction(e,t){this.busy=!0;try{const i=await e();this.dispatchEvent(new CustomEvent("action-done",{detail:{success:i,label:t},bubbles:!0,composed:!0}))}finally{this.busy=!1}}render(){return c`
  ...
  `;N([P()],an.prototype,"collapsed",2);N([P()],an.prototype,"busy",2);an=N([O("oig-boiler-debug-panel")],an);let ir=class extends E{constructor(){super(...arguments),this.data=null}render(){const e=this.data;if(!e)return c`<div>Nacitani stavu...</div>`;const t=(i,n,r=1)=>i!=null?`${i.toFixed(r)} ${n}`:`-- ${n}`;return c`
      <h3>Stav bojleru</h3>
      <div class="grid">
        <div class="card">
  ...
  `;N([g({type:Object})],rr.prototype,"data",2);rr=N([O("oig-boiler-predicted-usage")],rr);let on=class extends E{constructor(){super(...arguments),this.plan=null,this.forecastWindows={fve:"--",grid:"--"}}render(){var n;const e=this.plan,t=this.forecastWindows,i=r=>r??"--";return c`
  ...
  `;N([g({type:Object})],on.prototype,"plan",2);N([g({type:Object})],on.prototype,"forecastWindows",2);on=N([O("oig-boiler-plan-info")],on);let sn=class extends E{constructor(){super(...arguments),this.boilerState=null,this.targetTemp=60}render(){const e=this.boilerState;if(!e)return c`<div>Nacitani...</div>`;const t=10,i=70,n=b=>Fh((b-t)/(i-t)*100),r=e.heatingPercent??0,a=e.tempTop!==null?n(e.tempTop):null,o=e.tempBottom!==null?n(e.tempBottom):null,s=n(this.targetTemp),d=So(e.tempTop??this.targetTemp),p=So(e.tempBottom??10),u=`linear-gradient(180deg, ${d} 0%, ${p} 100%)`,h=e.heatingPercent!==null?`${e.heatingPercent.toFixed(0)}% nahrato`:"-- % nahrato";return c`
  ...
  `;N([g({type:Object})],sn.prototype,"boilerState",2);N([g({type:Number})],sn.prototype,"targetTemp",2);sn=N([O("oig-boiler-tank")],sn);let ln=class extends E{constructor(){super(...arguments),this.current="",this.available=[]}onChange(e){const t=e.target.value;this.dispatchEvent(new CustomEvent("category-change",{detail:{category:t},bubbles:!0,composed:!0}))}render(){const e=this.available.length?this.available:Object.keys(ca);return c`
      <div class="row">
        <label>Profil:</label>
  ...
  `;N([g({type:String})],ln.prototype,"current",2);N([g({type:Array})],ln.prototype,"available",2);ln=N([O("oig-boiler-category-select")],ln);let ar=class extends E{constructor(){super(...arguments),this.data=[]}render(){if(!this.data.length)return w;const e=this.data.flatMap(o=>o.hours),t=Math.max(...e,.1),i=t*.3,n=t*.7,r=Array.from({length:24},(o,s)=>s),a=o=>o===0?"none":o<i?"low":o<n?"medium":"high";return c`
  ...
  `;N([g({attribute:!1})],cn.prototype,"data",2);N([g({type:String})],cn.prototype,"lang",2);cn=N([O("oig-boiler-demand-map")],cn);let cr=class extends E{constructor(){super(...arguments),this.state=null}render(){return this.state?c`
  ...
  `;N([g({type:Object})],cr.prototype,"state",2);cr=N([O("oig-boiler-state")],cr);let dr=class extends E{constructor(){super(...arguments),this.data=[]}render(){return w}};dr.styles=z`
    :host { display: block; }
  `;N([g({type:Array})],dr.prototype,"data",2);dr=N([O("oig-boiler-heatmap")],dr);let dn=class extends E{constructor(){super(...arguments),this.profiles=[],this.editMode=!1}render(){return w}};dn.styles=z`
    :host { display: block; }
  `;N([g({type:Array})],dn.prototype,"profiles",2);N([g({type:Boolean})],dn.prototype,"editMode",2);dn=N([O("oig-boiler-profiles")],dn);let pn=class extends E{constructor(){super(...arguments),this.data=null,this.lang="cs"}render(){const e=this.data,t=this.lang,i=(e==null?void 0:e.currentState)??"unknown",n=x(`boiler.status.${i}`,t),r=(e==null?void 0:e.comfortSatisfied)===!0?x("boiler.status.comfort_satisfied",t):(e==null?void 0:e.comfortSatisfied)===!1?x("boiler.status.comfort_unsatisfied",t):x("boiler.status.comfort_unknown",t),a=(e==null?void 0:e.comfortSatisfied)===!0?"ok":(e==null?void 0:e.comfortSatisfied)===!1?"bad":"unknown",o=(e==null?void 0:e.degradedFlags)??[];return c`
  ...
  `;N([g({attribute:!1})],pn.prototype,"data",2);N([g({type:String})],pn.prototype,"lang",2);pn=N([O("oig-boiler-status-panel")],pn);let un=class extends E{constructor(){super(...arguments),this.slots=[],this.lang="cs"}srcClass(e){return e&&["fve","grid","alternative","overflow","discharge"].includes(e)?e:"other"}render(){const e=this.lang;return!this.slots||this.slots.length===0?c`<div data-testid="boiler-plan-timeline" class="wrap"><div class="heading">${x("boiler.timeline.heading",e)}</div><div class="empty">${x("boiler.timeline.empty",e)}</div></div>`:c`
  ...
  `;N([g({attribute:!1})],un.prototype,"slots",2);N([g({type:String})],un.prototype,"lang",2);un=N([O("oig-boiler-plan-timeline")],un);const To=new Set(["input_stale_price","input_stale_pv","input_stale_temperature","input_missing_recorder","input_adapter_error"]);let hn=class extends E{constructor(){super(...arguments),this.explanation=null,this.lang="cs"}render(){const e=this.explanation,t=this.lang;if(!e)return c`<div data-testid="boiler-source-explanation" class="wrap"><div class="heading">${x("boiler.explanation.heading",t)}</div><div class="empty">${x("boiler.explanation.empty",t)}</div></div>`;const i=e.reasonCodes??[],n=i.filter(o=>To.has(o)),r=i.filter(o=>!To.has(o)),a=e.degradedReasons??[];return c`
  ...
  `;N([g({attribute:!1})],hn.prototype,"explanation",2);N([g({type:String})],hn.prototype,"lang",2);hn=N([O("oig-boiler-source-explanation")],hn);let bi=class extends E{constructor(){super(...arguments),this.identity={entryId:null,boxId:null,available:!1},this.currentOverride=null,this.lang="cs"}render(){var a,o;const e=this.lang,t=this.identity.available,i=((a=this.currentOverride)==null?void 0:a.capabilityAvailable)??!1,n=t&&i,r=((o=this.currentOverride)==null?void 0:o.active)===!0;return c`
      ...
      <div class="timeline-section">
        ...
        `:c`
          <div class="chart-wrap">
            ...
            >
              ${Y`<rect x="0" y="0" width="${Qi}" height="${ri}" fill="transparent" />`}
              ...
              ${Y`<line x1="0" y1="${et}" x2="${Qi}" y2="${et}" stroke="rgba(255,255,255,.08)" stroke-width="1"/>`}
              ...
              ${b.map($=>{let Z;try{Z=Date.parse($.timestamp)}catch{return""}if(!isFinite(Z))return"";const ee=(Z-i)/6e4;if(ee<0||ee>Et||$.powerKw!==null)return"";const Fe=Oo(Z,m,e),De=Fe?Lo(Fe,e):null;if(De!==null&&De>0)return"";const We=tt(ee);return Y`<rect
        ...
        <div class="footer-meta">
          <div>
            ...
            ${Ae?c`<span class="degraded-chip">⚠ FVE predikce: stará data</span>`:""}
          </div>
        </div>
      </div>
 ...
 */class ya extends Mg{constructor(t){if(super(t),this.it=w,t.type!==Tg.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===w||t==null)return this._t=void 0,this.it=t;if(t===Js)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const i=[t];return i.raw=i,this._t={_$litType$:this.constructor.resultType,strings:i,values:[]}}}ya.directiveName="unsafeHTML",ya.resultType=1;const Dg=Pg(ya);var zg=Object.defineProperty,Eg=Object.getOwnPropertyDescriptor,Cn=(e,t,i,n)=>{for(var r=n>1?void 0:n?Eg(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(r=(n?o(t,i,r):o(r))||r);return n&&r&&zg(t,i,r),r};const Pe=Q;let Rt=class extends E{constructor(){super(...arguments),this.open=!1,this.config={title:"",message:""},this.acknowledged=!1,this.limitValue=5e3,this.resolver=null,this.onOverlayClick=()=>{this.closeDialog({confirmed:!1})},this.onDialogClick=e=>{e.stopPropagation()},this.onKeyDown=e=>{e.key==="Escape"&&this.open&&this.closeDialog({confirmed:!1})},this.onAckChange=e=>{this.acknowledged=e.target.checked},this.onLimitInput=e=>{this.limitValue=parseInt(e.target.value,10)||0},this.onCancel=()=>{this.closeDialog({confirmed:!1})},this.onConfirm=()=>{const e=this.config.showLimitInput||this.config.limitOnly;if(e){const t=this.config.limitMin??1,i=this.config.limitMax??2e4;if(isNaN(this.limitValue)||this.limitValue<t||this.limitValue>i)return}this.closeDialog({confirmed:!0,limit:e?this.limitValue:void 0})}}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.onKeyDown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("keydown",this.onKeyDown)}showDialog(e){return this.config=e,this.acknowledged=!1,this.limitValue=e.limitValue??5e3,this.open=!0,new Promise(t=>{this.resolver=t})}closeDialog(e){var t;this.open=!1,(t=this.resolver)==null||t.call(this,e),this.resolver=null}get canConfirm(){return!(this.config.requireAcknowledgement&&!this.acknowledged)}render(){if(!this.open)return w;const e=this.config;return e.limitOnly?c`
  ...
  `;Cn([g({type:Boolean,reflect:!0})],Rt.prototype,"open",2);Cn([g({type:Object})],Rt.prototype,"config",2);Cn([P()],Rt.prototype,"acknowledged",2);Cn([P()],Rt.prototype,"limitValue",2);Rt=Cn([O("oig-confirm-dialog")],Rt);var Og=Object.defineProperty,Lg=Object.getOwnPropertyDescriptor,Fs=(e,t,i,n)=>{for(var r=n>1?void 0:n?Lg(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(r=(n?o(t,i,r):o(r))||r);return n&&r&&Og(t,i,r),r};const Gi=Q;let ur=class extends E{constructor(){super(...arguments),this.shieldState=null}render(){if(!this.shieldState)return w;const e=this.determineStatus(this.shieldState),t=e.toLowerCase(),i=this.getStatusIcon(e),n=this.getStatusLabel(e),a=this.shieldState.queueCount>0?"has-items":"";return c`
  ...
  `;Cr([g({type:Boolean})],wi.prototype,"boxHasHome56",2);Cr([P()],wi.prototype,"shieldState",2);Cr([yr("oig-confirm-dialog")],wi.prototype,"_confirmDialogQuery",2);wi=Cr([O("oig-control-panel")],wi);var Ig=Object.defineProperty,Bg=Object.getOwnPropertyDescriptor,Di=(e,t,i,n)=>{for(var r=n>1?void 0:n?Bg(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(r=(n?o(t,i,r):o(r))||r);return n&&r&&Ig(t,i,r),r};const Ee=Q;let vt=class extends E{constructor(){super(...arguments),this.open=!1,this.currentSoc=0,this.maxSoc=100,this.estimate=null,this.targetSoc=80}onClose(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0}))}onSliderInput(e){this.targetSoc=parseInt(e.target.value,10),this.dispatchEvent(new CustomEvent("soc-change",{detail:{targetSoc:this.targetSoc},bubbles:!0}))}onConfirm(){this.dispatchEvent(new CustomEvent("confirm",{detail:{targetSoc:this.targetSoc},bubbles:!0}))}render(){return c`
...
`;let gn=class extends E{constructor(){super(...arguments),this.title="",this.icon="📊"}render(){return c`
    ...
    ${Ea}
  `;Ke([g({type:String})],gn.prototype,"title",2);Ke([g({type:String})],gn.prototype,"icon",2);gn=Ke([O("oig-analytics-block")],gn);let hr=class extends E{constructor(){super(...arguments),this.data=null}render(){if(!this.data)return c`<div>Načítání...</div>`;const e=this.data.trend>=0?"positive":"negative",t=this.data.trend>=0?"+":"",i=this.data.period==="last_month"?"Minulý měsíc":`Aktuální měsíc (${this.data.currentMonthDays} dní)`;return c`
  ...
  `;zi([g({type:Object})],fn.prototype,"data",2);zi([g({type:Boolean})],fn.prototype,"compact",2);fn=zi([O("oig-chmu-badge")],fn);let bn=class extends E{constructor(){super(...arguments),this.open=!1,this.data=Ji}onClose(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0}))}formatTime(e){return e?new Date(e).toLocaleString("cs-CZ"):"—"}renderWarning(e){const t=Zn[e.severity]??Zn[2],i=as(e.event_type),n=os[e.severity]??"Neznámá";return c`

...
Opravdu chcete přidat další úkol?`)}async setBoxMode(t){if(this.state.currentBoxMode===t&&!this.state.changingServices.has("box_mode"))return!1;const i=await re.callService("oig_cloud","set_box_mode",{mode:t,acknowledgement:!0});return i&&this.refresh(),i}async setGridDelivery(t,i){const r={acknowledgement:!0,warning:!0};t==="limited"&&i!=null?(this.needsGridModeChangeForLimitedRequest()&&(r.mode=t),r.limit=i):i!=null?r.limit=i:r.mode=t;const n=await re.callService("oig_cloud","set_grid_delivery",r);return n&&this.refresh(),n}async setBoilerMode(t){if(this.state.currentBoilerMode===t&&!this.state.changingServices.has("boiler_mode"))return!1;const i=await re.callService("oig_cloud","set_boiler_mode",{mode:t,acknowledgement:!0});return i&&this.refresh(),i}async removeFromQueue(t){const i=await re.callService("oig_cloud","shield_remove_from_queue",{position:t});return i&&this.refresh(),i}async setSupplementaryToggle(t,i){const r=await re.callService("oig_cloud","set_box_mode",{[t]:i,acknowledgement:!0});return r&&this.refresh(),r}notify(){for(const t of this.listeners)try{t(this.state)}catch(i){_.error("ShieldController listener error",i)}}}const ie=new Sc;var Cc=Object.defineProperty,Tc=Object.getOwnPropertyDescriptor,Mt=(e,t,i,r)=>{for(var n=r>1?void 0:r?Tc(t,i):t,a=e.length-1,s;a>=0;a--)(s=e[a])&&(n=(r?s(t,i,n):s(n))||n);return r&&n&&Cc(t,i,n),n};const Ce=G;let Ze=class extends D{constructor(){super(...arguments),this.title="Energetické Toky",this.time="",this.showStatus=!1,this.alertCount=0,this.leftPanelCollapsed=!1,this.rightPanelCollapsed=!1}onStatusClick(){this.dispatchEvent(new CustomEvent("status-click",{bubbles:!0}))}onEditClick(){this.dispatchEvent(new CustomEvent("edit-click",{bubbles:!0}))}onResetClick(){this.dispatchEvent(new CustomEvent("reset-click",{bubbles:!0}))}onToggleLeftPanel(){this.dispatchEvent(new CustomEvent("toggle-left-panel",{bubbles:!0}))}onToggleRightPanel(){this.dispatchEvent(new CustomEvent("toggle-right-panel",{bubbles:!0}))}render(){const e=this.alertCount>0?"warning":"ok";return c`
  ...
  `;er([g({type:String})],St.prototype,"mode",2);er([g({type:Boolean})],St.prototype,"bypassActive",2);er([g({type:Boolean})],St.prototype,"hasAlarm",2);er([g({type:Boolean})],St.prototype,"plannerAuto",2);St=er([E("oig-inverter-icon")],St);var Zc=Object.defineProperty,Qc=Object.getOwnPropertyDescriptor,He=(e,t,i,r)=>{for(var n=r>1?void 0:r?Qc(t,i):t,a=e.length-1,s;a>=0;a--)(s=e[a])&&(n=(r?s(t,i,n):s(n))||n);return r&&n&&Zc(t,i,n),n};const U=G,Pa=new URLSearchParams(window.location.search),Xc=Pa.get("sn")||Pa.get("inverter_sn")||"",Jc=e=>`sensor.oig_${Xc}_${e}`,on="oig_v2_flow_layout_",gt=["solar","battery","inverter","grid","house"],ed={solar:{top:"0%",left:"0%"},house:{top:"0%",left:"65%"},inverter:{top:"35%",left:"35%"},grid:{top:"70%",left:"0%"},battery:{top:"70%",left:"65%"}};function F(e){return()=>re.openEntityDialog(Jc(e))}let Ee=class extends D{constructor(){super(...arguments),this.data=On,this.editMode=!1,this.pendingServices=new Map,this.changingServices=new Set,this.shieldStatus="idle",this.shieldQueueCount=0,this.gridDeliveryState={currentLiveDelivery:"unknown",currentLiveLimit:null,pendingDeliveryTarget:null,pendingLimitTarget:null,isTransitioning:!1,isUnavailable:!1},this.shieldUnsub=null,this.expandedNodes=new Set,this.customPositions={},this.draggedNodeId=null,this.dragStartX=0,this.dragStartY=0,this.dragStartTop=0,this.dragStartLeft=0,this.onShieldUpdate=e=>{this.pendingServices=e.pendingServices,this.changingServices=e.changingServices,this.shieldStatus=e.status,this.shieldQueueCount=e.queueCount,this.gridDeliveryState=e.gridDeliveryState},this.handleDragStart=e=>{if(!this.editMode)return;e.preventDefault(),e.stopPropagation();const i=e.target.closest(".node");if(!i)return;const r=this.findNodeId(i);if(!r)return;this.draggedNodeId=r,i.classList.add("dragging");const n=i.getBoundingClientRect();this.dragStartX=e.clientX,this.dragStartY=e.clientY,this.dragStartTop=n.top,this.dragStartLeft=n.left},this.handleTouchStart=e=>{if(!this.editMode)return;e.preventDefault();const i=e.target.closest(".node");if(!i)return;const r=this.findNodeId(i);if(!r)return;this.draggedNodeId=r,i.classList.add("dragging");const n=e.touches[0],a=i.getBoundingClientRect();this.dragStartX=n.clientX,this.dragStartY=n.clientY,this.dragStartTop=a.top,this.dragStartLeft=a.left},this.handleDragMove=e=>{!this.draggedNodeId||!this.editMode||(e.preventDefault(),this.updateDragPosition(e.clientX,e.clientY))},this.handleTouchMove=e=>{if(!this.draggedNodeId||!this.editMode)return;e.preventDefault();const t=e.touches[0];this.updateDragPosition(t.clientX,t.clientY)},this.handleDragEnd=e=>{var r;if(!this.draggedNodeId||!this.editMode)return;const t=(r=this.shadowRoot)==null?void 0:r.querySelector(".flow-grid"),i=t==null?void 0:t.querySelector(`.node-${this.draggedNodeId}`);i&&i.classList.remove("dragging"),this.saveLayout(),this.dispatchEvent(new CustomEvent("layout-changed",{bubbles:!0,composed:!0})),this.draggedNodeId=null},this.handleTouchEnd=e=>{this.handleDragEnd(e)}}connectedCallback(){super.connectedCallback(),this.loadSavedLayout(),this.shieldUnsub=ie.subscribe(this.onShieldUpdate)}disconnectedCallback(){var e;super.disconnectedCallback(),this.removeDragListeners(),(e=this.shieldUnsub)==null||e.call(this),this.shieldUnsub=null}updated(e){e.has("editMode")&&(this.editMode?(this.setAttribute("editmode",""),this.loadSavedLayout(),this.requestUpdate(),this.updateComplete.then(()=>this.applySavedPositions())):(this.removeAttribute("editmode"),this.removeDragListeners(),this.clearInlinePositions(),this.updateComplete.then(()=>this.applyCustomPositions()))),!this.editMode&&this.hasCustomLayout&&this.updateComplete.then(()=>this.applyCustomPositions())}loadSavedLayout(){const e=Yt(window.innerWidth),t=`${on}${e}`;try{const i=localStorage.getItem(t);i&&(this.customPositions=JSON.parse(i),_.debug("[FlowNode] Loaded layout for "+e))}catch{}}applySavedPositions(){var t;if(!this.editMode)return;const e=(t=this.shadowRoot)==null?void 0:t.querySelector(".flow-grid");if(e){for(const i of gt){const r=this.customPositions[i];if(!r)continue;const n=e.querySelector(`.node-${i}`);n&&(n.style.top=r.top,n.style.left=r.left)}this.initDragListeners()}}clearInlinePositions(){var t;const e=(t=this.shadowRoot)==null?void 0:t.querySelector(".flow-grid");if(e)for(const i of gt){const r=e.querySelector(`.node-${i}`);r&&(r.style.top="",r.style.left="")}}saveLayout(){const e=Yt(window.innerWidth),t=`${on}${e}`;try{localStorage.setItem(t,JSON.stringify(this.customPositions)),_.debug("[FlowNode] Saved layout for "+e)}catch{}}toggleExpand(e,t){const i=t.target;if(i.closest(".clickable")||i.closest(".indicator")||i.closest(".forecast-badge")||i.closest(".node-value")||i.closest(".node-subvalue")||i.closest(".gc-plan-btn"))return;const r=new Set(this.expandedNodes);r.has(e)?r.delete(e):r.add(e),this.expandedNodes=r}nodeClass(e,t=""){const i=this.expandedNodes.has(e)?" expanded":"";return`node node-${e}${i}${t?" "+t:""}`}get hasCustomLayout(){return gt.some(e=>{const t=this.customPositions[e];return(t==null?void 0:t.top)!=null&&(t==null?void 0:t.left)!=null})}applyCustomPositions(){var t;if(this.editMode||!this.hasCustomLayout)return;const e=(t=this.shadowRoot)==null?void 0:t.querySelector(".flow-grid");if(e)for(const i of gt){const r=e.querySelector(`.node-${i}`);if(!r)continue;const n=this.customPositions[i]??ed[i];r.style.top=n.top,r.style.left=n.left}}resetLayout(){const e=Yt(window.innerWidth),t=`${on}${e}`;localStorage.removeItem(t),this.customPositions={},this.clearInlinePositions(),this.editMode&&this.requestUpdate(),_.debug("[FlowNode] Reset layout for "+e)}initDragListeners(){var t;const e=(t=this.shadowRoot)==null?void 0:t.querySelector(".flow-grid");if(e){for(const i of gt){const r=e.querySelector(`.node-${i}`);r&&(r.addEventListener("mousedown",this.handleDragStart),r.addEventListener("touchstart",this.handleTouchStart,{passive:!1}))}document.addEventListener("mousemove",this.handleDragMove),document.addEventListener("mouseup",this.handleDragEnd),document.addEventListener("touchmove",this.handleTouchMove,{passive:!1}),document.addEventListener("touchend",this.handleTouchEnd)}}removeDragListeners(){document.removeEventListener("mousemove",this.handleDragMove),document.removeEventListener("mouseup",this.handleDragEnd),document.removeEventListener("touchmove",this.handleTouchMove),document.removeEventListener("touchend",this.handleTouchEnd)}findNodeId(e){for(const i of gt)if(e.classList.contains(`node-${i}`))return i;const t=e.closest('[class*="node-"]');if(!t)return null;for(const i of gt)if(t.classList.contains(`node-${i}`))return i;return null}updateDragPosition(e,t){var x;if(!this.draggedNodeId)return;const i=(x=this.shadowRoot)==null?void 0:x.querySelector(".flow-grid");if(!i)return;const r=i.querySelector(`.node-${this.draggedNodeId}`);if(!r)return;const n=i.getBoundingClientRect(),a=r.getBoundingClientRect(),s=e-this.dragStartX,l=t-this.dragStartY,d=this.dragStartLeft+s,u=this.dragStartTop+l,p=n.left,h=n.right-a.width,b=n.top,f=n.bottom-a.height,m=Math.max(p,Math.min(h,d)),v=Math.max(b,Math.min(f,u)),$=(m-n.left)/n.width*100,w=(v-n.top)/n.height*100;r.style.left=`${$}%`,r.style.top=`${w}%`,this.customPositions[this.draggedNodeId]={top:`${w}%`,left:`${$}%`},this.dispatchEvent(new CustomEvent("layout-changed",{bubbles:!0,composed:!0}))}renderSolar(){const e=this.data,t=e.solarPercent,i=t<2,r=i?"linear-gradient(135deg, rgba(57,73,171,0.25) 0%, rgba(26,35,126,0.18) 100%)":vi.solar,n=i?"rgba(121,134,203,0.5)":yi.solar,a=i?"position:absolute;top:4px;left:6px;font-size:11px;background:rgba(57,73,171,0.35);color:#9fa8da;padding:3px 8px;border-radius:4px;border:1px solid rgba(121,134,203,0.4)":"position:absolute;top:4px;left:6px;font-size:9px",s=i?"position:absolute;top:4px;right:6px;font-size:11px;background:rgba(57,73,171,0.35);color:#9fa8da;padding:3px 8px;border-radius:4px;border:1px solid rgba(121,134,203,0.4)":"position:absolute;top:4px;right:6px;font-size:9px";return c`
      <div class="${this.nodeClass("solar",i?"night":"")}" style="--node-gradient: ${r}; --node-border: ${n};"
        ...
        <div class="node-value" @click=${F("actual_fv_total")}>
          ${Ft(e.solarPower)}
        </div>
        <div class="node-subvalue" @click=${F("dc_in_fv_ad")}>
          Dnes: ${(e.solarToday/1e3).toFixed(2)} kWh
        </div>

        <button class="indicator" style="${a}" @click=${F("solar_forecast")}
        ...
        <button class="indicator" style="${s}" @click=${F("solar_forecast")}
          ...
          <div class="solar-strings">
            <div>
              ...
              <div class="detail-row">
                ...
                <button class="clickable" @click=${F("extended_fve_voltage_1")}>${Math.round(e.solarV1)}V</button>
              </div>
              <div class="detail-row">
                <span class="icon">〰️</span>
                <button class="clickable" @click=${F("extended_fve_current_1")}>${e.solarI1.toFixed(1)}A</button>
              </div>
              <div class="detail-row">
                <span class="icon">⚡</span>
                <button class="clickable" @click=${F("dc_in_fv_p1")}>${Math.round(e.solarP1)} W</button>
              </div>
            </div>
            <div>
              ...
              <div class="detail-row">
                <span class="icon">⚡</span>
                <button class="clickable" @click=${F("extended_fve_voltage_2")}>${Math.round(e.solarV2)}V</button>
              </div>
              <div class="detail-row">
                <span class="icon">〰️</span>
                <button class="clickable" @click=${F("extended_fve_current_2")}>${e.solarI2.toFixed(1)}A</button>
              </div>
              <div class="detail-row">
                <span class="icon">⚡</span>
                <button class="clickable" @click=${F("dc_in_fv_p2")}>${Math.round(e.solarP2)} W</button>
              </div>
            </div>
          </div>
        </div>
    ...
    `}openGridChargingDialog(){this.dispatchEvent(new CustomEvent("oig-grid-charging-open",{bubbles:!0,composed:!0,detail:{data:this.data.gridChargingPlan}}))}getBatteryStatus(){const e=this.data;return e.batteryPower>10?{text:`⚡ Nabíjení${e.timeToFull?` (${e.timeToFull})`:""}`,cls:"status-charging pulse"}:e.batteryPower<-10?{text:`⚡ Vybíjení${e.timeToEmpty?` (${e.timeToEmpty})`:""}`,cls:"status-discharging pulse"}:{text:"◉ Klid",cls:"status-idle"}}getBalancingIndicator(){const e=this.data,t=e.balancingState;return t!=="charging"&&t!=="holding"&&t!=="completed"?{show:!1,text:"",icon:"",cls:""}:t==="charging"?{show:!0,text:`Nabíjení${e.balancingTimeRemaining?` (${e.balancingTimeRemaining})`:""}`,icon:"⚡",cls:"charging"}:t==="holding"?{show:!0,text:`Držení${e.balancingTimeRemaining?` (${e.balancingTimeRemaining})`:""}`,icon:"⏸️",cls:"holding"}:{show:!0,text:"Dokončeno",icon:"✅",cls:"completed"}}renderBattery(){const e=this.data,t=this.getBatteryStatus(),i=this.getBalancingIndicator(),r=e.batteryPower>10,n=e.batteryTemp>25?"🌡️":e.batteryTemp<15?"🧊":"🌡️",a=e.batteryTemp>25?"temp-hot":e.batteryTemp<15?"temp-cold":"";return c`
      <div class="${this.nodeClass("battery")}" style="--node-gradient: ${vi.battery}; --node-border: ${yi.battery};"
        ...
        <div class="node-value" @click=${F("batt_bat_c")}>
          ${Math.round(e.batterySoC)} %
        </div>
        <div class="node-subvalue" @click=${F("batt_batt_comp_p")}>
          ${Ft(e.batteryPower)}
        </div>
        ...
        <div class="battery-indicators">
          <button class="indicator" @click=${F("extended_battery_voltage")}>
            ⚡ ${e.batteryVoltage.toFixed(1)} V
          </button>
          <button class="indicator" @click=${F("extended_battery_current")}>
            〰️ ${e.batteryCurrent.toFixed(1)} A
          </button>
          <button class="indicator ${a}" @click=${F("extended_battery_temperature")}>
        ...
        <div class="battery-energy-section">
          ...
          <div class="energy-grid">
            <div class="detail-row">
              <span class="icon">⬆️</span>
              <button class="clickable" @click=${F("computed_batt_charge_energy_today")}>
                Nab: ${It(e.batteryChargeTotal)}
              </button>
            </div>
            <div class="detail-row">
              <span class="icon">⬇️</span>
              <button class="clickable" @click=${F("computed_batt_discharge_energy_today")}>
                Vyb: ${It(e.batteryDischargeTotal)}
              </button>
            </div>
            <div class="detail-row">
              <span class="icon">☀️</span>
              <button class="clickable" @click=${F("computed_batt_charge_fve_energy_today")}>
                FVE: ${It(e.batteryChargeSolar)}
              </button>
            </div>
            <div class="detail-row">
              <span class="icon">🔌</span>
              <button class="clickable" @click=${F("computed_batt_charge_grid_energy_today")}>
    ...
    `}getInverterModeDesc(){const e=this.data.inverterMode;return e.includes("Home 1")?"Max baterie + FVE":e.includes("Home 2")?"Šetří baterii":e.includes("Home 3")?"Priorita nabíjení":e.includes("UPS")?"Vše ze sítě":""}renderInverter(){const e=this.data,t=_l(e.inverterMode),i=e.bypassStatus.toLowerCase()==="on"||e.bypassStatus==="1",r=e.inverterTemp>35?"🔥":"🌡️",n=kl(e.inverterGridMode),a=Ic(this.pendingServices,this.changingServices),s=Fc(this.gridDeliveryState);let l="planner-unknown",d="Plánovač: N/A";return e.plannerAutoMode===!0?(l="planner-auto",d="Plánovač: AUTO"):e.plannerAutoMode===!1&&(l="planner-off",d="Plánovač: VYPNUTO"),c`
      <div class="${this.nodeClass("inverter",a.inverterModeChanging?"mode-changing":"")}" style="--node-gradient: ${vi.inverter}; --node-border: ${yi.inverter};"
        ...
        <div class="node-value" @click=${F("box_prms_mode")}>
        ...
        <div class="battery-indicators" style="margin-top:6px">
          <button class="indicator" @click=${F("box_temp")}>
            ${r} ${e.inverterTemp.toFixed(1)} °C
          </button>
          <button class="indicator ${i?"bypass-warning":""}" @click=${F("bypass_status")}>
        ...
        <div class="battery-indicators" style="margin-top:4px">
          <button class="indicator ${s.isUnavailable?"current-state-unknown":""}" @click=${F("invertor_prms_to_grid")}>
          ...
          <button class="clickable notif-badge ${e.notificationsError>0?"has-error":e.notificationsUnread>0?"has-unread":"indicator"}"
            @click=${F("notification_count_unread")}>
        ...
        <div class="detail-section">
          ...
          ${s.limitLabel!==null?c`
            <div class="detail-row">
              ...
              <button class="clickable ${s.showLimitAsActive?"limit-active":""}" @click=${F("invertor_prm1_p_max_feed_grid")}>
                ${s.limitValue}
              </button>
            </div>
          `:O}
    ...
    `}getGridStatus(){const e=this.data.gridPower;return e>10?{text:"⬇ Import",cls:"status-importing pulse"}:e<-10?{text:"⬆ Export",cls:"status-exporting pulse"}:{text:"◉ Žádný tok",cls:"status-idle"}}renderGrid(){const e=this.data,t=this.getGridStatus();return c`
      <div class="${this.nodeClass("grid")}" style="--node-gradient: ${vi.grid}; --node-border: ${yi.grid};"
        ...
        <button class="indicator" style="position:absolute;top:4px;left:6px;font-size:9px" @click=${F("current_tariff")}>
          ${$l(e.currentTariff)}
        </button>
        <!-- Frekvence vpravo nahoře -->
        <button class="indicator" style="position:absolute;top:4px;right:6px;font-size:9px" @click=${F("ac_in_aci_f")}>
        ...
        <!-- Hlavní hodnota -->
        <div class="node-value" @click=${F("actual_aci_wtotal")}>
          ${Ft(e.gridPower)}
        </div>
        <div class="node-status ${t.cls}">${t.text}</div>
        ...
        <div class="prices-row" style="margin-top:4px">
          <div class="price-cell">
            ...
            <button class="price-val price-spot" @click=${F("spot_price_current_15min")}>
          ...
          <div class="price-cell">
            ...
            <button class="price-val price-export" @click=${F("export_price_current_15min")}>
        ...
        <div class="phases-grid" style="margin-top:6px">
          <div class="phase-cell">
            ...
            <button class="phase-val" @click=${F("actual_aci_wr")}>${Math.round(e.gridL1P)}W</button>
            <button class="phase-val" style="font-size:10px;color:${U(o.textSecondary)}" @click=${F("ac_in_aci_vr")}>${Math.round(e.gridL1V)}V</button>
          </div>
          <div class="phase-cell">
            <span class="phase-label">L2</span>
            <button class="phase-val" @click=${F("actual_aci_ws")}>${Math.round(e.gridL2P)}W</button>
            <button class="phase-val" style="font-size:10px;color:${U(o.textSecondary)}" @click=${F("ac_in_aci_vs")}>${Math.round(e.gridL2V)}V</button>
          </div>
          <div class="phase-cell">
            <span class="phase-label">L3</span>
            <button class="phase-val" @click=${F("actual_aci_wt")}>${Math.round(e.gridL3P)}W</button>
            <button class="phase-val" style="font-size:10px;color:${U(o.textSecondary)}" @click=${F("ac_in_aci_vt")}>${Math.round(e.gridL3V)}V</button>
          </div>
        </div>
        ...
        <div class="detail-section">
          ...
          <div class="energy-symmetric">
            <div class="energy-side">
              ...
              <button class="energy-side-val energy-import" @click=${F("ac_in_ac_ad")}>
            ...
            <div class="energy-side">
              ...
              <button class="energy-side-val energy-export" @click=${F("ac_in_ac_pd")}>
    ...
    `}renderHouse(){const e=this.data,t=e.houseTodayWh/1e3,i=e.nonbackupTodayWh/1e3,r=t+i,n=e.housePower+e.nonbackupPower,a=t+e.zalohaPlannedRemainingKwh;return c`
      <div class="${this.nodeClass("house")}" style="--node-gradient: ${vi.house}; --node-border: ${yi.house};"
        ...
        <div class="node-value" @click=${F("actual_aco_p")}>
          ${Ft(n)}
        </div>
        <div class="node-subvalue" @click=${F("ac_out_en_day")}>
          Dnes celkem: ${r.toFixed(1)} kWh
        </div>
        ${a>0?c`
          <div class="node-subvalue" @click=${F("battery_forecast")}
          ...
          <div class="solar-strings">
            <div>
              ...
              <div class="detail-row">
                ...
                <button class="clickable" @click=${F("ac_out_aco_pr")}>${Math.round(e.houseL1)} W</button>
              </div>
              <div class="detail-row">
                <span class="icon">L2</span>
                <button class="clickable" @click=${F("ac_out_aco_ps")}>${Math.round(e.houseL2)} W</button>
              </div>
              <div class="detail-row">
                <span class="icon">L3</span>
                <button class="clickable" @click=${F("ac_out_aco_pt")}>${Math.round(e.houseL3)} W</button>
              </div>
              <div class="detail-row">
                <span class="icon">Σ</span>
                <button class="clickable" @click=${F("actual_aco_p")}>${Ft(e.housePower)}</button>
              </div>
              <div class="detail-row">
                <span class="icon">📊</span>
                <button class="clickable" @click=${F("ac_out_en_day")}>${t.toFixed(1)} kWh</button>
              </div>
            </div>
            <div>
              ...
              <div class="detail-row">
                <span class="icon">L1</span>
                <button class="clickable" @click=${F("actual_acinb_wr")}>${Math.round(e.nonbackupL1)} W</button>
              </div>
              <div class="detail-row">
                <span class="icon">L2</span>
                <button class="clickable" @click=${F("actual_acinb_ws")}>${Math.round(e.nonbackupL2)} W</button>
              </div>
              <div class="detail-row">
                <span class="icon">L3</span>
                <button class="clickable" @click=${F("actual_acinb_wt")}>${Math.round(e.nonbackupL3)} W</button>
              </div>
              <div class="detail-row">
                <span class="icon">Σ</span>
                <button class="clickable" @click=${F("actual_acinb_wtotal")}>${Ft(e.nonbackupPower)}</button>
              </div>
              <div class="detail-row">
                <span class="icon">📊</span>
                <button class="clickable" @click=${F("computed_nonbackup_consumption_today")}>${i.toFixed(1)} kWh</button>
              </div>
            </div>
          </div>
        </div>
...
`;function ch(e){return Math.max(0,Math.min(100,e))}function Ba(e){const r=Math.max(0,Math.min(1,(e-10)/60)),n={r:33,g:150,b:243},a={r:255,g:87,b:34},s=(l,d)=>Math.round(l+(d-l)*r);return`rgb(${s(n.r,a.r)}, ${s(n.g,a.g)}, ${s(n.b,a.b)})`}let Ni=class extends D{constructor(){super(...arguments),this.collapsed=!0,this.busy=!1}toggle(){this.collapsed=!this.collapsed}async doAction(e,t){this.busy=!0;try{const i=await e();this.dispatchEvent(new CustomEvent("action-done",{detail:{success:i,label:t},bubbles:!0,composed:!0}))}finally{this.busy=!1}}render(){return c`
  ...
  `;I([g({type:Object})],Ri.prototype,"plan",2);I([g({type:Object})],Ri.prototype,"forecastWindows",2);Ri=I([E("oig-boiler-plan-info")],Ri);let ji=class extends D{constructor(){super(...arguments),this.boilerState=null,this.targetTemp=60}render(){const e=this.boilerState;if(!e)return c`<div>Nacitani...</div>`;const t=10,i=70,r=f=>ch((f-t)/(i-t)*100),n=e.heatingPercent??0,a=e.tempTop!==null?r(e.tempTop):null,s=e.tempBottom!==null?r(e.tempBottom):null,l=r(this.targetTemp),d=Ba(e.tempTop??this.targetTemp),u=Ba(e.tempBottom??10),p=`linear-gradient(180deg, ${d} 0%, ${u} 100%)`,h=e.heatingPercent!==null?`${e.heatingPercent.toFixed(0)}% nahrato`:"-- % nahrato";return c`
  ...
  `;nr([g({type:Object})],Ct.prototype,"data",2);nr([g({type:Object})],Ct.prototype,"config",2);nr([g({type:String})],Ct.prototype,"lang",2);nr([g({type:String})],Ct.prototype,"panelType",2);Ct=nr([E("oig-boiler-metric-panel")],Ct);var Sh=Object.defineProperty,Ch=Object.getOwnPropertyDescriptor,di=(e,t,i,r)=>{for(var n=r>1?void 0:r?Ch(t,i):t,a=e.length-1,s;a>=0;a--)(s=e[a])&&(n=(r?s(t,i,n):s(n))||n);return r&&n&&Sh(t,i,n),n};const gn=G,Ei=1e3,Vt=200,Wa=20,fn=80,bt=3,qe=100,xt=1440;function Th(e){return e??Date.now()}function Ph(e,t){var a,s;const i=new Intl.DateTimeFormat("en-US",{timeZone:t,hour:"numeric",minute:"2-digit",hour12:!1}).formatToParts(new Date(e)),r=parseInt(((a=i.find(l=>l.type==="hour"))==null?void 0:a.value)??"0",10)%24,n=parseInt(((s=i.find(l=>l.type==="minute"))==null?void 0:s.value)??"0",10);return r*60+n}function Mh(e,t){const i=new Intl.DateTimeFormat("en-US",{timeZone:t,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1}).formatToParts(new Date(e)),r=w=>{var x;return((x=i.find(S=>S.type===w))==null?void 0:x.value)??"00"},n=r("year"),a=r("month"),s=r("day"),l=parseInt(r("hour"),10)%24,d=r("minute"),u=r("second"),p=String(l).padStart(2,"0"),h=Date.UTC(parseInt(n),parseInt(a)-1,parseInt(s),l,parseInt(d),parseInt(u)),b=Math.round((h-e)/6e4),f=b>=0?"+":"-",m=Math.abs(b),v=String(Math.floor(m/60)).padStart(2,"0"),$=String(m%60).padStart(2,"0");return`${n}-${a}-${s}T${p}:${d}:${u}${f}${v}:${$}`}function Ye(e){return e/xt*Ei}function Rt(e){return String(parseFloat(e.toFixed(3)))}function mn(e){const t=Math.max(Wa,Math.min(fn,e));return(fn-t)/(fn-Wa)*Vt}function Dh(e,t){const i=Ph(e,t);return e-i*6e4}function Eh(e){if(e.length<=1)return e;const t=[];let i={...e[0]};for(let r=1;r<e.length;r++){const n=e[r],a=i.recommendedSource===n.recommendedSource,s=(i.heatingKwh!=null?i.heatingKwh>0:!1)==(n.heatingKwh!=null?n.heatingKwh>0:!1),l=i.end===n.start;a&&s&&l?i={...i,end:n.end}:(t.push(i),i={...n})}return t.push(i),t}function qa(e,t,i){let r=null,n=-1/0;for(const a of t){const s=Date.parse(a.start);if(!isFinite(s))continue;const l=a.end!==null?Date.parse(a.end):i;isFinite(l)&&s<=e&&e<=l&&s>n&&(n=s,r=a)}return r}function Ya(e,t){const i=Date.parse(e.start),r=e.end!==null?Date.parse(e.end):t;if(!isFinite(i)||!isFinite(r))return null;const n=(r-i)/36e5;return n<=0||!isFinite(n)||!isFinite(e.energyKwh)||e.energyKwh<0?null:e.energyKwh/n}function Oh(e,t,i,r,n){const a=[C("boiler.aria.plan_timeline",n)];a.push(`NOW: ${e}`),t&&a.push(`${C("boiler.config.deadline",n)}: ${t}`),i!=null&&a.push(`${C("boiler.config.goal_temp",n)}: ${i}°C`);const s=[...new Set(r.filter(Boolean))];return s.length>0&&a.push(s.map(l=>Ge(l,n)).join(", ")),a.join(". ")}let st=class extends D{constructor(){super(...arguments),this.data=null,this.config=null,this.lang="cs",this.nowMs=null,this.timeZone=null}render(){try{return this._renderTimeline()}catch{return c`
      ...
      `}}_resolveTimeZone(){if(this.timeZone)return this.timeZone;try{return Intl.DateTimeFormat().resolvedOptions().timeZone}catch{return"Europe/Prague"}}_renderTimeline(){var Se;const e=Th(this.nowMs??void 0),t=this._resolveTimeZone();let i;try{i=Dh(e,t)}catch{i=e-e%864e5}const r=(e-i)/6e4,n=Ye(r);let a="";try{a=Mh(e,t)}catch{a=new Date(e).toISOString()}const s=this.config,l=s!=null&&s.deadlineTime&&s.deadlineTime!=="--:--"?s.deadlineTime:null;let d=null;if(l)try{const[A,ne]=l.split(":"),be=parseInt(A,10)*60+parseInt(ne,10);d=Ye(be)}catch{d=null}const u=(s==null?void 0:s.targetTempC)!=null&&isFinite(s.targetTempC)?s.targetTempC:60,p=mn(u),h=this.data,b=Array.isArray(h==null?void 0:h.planSlots)?h.planSlots:[],f=Array.isArray(h==null?void 0:h.timeline)?h.timeline:[],m=Array.isArray(h==null?void 0:h.sourceSegments)?h.sourceSegments:[],v=b.length>0&&b.every(A=>(A.heatingKwh??0)===0&&(A.pvKwh??0)===0&&(A.gridKwh??0)===0&&(A.altKwh??0)===0),$=this._buildPlanBands(b,i),w=this._buildTempPointsFromSlots(b,i),x=this._buildTempPointsFromTimeline(f,i),S=w.length>0?w:x,R=this._buildPowerBarsFromSlots(b,i),q=this._buildPowerBars(f,m,i,e),k=$.map(A=>A.source);let V="";try{V=Oh(a,l,u,k,this.lang)}catch{V=C("boiler.aria.plan_timeline",this.lang)}const y=S.length>=2?S.map(A=>`${A.x.toFixed(2)},${A.y.toFixed(2)}`).join(" "):null,B=b.reduce((A,ne)=>A+(ne.gridKwh??0),0),Y=b.reduce((A,ne)=>A+(ne.pvKwh??0)+(ne.altKwh??0),0),W=b.reduce((A,ne)=>A+(ne.estimatedCostCzk??0),0),K=B+Y,ae=((Se=h==null?void 0:h.status)==null?void 0:Se.degradedFlags)??[],ze=ae.includes("price_degraded"),gi=ae.includes("forecast_degraded"),fi=["00","03","06","09","12","15","18","21","24"];return c`
      <div class="timeline-section">

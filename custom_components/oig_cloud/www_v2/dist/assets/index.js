...
Opravdu chcete přidat další úkol?`)}async setBoxMode(t){if(this.state.currentBoxMode===t&&!this.state.changingServices.has("box_mode"))return!1;const i=await re.callService("oig_cloud","set_box_mode",{mode:t,acknowledgement:!0});return i&&this.refresh(),i}async setGridDelivery(t,i){const r={acknowledgement:!0,warning:!0};t==="limited"&&i!=null?(this.needsGridModeChangeForLimitedRequest()&&(r.mode=t),r.limit=i):i!=null?r.limit=i:r.mode=t;const n=await re.callService("oig_cloud","set_grid_delivery",r);return n&&this.refresh(),n}async setBoilerMode(t){if(this.state.currentBoilerMode===t&&!this.state.changingServices.has("boiler_mode"))return!1;const i=await re.callService("oig_cloud","set_boiler_mode",{mode:t,acknowledgement:!0});return i&&this.refresh(),i}async removeFromQueue(t){const i=await re.callService("oig_cloud","shield_remove_from_queue",{position:t});return i&&this.refresh(),i}async setSupplementaryToggle(t,i){const r=await re.callService("oig_cloud","set_box_mode",{[t]:i,acknowledgement:!0});return r&&this.refresh(),r}notify(){for(const t of this.listeners)try{t(this.state)}catch(i){_.error("ShieldController listener error",i)}}}const ie=new Sc;var Cc=Object.defineProperty,Pc=Object.getOwnPropertyDescriptor,Mt=(e,t,i,r)=>{for(var n=r>1?void 0:r?Pc(t,i):t,a=e.length-1,s;a>=0;a--)(s=e[a])&&(n=(r?s(t,i,n):s(n))||n);return r&&n&&Cc(t,i,n),n};const Ce=Z;let Ze=class extends D{constructor(){super(...arguments),this.title="Energetické Toky",this.time="",this.showStatus=!1,this.alertCount=0,this.leftPanelCollapsed=!1,this.rightPanelCollapsed=!1}onStatusClick(){this.dispatchEvent(new CustomEvent("status-click",{bubbles:!0}))}onEditClick(){this.dispatchEvent(new CustomEvent("edit-click",{bubbles:!0}))}onResetClick(){this.dispatchEvent(new CustomEvent("reset-click",{bubbles:!0}))}onToggleLeftPanel(){this.dispatchEvent(new CustomEvent("toggle-left-panel",{bubbles:!0}))}onToggleRightPanel(){this.dispatchEvent(new CustomEvent("toggle-right-panel",{bubbles:!0}))}render(){const e=this.alertCount>0?"warning":"ok";return c`
  ...
  `;In([g({type:Boolean})],Fi.prototype,"editable",2);In([T()],Fi.prototype,"breakpoint",2);Fi=In([E("oig-grid")],Fi);const Ac={off:"Vypnuto",on:"Zapnuto",limited:"Omezeno",unknown:"?"};function Pa(e){return Ac[e]??e}const _s=e=>{const t=e.trim();return t?t.endsWith("W")?t:`${t}W`:""};function Fc(e){const t=e.isUnavailable;let i;t||e.currentLiveDelivery==="unknown"?i="?":e.currentLiveDelivery==="limited"&&e.currentLiveLimit!==null?i=`Omezeno ${e.currentLiveLimit}W`:i=Pa(e.currentLiveDelivery);const r=!t&&e.currentLiveDelivery==="limited";let n=null,a=null;!t&&e.currentLiveLimit!==null&&(a=`${e.currentLiveLimit}W`,n=r?"Aktivní limit":"Nastavený limit");let s=null,l=null;return e.pendingDeliveryTarget!==null&&(s=`Ve frontě: ${Pa(e.pendingDeliveryTarget)}`),e.pendingLimitTarget!==null&&(l=`Ve frontě: limit ${_s(String(e.pendingLimitTarget))}`),{currentModeText:i,limitLabel:n,limitValue:a,showLimitAsActive:r,isUnavailable:t,isTransitioning:e.isTransitioning,pendingModeText:s,pendingLimitText:l}}function Ic(e,t){const i=t.has("box_mode"),r=e.get("box_mode"),n=t.has("grid_mode")||t.has("grid_limit"),a=e.get("grid_limit"),s=e.get("grid_mode");let l=null;if(a){const d=_s(a);l=d?`→ ${d}`:null}else s&&(l=`→ ${s}`);return{inverterModeChanging:i,inverterModeText:r?`→ ${r}`:null,gridExportChanging:n,gridExportText:l}}var Bc=Object.defineProperty,Nc=Object.getOwnPropertyDescriptor,Nr=(e,t,i,r)=>{for(var n=r>1?void 0:r?Nc(t,i):t,a=e.length-1,s;a>=0;a--)(s=e[a])&&(n=(r?s(t,i,n):s(n))||n);return r&&n&&Bc(t,i,n),n};let Zt=class extends D{constructor(){super(...arguments),this.soc=0,this.charging=!1,this.gridCharging=!1}get fillHeight(){return Math.max(0,Math.min(100,this.soc))/100*54}get fillY(){return 13+(54-this.fillHeight)}render(){return c`
  ...
  `;Ji([g({type:Number})],kt.prototype,"soc",2);Ji([g({type:Boolean})],kt.prototype,"charging",2);Ji([g({type:Boolean})],kt.prototype,"gridCharging",2);Ji([g({type:Boolean})],kt.prototype,"discharging",2);kt=Ji([E("oig-battery-icon")],kt);var Vc=Object.defineProperty,qc=Object.getOwnPropertyDescriptor,ks=(e,t,i,r)=>{for(var n=r>1?void 0:r?qc(t,i):t,a=e.length-1,s;a>=0;a--)(s=e[a])&&(n=(r?s(t,i,n):s(n))||n);return r&&n&&Vc(t,i,n),n};let xr=class extends D{constructor(){super(...arguments),this.power=0}get mode(){return this.power>50?"importing":this.power<-50?"exporting":"idle"}render(){const e=this.mode;return c`
      <svg viewBox="0 0 48 48">
  ...
  `;er([g({type:String})],St.prototype,"mode",2);er([g({type:Boolean})],St.prototype,"bypassActive",2);er([g({type:Boolean})],St.prototype,"hasAlarm",2);er([g({type:Boolean})],St.prototype,"plannerAuto",2);St=er([E("oig-inverter-icon")],St);var Zc=Object.defineProperty,Qc=Object.getOwnPropertyDescriptor,He=(e,t,i,r)=>{for(var n=r>1?void 0:r?Qc(t,i):t,a=e.length-1,s;a>=0;a--)(s=e[a])&&(n=(r?s(t,i,n):s(n))||n);return r&&n&&Zc(t,i,n),n};const U=Z,Ta=new URLSearchParams(window.location.search),Xc=Ta.get("sn")||Ta.get("inverter_sn")||"",Jc=e=>`sensor.oig_${Xc}_${e}`,on="oig_v2_flow_layout_",gt=["solar","battery","inverter","grid","house"],ed={solar:{top:"0%",left:"0%"},house:{top:"0%",left:"65%"},inverter:{top:"35%",left:"35%"},grid:{top:"70%",left:"0%"},battery:{top:"70%",left:"65%"}};function N(e){return()=>re.openEntityDialog(Jc(e))}let Ee=class extends D{constructor(){super(...arguments),this.data=On,this.editMode=!1,this.pendingServices=new Map,this.changingServices=new Set,this.shieldStatus="idle",this.shieldQueueCount=0,this.gridDeliveryState={currentLiveDelivery:"unknown",currentLiveLimit:null,pendingDeliveryTarget:null,pendingLimitTarget:null,isTransitioning:!1,isUnavailable:!1},this.shieldUnsub=null,this.expandedNodes=new Set,this.customPositions={},this.draggedNodeId=null,this.dragStartX=0,this.dragStartY=0,this.dragStartTop=0,this.dragStartLeft=0,this.onShieldUpdate=e=>{this.pendingServices=e.pendingServices,this.changingServices=e.changingServices,this.shieldStatus=e.status,this.shieldQueueCount=e.queueCount,this.gridDeliveryState=e.gridDeliveryState},this.handleDragStart=e=>{if(!this.editMode)return;e.preventDefault(),e.stopPropagation();const i=e.target.closest(".node");if(!i)return;const r=this.findNodeId(i);if(!r)return;this.draggedNodeId=r,i.classList.add("dragging");const n=i.getBoundingClientRect();this.dragStartX=e.clientX,this.dragStartY=e.clientY,this.dragStartTop=n.top,this.dragStartLeft=n.left},this.handleTouchStart=e=>{if(!this.editMode)return;e.preventDefault();const i=e.target.closest(".node");if(!i)return;const r=this.findNodeId(i);if(!r)return;this.draggedNodeId=r,i.classList.add("dragging");const n=e.touches[0],a=i.getBoundingClientRect();this.dragStartX=n.clientX,this.dragStartY=n.clientY,this.dragStartTop=a.top,this.dragStartLeft=a.left},this.handleDragMove=e=>{!this.draggedNodeId||!this.editMode||(e.preventDefault(),this.updateDragPosition(e.clientX,e.clientY))},this.handleTouchMove=e=>{if(!this.draggedNodeId||!this.editMode)return;e.preventDefault();const t=e.touches[0];this.updateDragPosition(t.clientX,t.clientY)},this.handleDragEnd=e=>{var r;if(!this.draggedNodeId||!this.editMode)return;const t=(r=this.shadowRoot)==null?void 0:r.querySelector(".flow-grid"),i=t==null?void 0:t.querySelector(`.node-${this.draggedNodeId}`);i&&i.classList.remove("dragging"),this.saveLayout(),this.dispatchEvent(new CustomEvent("layout-changed",{bubbles:!0,composed:!0})),this.draggedNodeId=null},this.handleTouchEnd=e=>{this.handleDragEnd(e)}}connectedCallback(){super.connectedCallback(),this.loadSavedLayout(),this.shieldUnsub=ie.subscribe(this.onShieldUpdate)}disconnectedCallback(){var e;super.disconnectedCallback(),this.removeDragListeners(),(e=this.shieldUnsub)==null||e.call(this),this.shieldUnsub=null}updated(e){e.has("editMode")&&(this.editMode?(this.setAttribute("editmode",""),this.loadSavedLayout(),this.requestUpdate(),this.updateComplete.then(()=>this.applySavedPositions())):(this.removeAttribute("editmode"),this.removeDragListeners(),this.clearInlinePositions(),this.updateComplete.then(()=>this.applyCustomPositions()))),!this.editMode&&this.hasCustomLayout&&this.updateComplete.then(()=>this.applyCustomPositions())}loadSavedLayout(){const e=Yt(window.innerWidth),t=`${on}${e}`;try{const i=localStorage.getItem(t);i&&(this.customPositions=JSON.parse(i),_.debug("[FlowNode] Loaded layout for "+e))}catch{}}applySavedPositions(){var t;if(!this.editMode)return;const e=(t=this.shadowRoot)==null?void 0:t.querySelector(".flow-grid");if(e){for(const i of gt){const r=this.customPositions[i];if(!r)continue;const n=e.querySelector(`.node-${i}`);n&&(n.style.top=r.top,n.style.left=r.left)}this.initDragListeners()}}clearInlinePositions(){var t;const e=(t=this.shadowRoot)==null?void 0:t.querySelector(".flow-grid");if(e)for(const i of gt){const r=e.querySelector(`.node-${i}`);r&&(r.style.top="",r.style.left="")}}saveLayout(){const e=Yt(window.innerWidth),t=`${on}${e}`;try{localStorage.setItem(t,JSON.stringify(this.customPositions)),_.debug("[FlowNode] Saved layout for "+e)}catch{}}toggleExpand(e,t){const i=t.target;if(i.closest(".clickable")||i.closest(".indicator")||i.closest(".forecast-badge")||i.closest(".node-value")||i.closest(".node-subvalue")||i.closest(".gc-plan-btn"))return;const r=new Set(this.expandedNodes);r.has(e)?r.delete(e):r.add(e),this.expandedNodes=r}nodeClass(e,t=""){const i=this.expandedNodes.has(e)?" expanded":"";return`node node-${e}${i}${t?" "+t:""}`}edgeGauge(e){const t=Math.max(0,Math.min(100,e.pct)),i=Math.max(2,Math.min(7,e.width??3)),r=e.full?0:100-t,n=e.stops.map(([s,l])=>G`<stop offset="${s}" stop-color="${l}"></stop>`),a=e.pulseDur?`--pulse-dur:${e.pulseDur}s`:"";return G`
      ...
      <div class="${this.nodeClass("solar",i?"night":"")}" style="--node-gradient: ${r}; --node-border: ${n};"
        ...
        <button class="indicator" style="position:absolute;top:4px;right:6px;font-size:9px;z-index:3" @click=${N("solar_forecast")}
        ...
        <div class="node-value" @click=${N("dc_in_fv_ad")}>
    ...
    `}openGridChargingDialog(){this.dispatchEvent(new CustomEvent("oig-grid-charging-open",{bubbles:!0,composed:!0,detail:{data:this.data.gridChargingPlan}}))}getBalancingIndicator(){const e=this.data,t=e.balancingState;return t!=="charging"&&t!=="holding"&&t!=="completed"?{show:!1,text:"",icon:"",cls:""}:t==="charging"?{show:!0,text:`Nabíjení${e.balancingTimeRemaining?` (${e.balancingTimeRemaining})`:""}`,icon:"⚡",cls:"charging"}:t==="holding"?{show:!0,text:`Držení${e.balancingTimeRemaining?` (${e.balancingTimeRemaining})`:""}`,icon:"⏸️",cls:"holding"}:{show:!0,text:"Dokončeno",icon:"✅",cls:"completed"}}renderBattery(){const e=this.data,t=this.getBalancingIndicator(),i=e.batteryTemp>25?"🌡️":e.batteryTemp<15?"🧊":"🌡️",r=e.batteryTemp>25?"temp-hot":e.batteryTemp<15?"temp-cold":"",n=Math.abs(e.batteryPower)/1e3,a=Math.abs(e.batteryPower)>10,s=e.batteryPower>10,l=e.batteryPower<-10,d=s?"Nabíjí":l?"Vybíjí":"Klid",u=s?"st-charge":l?"st-discharge":"st-idle",p=`${s?"+":l?"−":""}${Ft(Math.abs(e.batteryPower))}`,h=s&&e.timeToFull?` · do plna ${e.timeToFull}`:l&&e.timeToEmpty?` · do vybití ${e.timeToEmpty}`:"",m=e.batterySoC>=66?"rgba(67,160,71,0.13)":e.batterySoC>=33?"rgba(253,216,53,0.10)":"rgba(229,57,53,0.12)";return c`
      <div class="${this.nodeClass("battery")}" style="--node-gradient: ${vi.battery}; --node-border: ${yi.battery};"
        ...
        <div class="battery-indicators">
          ...
          <button class="indicator ${r}" @click=${N("extended_battery_temperature")}>
    ...
    `}renderGrid(){const e=this.data,t=e.gridPower>10,i=e.gridPower<-10,r=Math.abs(e.gridPower),n=r/1e3,a=t?"↓ Odběr ze sítě":i?"↑ Přetok do sítě":"◉ Žádný tok",s=25*230*3,l=e.inverterGridLimit>0?e.inverterGridLimit:5e3,d=t?r/s*100:i?r/l*100:0,u=t?`${Math.round(d)} % jističe`:i?`${Math.round(d)} % limitu`:"",p=t?e.spotPrice<=0?"#43a047":e.spotPrice<3?"#ffa726":"#ef5350":i?e.exportPrice>=3?"#43a047":e.exportPrice>=1.5?"#ffa726":"#ef5350":"rgba(255,255,255,0.35)",h=t?`${e.spotPrice.toFixed(2)} Kč`:i?`+${e.exportPrice.toFixed(2)} Kč`:"",m=(f,b)=>b>10?Math.round(Math.abs(f)/b):0;return c`
      <div class="${this.nodeClass("grid")}" style="--node-gradient: ${vi.grid}; --node-border: ${yi.grid};"
        ...
        <button class="indicator" style="position:absolute;top:4px;left:6px;font-size:9px;z-index:3" @click=${N("current_tariff")}>
          ${$l(e.currentTariff)}
        </button>
        <button class="indicator" style="position:absolute;top:4px;right:6px;font-size:9px;z-index:3" @click=${N("ac_in_aci_f")}>
        ...
        <div class="node-value" @click=${N("actual_aci_wtotal")}>${Ft(r)}</div>
        ...
        <div class="phases-grid" style="margin-top:6px">
          <div class="phase-cell">
            ...
            <button class="phase-val" @click=${N("actual_aci_wr")}>${m(e.gridL1P,e.gridL1V)} A</button>
            <button class="phase-val" style="font-size:10px;color:${U(o.textSecondary)}" @click=${N("actual_aci_wr")}>${Math.round(e.gridL1P)} W</button>
          </div>
          <div class="phase-cell">
            <span class="phase-label">L2</span>
            <button class="phase-val" @click=${N("actual_aci_ws")}>${m(e.gridL2P,e.gridL2V)} A</button>
            <button class="phase-val" style="font-size:10px;color:${U(o.textSecondary)}" @click=${N("actual_aci_ws")}>${Math.round(e.gridL2P)} W</button>
          </div>
          <div class="phase-cell">
            <span class="phase-label">L3</span>
            <button class="phase-val" @click=${N("actual_aci_wt")}>${m(e.gridL3P,e.gridL3V)} A</button>
            <button class="phase-val" style="font-size:10px;color:${U(o.textSecondary)}" @click=${N("actual_aci_wt")}>${Math.round(e.gridL3P)} W</button>
          </div>
        </div>
    ...
    `}renderHouse(){const e=this.data,t=e.houseTodayWh/1e3,i=e.nonbackupTodayWh/1e3,r=t+i,n=e.housePower+e.nonbackupPower,a=t+e.zalohaPlannedRemainingKwh;return c`
      <div class="${this.nodeClass("house")}" style="--node-gradient: ${vi.house}; --node-border: ${yi.house};"
        ...
        <button class="indicator house-corner" style="position:absolute;top:4px;left:6px"
          @click=${N("actual_aco_p")} title="Záloha — aktuální výkon · dnes">
        ...
        <button class="indicator house-corner" style="position:absolute;top:4px;right:6px;text-align:right"
          @click=${N("actual_acinb_wtotal")} title="Nezáloha — aktuální výkon · dnes">
        ...
        ${a>0?c`
          <div class="node-subvalue" @click=${N("battery_forecast")}
          ...
          <div class="solar-strings">
            <div>
              ...
              <div class="detail-row">
                ...
                <button class="clickable" @click=${N("ac_out_aco_pr")}>${Math.round(e.houseL1)} W</button>
              </div>
              <div class="detail-row">
                <span class="icon">L2</span>
                <button class="clickable" @click=${N("ac_out_aco_ps")}>${Math.round(e.houseL2)} W</button>
              </div>
              <div class="detail-row">
                <span class="icon">L3</span>
                <button class="clickable" @click=${N("ac_out_aco_pt")}>${Math.round(e.houseL3)} W</button>
              </div>
            </div>
            <div>
              ...
              <div class="detail-row">
                <span class="icon">L1</span>
                <button class="clickable" @click=${N("actual_acinb_wr")}>${Math.round(e.nonbackupL1)} W</button>
              </div>
              <div class="detail-row">
                <span class="icon">L2</span>
                <button class="clickable" @click=${N("actual_acinb_ws")}>${Math.round(e.nonbackupL2)} W</button>
              </div>
              <div class="detail-row">
                <span class="icon">L3</span>
                <button class="clickable" @click=${N("actual_acinb_wt")}>${Math.round(e.nonbackupL3)} W</button>
              </div>
            </div>
          </div>
        </div>
...
`;function ch(e){return Math.max(0,Math.min(100,e))}function Ba(e){const r=Math.max(0,Math.min(1,(e-10)/60)),n={r:33,g:150,b:243},a={r:255,g:87,b:34},s=(l,d)=>Math.round(l+(d-l)*r);return`rgb(${s(n.r,a.r)}, ${s(n.g,a.g)}, ${s(n.b,a.b)})`}let Ni=class extends D{constructor(){super(...arguments),this.collapsed=!0,this.busy=!1}toggle(){this.collapsed=!this.collapsed}async doAction(e,t){this.busy=!0;try{const i=await e();this.dispatchEvent(new CustomEvent("action-done",{detail:{success:i,label:t},bubbles:!0,composed:!0}))}finally{this.busy=!1}}render(){return c`
  ...
  `;F([T()],Ni.prototype,"collapsed",2);F([T()],Ni.prototype,"busy",2);Ni=F([E("oig-boiler-debug-panel")],Ni);let _r=class extends D{constructor(){super(...arguments),this.data=null}render(){const e=this.data;if(!e)return c`<div>Nacitani stavu...</div>`;const t=(i,r,n=1)=>i!=null?`${i.toFixed(n)} ${r}`:`-- ${r}`;return c`
      <h3>Stav bojleru</h3>
      <div class="grid">
        <div class="card">
  ...
  `;F([g({type:Array})],Cr.prototype,"data",2);Cr=F([E("oig-boiler-heatmap-grid")],Cr);let Pr=class extends D{constructor(){super(...arguments),this.plan=null}render(){const e=this.plan,t=(i,r=2)=>i!=null?i.toFixed(r):"-";return c`
      <div class="grid">
        <div class="card">
    ...
    .grid-c { color: #FF9800; }
    .cost { color: #2196F3; }
  `;F([g({type:Object})],Pr.prototype,"plan",2);Pr=F([E("oig-boiler-stats-cards")],Pr);let Tr=class extends D{constructor(){super(...arguments),this.data=null}render(){const e=this.data;if(!e)return O;const t=Math.max(...e.hourlyAvg,.01),i=new Set(e.peakHours),r=e.peakHours.length?e.peakHours.map(a=>`${a}h`).join(", "):"--",n=e.confidence!==null?`${Math.round(e.confidence*100)} %`:"-- %";return c`
  ...
  `;F([g({type:Object})],Tr.prototype,"data",2);Tr=F([E("oig-boiler-profiling")],Tr);let Mr=class extends D{constructor(){super(...arguments),this.config=null}render(){const e=this.config;if(!e)return O;const t=(i,r="")=>i!=null?`${i}${r?" "+r:""}`:`--${r?" "+r:""}`;return c`
  ...
  `;F([g({type:Object})],Dr.prototype,"state",2);Dr=F([E("oig-boiler-state")],Dr);let Er=class extends D{constructor(){super(...arguments),this.data=[]}render(){return O}};Er.styles=M`
    :host { display: block; }
  `;F([g({type:Array})],Er.prototype,"data",2);Er=F([E("oig-boiler-heatmap")],Er);let Wi=class extends D{constructor(){super(...arguments),this.profiles=[],this.editMode=!1}render(){return O}};Wi.styles=M`
    :host { display: block; }
  `;F([g({type:Array})],Wi.prototype,"profiles",2);F([g({type:Boolean})],Wi.prototype,"editMode",2);Wi=F([E("oig-boiler-profiles")],Wi);let Vi=class extends D{constructor(){super(...arguments),this.data=null,this.lang="cs"}render(){const e=this.data,t=this.lang,i=(e==null?void 0:e.currentState)??"unknown",r=C(`boiler.status.${i}`,t),n=(e==null?void 0:e.comfortSatisfied)===!0?C("boiler.status.comfort_satisfied",t):(e==null?void 0:e.comfortSatisfied)===!1?C("boiler.status.comfort_unsatisfied",t):C("boiler.status.comfort_unknown",t),a=(e==null?void 0:e.comfortSatisfied)===!0?"ok":(e==null?void 0:e.comfortSatisfied)===!1?"bad":"unknown",s=(e==null?void 0:e.degradedFlags)??[];return c`
  ...
  `;F([g({attribute:!1})],Vi.prototype,"data",2);F([g({type:String})],Vi.prototype,"lang",2);Vi=F([E("oig-boiler-status-panel")],Vi);let qi=class extends D{constructor(){super(...arguments),this.slots=[],this.lang="cs"}srcClass(e){return e&&["fve","grid","alternative","overflow","discharge"].includes(e)?e:"other"}render(){const e=this.lang;return!this.slots||this.slots.length===0?c`<div data-testid="boiler-plan-timeline" class="wrap"><div class="heading">${C("boiler.timeline.heading",e)}</div><div class="empty">${C("boiler.timeline.empty",e)}</div></div>`:c`
      ...
      <div class="panel" data-testid="boiler-source-panel">
        ...
        ${f!=null?c`
          <div class="stat-row sub no-spark">
            ...
            <span class="stat-value" style="color:${Pi("fve")}">${qt(f)}</span>
          </div>
        `:O}
        ...
        ${b!=null?c`
          <div class="stat-row sub no-spark">
            ...
            <span class="stat-value" style="color:${Pi("overflow")}">${qt(b)}</span>
          </div>
        `:O}
        ...
        ${v!=null?c`
          <div class="stat-row sub no-spark">
            ...
            <span class="stat-value" style="color:${Pi("grid")}">${qt(v)}</span>
          </div>
        `:O}
        ...
        <div class="stat-row no-spark">
          ...
          <span class="stat-value source-value">
            ${s?c`<span class="source-dot" style="background:${Pi(s)}"></span>${Ge(s,this.lang)}`:"—"}
          </span>
        </div>
        ...
        <div class="stat-row no-spark">
          ...
          <span class="stat-value source-value">
            ${l?c`<span class="source-dot" style="background:${Pi(l)}"></span>${Ge(l,this.lang)}`:"—"}
          </span>
        </div>
      </div>
        ...
        <div class="timeline-header">
          ...
          ${m.length>0?c`
            <div class="timeline-summary">
              ...
              ${V>0?c` · <strong>~${V.toFixed(2)} Kč</strong>`:""}
        ...
        `:c`
          <div class="chart-wrap">
            ...
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              ${G`<rect x="0" y="0" width="${Ei}" height="${Wt}" fill="transparent" />`}
              ...
              ${f.map(A=>{let ne;try{ne=Date.parse(A.timestamp)}catch{return""}if(!isFinite(ne))return"";const be=(ne-i)/6e4;if(be<0||be>xt||A.powerKw!==null)return"";const mi=qa(ne,b,e),Ie=mi?Ya(mi,e):null;if(Ie!==null&&Ie>0)return"";const We=Ye(be);return G`<rect
...
`;let ri=class extends D{constructor(){super(...arguments),this.value="home_1",this.disabled=!1,this.buttonStates={home_1:"idle",home_2:"idle",home_3:"idle",home_ups:"idle"}}onModeClick(e){const t=this.buttonStates[e];this.disabled||t==="active"||t==="pending"||t==="processing"||t==="disabled-by-service"||this.dispatchEvent(new CustomEvent("mode-change",{detail:{mode:e},bubbles:!0}))}render(){return c`
  ...
  `;ui([g({type:Array})],ct.prototype,"items",2);ui([g({type:Boolean})],ct.prototype,"expanded",2);ui([g({type:String})],ct.prototype,"shieldStatus",2);ui([g({type:Number})],ct.prototype,"queueCount",2);ui([T()],ct.prototype,"_now",2);ct=ui([E("oig-shield-queue")],ct);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */class En extends Rh{constructor(t){if(super(t),this.it=O,t.type!==Bh.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===O||t==null)return this._t=void 0,this.it=t;if(t===Lo)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const i=[t];return i.raw=i,this._t={_$litType$:this.constructor.resultType,strings:i,values:[]}}}En.directiveName="unsafeHTML",En.resultType=1;const jh=Nh(En);var Hh=Object.defineProperty,Wh=Object.getOwnPropertyDescriptor,ar=(e,t,i,r)=>{for(var n=r>1?void 0:r?Wh(t,i):t,a=e.length-1,s;a>=0;a--)(s=e[a])&&(n=(r?s(t,i,n):s(n))||n);return r&&n&&Hh(t,i,n),n};const ye=Z;let Pt=class extends D{constructor(){super(...arguments),this.open=!1,this.config={title:"",message:""},this.acknowledged=!1,this.limitValue=5e3,this.resolver=null,this.onOverlayClick=()=>{this.closeDialog({confirmed:!1})},this.onDialogClick=e=>{e.stopPropagation()},this.onKeyDown=e=>{e.key==="Escape"&&this.open&&this.closeDialog({confirmed:!1})},this.onAckChange=e=>{this.acknowledged=e.target.checked},this.onLimitInput=e=>{this.limitValue=parseInt(e.target.value,10)||0},this.onCancel=()=>{this.closeDialog({confirmed:!1})},this.onConfirm=()=>{const e=this.config.showLimitInput||this.config.limitOnly;if(e){const t=this.config.limitMin??1,i=this.config.limitMax??2e4;if(isNaN(this.limitValue)||this.limitValue<t||this.limitValue>i)return}this.closeDialog({confirmed:!0,limit:e?this.limitValue:void 0})}}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.onKeyDown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("keydown",this.onKeyDown)}showDialog(e){return this.config=e,this.acknowledged=!1,this.limitValue=e.limitValue??5e3,this.open=!0,new Promise(t=>{this.resolver=t})}closeDialog(e){var t;this.open=!1,(t=this.resolver)==null||t.call(this,e),this.resolver=null}get canConfirm(){return!(this.config.requireAcknowledgement&&!this.acknowledged)}render(){if(!this.open)return O;const e=this.config;return e.limitOnly?c`
    ...
    `}renderHTML(e){return jh(e)}};Pt.styles=M`
    :host {
      display: none;
    }
  ...
  `;ar([g({type:Boolean,reflect:!0})],Pt.prototype,"open",2);ar([g({type:Object})],Pt.prototype,"config",2);ar([T()],Pt.prototype,"acknowledged",2);ar([T()],Pt.prototype,"limitValue",2);Pt=ar([E("oig-confirm-dialog")],Pt);var Vh=Object.defineProperty,qh=Object.getOwnPropertyDescriptor,qs=(e,t,i,r)=>{for(var n=r>1?void 0:r?qh(t,i):t,a=e.length-1,s;a>=0;a--)(s=e[a])&&(n=(r?s(t,i,n):s(n))||n);return r&&n&&Vh(t,i,n),n};const Ti=Z;let Or=class extends D{constructor(){super(...arguments),this.shieldState=null}render(){if(!this.shieldState)return O;const e=this.determineStatus(this.shieldState),t=e.toLowerCase(),i=this.getStatusIcon(e),r=this.getStatusLabel(e),a=this.shieldState.queueCount>0?"has-items":"";return c`
    ...
    :host {
      display: block;
      padding: 16px 20px;
      border-top: 1px solid ${Ti(o.divider)};
    }
    ...
    .shield-status-title {
      font-size: 13px;
      font-weight: 600;
      color: ${Ti(o.textPrimary)};
    }

    .shield-status-subtitle {
      font-size: 11px;
      color: ${Ti(o.textSecondary)};
    }
  ...
  `;pi([g({type:Boolean})],dt.prototype,"open",2);pi([g({type:Number})],dt.prototype,"currentSoc",2);pi([g({type:Number})],dt.prototype,"maxSoc",2);pi([g({type:Object})],dt.prototype,"estimate",2);pi([T()],dt.prototype,"targetSoc",2);dt=pi([E("oig-battery-charge-dialog")],dt);var Zh=Object.defineProperty,Qh=Object.getOwnPropertyDescriptor,Fe=(e,t,i,r)=>{for(var n=r>1?void 0:r?Qh(t,i):t,a=e.length-1,s;a>=0;a--)(s=e[a])&&(n=(r?s(t,i,n):s(n))||n);return r&&n&&Zh(t,i,n),n};const bn=Z,Yn=M`
  .metric {
    display: flex;
    justify-content: space-between;
    padding: 8px 0;

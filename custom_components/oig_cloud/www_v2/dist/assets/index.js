...
Opravdu chcete přidat další úkol?`)}async setBoxMode(t){if(this.state.currentBoxMode===t&&!this.state.changingServices.has("box_mode"))return!1;const i=await re.callService("oig_cloud","set_box_mode",{mode:t,acknowledgement:!0});return i&&this.refresh(),i}async setGridDelivery(t,i){const r={acknowledgement:!0,warning:!0};t==="limited"&&i!=null?(this.needsGridModeChangeForLimitedRequest()&&(r.mode=t),r.limit=i):i!=null?r.limit=i:r.mode=t;const n=await re.callService("oig_cloud","set_grid_delivery",r);return n&&this.refresh(),n}async setBoilerMode(t){if(this.state.currentBoilerMode===t&&!this.state.changingServices.has("boiler_mode"))return!1;const i=await re.callService("oig_cloud","set_boiler_mode",{mode:t,acknowledgement:!0});return i&&this.refresh(),i}async removeFromQueue(t){const i=await re.callService("oig_cloud","shield_remove_from_queue",{position:t});return i&&this.refresh(),i}async setSupplementaryToggle(t,i){const r=await re.callService("oig_cloud","set_box_mode",{[t]:i,acknowledgement:!0});return r&&this.refresh(),r}notify(){for(const t of this.listeners)try{t(this.state)}catch(i){_.error("ShieldController listener error",i)}}}const ie=new Sc;var Cc=Object.defineProperty,Tc=Object.getOwnPropertyDescriptor,Mt=(e,t,i,r)=>{for(var n=r>1?void 0:r?Tc(t,i):t,a=e.length-1,s;a>=0;a--)(s=e[a])&&(n=(r?s(t,i,n):s(n))||n);return r&&n&&Cc(t,i,n),n};const Ce=G;let Ze=class extends D{constructor(){super(...arguments),this.title="Energetické Toky",this.time="",this.showStatus=!1,this.alertCount=0,this.leftPanelCollapsed=!1,this.rightPanelCollapsed=!1}onStatusClick(){this.dispatchEvent(new CustomEvent("status-click",{bubbles:!0}))}onEditClick(){this.dispatchEvent(new CustomEvent("edit-click",{bubbles:!0}))}onResetClick(){this.dispatchEvent(new CustomEvent("reset-click",{bubbles:!0}))}onToggleLeftPanel(){this.dispatchEvent(new CustomEvent("toggle-left-panel",{bubbles:!0}))}onToggleRightPanel(){this.dispatchEvent(new CustomEvent("toggle-right-panel",{bubbles:!0}))}render(){const e=this.alertCount>0?"warning":"ok";return c`
  ...
  `;Fn([g({type:Array})],Ai.prototype,"tabs",2);Fn([g({type:String})],Ai.prototype,"activeTab",2);Ai=Fn([E("oig-tabs")],Ai);var Oc=Object.defineProperty,zc=Object.getOwnPropertyDescriptor,In=(e,t,i,r)=>{for(var n=r>1?void 0:r?zc(t,i):t,a=e.length-1,s;a>=0;a--)(s=e[a])&&(n=(r?s(t,i,n):s(n))||n);return r&&n&&Oc(t,i,n),n};const Lc="oig_v2_layout_",sn=G;let Fi=class extends D{constructor(){super(...arguments),this.editable=!1,this.breakpoint="desktop",this.onResize=$s(()=>{this.breakpoint=Yt(window.innerWidth)},100)}connectedCallback(){super.connectedCallback(),this.breakpoint=Yt(window.innerWidth),window.addEventListener("resize",this.onResize)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("resize",this.onResize)}updated(e){e.has("breakpoint")&&this.setAttribute("breakpoint",this.breakpoint)}resetLayout(){const e=`${Lc}${this.breakpoint}`;localStorage.removeItem(e),this.requestUpdate()}render(){return c`<slot></slot>`}};Fi.styles=M`
    :host {
      display: grid;
      gap: 16px;
      padding: 16px;
        ...
        `:c`
          <div class="chart-wrap">
            ...
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              ${Z`<rect x="0" y="0" width="${Ei}" height="${Vt}" fill="transparent" />`}

              ${$.map(A=>{const ne=A.source?An[A.source]??"#9E9E9E":"#9E9E9E",be=A.x2-A.x1;return Z`<rect
                  class="plan-band"
              ...
              ${R.map(A=>{if(A.isCharge){const ne=qe-A.barH;return Z`<rect class="charge-bar" data-testid="boiler-charge-bar-up"
                    x="${(A.x-2).toFixed(2)}" y="${ne.toFixed(2)}" width="4" height="${A.barH.toFixed(2)}"/>`}else return Z`<rect class="draw-bar" data-testid="boiler-draw-bar-down"
                    x="${(A.x-2).toFixed(2)}" y="${qe}" width="4" height="${A.barH.toFixed(2)}"/>`})}

              ${q.map(A=>{if(A.isCharge){const ne=qe-A.barH;return Z`<rect class="charge-bar" data-testid="boiler-charge-bar-up"
                    data-estimated-power="${A.isEstimated?"true":"false"}"
                    x="${(A.x-2).toFixed(2)}" y="${ne.toFixed(2)}" width="4" height="${A.barH.toFixed(2)}"/>`}else return Z`<rect class="draw-bar" data-testid="boiler-draw-bar-down"
                    data-estimated-power="${A.isEstimated?"true":"false"}"
                    x="${(A.x-2).toFixed(2)}" y="${qe}" width="4" height="${A.barH.toFixed(2)}"/>`})}

              ${f.map(A=>{let ne;try{ne=Date.parse(A.timestamp)}catch{return""}if(!isFinite(ne))return"";const be=(ne-i)/6e4;if(be<0||be>xt||A.powerKw!==null)return"";const mi=qa(ne,m,e),Ie=mi?Ya(mi,e):null;if(Ie!==null&&Ie>0)return"";const Ve=Ye(be);return Z`<rect
 ...
 */class En extends Rh{constructor(t){if(super(t),this.it=O,t.type!==Bh.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===O||t==null)return this._t=void 0,this.it=t;if(t===Lo)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const i=[t];return i.raw=i,this._t={_$litType$:this.constructor.resultType,strings:i,values:[]}}}En.directiveName="unsafeHTML",En.resultType=1;const jh=Nh(En);var Hh=Object.defineProperty,Vh=Object.getOwnPropertyDescriptor,ar=(e,t,i,r)=>{for(var n=r>1?void 0:r?Vh(t,i):t,a=e.length-1,s;a>=0;a--)(s=e[a])&&(n=(r?s(t,i,n):s(n))||n);return r&&n&&Hh(t,i,n),n};const ye=G;let Tt=class extends D{constructor(){super(...arguments),this.open=!1,this.config={title:"",message:""},this.acknowledged=!1,this.limitValue=5e3,this.resolver=null,this.onOverlayClick=()=>{this.closeDialog({confirmed:!1})},this.onDialogClick=e=>{e.stopPropagation()},this.onKeyDown=e=>{e.key==="Escape"&&this.open&&this.closeDialog({confirmed:!1})},this.onAckChange=e=>{this.acknowledged=e.target.checked},this.onLimitInput=e=>{this.limitValue=parseInt(e.target.value,10)||0},this.onCancel=()=>{this.closeDialog({confirmed:!1})},this.onConfirm=()=>{const e=this.config.showLimitInput||this.config.limitOnly;if(e){const t=this.config.limitMin??1,i=this.config.limitMax??2e4;if(isNaN(this.limitValue)||this.limitValue<t||this.limitValue>i)return}this.closeDialog({confirmed:!0,limit:e?this.limitValue:void 0})}}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.onKeyDown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("keydown",this.onKeyDown)}showDialog(e){return this.config=e,this.acknowledged=!1,this.limitValue=e.limitValue??5e3,this.open=!0,new Promise(t=>{this.resolver=t})}closeDialog(e){var t;this.open=!1,(t=this.resolver)==null||t.call(this,e),this.resolver=null}get canConfirm(){return!(this.config.requireAcknowledgement&&!this.acknowledged)}render(){if(!this.open)return O;const e=this.config;return e.limitOnly?c`
  ...
  `;qn([P()],Ki.prototype,"shieldState",2);qn([Br("oig-confirm-dialog")],Ki.prototype,"_confirmDialogQuery",2);Ki=qn([E("oig-control-panel")],Ki);var Uh=Object.defineProperty,Gh=Object.getOwnPropertyDescriptor,pi=(e,t,i,r)=>{for(var n=r>1?void 0:r?Gh(t,i):t,a=e.length-1,s;a>=0;a--)(s=e[a])&&(n=(r?s(t,i,n):s(n))||n);return r&&n&&Uh(t,i,n),n};const we=G;let dt=class extends D{constructor(){super(...arguments),this.open=!1,this.currentSoc=0,this.maxSoc=100,this.estimate=null,this.targetSoc=80}onClose(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0}))}onSliderInput(e){this.targetSoc=parseInt(e.target.value,10),this.dispatchEvent(new CustomEvent("soc-change",{detail:{targetSoc:this.targetSoc},bubbles:!0}))}onConfirm(){this.dispatchEvent(new CustomEvent("confirm",{detail:{targetSoc:this.targetSoc},bubbles:!0}))}render(){return c`

...
`;function Mu(t){return Math.max(0,Math.min(100,t))}function Ir(t){const n=Math.max(0,Math.min(1,(t-10)/60)),r={r:33,g:150,b:243},a={r:255,g:87,b:34},s=(l,c)=>Math.round(l+(c-l)*n);return`rgb(${s(r.r,a.r)}, ${s(r.g,a.g)}, ${s(r.b,a.b)})`}let ni=class extends M{constructor(){super(...arguments),this.collapsed=!0,this.busy=!1}toggle(){this.collapsed=!this.collapsed}async doAction(t,e){this.busy=!0;try{const i=await t();this.dispatchEvent(new CustomEvent("action-done",{detail:{success:i,label:e},bubbles:!0,composed:!0}))}finally{this.busy=!1}}render(){return d`
  ...
  `;q([h({type:Object})],Ii.prototype,"data",2);Ii=q([D("oig-boiler-status-grid")],Ii);let Bi=class extends M{constructor(){super(...arguments),this.data=null}render(){const t=this.data;if(!t)return O;const e=i=>`${i.toFixed(2)} kWh`;return d`
  ...
  `;q([h({type:Object})],Bi.prototype,"data",2);Bi=q([D("oig-boiler-energy-breakdown")],Bi);let Fi=class extends M{constructor(){super(...arguments),this.data=null}render(){const t=this.data;if(!t)return O;const e=t.peakHours.length?t.peakHours.map(r=>`${r}h`).join(", "):"--",i=t.waterLiters40c!==null?`${t.waterLiters40c.toFixed(0)} L`:"-- L",n=t.circulationNow.startsWith("ANO");return d`
  ...
  `;q([h({type:String})],si.prototype,"current",2);q([h({type:Array})],si.prototype,"available",2);si=q([D("oig-boiler-category-select")],si);let Ni=class extends M{constructor(){super(...arguments),this.data=[]}render(){if(!this.data.length)return O;const t=this.data.flatMap(s=>s.hours),e=Math.max(...t,.1),i=e*.3,n=e*.7,r=Array.from({length:24},(s,l)=>l),a=s=>s===0?"none":s<i?"low":s<n?"medium":"high";return d`
  ...
  `;q([h({type:Array})],Ni.prototype,"data",2);Ni=q([D("oig-boiler-heatmap-grid")],Ni);let Ri=class extends M{constructor(){super(...arguments),this.plan=null}render(){const t=this.plan,e=(i,n=2)=>i!=null?i.toFixed(n):"-";return d`
    ...
    .grid-c { color: #FF9800; }
    .cost { color: #2196F3; }
  `;q([h({type:Object})],Ri.prototype,"plan",2);Ri=q([D("oig-boiler-stats-cards")],Ri);let Hi=class extends M{constructor(){super(...arguments),this.data=null}render(){const t=this.data;if(!t)return O;const e=Math.max(...t.hourlyAvg,.01),i=new Set(t.peakHours),n=t.peakHours.length?t.peakHours.map(a=>`${a}h`).join(", "):"--",r=t.confidence!==null?`${Math.round(t.confidence*100)} %`:"-- %";return d`
  ...
  `;q([h({type:Object})],Hi.prototype,"data",2);Hi=q([D("oig-boiler-profiling")],Hi);let Wi=class extends M{constructor(){super(...arguments),this.config=null}render(){const t=this.config;if(!t)return O;const e=(i,n="")=>i!=null?`${i}${n?" "+n:""}`:`--${n?" "+n:""}`;return d`
  ...
  `;q([h({type:Object})],ji.prototype,"state",2);ji=q([D("oig-boiler-state")],ji);let Vi=class extends M{constructor(){super(...arguments),this.data=[]}render(){return O}};Vi.styles=P`
    :host { display: block; }
  `;q([h({type:Array})],Vi.prototype,"data",2);Vi=q([D("oig-boiler-heatmap")],Vi);let oi=class extends M{constructor(){super(...arguments),this.profiles=[],this.editMode=!1}render(){return O}};oi.styles=P`
    :host { display: block; }
  `;q([h({type:Array})],oi.prototype,"profiles",2);q([h({type:Boolean})],oi.prototype,"editMode",2);oi=q([D("oig-boiler-profiles")],oi);var Du=Object.defineProperty,Eu=Object.getOwnPropertyDescriptor,ft=(t,e,i,n)=>{for(var r=n>1?void 0:n?Eu(e,i):e,a=t.length-1,s;a>=0;a--)(s=t[a])&&(r=(n?s(e,i,r):s(r))||r);return n&&r&&Du(e,i,r),r};const kt=Q,Hn=P`
  .selector-label {
    font-size: 12px;
 ...
 */class Tn extends Iu{constructor(e){if(super(e),this.it=O,e.type!==zu.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===O||e==null)return this._t=void 0,this.it=e;if(e===us)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const i=[e];return i.raw=i,this._t={_$litType$:this.constructor.resultType,strings:i,values:[]}}}Tn.directiveName="unsafeHTML",Tn.resultType=1;const Bu=Au(Tn);var Fu=Object.defineProperty,Nu=Object.getOwnPropertyDescriptor,vi=(t,e,i,n)=>{for(var r=n>1?void 0:n?Nu(e,i):e,a=t.length-1,s;a>=0;a--)(s=t[a])&&(r=(n?s(e,i,r):s(r))||r);return n&&r&&Fu(e,i,r),r};const pt=Q;let re=class extends M{constructor(){super(...arguments),this.open=!1,this.config={title:"",message:""},this.acknowledged=!1,this.limitValue=5e3,this.resolver=null,this.onOverlayClick=()=>{this.closeDialog({confirmed:!1})},this.onDialogClick=t=>{t.stopPropagation()},this.onKeyDown=t=>{t.key==="Escape"&&this.open&&this.closeDialog({confirmed:!1})},this.onAckChange=t=>{this.acknowledged=t.target.checked},this.onLimitInput=t=>{this.limitValue=parseInt(t.target.value,10)||0},this.onCancel=()=>{this.closeDialog({confirmed:!1})},this.onConfirm=()=>{if(this.config.showLimitInput){const t=this.config.limitMin??1,e=this.config.limitMax??2e4;if(isNaN(this.limitValue)||this.limitValue<t||this.limitValue>e)return}this.closeDialog({confirmed:!0,limit:this.config.showLimitInput?this.limitValue:void 0})}}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.onKeyDown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("keydown",this.onKeyDown)}showDialog(t){return this.config=t,this.acknowledged=!1,this.limitValue=t.limitValue??5e3,this.open=!0,new Promise(e=>{this.resolver=e})}closeDialog(t){var e;this.open=!1,(e=this.resolver)==null||e.call(this,t),this.resolver=null}get canConfirm(){return!(this.config.requireAcknowledgement&&!this.acknowledged)}render(){if(!this.open)return O;const t=this.config;return d`
  ...
  `;Oe([h({type:Boolean})],jt.prototype,"open",2);Oe([h({type:Number})],jt.prototype,"currentSoc",2);Oe([h({type:Number})],jt.prototype,"maxSoc",2);Oe([h({type:Object})],jt.prototype,"estimate",2);Oe([x()],jt.prototype,"targetSoc",2);jt=Oe([D("oig-battery-charge-dialog")],jt);var Yu=Object.defineProperty,Uu=Object.getOwnPropertyDescriptor,St=(t,e,i,n)=>{for(var r=n>1?void 0:n?Uu(e,i):e,a=t.length-1,s;a>=0;a--)(s=t[a])&&(r=(n?s(e,i,r):s(r))||r);return n&&r&&Yu(e,i,r),r};const bn=Q,jn=P`
  .metric {
    display: flex;
    justify-content: space-between;
    padding: 8px 0;
...
`;let ci=class extends M{constructor(){super(...arguments),this.title="",this.icon="📊"}render(){return d`
  ...
  `;St([h({type:Object})],Yi.prototype,"data",2);Yi=St([D("oig-battery-efficiency")],Yi);let Ui=class extends M{constructor(){super(...arguments),this.data=null}renderSparkline(){var c;const t=(c=this.data)==null?void 0:c.measurementHistory;if(!t||t.length<2)return null;const e=t.map(u=>u.soh_percent),i=Math.min(...e)-1,r=Math.max(...e)+1-i||1,a=200,s=40,l=e.map((u,p)=>{const f=p/(e.length-1)*a,v=s-(u-i)/r*s;return`${f},${v}`}).join(" ");return d`
      <div class="sparkline-container">
  ...
  `;Le([h({type:Object})],di.prototype,"data",2);Le([h({type:Boolean})],di.prototype,"compact",2);di=Le([D("oig-chmu-badge")],di);let ui=class extends M{constructor(){super(...arguments),this.open=!1,this.data=Xe}onClose(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0}))}formatTime(t){return t?new Date(t).toLocaleString("cs-CZ"):"—"}renderWarning(t){const e=Ei[t.severity]??Ei[2],i=sa(t.event_type),n=oa[t.severity]??"Neznámá";return d`
                ...
                <div class="icon-grid">
                  ${n.map(r=>d`
                    <button class="icon-item" type="button" @click=${()=>this.onIconClick(r)}>
                      <span class="icon-emoji">${Oi(r)}</span>

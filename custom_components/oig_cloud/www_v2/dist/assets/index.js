...
Opravdu chcete přidat další úkol?`)}async setBoxMode(t){if(this.state.currentBoxMode===t&&!this.state.changingServices.has("box_mode"))return!1;const i=await ae.callService("oig_cloud","set_box_mode",{mode:t,acknowledgement:!0});return i&&this.refresh(),i}async setGridDelivery(t,i){const r={acknowledgement:!0,warning:!0};t==="limited"&&i!=null?(this.needsGridModeChangeForLimitedRequest()&&(r.mode=t),r.limit=i):i!=null?r.limit=i:r.mode=t;const n=await ae.callService("oig_cloud","set_grid_delivery",r);return n&&this.refresh(),n}async setBoilerMode(t){if(this.state.currentBoilerMode===t&&!this.state.changingServices.has("boiler_mode"))return!1;const i=await ae.callService("oig_cloud","set_boiler_mode",{mode:t,acknowledgement:!0});return i&&this.refresh(),i}async removeFromQueue(t){const i=await ae.callService("oig_cloud","shield_remove_from_queue",{position:t});return i&&this.refresh(),i}async setSupplementaryToggle(t,i){const r=await ae.callService("oig_cloud","set_box_mode",{[t]:i,acknowledgement:!0});return r&&this.refresh(),r}notify(){for(const t of this.listeners)try{t(this.state)}catch(i){P.error("ShieldController listener error",i)}}}const de=new ed;var td=Object.defineProperty,id=Object.getOwnPropertyDescriptor,Wt=(e,t,i,r)=>{for(var n=r>1?void 0:r?id(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&td(t,i,n),n};const Ie=Q;let tt=class extends O{constructor(){super(...arguments),this.title="Energetické Toky",this.time="",this.showStatus=!1,this.alertCount=0,this.leftPanelCollapsed=!1,this.rightPanelCollapsed=!1}onStatusClick(){this.dispatchEvent(new CustomEvent("status-click",{bubbles:!0}))}onEditClick(){this.dispatchEvent(new CustomEvent("edit-click",{bubbles:!0}))}onResetClick(){this.dispatchEvent(new CustomEvent("reset-click",{bubbles:!0}))}onToggleLeftPanel(){this.dispatchEvent(new CustomEvent("toggle-left-panel",{bubbles:!0}))}onToggleRightPanel(){this.dispatchEvent(new CustomEvent("toggle-right-panel",{bubbles:!0}))}render(){const e=this.alertCount>0?"warning":"ok";return c`
  ...
  `;Sa([g({type:Array})],Ji.prototype,"tabs",2);Sa([g({type:String})],Ji.prototype,"activeTab",2);Ji=Sa([L("oig-tabs")],Ji);var sd=Object.defineProperty,ld=Object.getOwnPropertyDescriptor,Ca=(e,t,i,r)=>{for(var n=r>1?void 0:r?ld(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&sd(t,i,n),n};const cd="oig_v2_layout_",Qn=Q;let er=class extends O{constructor(){super(...arguments),this.editable=!1,this.breakpoint="desktop",this.onResize=gs(()=>{this.breakpoint=oi(window.innerWidth)},100)}connectedCallback(){super.connectedCallback(),this.breakpoint=oi(window.innerWidth),window.addEventListener("resize",this.onResize)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("resize",this.onResize)}updated(e){e.has("breakpoint")&&this.setAttribute("breakpoint",this.breakpoint)}resetLayout(){const e=`${cd}${this.breakpoint}`;localStorage.removeItem(e),this.requestUpdate()}render(){return c`<slot></slot>`}};er.styles=E`
    :host {
      display: grid;
      gap: 16px;
      padding: 16px;
  ...
  `;$n([g({type:Number})],pi.prototype,"soc",2);$n([g({type:Boolean})],pi.prototype,"charging",2);$n([g({type:Boolean})],pi.prototype,"gridCharging",2);pi=$n([L("oig-battery-gauge")],pi);var bd=Object.defineProperty,fd=Object.getOwnPropertyDescriptor,kn=(e,t,i,r)=>{for(var n=r>1?void 0:r?fd(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&bd(t,i,n),n};let ui=class extends O{constructor(){super(...arguments),this.power=0,this.percent=0,this.maxPower=5400}get isNight(){return this.percent<2}get level(){return this.percent<2?"night":this.percent<20?"low":this.percent<65?"mid":"high"}get sunColor(){const e=this.level;return e==="low"?"#b0bec5":e==="mid"?"#ffd54f":"#ffb300"}get rayLen(){const e=this.level;return e==="low"?4:e==="mid"?7:10}get rayOpacity(){const e=this.level;return e==="low"?.5:e==="mid"?.8:1}get coreRadius(){const e=this.level;return e==="low"?7:e==="mid"?9:11}renderMoon(){return I`
  ...
  `;kn([g({type:Number})],ui.prototype,"power",2);kn([g({type:Number})],ui.prototype,"percent",2);kn([g({type:Number})],ui.prototype,"maxPower",2);ui=kn([L("oig-solar-icon")],ui);var md=Object.defineProperty,yd=Object.getOwnPropertyDescriptor,mr=(e,t,i,r)=>{for(var n=r>1?void 0:r?yd(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&md(t,i,n),n};let It=class extends O{constructor(){super(...arguments),this.soc=0,this.charging=!1,this.gridCharging=!1,this.discharging=!1,this._clipId=`batt-clip-${Math.random().toString(36).slice(2)}`}get fillColor(){return this.gridCharging?"#42a5f5":this.soc>50?"#4caf50":this.soc>20?"#ff9800":"#f44336"}get fillHeight(){return Math.max(1,Math.min(100,this.soc)/100*48)}get fillY(){return 14+(48-this.fillHeight)}get stripeColor(){return this.gridCharging?"#90caf9":"#a5d6a7"}render(){const e=this.charging||this.gridCharging,t=this.soc>=25;return c`
  ...
  `;mr([g({type:Number})],It.prototype,"soc",2);mr([g({type:Boolean})],It.prototype,"charging",2);mr([g({type:Boolean})],It.prototype,"gridCharging",2);mr([g({type:Boolean})],It.prototype,"discharging",2);It=mr([L("oig-battery-icon")],It);var vd=Object.defineProperty,xd=Object.getOwnPropertyDescriptor,fs=(e,t,i,r)=>{for(var n=r>1?void 0:r?xd(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&vd(t,i,n),n};let tn=class extends O{constructor(){super(...arguments),this.power=0}get mode(){return this.power>50?"importing":this.power<-50?"exporting":"idle"}render(){const e=this.mode;return c`
      <svg viewBox="0 0 48 48">
  ...
  `;Sn([g({type:Number})],hi.prototype,"power",2);Sn([g({type:Number})],hi.prototype,"maxPower",2);Sn([g({type:Boolean})],hi.prototype,"boilerActive",2);hi=Sn([L("oig-house-icon")],hi);var $d=Object.defineProperty,kd=Object.getOwnPropertyDescriptor,yr=(e,t,i,r)=>{for(var n=r>1?void 0:r?kd(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&$d(t,i,n),n};let Bt=class extends O{constructor(){super(...arguments),this.mode="",this.bypassActive=!1,this.hasAlarm=!1,this.plannerAuto=!1}get modeType(){return this.hasAlarm?"alarm":this.bypassActive?"bypass":this.mode.includes("UPS")?"ups":"normal"}render(){const e=this.modeType;return c`
      <svg viewBox="0 0 48 48">
        <!-- Hlavní box střídače -->
        <rect
          class="box ${e}"
  ...
  `;yr([g({type:String})],Bt.prototype,"mode",2);yr([g({type:Boolean})],Bt.prototype,"bypassActive",2);yr([g({type:Boolean})],Bt.prototype,"hasAlarm",2);yr([g({type:Boolean})],Bt.prototype,"plannerAuto",2);Bt=yr([L("oig-inverter-icon")],Bt);var Sd=Object.defineProperty,Cd=Object.getOwnPropertyDescriptor,We=(e,t,i,r)=>{for(var n=r>1?void 0:r?Cd(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&Sd(t,i,n),n};const J=Q,vo=new URLSearchParams(window.location.search),Td=vo.get("sn")||vo.get("inverter_sn")||"",Pd=e=>`sensor.oig_${Td}_${e}`,Xn="oig_v2_flow_layout_",ot=["solar","battery","inverter","grid","house"],Md={solar:{top:"0%",left:"0%"},house:{top:"0%",left:"65%"},inverter:{top:"35%",left:"35%"},grid:{top:"70%",left:"0%"},battery:{top:"70%",left:"65%"}},ms="oig_v2_flow_expanded_nodes";function zd(){try{const e=localStorage.getItem(ms);if(e)return new Set(JSON.parse(e))}catch{}return new Set(["solar","house"])}function Dd(e){try{localStorage.setItem(ms,JSON.stringify([...e]))}catch{}}function le(e){return()=>ae.openEntityDialog(Pd(e))}const Ed=1e3,rn=3300,ys=300;function Od(e){const[t,i,r]=e.map(y=>Math.max(0,isFinite(y)?y:0)),n=t+i+r,a=Math.max(t,i,r)-Math.min(t,i,r),o=n<ys,s=a<=Ed,p=Math.max(t,i,r)/rn*100,u=["L1","L2","L3"],h=[t,i,r].findIndex(y=>y>=rn),b=h>=0?u[h]:null;return{spreadW:a,balanced:s,calm:o,worstPct:p,overloadPhase:b}}function Ld(e,t){if(t<ys)return{leftPct:0,widthPct:0};const i=Math.min(...e),r=Math.max(...e);return{leftPct:i,widthPct:r-i}}let Ae=class extends O{constructor(){super(...arguments),this.data=wa,this.editMode=!1,this.pendingServices=new Map,this.changingServices=new Set,this.shieldStatus="idle",this.shieldQueueCount=0,this.gridDeliveryState={currentLiveDelivery:"unknown",currentLiveLimit:null,pendingDeliveryTarget:null,pendingLimitTarget:null,isTransitioning:!1,isUnavailable:!1},this.shieldUnsub=null,this.expandedNodes=zd(),this.gaugeDetailOpen=null,this.customPositions={},this.draggedNodeId=null,this.dragStartX=0,this.dragStartY=0,this.dragStartTop=0,this.dragStartLeft=0,this.onShieldUpdate=e=>{this.pendingServices=e.pendingServices,this.changingServices=e.changingServices,this.shieldStatus=e.status,this.shieldQueueCount=e.queueCount,this.gridDeliveryState=e.gridDeliveryState},this.nodeDims={},this.handleDragStart=e=>{if(!this.editMode)return;e.preventDefault(),e.stopPropagation();const i=e.target.closest(".node");if(!i)return;const r=this.findNodeId(i);if(!r)return;this.draggedNodeId=r,i.classList.add("dragging");const n=i.getBoundingClientRect();this.dragStartX=e.clientX,this.dragStartY=e.clientY,this.dragStartTop=n.top,this.dragStartLeft=n.left},this.handleTouchStart=e=>{if(!this.editMode)return;e.preventDefault();const i=e.target.closest(".node");if(!i)return;const r=this.findNodeId(i);if(!r)return;this.draggedNodeId=r,i.classList.add("dragging");const n=e.touches[0],a=i.getBoundingClientRect();this.dragStartX=n.clientX,this.dragStartY=n.clientY,this.dragStartTop=a.top,this.dragStartLeft=a.left},this.handleDragMove=e=>{!this.draggedNodeId||!this.editMode||(e.preventDefault(),this.updateDragPosition(e.clientX,e.clientY))},this.handleTouchMove=e=>{if(!this.draggedNodeId||!this.editMode)return;e.preventDefault();const t=e.touches[0];this.updateDragPosition(t.clientX,t.clientY)},this.handleDragEnd=e=>{var r;if(!this.draggedNodeId||!this.editMode)return;const t=(r=this.shadowRoot)==null?void 0:r.querySelector(".flow-grid"),i=t==null?void 0:t.querySelector(`.node-${this.draggedNodeId}`);i&&i.classList.remove("dragging"),this.saveLayout(),this.dispatchEvent(new CustomEvent("layout-changed",{bubbles:!0,composed:!0})),this.draggedNodeId=null},this.handleTouchEnd=e=>{this.handleDragEnd(e)}}connectedCallback(){super.connectedCallback(),this.loadSavedLayout(),this.shieldUnsub=de.subscribe(this.onShieldUpdate)}disconnectedCallback(){var e;super.disconnectedCallback(),this.removeDragListeners(),(e=this.shieldUnsub)==null||e.call(this),this.shieldUnsub=null}updated(e){e.has("editMode")&&(this.editMode?(this.setAttribute("editmode",""),this.loadSavedLayout(),this.requestUpdate(),this.updateComplete.then(()=>this.applySavedPositions())):(this.removeAttribute("editmode"),this.removeDragListeners(),this.clearInlinePositions(),this.updateComplete.then(()=>this.applyCustomPositions()))),!this.editMode&&this.hasCustomLayout&&this.updateComplete.then(()=>this.applyCustomPositions()),this.measureNodes()}measureNodes(){var r;const e=(r=this.shadowRoot)==null?void 0:r.querySelector(".flow-grid");if(!e)return;let t=!1;const i={...this.nodeDims};for(const n of ot){const a=e.querySelector(`.node-${n}`);if(!a)continue;const o=Math.round(a.offsetWidth),s=Math.round(a.offsetHeight);if(o<10||s<10)continue;const d=i[n];(!d||Math.abs(d.w-o)>1||Math.abs(d.h-s)>1)&&(i[n]={w:o,h:s},t=!0)}t&&(this.nodeDims=i)}loadSavedLayout(){const e=oi(window.innerWidth),t=`${Xn}${e}`;try{const i=localStorage.getItem(t);i&&(this.customPositions=JSON.parse(i),P.debug("[FlowNode] Loaded layout for "+e))}catch{}}applySavedPositions(){var t;if(!this.editMode)return;const e=(t=this.shadowRoot)==null?void 0:t.querySelector(".flow-grid");if(e){for(const i of ot){const r=this.customPositions[i];if(!r)continue;const n=e.querySelector(`.node-${i}`);n&&(n.style.top=r.top,n.style.left=r.left)}this.initDragListeners()}}clearInlinePositions(){var t;const e=(t=this.shadowRoot)==null?void 0:t.querySelector(".flow-grid");if(e)for(const i of ot){const r=e.querySelector(`.node-${i}`);r&&(r.style.top="",r.style.left="")}}saveLayout(){const e=oi(window.innerWidth),t=`${Xn}${e}`;try{localStorage.setItem(t,JSON.stringify(this.customPositions)),P.debug("[FlowNode] Saved layout for "+e)}catch{}}toggleExpand(e,t){const i=t.target;if(i.closest(".clickable")||i.closest(".indicator")||i.closest(".node-value")||i.closest(".node-subvalue")||i.closest(".gc-plan-btn"))return;const r=new Set(this.expandedNodes);r.has(e)?r.delete(e):r.add(e),this.expandedNodes=r,Dd(r)}nodeClass(e,t=""){const i=this.expandedNodes.has(e)?" expanded":"";return`node node-${e}${i}${t?" "+t:""}`}gaugePill(e,t,i,r){const n=this.gaugeDetailOpen===e;return c`
      ...
      <div class="${this.nodeClass("solar",r?"sol-night":"")}"
        ...
        <div class="sol-head">
          ${r?I`<svg class="sol-ico" viewBox="0 0 24 24" fill="none" stroke="#9fa8da" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              ...
              </svg>`:I`<svg class="sol-ico" viewBox="0 0 24 24" fill="none" stroke="${$}" stroke-width="2" stroke-linecap="round">
        ...
        <div class="sol-pbar">
          <div class="sol-pbar-fill" style="width:${y.toFixed(1)}%;background:${D}">
      ...
      <div class="${this.nodeClass("battery")}" style="--node-gradient: ${Bi.battery}; --node-border: ${jr.battery};"
        ...
        <div class="bt-pure">
          ...
          <div class="bt-pd ${d}">
            ...
            ${h?c`<span class="bt-sep">·</span>${I`<svg class="bt-ic" viewBox="0 0 24 24"><use href="#bt-clock"/></svg>`} ${h}`:w}
          </div>
        </div>
        ...
        <div class="bt-soc">
          <div class="bt-soctop">
            <button class="bt-kwh" @click=${le("usable_battery_capacity")}>${$(e.batteryUsableKwh)} <small>kWh</small></button>
        ...
        <div class="bt-today">
          <button class="bt-tc" @click=${le("computed_batt_charge_energy_today")}>
            <div class="bt-tch bt-chg">${I`<svg class="bt-ic" viewBox="0 0 24 24"><use href="#bt-up"/></svg>`} ${$(e.batteryChargeTotal/1e3)} <small>kWh</small></div>
            ${v>0?c`
              ...
              <div class="bt-splitleg">
                <span style="color:#ffd54f">${I`<svg viewBox="0 0 24 24"><use href="#bt-sun"/></svg>`} ${$(e.batteryChargeSolar/1e3)}</span>
                <span style="color:#fb8c00">${I`<svg viewBox="0 0 24 24"><use href="#bt-plug"/></svg>`} ${$(e.batteryChargeGrid/1e3)}</span>
              </div>`:w}
          </button>
          <button class="bt-tc" @click=${le("computed_batt_discharge_energy_today")}>
            <div class="bt-tch bt-dis">${I`<svg class="bt-ic" viewBox="0 0 24 24"><use href="#bt-dn"/></svg>`} ${$(e.batteryDischargeTotal/1e3)} <small>kWh</small></div>
    ...
    `}getInverterModeDesc(){const e=this.data.inverterMode;return e.includes("Home 1")?"Max baterie + FVE":e.includes("Home 2")?"Šetří baterii":e.includes("Home 3")?"Priorita nabíjení":e.includes("UPS")?"Vše ze sítě":""}inverterIconDefs(){return I`
      ...
      </defs></svg>`}renderInverter(){const e=this.data,t=io(e.inverterMode),i=e.bypassStatus.toLowerCase()==="on"||e.bypassStatus==="1",r=ud(this.pendingServices,this.changingServices),n=pd(this.gridDeliveryState),a=e.inverterMode,o=a.includes("UPS")?"#ffa726":a.includes("Home 2")?"#42a5f5":a.includes("Home 3")?"#ba68c8":"#5cc46a",s=e.inverterTemp>=45?"#e53935":e.inverterTemp>=35?"#ffa726":"#43a047",d=Math.max(0,Math.min(100,e.inverterTemp/55*100)),p=i?"#e53935":s,u=e.plannerAutoMode,h=u===!0?"řídí · AUTO":u===!1?"VYPNUTO":"N/A",b=u===!0?"iv-plan-auto":"iv-plan-off",y=e.plannerRecommendedMode?io(e.plannerRecommendedMode):null,m=!!y&&!!y.text&&y.text!==t.text,f=e.inverterGridMode,$=f==="limited"?this.fmtKwGrid(e.inverterGridLimit):f==="on"?"Zap":f==="off"?"Vyp":"—",v=f==="on"?"iv-ok":f==="limited"?"iv-warn":"iv-off",_=this.getInverterModeDesc(),T=this.shieldStatus==="running"?`Zpracovávám${this.shieldQueueCount>0?` (${this.shieldQueueCount})`:""}`:"Nečinný",N=(S,A,z,q)=>S===1?A:S>=2&&S<=4?z:q,D=N(e.notificationsError,"chyba","chyby","chyb"),R=N(e.notificationsUnread,"nepřečtená","nepřečtené","nepřečtených");return c`
      <div class="${this.nodeClass("inverter",r.inverterModeChanging?"mode-changing":"")}" style="--node-gradient: ${Bi.inverter}; --node-border: ${jr.inverter};"
        @click=${S=>this.toggleExpand("inverter",S)}>
        ...
        <button class="iv-notif ${e.notificationsError>0?"warn":""}" @click=${le("notification_count_unread")}>
          ${e.notificationsError>0?c`${I`<svg viewBox="0 0 24 24"><use href="#iv-warn"/></svg>`} ${e.notificationsError} ${D} · ${e.notificationsUnread} ${R}`:e.notificationsUnread>0?c`${I`<svg viewBox="0 0 24 24"><use href="#iv-bell"/></svg>`} ${e.notificationsUnread} ${R}`:c`${I`<svg viewBox="0 0 24 24"><use href="#iv-bell"/></svg>`} Bez notifikací`}
        </button>
    ...
    `}gridIconDefs(){return I`
      ...
      </svg>`}iImp(){return I`<svg class="gd-ic" viewBox="0 0 24 24"><use href="#gi-imp"/></svg>`}iExp(){return I`<svg class="gd-ic" viewBox="0 0 24 24"><use href="#gi-exp"/></svg>`}fmtKwGrid(e){const t=Math.abs(e);return t>=1e3?`${(t/1e3).toFixed(1).replace(".",",")} kW`:`${Math.round(t)} W`}renderGrid(){var Fr,Ir;const e=this.data,t=[e.gridL1P,e.gridL2P,e.gridL3P],i=t.some(C=>C>10),r=t.some(C=>C<-10),n=i&&r,a=i&&!r,o=r&&!i,s=t.reduce((C,se)=>C+se,0),d=Math.abs(s),p=t.filter(C=>C>0).reduce((C,se)=>C+se,0),u=t.filter(C=>C<0).reduce((C,se)=>C+Math.abs(se),0),h=d/1e3,b=e.gridImportCostToday!==null||e.gridExportEarningsToday!==null,y=e.gridImportCostToday??0,m=e.gridExportEarningsToday??0,f=m-y,$=(e.gridExportEarningsMonth??0)-(e.gridImportCostMonth??0),v=f>=0?"#9fe6a8":"#ff8a80",_=C=>C.toFixed(2).replace(".",","),T=C=>(C>=0?"+":"−")+_(Math.abs(C)),N=25*230*3,D=e.inverterGridLimit>0?e.inverterGridLimit:5e3,R=o?d/D*100:d/N*100,S=C=>C>=1e3?`${(C/1e3).toFixed(1).replace(".",",")}k`:C>=10?`${Math.round(C)}`:C.toFixed(1).replace(".",","),A=C=>{const se=C<0;return{txt:(se?"−":"")+S(Math.abs(C)),cls:se?"gd-col-imp":"gd-col-exp",earn:!se}},z=C=>{const se=C<0;return{txt:(se?"+":"")+S(Math.abs(C)),cls:se?"gd-col-exp":"gd-col-imp",earn:se}},q=A(m),G=A(e.gridExportEarningsMonth??0),V=z(y),K=z(e.gridImportCostMonth??0),Me=e.exportPrice>=0?"gd-col-exp":"gd-col-imp",Ne=e.spotPrice<=0?"gd-col-exp":"gd-col-imp",X=207,pe=253,k=212,Z=248,ie=[{v:e.gridL1V,label:"L1",entity:"ac_in_aci_vr"},{v:e.gridL2V,label:"L2",entity:"ac_in_aci_vs"},{v:e.gridL3V,label:"L3",entity:"ac_in_aci_vt"}],Se=ie.filter(C=>C.v>0),Ce=Se.length>0,Oe=Ce?Se.reduce((C,se)=>C+se.v,0)/Se.length:230,Dn=Ce?Math.min(...Se.map(C=>C.v)):230,En=Ce?Math.max(...Se.map(C=>C.v)):230,Sr=Math.max((En-Dn)/2+1.5,2.5),wt=Oe-Sr,Ut=Oe+Sr,Cr=Ut-wt,On=C=>C<X||C>pe?"crit":C<k||C>Z?"warn":"ok",Tr=C=>Math.max(0,Math.min(100,(C-wt)/Cr*100));let _t=ie.map((C,se)=>({...C,sev:C.v>0?On(C.v):"na",pct:C.v>0?Tr(C.v):50,lcls:`l${se+1}`,below:!1}));const Pr=_t.filter(C=>C.v>0).slice().sort((C,se)=>C.pct-se.pct),Mr=Pr.length===3?Pr[1].pct:null;_t=_t.map(C=>({...C,below:C.v>0&&Mr!==null&&C.pct===Mr}));const Yt=C=>C<X||C>pe?"rgba(229,57,53,.6)":C<k||C>Z?"rgba(255,167,38,.55)":"rgba(76,175,80,.4)",Ln=[X,k,Z,pe].filter(C=>C>wt&&C<Ut),Ei=[`${Yt(wt+.001)} 0%`];for(const C of Ln){const se=Tr(C).toFixed(1);Ei.push(`${Yt(C-.001)} ${se}%`,`${Yt(C+.001)} ${se}%`)}Ei.push(`${Yt(Ut-.001)} 100%`);const An=`linear-gradient(90deg, ${Ei.join(", ")})`,$t=e.gridFrequency>0?Math.abs(e.gridFrequency-50):0,Fn=e.gridFrequency>0&&$t>.5,zr=e.gridFrequency>0&&$t>.2,In=Fn?"gd-hz crit":zr?"gd-hz warn":"gd-hz",Dr=e.currentTariff==="VT"||((Fr=e.currentTariff)==null?void 0:Fr.includes("vysoký")),Er=e.currentTariff==="NT"||((Ir=e.currentTariff)==null?void 0:Ir.includes("nízký")),Or=Dr?"gd-tar vt":Er?"gd-tar nt":"gd-tar",Bn=Dr?"VT":Er?"NT":e.currentTariff||"--",Nn=Math.max(0,...t.filter(C=>C>0)),Lr=Math.max(0,...t.filter(C=>C<0).map(Math.abs)),Ar=Math.max(50,Nn+Lr),Zt=Lr/Ar*100,jn=c`
    ...
    `;return c`
      <div class="${this.nodeClass("grid")}" style="--node-gradient: ${Bi.grid}; --node-border: ${jr.grid};"
        ...
        ${this.gaugePill("grid",b?`${T(f)} Kč`:`${Math.round(R)} %`,v,jn)}
    ...
    `}renderHouse(){const e=this.data,t=e.houseTodayWh/1e3,i=e.nonbackupTodayWh/1e3,r=t+i,n=e.housePower+e.nonbackupPower,a=t+e.zalohaPlannedRemainingKwh,o=e.selfSufficiencyTodayPct,s=e.houseTodayWh+e.nonbackupTodayWh,d=s>0?e.srcBatteryTodayKwh*1e3/s*100:0,p=s>0?e.srcFveTodayKwh*1e3/s*100:0,u=s>0?e.srcGridTodayKwh*1e3/s*100:0,h=o>=66?"#43a047":o>=33?"#fdd835":"#e53935",b=`hsl(${Math.round(Math.max(0,Math.min(120,o*1.2)))}, 72%, 46%)`,y=r>0,m=y?r:1,f=y?Math.round(e.srcFveTodayKwh/m*100):0,$=y?Math.round(e.srcBatteryTodayKwh/m*100):0,v=y?Math.max(0,100-f-$):0,_=`Denní soběstačnost ${Math.round(o)} % · FVE ${f} % · Baterie ${$} % · Síť ${v} %`,T=Od([e.houseL1,e.houseL2,e.houseL3]),N=[{z:e.houseL1,n:e.nonbackupL1,ze:"ac_out_aco_pr"},{z:e.houseL2,n:e.nonbackupL2,ze:"ac_out_aco_ps"},{z:e.houseL3,n:e.nonbackupL3,ze:"ac_out_aco_pt"}],D=Math.max(300,...N.map(X=>X.z+X.n)),R=rn/D*100,S=R<=100,A=T.spreadW>=1e3?`${(T.spreadW/1e3).toFixed(1).replace(".",",")} kW`:`${Math.round(T.spreadW)} W`,z=N.map(X=>Math.max(0,X.z)/D*100),q=e.houseL1+e.houseL2+e.houseL3,G=Ld(z,q),V=X=>X>=1e3?`${(X/1e3).toFixed(1).replace(".",",")} kW`:`${Math.round(X)} W`,K=26,Me=`Záloha ${Tt(e.housePower)} · dnes ${t.toFixed(1)} kWh${e.zalohaPlannedRemainingKwh>0?` · plán ${a.toFixed(1)} kWh`:""}`,Ne=`Nezáloha ${Tt(e.nonbackupPower)} · dnes ${i.toFixed(1)} kWh`;return c`
      <div class="${this.nodeClass("house")}" style="--node-gradient: ${Bi.house}; --node-border: ${jr.house};"
        ...
        <div class="pg">
          ...
          ${N.map((X,pe)=>{const k=X.z>=rn,Z=X.z+X.n,ie=Math.max(0,X.z)/D*100,Se=Math.max(0,X.n)/D*100,Ce=ie>=K&&X.z>100,Oe=Se>=K&&X.n>100;return c`
              <div class="pg-row l${pe+1}">
                <div class="pg-track">
                  <div class="pg-z ${k?"crit":""}" style="width:${ie.toFixed(1)}%">
                    ${Ce?V(X.z):w}
                  </div>
                  ${X.n>0?c`
                  ...
                  ${S?c`<div class="pg-lim" style="left:${R.toFixed(1)}%"></div>`:w}
                </div>
...
`;function Wh(e){return Math.max(0,Math.min(100,e))}function Mo(e){const r=Math.max(0,Math.min(1,(e-10)/60)),n={r:33,g:150,b:243},a={r:255,g:87,b:34},o=(s,d)=>Math.round(s+(d-s)*r);return`rgb(${o(n.r,a.r)}, ${o(n.g,a.g)}, ${o(n.b,a.b)})`}let rr=class extends O{constructor(){super(...arguments),this.collapsed=!0,this.busy=!1}toggle(){this.collapsed=!this.collapsed}async doAction(e,t){this.busy=!0;try{const i=await e();this.dispatchEvent(new CustomEvent("action-done",{detail:{success:i,label:t},bubbles:!0,composed:!0}))}finally{this.busy=!1}}render(){return c`
  ...
  `;H([M()],rr.prototype,"collapsed",2);H([M()],rr.prototype,"busy",2);rr=H([L("oig-boiler-debug-panel")],rr);let on=class extends O{constructor(){super(...arguments),this.data=null}render(){const e=this.data;if(!e)return c`<div>Nacitani stavu...</div>`;const t=(i,r,n=1)=>i!=null?`${i.toFixed(n)} ${r}`:`-- ${r}`;return c`
      <h3>Stav bojleru</h3>
      <div class="grid">
        <div class="card">
  ...
  `;H([g({type:Object})],on.prototype,"data",2);on=H([L("oig-boiler-status-grid")],on);let sn=class extends O{constructor(){super(...arguments),this.data=null}render(){const e=this.data;if(!e)return w;const t=i=>`${i.toFixed(2)} kWh`;return c`
  ...
  `;H([g({type:Object})],sn.prototype,"data",2);sn=H([L("oig-boiler-energy-breakdown")],sn);let ln=class extends O{constructor(){super(...arguments),this.data=null}render(){const e=this.data;if(!e)return w;const t=e.peakHours.length?e.peakHours.map(n=>`${n}h`).join(", "):"--",i=e.waterLiters40c!==null?`${e.waterLiters40c.toFixed(0)} L`:"-- L",r=e.circulationNow.startsWith("ANO");return c`
  ...
  `;H([g({type:Object})],ln.prototype,"data",2);ln=H([L("oig-boiler-predicted-usage")],ln);let nr=class extends O{constructor(){super(...arguments),this.plan=null,this.forecastWindows={fve:"--",grid:"--"}}render(){var r;const e=this.plan,t=this.forecastWindows,i=n=>n??"--";return c`
  ...
  `;H([g({type:Object})],nr.prototype,"plan",2);H([g({type:Object})],nr.prototype,"forecastWindows",2);nr=H([L("oig-boiler-plan-info")],nr);let ar=class extends O{constructor(){super(...arguments),this.boilerState=null,this.targetTemp=60}render(){const e=this.boilerState;if(!e)return c`<div>Nacitani...</div>`;const t=10,i=70,r=y=>Wh((y-t)/(i-t)*100),n=e.heatingPercent??0,a=e.tempTop!==null?r(e.tempTop):null,o=e.tempBottom!==null?r(e.tempBottom):null,s=r(this.targetTemp),d=Mo(e.tempTop??this.targetTemp),p=Mo(e.tempBottom??10),u=`linear-gradient(180deg, ${d} 0%, ${p} 100%)`,h=e.heatingPercent!==null?`${e.heatingPercent.toFixed(0)}% nahrato`:"-- % nahrato";return c`
  ...
  `;H([g({type:Object})],ar.prototype,"boilerState",2);H([g({type:Number})],ar.prototype,"targetTemp",2);ar=H([L("oig-boiler-tank")],ar);let or=class extends O{constructor(){super(...arguments),this.current="",this.available=[]}onChange(e){const t=e.target.value;this.dispatchEvent(new CustomEvent("category-change",{detail:{category:t},bubbles:!0,composed:!0}))}render(){const e=this.available.length?this.available:Object.keys(pa);return c`
      <div class="row">
        <label>Profil:</label>
  ...
  `;H([g({type:String})],or.prototype,"current",2);H([g({type:Array})],or.prototype,"available",2);or=H([L("oig-boiler-category-select")],or);let cn=class extends O{constructor(){super(...arguments),this.data=[]}render(){if(!this.data.length)return w;const e=this.data.flatMap(o=>o.hours),t=Math.max(...e,.1),i=t*.3,r=t*.7,n=Array.from({length:24},(o,s)=>s),a=o=>o===0?"none":o<i?"low":o<r?"medium":"high";return c`
  ...
  `;H([g({type:Array})],cn.prototype,"data",2);cn=H([L("oig-boiler-heatmap-grid")],cn);let dn=class extends O{constructor(){super(...arguments),this.plan=null}render(){const e=this.plan,t=(i,r=2)=>i!=null?i.toFixed(r):"-";return c`
      <div class="grid">
        <div class="card">
    ...
    .grid-c { color: #FF9800; }
    .cost { color: #2196F3; }
  `;H([g({type:Object})],dn.prototype,"plan",2);dn=H([L("oig-boiler-stats-cards")],dn);let pn=class extends O{constructor(){super(...arguments),this.data=null}render(){const e=this.data;if(!e)return w;const t=Math.max(...e.hourlyAvg,.01),i=new Set(e.peakHours),r=e.peakHours.length?e.peakHours.map(a=>`${a}h`).join(", "):"--",n=e.confidence!==null?`${Math.round(e.confidence*100)} %`:"-- %";return c`
  ...
  `;H([g({type:Object})],pn.prototype,"data",2);pn=H([L("oig-boiler-profiling")],pn);let un=class extends O{constructor(){super(...arguments),this.config=null}render(){const e=this.config;if(!e)return w;const t=(i,r="")=>i!=null?`${i}${r?" "+r:""}`:`--${r?" "+r:""}`;return c`
  ...
  `;H([g({attribute:!1})],sr.prototype,"data",2);H([g({type:String})],sr.prototype,"lang",2);sr=H([L("oig-boiler-demand-map")],sr);let hn=class extends O{constructor(){super(...arguments),this.state=null}render(){return this.state?c`
  ...
  `;H([g({type:Object})],hn.prototype,"state",2);hn=H([L("oig-boiler-state")],hn);let gn=class extends O{constructor(){super(...arguments),this.data=[]}render(){return w}};gn.styles=E`
    :host { display: block; }
  `;H([g({type:Array})],gn.prototype,"data",2);gn=H([L("oig-boiler-heatmap")],gn);let lr=class extends O{constructor(){super(...arguments),this.profiles=[],this.editMode=!1}render(){return w}};lr.styles=E`
    :host { display: block; }
  `;H([g({type:Array})],lr.prototype,"profiles",2);H([g({type:Boolean})],lr.prototype,"editMode",2);lr=H([L("oig-boiler-profiles")],lr);let cr=class extends O{constructor(){super(...arguments),this.data=null,this.lang="cs"}render(){const e=this.data,t=this.lang,i=(e==null?void 0:e.currentState)??"unknown",r=x(`boiler.status.${i}`,t),n=(e==null?void 0:e.comfortSatisfied)===!0?x("boiler.status.comfort_satisfied",t):(e==null?void 0:e.comfortSatisfied)===!1?x("boiler.status.comfort_unsatisfied",t):x("boiler.status.comfort_unknown",t),a=(e==null?void 0:e.comfortSatisfied)===!0?"ok":(e==null?void 0:e.comfortSatisfied)===!1?"bad":"unknown",o=(e==null?void 0:e.degradedFlags)??[];return c`
  ...
  `;H([g({attribute:!1})],cr.prototype,"data",2);H([g({type:String})],cr.prototype,"lang",2);cr=H([L("oig-boiler-status-panel")],cr);let dr=class extends O{constructor(){super(...arguments),this.slots=[],this.lang="cs"}srcClass(e){return e&&["fve","grid","alternative","overflow","discharge"].includes(e)?e:"other"}render(){const e=this.lang;return!this.slots||this.slots.length===0?c`<div data-testid="boiler-plan-timeline" class="wrap"><div class="heading">${x("boiler.timeline.heading",e)}</div><div class="empty">${x("boiler.timeline.empty",e)}</div></div>`:c`
  ...
  `;H([g({attribute:!1})],pr.prototype,"explanation",2);H([g({type:String})],pr.prototype,"lang",2);pr=H([L("oig-boiler-source-explanation")],pr);let fi=class extends O{constructor(){super(...arguments),this.identity={entryId:null,boxId:null,available:!1},this.currentOverride=null,this.lang="cs"}render(){var a,o;const e=this.lang,t=this.identity.available,i=((a=this.currentOverride)==null?void 0:a.capabilityAvailable)??!1,r=t&&i,n=((o=this.currentOverride)==null?void 0:o.active)===!0;return c`
  ...
  `;H([g({attribute:!1})],fi.prototype,"identity",2);H([g({attribute:!1})],fi.prototype,"currentOverride",2);H([g({type:String})],fi.prototype,"lang",2);fi=H([L("oig-boiler-override-panel")],fi);let mi=class extends O{constructor(){super(...arguments),this.reason="unavailable",this.message="",this.lang="cs"}render(){const e=this.lang,t=this.reason==="loading"?"⏳":this.reason==="error"?"⚠️":this.reason==="degraded"?"🟠":"ℹ️";return c`
  ...
  `;Pn([g({type:Object})],yi.prototype,"data",2);Pn([g({type:Object})],yi.prototype,"config",2);Pn([g({type:String})],yi.prototype,"lang",2);yi=Pn([L("oig-boiler-v2-shell")],yi);var ug=Object.defineProperty,hg=Object.getOwnPropertyDescriptor,Ti=(e,t,i,r)=>{for(var n=r>1?void 0:r?hg(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&ug(t,i,n),n};let ut=class extends O{constructor(){super(...arguments),this.values=[],this.color="#4CAF50",this.sparkWidth=100,this.sparkHeight=30,this.label=""}render(){try{return this._renderSparkline()}catch{return c`<svg
  ...
  `;Ti([g({type:Array})],ut.prototype,"values",2);Ti([g({type:String})],ut.prototype,"color",2);Ti([g({type:Number})],ut.prototype,"sparkWidth",2);Ti([g({type:Number})],ut.prototype,"sparkHeight",2);Ti([g({type:String})],ut.prototype,"label",2);ut=Ti([L("oig-boiler-sparkline")],ut);var gg=Object.defineProperty,bg=Object.getOwnPropertyDescriptor,$r=(e,t,i,r)=>{for(var n=r>1?void 0:r?bg(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&gg(t,i,n),n};const Ur=Q;function fg(e,t){switch(e){case"fve":case"overflow":return x("boiler.panel.source_overflow",t);case"grid":return x("boiler.panel.source_grid",t);case"battery":return x("boiler.panel.source_battery_short",t);case"alternative":return x("boiler.panel.source_alt",t);default:return e??"—"}}function mg(e){switch(e){case"morning":return"🌅";case"afternoon":return"☀️";case"evening":return"🌆";case"night":return"🌙";default:return"💧"}}function yg(e,t){const i=`boiler.demand_map.window.${e}`,r=x(i,t);return r!==i?r.toLowerCase():e}function vg(e){const t=e*15,i=Math.floor(t/60)%24,r=t%60;return`${String(i).padStart(2,"0")}:${String(r).padStart(2,"0")}`}function Ao(e){const t=new Date(e);return Number.isNaN(t.getTime())?"??:??":`${String(t.getHours()).padStart(2,"0")}:${String(t.getMinutes()).padStart(2,"0")}`}function xg(e,t){const i=Date.now();for(const r of e){const n=new Date(r.start).getTime();if(!Number.isFinite(n)||n<i-6e4)continue;const a=r.heatingKwh??null;if(a!==null&&a<=0)continue;const o=r.recommendedSource;if(!o)continue;const s=new Date(n),d=new Date,p=s.getDate()!==d.getDate()||s.getMonth()!==d.getMonth()||s.getFullYear()!==d.getFullYear(),u=fg(o,t),h=`${String(s.getHours()).padStart(2,"0")}:${String(s.getMinutes()).padStart(2,"0")}`;return{label:u,timeStr:h,isTomorrow:p}}return null}let jt=class extends O{constructor(){super(...arguments),this.data=null,this.config=null,this.lang="cs",this.panelType="source"}render(){try{return this.panelType==="source"?this._renderSourcePanel():this._renderComfortPanel()}catch{return c`
    ...
    `}_renderComfortPanel(){var $,v,_,T,N;const e=this.data,t=this.lang,r=(($=e==null?void 0:e.status)==null?void 0:$.comfortSatisfied)??null,n=(e==null?void 0:e.demandMap)??null,a=((v=n==null?void 0:n.windows)==null?void 0:v.slice(0,3))??[],o=(e==null?void 0:e.planSummary)??null,s=(o==null?void 0:o.deadlineTime)??(((_=this.config)==null?void 0:_.deadlineTime)!=="--:--"?(T=this.config)==null?void 0:T.deadlineTime:null)??null,d=((N=this.config)==null?void 0:N.targetTempC)??null,p=(e==null?void 0:e.legionella)??null,u=(()=>{if(!p)return null;if(!p.enabled)return x("boiler.panel.legionella_off",t);if(p.scheduledStart){const S=p.scheduledStart,A=S.includes("T")?Ao(S):S.substring(0,5);return`${x("boiler.panel.legionella_plan",t)} ${A}`}const D=p.daysSinceLast??null,R=p.intervalDays??null;if(D!==null&&R!==null){const S=R-D;return S<=0?x("boiler.panel.legionella_overdue",t):`${x("boiler.panel.legionella_in",t)} ${S} ${x("boiler.panel.legionella_days",t)}`}return x("boiler.panel.legionella_scheduled",t)})(),h=(e==null?void 0:e.activity)??null,b=(h==null?void 0:h.temperatureTrendCPerMin)??null,y=b!=null?`${b>=0?"+":""}${b.toFixed(1).replace(".",",")} °C/min`:null,m=(e==null?void 0:e.circulationRuns)??[],f=(()=>{if(!m.length)return null;const D=m[0];return`💧 ${Ao(D.start)} (${x("boiler.panel.circ_before_peak",t)})`})();return c`
      <div class="panel" data-testid="boiler-comfort-panel">
        ...
        ${a.map(D=>{const R=mg(D.label),S=yg(D.label,t),A=vg(D.slotIndex),z=Math.round(D.liters);return c`
        ...
        `:c`
          <div class="chart-wrap">
            ...
            >
              ...
              ${$.map(k=>{const Z=k.source?hc[k.source]??"#9E9E9E":"#9E9E9E",ie=k.x2-k.x1;return I`<rect
                  class="plan-band"
              ...
              ${N.map(k=>{if(k.isCharge){const Z=Je-k.barH;return I`<rect class="charge-bar" data-testid="boiler-charge-bar-up"
                    x="${(k.x-2).toFixed(2)}" y="${Z.toFixed(2)}" width="4" height="${k.barH.toFixed(2)}"/>`}else return I`<rect class="draw-bar" data-testid="boiler-draw-bar-down"
                    x="${(k.x-2).toFixed(2)}" y="${Je}" width="4" height="${k.barH.toFixed(2)}"/>`})}

              ${D.map(k=>{if(k.isCharge){const Z=Je-k.barH;return I`<rect class="charge-bar" data-testid="boiler-charge-bar-up"
                    data-estimated-power="${k.isEstimated?"true":"false"}"
                    x="${(k.x-2).toFixed(2)}" y="${Z.toFixed(2)}" width="4" height="${k.barH.toFixed(2)}"/>`}else return I`<rect class="draw-bar" data-testid="boiler-draw-bar-down"
                    data-estimated-power="${k.isEstimated?"true":"false"}"
                    x="${(k.x-2).toFixed(2)}" y="${Je}" width="4" height="${k.barH.toFixed(2)}"/>`})}

              ${y.map(k=>{let Z;try{Z=Date.parse(k.timestamp)}catch{return""}if(!isFinite(Z))return"";const ie=(Z-i)/6e4;if(ie<0||ie>Et||k.powerKw!==null)return"";const Se=Io(Z,m,e),Ce=Se?Bo(Se,e):null;if(Ce!==null&&Ce>0)return"";const Oe=et(ie);return I`<rect
              ...
              ${A!=null?I`<polyline class="temp-line" points="${A}" />`:""}
  ...
  `;Pi([g({type:Object})],ht.prototype,"data",2);Pi([g({type:Object})],ht.prototype,"config",2);Pi([g({type:String})],ht.prototype,"lang",2);Pi([g({type:Number})],ht.prototype,"nowMs",2);Pi([g({type:String})],ht.prototype,"timeZone",2);ht=Pi([L("oig-boiler-timeline-chart")],ht);var Mg=Object.defineProperty,zg=Object.getOwnPropertyDescriptor,ke=(e,t,i,r)=>{for(var n=r>1?void 0:r?zg(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&Mg(t,i,n),n};const zt=Q,Mn=E`
  .selector-label {
    font-size: 12px;
 ...
 */class xa extends Fg{constructor(t){if(super(t),this.it=w,t.type!==Lg.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===w||t==null)return this._t=void 0,this.it=t;if(t===ll)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const i=[t];return i.raw=i,this._t={_$litType$:this.constructor.resultType,strings:i,values:[]}}}xa.directiveName="unsafeHTML",xa.resultType=1;const Ig=Ag(xa);var Bg=Object.defineProperty,Ng=Object.getOwnPropertyDescriptor,kr=(e,t,i,r)=>{for(var n=r>1?void 0:r?Ng(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&Bg(t,i,n),n};const ze=Q;let Rt=class extends O{constructor(){super(...arguments),this.open=!1,this.config={title:"",message:""},this.acknowledged=!1,this.limitValue=5e3,this.resolver=null,this.onOverlayClick=()=>{this.closeDialog({confirmed:!1})},this.onDialogClick=e=>{e.stopPropagation()},this.onKeyDown=e=>{e.key==="Escape"&&this.open&&this.closeDialog({confirmed:!1})},this.onAckChange=e=>{this.acknowledged=e.target.checked},this.onLimitInput=e=>{this.limitValue=parseInt(e.target.value,10)||0},this.onCancel=()=>{this.closeDialog({confirmed:!1})},this.onConfirm=()=>{const e=this.config.showLimitInput||this.config.limitOnly;if(e){const t=this.config.limitMin??1,i=this.config.limitMax??2e4;if(isNaN(this.limitValue)||this.limitValue<t||this.limitValue>i)return}this.closeDialog({confirmed:!0,limit:e?this.limitValue:void 0})}}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.onKeyDown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("keydown",this.onKeyDown)}showDialog(e){return this.config=e,this.acknowledged=!1,this.limitValue=e.limitValue??5e3,this.open=!0,new Promise(t=>{this.resolver=t})}closeDialog(e){var t;this.open=!1,(t=this.resolver)==null||t.call(this,e),this.resolver=null}get canConfirm(){return!(this.config.requireAcknowledgement&&!this.acknowledged)}render(){if(!this.open)return w;const e=this.config;return e.limitOnly?c`
  ...
  `;kr([g({type:Boolean,reflect:!0})],Rt.prototype,"open",2);kr([g({type:Object})],Rt.prototype,"config",2);kr([M()],Rt.prototype,"acknowledged",2);kr([M()],Rt.prototype,"limitValue",2);Rt=kr([L("oig-confirm-dialog")],Rt);var jg=Object.defineProperty,Rg=Object.getOwnPropertyDescriptor,js=(e,t,i,r)=>{for(var n=r>1?void 0:r?Rg(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&jg(t,i,n),n};const qi=Q;let fn=class extends O{constructor(){super(...arguments),this.shieldState=null}render(){if(!this.shieldState)return w;const e=this.determineStatus(this.shieldState),t=e.toLowerCase(),i=this.getStatusIcon(e),r=this.getStatusLabel(e),a=this.shieldState.queueCount>0?"has-items":"";return c`
  ...
  `;zn([g({type:Boolean})],wi.prototype,"boxHasHome56",2);zn([M()],wi.prototype,"shieldState",2);zn([_n("oig-confirm-dialog")],wi.prototype,"_confirmDialogQuery",2);wi=zn([L("oig-control-panel")],wi);var Vg=Object.defineProperty,Kg=Object.getOwnPropertyDescriptor,zi=(e,t,i,r)=>{for(var n=r>1?void 0:r?Kg(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&Vg(t,i,n),n};const Le=Q;let mt=class extends O{constructor(){super(...arguments),this.open=!1,this.currentSoc=0,this.maxSoc=100,this.estimate=null,this.targetSoc=80}onClose(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0}))}onSliderInput(e){this.targetSoc=parseInt(e.target.value,10),this.dispatchEvent(new CustomEvent("soc-change",{detail:{targetSoc:this.targetSoc},bubbles:!0}))}onConfirm(){this.dispatchEvent(new CustomEvent("confirm",{detail:{targetSoc:this.targetSoc},bubbles:!0}))}render(){return c`
  ...
  `;zi([g({type:Boolean})],mt.prototype,"open",2);zi([g({type:Number})],mt.prototype,"currentSoc",2);zi([g({type:Number})],mt.prototype,"maxSoc",2);zi([g({type:Object})],mt.prototype,"estimate",2);zi([M()],mt.prototype,"targetSoc",2);mt=zi([L("oig-battery-charge-dialog")],mt);var qg=Object.defineProperty,Gg=Object.getOwnPropertyDescriptor,Ke=(e,t,i,r)=>{for(var n=r>1?void 0:r?Gg(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&qg(t,i,n),n};function li(e){return e==null||Number.isNaN(e)?"-- kWh":`${e.toFixed(Math.abs(e)>=10?1:2)} kWh`}const oa=Q,La=E`
  .metric {
    display: flex;
    justify-content: space-between;
    padding: 8px 0;
...
`;let ur=class extends O{constructor(){super(...arguments),this.title="",this.icon="📊"}render(){return c`
  ...
  `;oe([g({type:Object})],ee.prototype,"hass",2);oe([M()],ee.prototype,"loading",2);oe([M()],ee.prototype,"error",2);oe([M()],ee.prototype,"activeTab",2);oe([M()],ee.prototype,"editMode",2);oe([M()],ee.prototype,"time",2);oe([M()],ee.prototype,"leftPanelCollapsed",2);oe([M()],ee.prototype,"rightPanelCollapsed",2);oe([M()],ee.prototype,"flowData",2);oe([M()],ee.prototype,"pricingData",2);oe([M()],ee.prototype,"pricingLoading",2);oe([M()],ee.prototype,"boilerState",2);oe([M()],ee.prototype,"boilerLoading",2);oe([M()],ee.prototype,"boilerV2Data",2);oe([M()],ee.prototype,"boilerConfig",2);oe([M()],ee.prototype,"boxHasHome56",2);oe([M()],ee.prototype,"analyticsData",2);oe([M()],ee.prototype,"chmuData",2);oe([M()],ee.prototype,"chmuModalOpen",2);oe([M()],ee.prototype,"timelineTab",2);oe([M()],ee.prototype,"timelineData",2);oe([M()],ee.prototype,"tilesConfig",2);oe([M()],ee.prototype,"tilesLeft",2);oe([M()],ee.prototype,"tilesRight",2);oe([M()],ee.prototype,"tileDialogOpen",2);oe([M()],ee.prototype,"editingTileIndex",2);oe([M()],ee.prototype,"editingTileSide",2);oe([M()],ee.prototype,"editingTileConfig",2);ee=oe([L("oig-app")],ee);P.info("V2 starting",{version:"2.0.0-beta.1"});Sl();async function kb(){try{const e=await kl(),t=document.getElementById("app");t&&(t.innerHTML="",t.appendChild(e)),P.info("V2 mounted successfully")}catch(e){P.error("V2 bootstrap failed",e);const t=document.getElementById("app");t&&(t.innerHTML=`

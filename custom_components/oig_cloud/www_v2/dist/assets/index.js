var nl=Object.defineProperty;var al=(e,t,i)=>t in e?nl(e,t,{enumerable:!0,configurable:!0,writable:!0,value:i}):e[t]=i;var F=(e,t,i)=>al(e,typeof t!="symbol"?t+"":t,i);import{f as ol,u as sl,i as E,a as L,b as c,r as Q,w as I,A as w,E as ll}from"./vendor.js";import{C as wn,a as Ho,L as Wo,P as Vo,b as Ko,i as qo,p as Go,c as Uo,d as cl,T as dl,e as pl,B as ul,f as hl,g as gl,h as bl,j as fl,k as Yo}from"./charts.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))r(n);new MutationObserver(n=>{for(const a of n)if(a.type==="childList")for(const o of a.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function i(n){const a={};return n.integrity&&(a.integrity=n.integrity),n.referrerPolicy&&(a.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?a.credentials="include":n.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(n){if(n.ep)return;n.ep=!0;const a=i(n);fetch(n.href,a)}})();const Ct="[V2]";function ml(){return new Date().toISOString().substr(11,12)}function Nr(e,t){const i=ml(),r=e.toUpperCase().padEnd(5);return`${i} ${r} ${t}`}const P={debug(e,t){typeof window<"u"&&window.OIG_DEBUG&&console.debug(Ct,Nr("debug",e),t??"")},info(e,t){console.info(Ct,Nr("info",e),t??"")},warn(e,t){console.warn(Ct,Nr("warn",e),t??"")},error(e,t,i){const r=t?{error:t.message,stack:t.stack,...i}:i;console.error(Ct,Nr("error",e),r??"")},time(e){console.time(`${Ct} ${e}`)},timeEnd(e){console.timeEnd(`${Ct} ${e}`)},group(e){console.group(`${Ct} ${e}`)},groupEnd(){console.groupEnd()}};function yl(){window.addEventListener("error",vl),window.addEventListener("unhandledrejection",xl),P.debug("Error handling setup complete")}function vl(e){const t=e.error||new Error(e.message);P.error("Uncaught error",t,{filename:e.filename,lineno:e.lineno,colno:e.colno}),e.preventDefault()}function xl(e){const t=e.reason instanceof Error?e.reason:new Error(String(e.reason));P.error("Unhandled promise rejection",t),e.preventDefault()}class Zo extends Error{constructor(t,i,r=!1,n){super(t),this.code=i,this.recoverable=r,this.cause=n,this.name="AppError"}}class Ii extends Zo{constructor(t="Authentication failed"){super(t,"AUTH_ERROR",!1),this.name="AuthError"}}class Va extends Zo{constructor(t="Network error",i){super(t,"NETWORK_ERROR",!0,i),this.name="NetworkError"}}const wl="oig_v2_";function _l(){var e;try{const t=((e=globalThis.navigator)==null?void 0:e.userAgent)||"";return/Home Assistant|HomeAssistant|HAcompanion/i.test(t)}catch{return!1}}function $l(){var e;try{const t=((e=globalThis.navigator)==null?void 0:e.userAgent)||"",i=/Android|iPhone|iPad|iPod|Mobile/i.test(t),r=globalThis.innerWidth<=768;return i||r}catch{return!1}}const je={isHaApp:!1,isMobile:!1,reduceMotion:!1};async function kl(){var i,r;P.info("Bootstrap starting"),yl(),je.isHaApp=_l(),je.isMobile=$l(),je.reduceMotion=je.isHaApp||je.isMobile||((r=(i=globalThis.matchMedia)==null?void 0:i.call(globalThis,"(prefers-reduced-motion: reduce)"))==null?void 0:r.matches)||!1;const e=document.documentElement;je.isHaApp&&e.classList.add("oig-ha-app"),je.isMobile&&e.classList.add("oig-mobile"),je.reduceMotion&&e.classList.add("oig-reduce-motion");const t={version:"2.0.0-beta.1",storagePrefix:wl};return P.info("Bootstrap complete",{...t,isHaApp:je.isHaApp,isMobile:je.isMobile,reduceMotion:je.reduceMotion}),document.createElement("oig-app")}const l={bgPrimary:"var(--primary-background-color, #ffffff)",bgSecondary:"var(--secondary-background-color, #f5f5f5)",textPrimary:"var(--primary-text-color, #212121)",textSecondary:"var(--secondary-text-color, #757575)",accent:"var(--accent-color, #03a9f4)",divider:"var(--divider-color, #e0e0e0)",error:"var(--error-color, #db4437)",success:"var(--success-color, #0f9d58)",warning:"var(--warning-color, #f4b400)",cardBg:"var(--card-background-color, #ffffff)",cardBgSolid:"var(--oig-surface, #ffffff)",cardShadow:"var(--shadow-elevation-2dp_-_box-shadow, 0 2px 2px 0 rgba(0,0,0,0.14))",fontFamily:"var(--primary-font-family, system-ui, sans-serif)"},Ka={"--primary-background-color":"#111936","--secondary-background-color":"#1a2044","--primary-text-color":"#e1e1e1","--secondary-text-color":"rgba(255,255,255,0.7)","--accent-color":"#03a9f4","--divider-color":"rgba(255,255,255,0.12)","--error-color":"#ef5350","--success-color":"#66bb6a","--warning-color":"#ffa726","--card-background-color":"rgba(255,255,255,0.06)","--oig-surface":"#1b2440","--shadow-elevation-2dp_-_box-shadow":"0 2px 4px 0 rgba(0,0,0,0.4)"},qa={"--primary-background-color":"#ffffff","--secondary-background-color":"#f5f5f5","--primary-text-color":"#212121","--secondary-text-color":"#757575","--accent-color":"#03a9f4","--divider-color":"#e0e0e0","--error-color":"#db4437","--success-color":"#0f9d58","--warning-color":"#f4b400","--card-background-color":"#ffffff","--oig-surface":"#ffffff","--shadow-elevation-2dp_-_box-shadow":"0 2px 2px 0 rgba(0,0,0,0.14)"};function Hn(){var e,t;try{if(window.parent&&window.parent!==window){const i=(t=(e=window.parent.document)==null?void 0:e.querySelector("home-assistant"))==null?void 0:t.hass;if(i!=null&&i.themes){if(typeof i.themes.darkMode=="boolean")return i.themes.darkMode;const r=(i.themes.theme||"").toLowerCase();if(r.includes("dark"))return!0;if(r.includes("light"))return!1}}}catch{}return window.matchMedia("(prefers-color-scheme: dark)").matches}function Wn(e){const t=e?Ka:qa,i=document.documentElement;for(const[r,n]of Object.entries(t))i.style.setProperty(r,n);i.classList.toggle("dark",e),document.body.style.background=e?Ka["--secondary-background-color"]:qa["--secondary-background-color"]}function Sl(){const e=Hn();Wn(e),window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",()=>{const i=Hn();Wn(i)}),setInterval(()=>{const i=Hn(),r=document.documentElement.classList.contains("dark");i!==r&&Wn(i)},5e3)}const Ga={mobile:768,tablet:1024};function oi(e){return e<Ga.mobile?"mobile":e<Ga.tablet?"tablet":"desktop"}/**
 * @license
...
Opravdu chcete přidat další úkol?`)}async setBoxMode(t){if(this.state.currentBoxMode===t&&!this.state.changingServices.has("box_mode"))return!1;const i=await ae.callService("oig_cloud","set_box_mode",{mode:t,acknowledgement:!0});return i&&this.refresh(),i}async setGridDelivery(t,i){const r={acknowledgement:!0,warning:!0};t==="limited"&&i!=null?(this.needsGridModeChangeForLimitedRequest()&&(r.mode=t),r.limit=i):i!=null?r.limit=i:r.mode=t;const n=await ae.callService("oig_cloud","set_grid_delivery",r);return n&&this.refresh(),n}async setBoilerMode(t){if(this.state.currentBoilerMode===t&&!this.state.changingServices.has("boiler_mode"))return!1;const i=await ae.callService("oig_cloud","set_boiler_mode",{mode:t,acknowledgement:!0});return i&&this.refresh(),i}async removeFromQueue(t){const i=await ae.callService("oig_cloud","shield_remove_from_queue",{position:t});return i&&this.refresh(),i}async setSupplementaryToggle(t,i){const r=await ae.callService("oig_cloud","set_box_mode",{[t]:i,acknowledgement:!0});return r&&this.refresh(),r}notify(){for(const t of this.listeners)try{t(this.state)}catch(i){P.error("ShieldController listener error",i)}}}const de=new ed;var td=Object.defineProperty,id=Object.getOwnPropertyDescriptor,Wt=(e,t,i,r)=>{for(var n=r>1?void 0:r?id(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&td(t,i,n),n};const Ie=Q;let tt=class extends L{constructor(){super(...arguments),this.title="Energetické Toky",this.time="",this.showStatus=!1,this.alertCount=0,this.leftPanelCollapsed=!1,this.rightPanelCollapsed=!1}onStatusClick(){this.dispatchEvent(new CustomEvent("status-click",{bubbles:!0}))}onEditClick(){this.dispatchEvent(new CustomEvent("edit-click",{bubbles:!0}))}onResetClick(){this.dispatchEvent(new CustomEvent("reset-click",{bubbles:!0}))}onToggleLeftPanel(){this.dispatchEvent(new CustomEvent("toggle-left-panel",{bubbles:!0}))}onToggleRightPanel(){this.dispatchEvent(new CustomEvent("toggle-right-panel",{bubbles:!0}))}render(){const e=this.alertCount>0?"warning":"ok";return c`
  ...
  `;Wt([g({type:String})],tt.prototype,"title",2);Wt([g({type:String})],tt.prototype,"time",2);Wt([g({type:Boolean})],tt.prototype,"showStatus",2);Wt([g({type:Number})],tt.prototype,"alertCount",2);Wt([g({type:Boolean})],tt.prototype,"leftPanelCollapsed",2);Wt([g({type:Boolean})],tt.prototype,"rightPanelCollapsed",2);tt=Wt([A("oig-header")],tt);function gs(e,t){let i=null;return function(...r){i!==null&&clearTimeout(i),i=window.setTimeout(()=>{e.apply(this,r),i=null},t)}}var rd=Object.defineProperty,nd=Object.getOwnPropertyDescriptor,fr=(e,t,i,r)=>{for(var n=r>1?void 0:r?nd(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&rd(t,i,n),n};const mo="oig_v2_theme";let Ft=class extends L{constructor(){super(...arguments),this.mode="auto",this.isDark=!1,this.breakpoint="desktop",this.width=1280,this.mediaQuery=null,this.resizeObserver=null,this.debouncedResize=gs(this.updateBreakpoint.bind(this),100),this.onMediaChange=e=>{this.mode==="auto"&&(this.isDark=e.matches,this.dispatchEvent(new CustomEvent("theme-changed",{detail:{isDark:this.isDark}})))},this.onThemeChange=()=>{this.detectTheme()}}connectedCallback(){super.connectedCallback(),this.loadTheme(),this.setupMediaQuery(),this.setupResizeObserver(),this.detectTheme(),window.addEventListener("oig-theme-change",this.onThemeChange)}disconnectedCallback(){var e,t;super.disconnectedCallback(),(e=this.mediaQuery)==null||e.removeEventListener("change",this.onMediaChange),(t=this.resizeObserver)==null||t.disconnect(),window.removeEventListener("oig-theme-change",this.onThemeChange)}loadTheme(){const e=localStorage.getItem(mo);e&&["light","dark","auto"].includes(e)&&(this.mode=e)}saveTheme(){localStorage.setItem(mo,this.mode)}setupMediaQuery(){this.mediaQuery=window.matchMedia("(prefers-color-scheme: dark)"),this.mediaQuery.addEventListener("change",this.onMediaChange)}setupResizeObserver(){this.resizeObserver=new ResizeObserver(this.debouncedResize),this.resizeObserver.observe(document.documentElement),this.updateBreakpoint()}updateBreakpoint(){this.width=window.innerWidth,this.breakpoint=oi(this.width)}detectTheme(){this.mode==="auto"?this.isDark=window.matchMedia("(prefers-color-scheme: dark)").matches:this.isDark=this.mode==="dark"}setTheme(e){this.mode=e,this.saveTheme(),this.detectTheme(),this.dispatchEvent(new CustomEvent("theme-changed",{detail:{mode:e,isDark:this.isDark}})),P.info("Theme changed",{mode:e,isDark:this.isDark})}getThemeInfo(){return{mode:this.mode,isDark:this.isDark,breakpoint:this.breakpoint,width:this.width}}render(){return c`
      <slot></slot>
    `}};Ft.styles=E`
    :host {
      display: contents;
    }
  `;fr([g({type:String})],Ft.prototype,"mode",2);fr([D()],Ft.prototype,"isDark",2);fr([D()],Ft.prototype,"breakpoint",2);fr([D()],Ft.prototype,"width",2);Ft=fr([A("oig-theme-provider")],Ft);var ad=Object.defineProperty,od=Object.getOwnPropertyDescriptor,Sa=(e,t,i,r)=>{for(var n=r>1?void 0:r?od(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&ad(t,i,n),n};let Ji=class extends L{constructor(){super(...arguments),this.tabs=[],this.activeTab=""}onTabClick(e){e!==this.activeTab&&(this.activeTab=e,this.dispatchEvent(new CustomEvent("tab-change",{detail:{tabId:e},bubbles:!0})))}isActive(e){return this.activeTab===e}render(){return c`
      ${this.tabs.map(e=>c`
        <button 
  ...
  `;Sa([g({type:Array})],Ji.prototype,"tabs",2);Sa([g({type:String})],Ji.prototype,"activeTab",2);Ji=Sa([A("oig-tabs")],Ji);var sd=Object.defineProperty,ld=Object.getOwnPropertyDescriptor,Ca=(e,t,i,r)=>{for(var n=r>1?void 0:r?ld(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&sd(t,i,n),n};const cd="oig_v2_layout_",Qn=Q;let er=class extends L{constructor(){super(...arguments),this.editable=!1,this.breakpoint="desktop",this.onResize=gs(()=>{this.breakpoint=oi(window.innerWidth)},100)}connectedCallback(){super.connectedCallback(),this.breakpoint=oi(window.innerWidth),window.addEventListener("resize",this.onResize)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("resize",this.onResize)}updated(e){e.has("breakpoint")&&this.setAttribute("breakpoint",this.breakpoint)}resetLayout(){const e=`${cd}${this.breakpoint}`;localStorage.removeItem(e),this.requestUpdate()}render(){return c`<slot></slot>`}};er.styles=E`
    :host {
      display: grid;
      gap: 16px;
      padding: 16px;
  ...
  `;Ca([g({type:Boolean})],er.prototype,"editable",2);Ca([D()],er.prototype,"breakpoint",2);er=Ca([A("oig-grid")],er);const dd={off:"Vypnuto",on:"Zapnuto",limited:"Omezeno",unknown:"?"};function yo(e){return dd[e]??e}const bs=e=>{const t=e.trim();return t?t.endsWith("W")?t:`${t}W`:""};function pd(e){const t=e.isUnavailable;let i;t||e.currentLiveDelivery==="unknown"?i="?":e.currentLiveDelivery==="limited"&&e.currentLiveLimit!==null?i=`Omezeno ${e.currentLiveLimit}W`:i=yo(e.currentLiveDelivery);const r=!t&&e.currentLiveDelivery==="limited";let n=null,a=null;!t&&e.currentLiveLimit!==null&&(a=`${e.currentLiveLimit}W`,n=r?"Aktivní limit":"Nastavený limit");let o=null,s=null;return e.pendingDeliveryTarget!==null&&(o=`Ve frontě: ${yo(e.pendingDeliveryTarget)}`),e.pendingLimitTarget!==null&&(s=`Ve frontě: limit ${bs(String(e.pendingLimitTarget))}`),{currentModeText:i,limitLabel:n,limitValue:a,showLimitAsActive:r,isUnavailable:t,isTransitioning:e.isTransitioning,pendingModeText:o,pendingLimitText:s}}function ud(e,t){const i=t.has("box_mode"),r=e.get("box_mode"),n=t.has("grid_mode")||t.has("grid_limit"),a=e.get("grid_limit"),o=e.get("grid_mode");let s=null;if(a){const d=bs(a);s=d?`→ ${d}`:null}else o&&(s=`→ ${o}`);return{inverterModeChanging:i,inverterModeText:r?`→ ${r}`:null,gridExportChanging:n,gridExportText:s}}var hd=Object.defineProperty,gd=Object.getOwnPropertyDescriptor,$n=(e,t,i,r)=>{for(var n=r>1?void 0:r?gd(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&hd(t,i,n),n};let pi=class extends L{constructor(){super(...arguments),this.soc=0,this.charging=!1,this.gridCharging=!1}get fillHeight(){return Math.max(0,Math.min(100,this.soc))/100*54}get fillY(){return 13+(54-this.fillHeight)}render(){return c`
  ...
  `;$n([g({type:Number})],pi.prototype,"soc",2);$n([g({type:Boolean})],pi.prototype,"charging",2);$n([g({type:Boolean})],pi.prototype,"gridCharging",2);pi=$n([A("oig-battery-gauge")],pi);var bd=Object.defineProperty,fd=Object.getOwnPropertyDescriptor,kn=(e,t,i,r)=>{for(var n=r>1?void 0:r?fd(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&bd(t,i,n),n};let ui=class extends L{constructor(){super(...arguments),this.power=0,this.percent=0,this.maxPower=5400}get isNight(){return this.percent<2}get level(){return this.percent<2?"night":this.percent<20?"low":this.percent<65?"mid":"high"}get sunColor(){const e=this.level;return e==="low"?"#b0bec5":e==="mid"?"#ffd54f":"#ffb300"}get rayLen(){const e=this.level;return e==="low"?4:e==="mid"?7:10}get rayOpacity(){const e=this.level;return e==="low"?.5:e==="mid"?.8:1}get coreRadius(){const e=this.level;return e==="low"?7:e==="mid"?9:11}renderMoon(){return I`
    ...
    `}renderSun(){const i=this.coreRadius,r=i+3,n=r+this.rayLen,a=this.sunColor,o=this.rayOpacity,d=[0,45,90,135,180,225,270,315].map(u=>{const h=u*Math.PI/180,b=24+Math.cos(h)*r,y=24+Math.sin(h)*r,m=24+Math.cos(h)*n,f=24+Math.sin(h)*n;return I`
        <line class="ray"
          x1="${b}" y1="${y}" x2="${m}" y2="${f}"
          stroke="${a}" stroke-width="2.5" opacity="${o}"
        />
      `}),p=this.level==="low";return I`
  ...
  `;kn([g({type:Number})],ui.prototype,"power",2);kn([g({type:Number})],ui.prototype,"percent",2);kn([g({type:Number})],ui.prototype,"maxPower",2);ui=kn([A("oig-solar-icon")],ui);var md=Object.defineProperty,yd=Object.getOwnPropertyDescriptor,mr=(e,t,i,r)=>{for(var n=r>1?void 0:r?yd(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&md(t,i,n),n};let It=class extends L{constructor(){super(...arguments),this.soc=0,this.charging=!1,this.gridCharging=!1,this.discharging=!1,this._clipId=`batt-clip-${Math.random().toString(36).slice(2)}`}get fillColor(){return this.gridCharging?"#42a5f5":this.soc>50?"#4caf50":this.soc>20?"#ff9800":"#f44336"}get fillHeight(){return Math.max(1,Math.min(100,this.soc)/100*48)}get fillY(){return 14+(48-this.fillHeight)}get stripeColor(){return this.gridCharging?"#90caf9":"#a5d6a7"}render(){const e=this.charging||this.gridCharging,t=this.soc>=25;return c`
  ...
  `;mr([g({type:Number})],It.prototype,"soc",2);mr([g({type:Boolean})],It.prototype,"charging",2);mr([g({type:Boolean})],It.prototype,"gridCharging",2);mr([g({type:Boolean})],It.prototype,"discharging",2);It=mr([A("oig-battery-icon")],It);var vd=Object.defineProperty,xd=Object.getOwnPropertyDescriptor,fs=(e,t,i,r)=>{for(var n=r>1?void 0:r?xd(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&vd(t,i,n),n};let tn=class extends L{constructor(){super(...arguments),this.power=0}get mode(){return this.power>50?"importing":this.power<-50?"exporting":"idle"}render(){const e=this.mode;return c`
      <svg viewBox="0 0 48 48">
  ...
  `;fs([g({type:Number})],tn.prototype,"power",2);tn=fs([A("oig-grid-icon")],tn);var wd=Object.defineProperty,_d=Object.getOwnPropertyDescriptor,Sn=(e,t,i,r)=>{for(var n=r>1?void 0:r?_d(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&wd(t,i,n),n};let hi=class extends L{constructor(){super(...arguments),this.power=0,this.maxPower=1e4,this.boilerActive=!1}get percent(){return Math.min(100,this.power/Math.max(1,this.maxPower)*100)}get fillColor(){const e=this.percent;return e<15?"#546e7a":e<40?"#f06292":e<70?"#e91e63":"#c62828"}get level(){const e=this.percent;return e<15?"low":e<60?"mid":"high"}get windowColor(){const e=this.level;return e==="low"?"#37474f":e==="mid"?"#ffd54f":"#ffb300"}render(){const e=this.percent,t=24,i=22,r=Math.max(1,e/100*t),n=i+(t-r),a=this.level;return c`
      <svg viewBox="0 0 48 48">
        <defs>
  ...
  `;Sn([g({type:Number})],hi.prototype,"power",2);Sn([g({type:Number})],hi.prototype,"maxPower",2);Sn([g({type:Boolean})],hi.prototype,"boilerActive",2);hi=Sn([A("oig-house-icon")],hi);var $d=Object.defineProperty,kd=Object.getOwnPropertyDescriptor,yr=(e,t,i,r)=>{for(var n=r>1?void 0:r?kd(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&$d(t,i,n),n};let Bt=class extends L{constructor(){super(...arguments),this.mode="",this.bypassActive=!1,this.hasAlarm=!1,this.plannerAuto=!1}get modeType(){return this.hasAlarm?"alarm":this.bypassActive?"bypass":this.mode.includes("UPS")?"ups":"normal"}render(){const e=this.modeType;return c`
      <svg viewBox="0 0 48 48">
        <!-- Hlavní box střídače -->
        <rect
          class="box ${e}"
  ...
  `;yr([g({type:String})],Bt.prototype,"mode",2);yr([g({type:Boolean})],Bt.prototype,"bypassActive",2);yr([g({type:Boolean})],Bt.prototype,"hasAlarm",2);yr([g({type:Boolean})],Bt.prototype,"plannerAuto",2);Bt=yr([A("oig-inverter-icon")],Bt);var Sd=Object.defineProperty,Cd=Object.getOwnPropertyDescriptor,We=(e,t,i,r)=>{for(var n=r>1?void 0:r?Cd(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&Sd(t,i,n),n};const J=Q,vo=new URLSearchParams(window.location.search),Td=vo.get("sn")||vo.get("inverter_sn")||"",Pd=e=>`sensor.oig_${Td}_${e}`,Xn="oig_v2_flow_layout_",ot=["solar","battery","inverter","grid","house"],Md={solar:{top:"0%",left:"0%"},house:{top:"0%",left:"65%"},inverter:{top:"35%",left:"35%"},grid:{top:"70%",left:"0%"},battery:{top:"70%",left:"65%"}},ms="oig_v2_flow_expanded_nodes";function zd(){try{const e=localStorage.getItem(ms);if(e)return new Set(JSON.parse(e))}catch{}return new Set(["solar","house"])}function Dd(e){try{localStorage.setItem(ms,JSON.stringify([...e]))}catch{}}function le(e){return()=>ae.openEntityDialog(Pd(e))}const Ed=1e3,rn=3300,ys=300;function Od(e){const[t,i,r]=e.map(y=>Math.max(0,isFinite(y)?y:0)),n=t+i+r,a=Math.max(t,i,r)-Math.min(t,i,r),o=n<ys,s=a<=Ed,p=Math.max(t,i,r)/rn*100,u=["L1","L2","L3"],h=[t,i,r].findIndex(y=>y>=rn),b=h>=0?u[h]:null;return{spreadW:a,balanced:s,calm:o,worstPct:p,overloadPhase:b}}function Ld(e,t){if(t<ys)return{leftPct:0,widthPct:0};const i=Math.min(...e),r=Math.max(...e);return{leftPct:i,widthPct:r-i}}let Ae=class extends L{constructor(){super(...arguments),this.data=wa,this.editMode=!1,this.pendingServices=new Map,this.changingServices=new Set,this.shieldStatus="idle",this.shieldQueueCount=0,this.gridDeliveryState={currentLiveDelivery:"unknown",currentLiveLimit:null,pendingDeliveryTarget:null,pendingLimitTarget:null,isTransitioning:!1,isUnavailable:!1},this.shieldUnsub=null,this.expandedNodes=zd(),this.gaugeDetailOpen=null,this.customPositions={},this.draggedNodeId=null,this.dragStartX=0,this.dragStartY=0,this.dragStartTop=0,this.dragStartLeft=0,this.onShieldUpdate=e=>{this.pendingServices=e.pendingServices,this.changingServices=e.changingServices,this.shieldStatus=e.status,this.shieldQueueCount=e.queueCount,this.gridDeliveryState=e.gridDeliveryState},this.nodeDims={},this.handleDragStart=e=>{if(!this.editMode)return;e.preventDefault(),e.stopPropagation();const i=e.target.closest(".node");if(!i)return;const r=this.findNodeId(i);if(!r)return;this.draggedNodeId=r,i.classList.add("dragging");const n=i.getBoundingClientRect();this.dragStartX=e.clientX,this.dragStartY=e.clientY,this.dragStartTop=n.top,this.dragStartLeft=n.left},this.handleTouchStart=e=>{if(!this.editMode)return;e.preventDefault();const i=e.target.closest(".node");if(!i)return;const r=this.findNodeId(i);if(!r)return;this.draggedNodeId=r,i.classList.add("dragging");const n=e.touches[0],a=i.getBoundingClientRect();this.dragStartX=n.clientX,this.dragStartY=n.clientY,this.dragStartTop=a.top,this.dragStartLeft=a.left},this.handleDragMove=e=>{!this.draggedNodeId||!this.editMode||(e.preventDefault(),this.updateDragPosition(e.clientX,e.clientY))},this.handleTouchMove=e=>{if(!this.draggedNodeId||!this.editMode)return;e.preventDefault();const t=e.touches[0];this.updateDragPosition(t.clientX,t.clientY)},this.handleDragEnd=e=>{var r;if(!this.draggedNodeId||!this.editMode)return;const t=(r=this.shadowRoot)==null?void 0:r.querySelector(".flow-grid"),i=t==null?void 0:t.querySelector(`.node-${this.draggedNodeId}`);i&&i.classList.remove("dragging"),this.saveLayout(),this.dispatchEvent(new CustomEvent("layout-changed",{bubbles:!0,composed:!0})),this.draggedNodeId=null},this.handleTouchEnd=e=>{this.handleDragEnd(e)}}connectedCallback(){super.connectedCallback(),this.loadSavedLayout(),this.shieldUnsub=de.subscribe(this.onShieldUpdate)}disconnectedCallback(){var e;super.disconnectedCallback(),this.removeDragListeners(),(e=this.shieldUnsub)==null||e.call(this),this.shieldUnsub=null}updated(e){e.has("editMode")&&(this.editMode?(this.setAttribute("editmode",""),this.loadSavedLayout(),this.requestUpdate(),this.updateComplete.then(()=>this.applySavedPositions())):(this.removeAttribute("editmode"),this.removeDragListeners(),this.clearInlinePositions(),this.updateComplete.then(()=>this.applyCustomPositions()))),!this.editMode&&this.hasCustomLayout&&this.updateComplete.then(()=>this.applyCustomPositions()),this.measureNodes()}measureNodes(){var r;const e=(r=this.shadowRoot)==null?void 0:r.querySelector(".flow-grid");if(!e)return;let t=!1;const i={...this.nodeDims};for(const n of ot){const a=e.querySelector(`.node-${n}`);if(!a)continue;const o=Math.round(a.offsetWidth),s=Math.round(a.offsetHeight);if(o<10||s<10)continue;const d=i[n];(!d||Math.abs(d.w-o)>1||Math.abs(d.h-s)>1)&&(i[n]={w:o,h:s},t=!0)}t&&(this.nodeDims=i)}loadSavedLayout(){const e=oi(window.innerWidth),t=`${Xn}${e}`;try{const i=localStorage.getItem(t);i&&(this.customPositions=JSON.parse(i),P.debug("[FlowNode] Loaded layout for "+e))}catch{}}applySavedPositions(){var t;if(!this.editMode)return;const e=(t=this.shadowRoot)==null?void 0:t.querySelector(".flow-grid");if(e){for(const i of ot){const r=this.customPositions[i];if(!r)continue;const n=e.querySelector(`.node-${i}`);n&&(n.style.top=r.top,n.style.left=r.left)}this.initDragListeners()}}clearInlinePositions(){var t;const e=(t=this.shadowRoot)==null?void 0:t.querySelector(".flow-grid");if(e)for(const i of ot){const r=e.querySelector(`.node-${i}`);r&&(r.style.top="",r.style.left="")}}saveLayout(){const e=oi(window.innerWidth),t=`${Xn}${e}`;try{localStorage.setItem(t,JSON.stringify(this.customPositions)),P.debug("[FlowNode] Saved layout for "+e)}catch{}}toggleExpand(e,t){const i=t.target;if(i.closest(".clickable")||i.closest(".indicator")||i.closest(".node-value")||i.closest(".node-subvalue")||i.closest(".gc-plan-btn"))return;const r=new Set(this.expandedNodes);r.has(e)?r.delete(e):r.add(e),this.expandedNodes=r,Dd(r)}nodeClass(e,t=""){const i=this.expandedNodes.has(e)?" expanded":"";return`node node-${e}${i}${t?" "+t:""}`}gaugePill(e,t,i,r){const n=this.gaugeDetailOpen===e;return c`
    ...
    `}edgeGauge(e){const t=Math.max(0,Math.min(100,e.pct)),i=Math.max(1.5,Math.min(6,e.width??2.5)),r=e.nodeId?this.nodeDims[e.nodeId]:void 0,n=(r==null?void 0:r.w)??180,a=(r==null?void 0:r.h)??180,o=1.5,s=e.full?0:100-t,d=e.stops.map(([u,h])=>I`<stop offset="${u}" stop-color="${h}"></stop>`),p=e.pulseDur?`--pulse-dur:${e.pulseDur}s`:"";return I`
      ...
      </svg>`}edgeGaugeSegments(e){const t=Math.max(1.5,Math.min(6,e.width??3.5)),i=this.nodeDims[e.nodeId],r=(i==null?void 0:i.w)??180,n=(i==null?void 0:i.h)??180,a=1.5,o=10.5,s=e.segments.filter(u=>u.frac>.001);let d=0;const p=s.map(u=>{const h=-d;return d+=u.frac,I`<rect x=${a} y=${a}
        width=${r-a*2} height=${n-a*2} rx=${o}
        fill="none" stroke=${u.color} stroke-width=${t}
        pathLength="100"
        stroke-dasharray="${u.frac} 100"
        stroke-dashoffset="${h}"></rect>`});return I`
      ...
      <div class="${this.nodeClass("solar",r?"sol-night":"")}"
        ...
        <div class="sol-head">
          ${r?I`<svg class="sol-ico" viewBox="0 0 24 24" fill="none" stroke="#9fa8da" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M20 14.5A8 8 0 1 1 9.5 4 6.2 6.2 0 0 0 20 14.5z" fill="#2a3050"/>
              </svg>`:I`<svg class="sol-ico" viewBox="0 0 24 24" fill="none" stroke="${k}" stroke-width="2" stroke-linecap="round">
        ...
        <div class="sol-pbar">
          <div class="sol-pbar-fill" style="width:${y.toFixed(1)}%;background:${O}">
    ...
    `}getBalancingIndicator(){const e=this.data,t=e.balancingState;return t!=="charging"&&t!=="holding"&&t!=="completed"?{show:!1,text:"",icon:"",cls:""}:t==="charging"?{show:!0,text:`Nabíjení${e.balancingTimeRemaining?` (${e.balancingTimeRemaining})`:""}`,icon:"⚡",cls:"charging"}:t==="holding"?{show:!0,text:`Držení${e.balancingTimeRemaining?` (${e.balancingTimeRemaining})`:""}`,icon:"⏸️",cls:"holding"}:{show:!0,text:"Dokončeno",icon:"✅",cls:"completed"}}batteryIconDefs(){return I`
      ...
      </defs></svg>`}renderBattery(){const e=this.data,t=this.getBalancingIndicator(),i=e.batteryTemp>35?"bt-hot":e.batteryTemp<10?"bt-cold":"",r=Math.abs(e.batteryPower)/1e3,n=Math.abs(e.batteryPower)>10,a=e.batteryPower>10,o=e.batteryPower<-10,s=a?"Nabíjí":o?"Vybíjí":"Klid",d=a?"bt-chg":o?"bt-dis":"",p=M=>!!M&&/\d/.test(M),h=(a&&p(e.timeToFull)?e.timeToFull:o&&p(e.timeToEmpty)?e.timeToEmpty:"").replace(/\s*hodin[aquy]*/gi," h").replace(/\s*minut[ay]*/gi," min").replace(/\s+/g," ").trim(),b=Math.round(e.batterySoC),y=b>=66?"rgba(67,160,71,0.13)":b>=33?"rgba(253,216,53,0.10)":"rgba(229,57,53,0.12)",m=b>=66?"#43a047":b>=33?"#fdd835":"#e53935",f=Math.round(e.batteryFloorPct),k=M=>M.toFixed(1).replace(".",","),v=Math.max(0,(e.batterySoC-e.batteryFloorPct)/100)*e.batteryInstalledKwh,_=Math.max(0,(e.housePower-e.solarPower)/1e3);let T;if(v<=.05)T="0 h";else if(_<=.05)T="∞";else{const M=v/_;if(M>=24)T="> 24 h";else if(M>=10)T=`${Math.round(M)} h`;else if(M>=1){const z=Math.floor(M);T=`${z} h ${Math.round((M-z)*60)} min`}else T=`${Math.max(1,Math.round(M*60))} min`}const R=e.batteryChargeSolar+e.batteryChargeGrid,O=R>0?e.batteryChargeSolar/R*100:0,N=100-O,$=e.batterySoH>=90?"#9fe6a8":e.batterySoH>=75?"#ffcc80":"#ff8a80";return c`
      <div class="${this.nodeClass("battery")}" style="--node-gradient: ${Bi.battery}; --node-border: ${jr.battery};"
        @click=${M=>this.toggleExpand("battery",M)}>
        ...
        <div class="bt-head">
          ${I`<svg class="bt-head-ico" viewBox="0 0 24 24" fill="none" stroke="#cfe0ff" stroke-width="2" stroke-linejoin="round">
          ...
          <button class="bt-soh" style="color:${$};border-color:${$}66;background:${$}1f"
            ...
            ${I`<svg viewBox="0 0 24 24"><use href="#bt-heart"/></svg>`} ${Math.round(e.batterySoH)} %
          </button>
        </div>
        ...
        <div class="bt-pure">
          ...
          <div class="bt-pd ${d}">
            ${a?c`${I`<svg class="bt-ic" viewBox="0 0 24 24"><use href="#bt-up"/></svg>`} Nabíjí`:o?c`${I`<svg class="bt-ic" viewBox="0 0 24 24"><use href="#bt-dn"/></svg>`} Vybíjí`:"◉ Klid"}
          </div>
        </div>
        ...
        <div class="bt-soc">
          <div class="bt-soctop">
            <div class="bt-aut" title="Kdyby teď vypadla síť: použitelné kWh nad podlahou / (zálohová spotřeba − FVE)">
              ${I`<svg class="bt-aut-ico" viewBox="0 0 24 24" fill="none" stroke="currentColor"><use href="#bt-clock"/></svg>`}
              <div><div class="bt-aut-lbl">vydrží</div><div class="bt-aut-v ${v<=.05?"bt-dis":""}">${T}</div></div>
            </div>
            <button class="bt-use" @click=${le("usable_battery_capacity")}>
              <span class="bt-use-lbl">využitelných</span>
              <span class="bt-use-v">${k(v)} <small>kWh</small></span>
            </button>
          </div>
          <div class="bt-socbar">
            ${f>0?c`<div class="bt-socres" style="width:${f}%"></div>`:w}
            <div class="bt-socfill" style="width:${b}%;background:${m}"></div>
            ${f>0?c`<div class="bt-socfloor" style="left:${f}%" title="Podlaha ${f} %">
              ${I`<svg viewBox="0 0 24 24"><use href="#bt-floor"/></svg>`}</div>`:w}
          </div>
          <div class="bt-socsc"><span>0 %</span>${f>0?c`<span class="bt-fl">podlaha ${f} %</span>`:w}<span>100 %</span></div>
        </div>

        <!-- TODAY: charge (FVE/grid split) · discharge -->
        <div class="bt-today">
          <button class="bt-tc" @click=${le("computed_batt_charge_energy_today")}>
            <div class="bt-tch bt-chg">${I`<svg class="bt-ic" viewBox="0 0 24 24"><use href="#bt-up"/></svg>`} ${k(e.batteryChargeTotal/1e3)} <small>kWh</small></div>
            ${R>0?c`
              <div class="bt-split"><div class="bt-sp-fve" style="width:${O.toFixed(0)}%"></div><div class="bt-sp-grid" style="width:${N.toFixed(0)}%"></div></div>
              <div class="bt-splitleg">
                <span style="color:#ffd54f">${I`<svg viewBox="0 0 24 24"><use href="#bt-sun"/></svg>`} ${k(e.batteryChargeSolar/1e3)}</span>
                <span style="color:#fb8c00">${I`<svg viewBox="0 0 24 24"><use href="#bt-plug"/></svg>`} ${k(e.batteryChargeGrid/1e3)}</span>
              </div>`:w}
          </button>
          <button class="bt-tc" @click=${le("computed_batt_discharge_energy_today")}>
            <div class="bt-tch bt-dis">${I`<svg class="bt-ic" viewBox="0 0 24 24"><use href="#bt-dn"/></svg>`} ${k(e.batteryDischargeTotal/1e3)} <small>kWh</small></div>
            <div class="bt-tc-mid">${I`<svg viewBox="0 0 24 24"><use href="#bt-home"/></svg>`}</div>
          </button>
        </div>

        <!-- METRICS: voltage · current · temperature -->
        <div class="bt-met">
          <button @click=${le("extended_battery_voltage")}>${I`<svg viewBox="0 0 24 24"><use href="#bt-bolt"/></svg>`} ${e.batteryVoltage.toFixed(1).replace(".",",")} V</button>
          <button @click=${le("extended_battery_current")}>${I`<svg viewBox="0 0 24 24"><use href="#bt-amp"/></svg>`} ${Math.abs(e.batteryCurrent).toFixed(1).replace(".",",")} A</button>
          <button class="${i}" @click=${le("extended_battery_temperature")}>${I`<svg viewBox="0 0 24 24"><use href="#bt-temp"/></svg>`} ${e.batteryTemp.toFixed(1).replace(".",",")} °C</button>
        </div>
      </div>
    `}getInverterModeDesc(){const e=this.data.inverterMode;return e.includes("Home 1")?"Max baterie + FVE":e.includes("Home 2")?"Šetří baterii":e.includes("Home 3")?"Priorita nabíjení":e.includes("UPS")?"Vše ze sítě":""}inverterIconDefs(){return I`
      <svg width="0" height="0" style="position:absolute;pointer-events:none"><defs>
      ...
      </defs></svg>`}renderInverter(){const e=this.data,t=io(e.inverterMode),i=e.bypassStatus.toLowerCase()==="on"||e.bypassStatus==="1",r=ud(this.pendingServices,this.changingServices),n=pd(this.gridDeliveryState),a=e.inverterMode,o=a.includes("UPS")?"#ffa726":a.includes("Home 2")?"#42a5f5":a.includes("Home 3")?"#ba68c8":"#5cc46a",s=e.inverterTemp>=45?"#e53935":e.inverterTemp>=35?"#ffa726":"#43a047",d=Math.max(0,Math.min(100,e.inverterTemp/55*100)),p=i?"#e53935":s,u=e.plannerAutoMode,h=u===!0?"řídí · AUTO":u===!1?"VYPNUTO":"N/A",b=u===!0?"iv-plan-auto":"iv-plan-off",y=e.plannerRecommendedMode?io(e.plannerRecommendedMode):null,m=!!y&&!!y.text&&y.text!==t.text,f=e.inverterGridMode,k=f==="limited"?this.fmtKwGrid(e.inverterGridLimit):f==="on"?"Zap":f==="off"?"Vyp":"—",v=f==="on"?"iv-ok":f==="limited"?"iv-warn":"iv-off",_=this.getInverterModeDesc(),T=this.shieldStatus==="running"?`Zpracovávám${this.shieldQueueCount>0?` (${this.shieldQueueCount})`:""}`:"Nečinný",R=($,M,z,q)=>$===1?M:$>=2&&$<=4?z:q,O=R(e.notificationsError,"chyba","chyby","chyb"),N=R(e.notificationsUnread,"nepřečtená","nepřečtené","nepřečtených");return c`
      <div class="${this.nodeClass("inverter",r.inverterModeChanging?"mode-changing":"")}" style="--node-gradient: ${Bi.inverter}; --node-border: ${jr.inverter};"
        ...
        ${this.gaugePill("inverter",i?"⚠ BYPASS":`${e.inverterTemp.toFixed(0)} °C`,p,c`
          ...
          <div class="gp-r"><span>Dodávka</span><b>${n.currentModeText}${f==="limited"?` · ${this.fmtKwGrid(e.inverterGridLimit)}`:""}</b></div>
          <div class="gp-r"><span>Plánovač</span><b>${h}${m?` · doporučuje ${y.text}`:""}</b></div>
          <div class="gp-r"><span>Shield</span><b>${T}</b></div>
        `)}

        <!-- HEADER: ⚙️ STŘÍDAČ · bypass badge (when active) -->
        <div class="iv-head">
          ${I`<svg class="iv-head-ico" viewBox="0 0 24 24" fill="none" stroke="#cfe0ff" stroke-width="2"><use href="#iv-cog"/></svg>`}
          <span class="iv-cap">STŘÍDAČ</span>
          ${i?c`<span class="iv-bpbadge">${I`<svg viewBox="0 0 24 24"><use href="#iv-warn"/></svg>`} BYPASS</span>`:w}
        </div>

        <!-- HERO: working mode + description -->
        <div class="iv-mode">
          <button class="iv-mn" style="color:${o}" @click=${le("box_prms_mode")}>
            ${r.inverterModeChanging?c`<span class="spinner spinner--small"></span>`:I`<svg class="iv-ic" viewBox="0 0 24 24"><use href="#iv-bolt"/></svg>`}
            ${t.text}
          </button>
        ...
        <!-- PLANNER chip -->
        <div class="iv-plan ${b}">
          ${I`<svg viewBox="0 0 24 24"><use href="#iv-bot"/></svg>`} Plánovač ${h}${m?c`<span class="iv-rec"> · doporučuje ${y.text}</span>`:w}
        </div>

        <!-- STATUS strip: Bypass · Dodávka -->
        <div class="iv-strip">
          <button class="iv-sp" @click=${le("bypass_status")}>
            <div class="iv-spl">${I`<svg viewBox="0 0 24 24"><use href="#iv-swap"/></svg>`} Bypass</div>
            <div class="iv-spv ${i?"iv-bad":"iv-ok"}">${i?"ZAP":"Vyp"}</div>
          </button>
          <button class="iv-sp" @click=${le(f==="limited"?"invertor_prm1_p_max_feed_grid":"invertor_prms_to_grid")}>
            <div class="iv-spl">${I`<svg viewBox="0 0 24 24"><use href="#iv-exp"/></svg>`} Dodávka</div>
            <div class="iv-spv ${v}">${k}</div>
          </button>
        </div>

        <!-- NOTIFICATIONS -->
        <button class="iv-notif ${e.notificationsError>0?"warn":""}" @click=${le("notification_count_unread")}>
          ${e.notificationsError>0?c`${I`<svg viewBox="0 0 24 24"><use href="#iv-warn"/></svg>`} ${e.notificationsError} ${O} · ${e.notificationsUnread} ${N}`:e.notificationsUnread>0?c`${I`<svg viewBox="0 0 24 24"><use href="#iv-bell"/></svg>`} ${e.notificationsUnread} ${N}`:c`${I`<svg viewBox="0 0 24 24"><use href="#iv-bell"/></svg>`} Bez notifikací`}
        </button>
    ...
    `}gridIconDefs(){return I`
      ...
      </svg>`}iImp(){return I`<svg class="gd-ic" viewBox="0 0 24 24"><use href="#gi-imp"/></svg>`}iExp(){return I`<svg class="gd-ic" viewBox="0 0 24 24"><use href="#gi-exp"/></svg>`}fmtKwGrid(e){const t=Math.abs(e);return t>=1e3?`${(t/1e3).toFixed(1).replace(".",",")} kW`:`${Math.round(t)} W`}renderGrid(){var Fr,Ir;const e=this.data,t=[e.gridL1P,e.gridL2P,e.gridL3P],i=t.some(C=>C>10),r=t.some(C=>C<-10),n=i&&r,a=i&&!r,o=r&&!i,s=t.reduce((C,se)=>C+se,0),d=Math.abs(s),p=t.filter(C=>C>0).reduce((C,se)=>C+se,0),u=t.filter(C=>C<0).reduce((C,se)=>C+Math.abs(se),0),h=d/1e3,b=e.gridImportCostToday!==null||e.gridExportEarningsToday!==null,y=e.gridImportCostToday??0,m=e.gridExportEarningsToday??0,f=m-y,k=(e.gridExportEarningsMonth??0)-(e.gridImportCostMonth??0),v=f>=0?"#9fe6a8":"#ff8a80",_=C=>C.toFixed(2).replace(".",","),T=C=>(C>=0?"+":"−")+_(Math.abs(C)),R=25*230*3,O=e.inverterGridLimit>0?e.inverterGridLimit:5e3,N=o?d/O*100:d/R*100,$=C=>C>=1e3?`${(C/1e3).toFixed(1).replace(".",",")}k`:C>=10?`${Math.round(C)}`:C.toFixed(1).replace(".",","),M=C=>{const se=C<0;return{txt:(se?"−":"")+$(Math.abs(C)),cls:se?"gd-col-imp":"gd-col-exp",earn:!se}},z=C=>{const se=C<0;return{txt:(se?"+":"")+$(Math.abs(C)),cls:se?"gd-col-exp":"gd-col-imp",earn:se}},q=M(m),G=M(e.gridExportEarningsMonth??0),V=z(y),K=z(e.gridImportCostMonth??0),Me=e.exportPrice>=0?"gd-col-exp":"gd-col-imp",Ne=e.spotPrice<=0?"gd-col-exp":"gd-col-imp",X=207,pe=253,S=212,Z=248,ie=[{v:e.gridL1V,label:"L1",entity:"ac_in_aci_vr"},{v:e.gridL2V,label:"L2",entity:"ac_in_aci_vs"},{v:e.gridL3V,label:"L3",entity:"ac_in_aci_vt"}],Se=ie.filter(C=>C.v>0),Ce=Se.length>0,Oe=Ce?Se.reduce((C,se)=>C+se.v,0)/Se.length:230,Dn=Ce?Math.min(...Se.map(C=>C.v)):230,En=Ce?Math.max(...Se.map(C=>C.v)):230,Sr=Math.max((En-Dn)/2+1.5,2.5),wt=Oe-Sr,Ut=Oe+Sr,Cr=Ut-wt,On=C=>C<X||C>pe?"crit":C<S||C>Z?"warn":"ok",Tr=C=>Math.max(0,Math.min(100,(C-wt)/Cr*100));let _t=ie.map((C,se)=>({...C,sev:C.v>0?On(C.v):"na",pct:C.v>0?Tr(C.v):50,lcls:`l${se+1}`,below:!1}));const Pr=_t.filter(C=>C.v>0).slice().sort((C,se)=>C.pct-se.pct),Mr=Pr.length===3?Pr[1].pct:null;_t=_t.map(C=>({...C,below:C.v>0&&Mr!==null&&C.pct===Mr}));const Yt=C=>C<X||C>pe?"rgba(229,57,53,.6)":C<S||C>Z?"rgba(255,167,38,.55)":"rgba(76,175,80,.4)",Ln=[X,S,Z,pe].filter(C=>C>wt&&C<Ut),Ei=[`${Yt(wt+.001)} 0%`];for(const C of Ln){const se=Tr(C).toFixed(1);Ei.push(`${Yt(C-.001)} ${se}%`,`${Yt(C+.001)} ${se}%`)}Ei.push(`${Yt(Ut-.001)} 100%`);const An=`linear-gradient(90deg, ${Ei.join(", ")})`,$t=e.gridFrequency>0?Math.abs(e.gridFrequency-50):0,Fn=e.gridFrequency>0&&$t>.5,zr=e.gridFrequency>0&&$t>.2,In=Fn?"gd-hz crit":zr?"gd-hz warn":"gd-hz",Dr=e.currentTariff==="VT"||((Fr=e.currentTariff)==null?void 0:Fr.includes("vysoký")),Er=e.currentTariff==="NT"||((Ir=e.currentTariff)==null?void 0:Ir.includes("nízký")),Or=Dr?"gd-tar vt":Er?"gd-tar nt":"gd-tar",Bn=Dr?"VT":Er?"NT":e.currentTariff||"--",Nn=Math.max(0,...t.filter(C=>C>0)),Lr=Math.max(0,...t.filter(C=>C<0).map(Math.abs)),Ar=Math.max(50,Nn+Lr),Zt=Lr/Ar*100,jn=c`
      <div class="ss-pop-h"><span>Bilance dnes</span>
        <b style="color:${v}">${T(f)} Kč</b></div>
      ...
      ${e.gridImportCostMonth!==null||e.gridExportEarningsMonth!==null?c`
        <div class="gp-r" style="margin-top:4px;border-top:1px solid rgba(255,255,255,.12);padding-top:4px">
          <span>Bilance měsíc</span><b style="color:${k>=0?"#9fe6a8":"#ff8a80"}">${T(k)} Kč</b></div>
      `:w}
      <div class="gp-r" style="margin-top:4px;border-top:1px solid rgba(255,255,255,.12);padding-top:4px">
      ...
      ${Ce?c`<div class="gp-r"><span>Napětí fází</span><b>${ie.map(C=>C.v>0?C.v.toFixed(0):"–").join(" · ")} V</b></div>`:w}
    ...
    `;return c`
      <div class="${this.nodeClass("grid")}" style="--node-gradient: ${Bi.grid}; --node-border: ${jr.grid};"
        ...
        ${this.edgeGauge({id:"gauge-grid",nodeId:"grid",pct:b?100:N,stops:[[0,v],[1,v]],width:b?3:2+Math.min(3,h),pulse:i||r,pulseDur:Math.max(.9,2.2-h*.35)})}

        <div class="node-tint" style="background: radial-gradient(120% 80% at 50% 50%, ${v}22, transparent 72%)"></div>

        ${this.gaugePill("grid",b?`${T(f)} Kč`:`${Math.round(N)} %`,v,jn)}

        <!-- ── HEADER: frequency (left) · SÍŤ · tariff (right) ── -->
        <div class="gd-head" style="margin-top:16px">
          ${e.gridFrequency>0?c`
            <button class="${In}" @click=${le("ac_in_aci_f")}>
              ${zr?"⚠":"⚡"} ${e.gridFrequency.toFixed(2)} Hz
            </button>`:w}
          ${I`<svg class="gd-head-ico" viewBox="0 0 24 24" fill="none" stroke="#cfe0ff" stroke-width="2" stroke-linejoin="round">
            <path d="M12 2v20M5 6l7-4 7 4M5 6v5l7 4 7-4V6M5 16l7 4 7-4"/>
          </svg>`}
          <span class="gd-cap">SÍŤ</span>
          <button class="${Or}" @click=${le("current_tariff")}>
            ${I`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><path d="M12 7v5l3 2"/><circle cx="12" cy="12" r="9"/></svg>`}
            ${Bn}
          </button>
        </div>
        ...
        <div class="gd-ph">
          ${["L1","L2","L3"].map((C,se)=>{const Oi=t[se],Li=Math.abs(Oi),kt=Math.min(100,Li/Ar*100),Ai=Oi>10,Fi=Oi<-10;return c`
              <div class="gd-phr">
                <div class="gd-ptr">
                  <div class="gd-zero" style="left:${Zt.toFixed(1)}%"></div>
                  ${Fi?c`
                    <div class="gd-seg l${se+1}" style="left:${(Zt-kt).toFixed(1)}%;width:${kt.toFixed(1)}%">
                      ${kt>=22?c`${this.fmtKwGrid(Li)}`:w}
                    </div>`:w}
                  ${Ai?c`
                    <div class="gd-seg l${se+1}" style="left:${Zt.toFixed(1)}%;width:${kt.toFixed(1)}%">
                      ${kt>=22?c`${this.fmtKwGrid(Li)}`:w}
                    </div>`:w}
                </div>
              </div>`})}
            ...
            <div class="gd-vband" style="background:${An}">
              ...
              ${_t.filter(C=>C.v>0).map(C=>c`
                <button class="gd-vlab ${C.below?"below":"above"} ${C.sev==="ok"?C.lcls:""}"
                  ...
                  @click=${le(C.entity)}>${C.v.toFixed(0)}<small> V</small></button>`)}
    ...
    `}renderHouse(){const e=this.data,t=e.houseTodayWh/1e3,i=e.nonbackupTodayWh/1e3,r=t+i,n=e.housePower+e.nonbackupPower,a=t+e.zalohaPlannedRemainingKwh,o=e.selfSufficiencyTodayPct,s=e.houseTodayWh+e.nonbackupTodayWh,d=s>0?e.srcBatteryTodayKwh*1e3/s*100:0,p=s>0?e.srcFveTodayKwh*1e3/s*100:0,u=s>0?e.srcGridTodayKwh*1e3/s*100:0,h=o>=66?"#43a047":o>=33?"#fdd835":"#e53935",b=`hsl(${Math.round(Math.max(0,Math.min(120,o*1.2)))}, 72%, 46%)`,y=r>0,m=y?r:1,f=y?Math.round(e.srcFveTodayKwh/m*100):0,k=y?Math.round(e.srcBatteryTodayKwh/m*100):0,v=y?Math.max(0,100-f-k):0,_=`Denní soběstačnost ${Math.round(o)} % · FVE ${f} % · Baterie ${k} % · Síť ${v} %`,T=Od([e.houseL1,e.houseL2,e.houseL3]),R=[{z:e.houseL1,n:e.nonbackupL1,ze:"ac_out_aco_pr"},{z:e.houseL2,n:e.nonbackupL2,ze:"ac_out_aco_ps"},{z:e.houseL3,n:e.nonbackupL3,ze:"ac_out_aco_pt"}],O=Math.max(300,...R.map(X=>X.z+X.n)),N=rn/O*100,$=N<=100,M=T.spreadW>=1e3?`${(T.spreadW/1e3).toFixed(1).replace(".",",")} kW`:`${Math.round(T.spreadW)} W`,z=R.map(X=>Math.max(0,X.z)/O*100),q=e.houseL1+e.houseL2+e.houseL3,G=Ld(z,q),V=X=>X>=1e3?`${(X/1e3).toFixed(1).replace(".",",")} kW`:`${Math.round(X)} W`,K=26,Me=`Záloha ${Tt(e.housePower)} · dnes ${t.toFixed(1)} kWh${e.zalohaPlannedRemainingKwh>0?` · plán ${a.toFixed(1)} kWh`:""}`,Ne=`Nezáloha ${Tt(e.nonbackupPower)} · dnes ${i.toFixed(1)} kWh`;return c`
      <div class="${this.nodeClass("house")}" style="--node-gradient: ${Bi.house}; --node-border: ${jr.house};"
        ...
        <div class="house-head">
          ${I`<svg class="house-ico" viewBox="0 0 24 24" fill="none" stroke="#cfe0ff" stroke-width="2" stroke-linejoin="round" stroke-linecap="round"><path d="M3 11l9-7 9 7"></path><path d="M5 10v10h14V10"></path></svg>`}
          <span class="house-cap">SPOTŘEBA</span>
        </div>
        <div class="node-value" @click=${le("actual_aco_p")}>${Tt(n)}</div>
        ...
        <div class="csplit">
          <button class="cs" @click=${le("actual_aco_p")} title=${Me}>
          ...
          <button class="cs" @click=${le("actual_acinb_wtotal")} title=${Ne}>
        ...
        <div class="pg">
          ...
          ${G.widthPct>0?c`
            <div class="pg-spread ${T.balanced?"balanced":"unbal"}"
              title=${T.balanced?"Fáze vyvážené":`Fáze nevyvážené — rozdíl ${M}`}
          ...
          ${R.map((X,pe)=>{const S=X.z>=rn,Z=X.z+X.n,ie=Math.max(0,X.z)/O*100,Se=Math.max(0,X.n)/O*100,Ce=ie>=K&&X.z>100,Oe=Se>=K&&X.n>100;return c`
              <div class="pg-row l${pe+1}">
                <div class="pg-track">
                  <div class="pg-z ${S?"crit":""}" style="width:${ie.toFixed(1)}%">
                    ${Ce?V(X.z):w}
                  </div>
                  ${X.n>0?c`
                  ...
                  ${$?c`<div class="pg-lim" style="left:${N.toFixed(1)}%"></div>`:w}
                </div>
  ...
  `;we([g({type:Array})],dt.prototype,"values",2);we([g({type:String})],dt.prototype,"color",2);we([g({type:String})],dt.prototype,"startTime",2);we([g({type:String})],dt.prototype,"endTime",2);we([_n("canvas")],dt.prototype,"canvas",2);dt=we([A("oig-mini-sparkline")],dt);let Fe=class extends L{constructor(){super(...arguments),this.title="",this.time="",this.valueText="",this.value=0,this.unit="Kč/kWh",this.variant="default",this.clickable=!1,this.startTime="",this.endTime="",this.sparklineValues=[],this.sparklineColor="rgba(76, 175, 80, 1)",this.handleClick=()=>{this.clickable&&this.dispatchEvent(new CustomEvent("card-click",{detail:{startTime:this.startTime,endTime:this.endTime,value:this.value},bubbles:!0,composed:!0}))}}connectedCallback(){super.connectedCallback(),this.clickable&&this.addEventListener("click",this.handleClick)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}render(){const e=this.valueText||`${this.value.toFixed(2)} <span class="stat-unit">${this.unit}</span>`;return c`
  ...
  `;we([g({type:Object})],ir.prototype,"data",2);we([g({type:Boolean})],ir.prototype,"topOnly",2);ir=we([A("oig-pricing-stats")],ir);const vs=6048e5,Vd=864e5,vr=6e4,xr=36e5,Kd=1e3,xo=Symbol.for("constructDateFrom");function me(e,t){return typeof e=="function"?e(t):e&&typeof e=="object"&&xo in e?e[xo](t):e instanceof Date?new e.constructor(t):new Date(t)}function Y(e,t){return me(t||e,e)}function Cn(e,t,i){const r=Y(e,i==null?void 0:i.in);return isNaN(t)?me((i==null?void 0:i.in)||e,NaN):(t&&r.setDate(r.getDate()+t),r)}function Pa(e,t,i){const r=Y(e,i==null?void 0:i.in);if(isNaN(t))return me(e,NaN);if(!t)return r;const n=r.getDate(),a=me(e,r.getTime());a.setMonth(r.getMonth()+t+1,0);const o=a.getDate();return n>=o?a:(r.setFullYear(a.getFullYear(),a.getMonth(),n),r)}function Ma(e,t,i){return me(e,+Y(e)+t)}function qd(e,t,i){return Ma(e,t*xr)}let Gd={};function Kt(){return Gd}function Ye(e,t){var s,d,p,u;const i=Kt(),r=(t==null?void 0:t.weekStartsOn)??((d=(s=t==null?void 0:t.locale)==null?void 0:s.options)==null?void 0:d.weekStartsOn)??i.weekStartsOn??((u=(p=i.locale)==null?void 0:p.options)==null?void 0:u.weekStartsOn)??0,n=Y(e,t==null?void 0:t.in),a=n.getDay(),o=(a<r?7:0)+a-r;return n.setDate(n.getDate()-o),n.setHours(0,0,0,0),n}function gi(e,t){return Ye(e,{...t,weekStartsOn:1})}function xs(e,t){const i=Y(e,t==null?void 0:t.in),r=i.getFullYear(),n=me(i,0);n.setFullYear(r+1,0,4),n.setHours(0,0,0,0);const a=gi(n),o=me(i,0);o.setFullYear(r,0,4),o.setHours(0,0,0,0);const s=gi(o);return i.getTime()>=a.getTime()?r+1:i.getTime()>=s.getTime()?r:r-1}function nn(e){const t=Y(e),i=new Date(Date.UTC(t.getFullYear(),t.getMonth(),t.getDate(),t.getHours(),t.getMinutes(),t.getSeconds(),t.getMilliseconds()));return i.setUTCFullYear(t.getFullYear()),+e-+i}function qt(e,...t){const i=me.bind(null,t.find(r=>typeof r=="object"));return t.map(i)}function ma(e,t){const i=Y(e,t==null?void 0:t.in);return i.setHours(0,0,0,0),i}function ws(e,t,i){const[r,n]=qt(i==null?void 0:i.in,e,t),a=ma(r),o=ma(n),s=+a-nn(a),d=+o-nn(o);return Math.round((s-d)/Vd)}function Ud(e,t){const i=xs(e,t),r=me(e,0);return r.setFullYear(i,0,4),r.setHours(0,0,0,0),gi(r)}function Yd(e,t,i){const r=Y(e,i==null?void 0:i.in);return r.setTime(r.getTime()+t*vr),r}function Zd(e,t,i){return Pa(e,t*3,i)}function Qd(e,t,i){return Ma(e,t*1e3)}function Xd(e,t,i){return Cn(e,t*7,i)}function Jd(e,t,i){return Pa(e,t*12,i)}function Qi(e,t){const i=+Y(e)-+Y(t);return i<0?-1:i>0?1:i}function ep(e){return e instanceof Date||typeof e=="object"&&Object.prototype.toString.call(e)==="[object Date]"}function _s(e){return!(!ep(e)&&typeof e!="number"||isNaN(+Y(e)))}function tp(e,t,i){const[r,n]=qt(i==null?void 0:i.in,e,t),a=r.getFullYear()-n.getFullYear(),o=r.getMonth()-n.getMonth();return a*12+o}function ip(e,t,i){const[r,n]=qt(i==null?void 0:i.in,e,t);return r.getFullYear()-n.getFullYear()}function $s(e,t,i){const[r,n]=qt(i==null?void 0:i.in,e,t),a=wo(r,n),o=Math.abs(ws(r,n));r.setDate(r.getDate()-a*o);const s=+(wo(r,n)===-a),d=a*(o-s);return d===0?0:d}function wo(e,t){const i=e.getFullYear()-t.getFullYear()||e.getMonth()-t.getMonth()||e.getDate()-t.getDate()||e.getHours()-t.getHours()||e.getMinutes()-t.getMinutes()||e.getSeconds()-t.getSeconds()||e.getMilliseconds()-t.getMilliseconds();return i<0?-1:i>0?1:i}function wr(e){return t=>{const r=(e?Math[e]:Math.trunc)(t);return r===0?0:r}}function rp(e,t,i){const[r,n]=qt(i==null?void 0:i.in,e,t),a=(+r-+n)/xr;return wr(i==null?void 0:i.roundingMethod)(a)}function za(e,t){return+Y(e)-+Y(t)}function np(e,t,i){const r=za(e,t)/vr;return wr(i==null?void 0:i.roundingMethod)(r)}function ks(e,t){const i=Y(e,t==null?void 0:t.in);return i.setHours(23,59,59,999),i}function Ss(e,t){const i=Y(e,t==null?void 0:t.in),r=i.getMonth();return i.setFullYear(i.getFullYear(),r+1,0),i.setHours(23,59,59,999),i}function ap(e,t){const i=Y(e,t==null?void 0:t.in);return+ks(i,t)==+Ss(i,t)}function Cs(e,t,i){const[r,n,a]=qt(i==null?void 0:i.in,e,e,t),o=Qi(n,a),s=Math.abs(tp(n,a));if(s<1)return 0;n.getMonth()===1&&n.getDate()>27&&n.setDate(30),n.setMonth(n.getMonth()-o*s);let d=Qi(n,a)===-o;ap(r)&&s===1&&Qi(r,a)===1&&(d=!1);const p=o*(s-+d);return p===0?0:p}function op(e,t,i){const r=Cs(e,t,i)/3;return wr(i==null?void 0:i.roundingMethod)(r)}function sp(e,t,i){const r=za(e,t)/1e3;return wr(i==null?void 0:i.roundingMethod)(r)}function lp(e,t,i){const r=$s(e,t,i)/7;return wr(i==null?void 0:i.roundingMethod)(r)}function cp(e,t,i){const[r,n]=qt(i==null?void 0:i.in,e,t),a=Qi(r,n),o=Math.abs(ip(r,n));r.setFullYear(1584),n.setFullYear(1584);const s=Qi(r,n)===-a,d=a*(o-+s);return d===0?0:d}function dp(e,t){const i=Y(e,t==null?void 0:t.in),r=i.getMonth(),n=r-r%3;return i.setMonth(n,1),i.setHours(0,0,0,0),i}function pp(e,t){const i=Y(e,t==null?void 0:t.in);return i.setDate(1),i.setHours(0,0,0,0),i}function up(e,t){const i=Y(e,t==null?void 0:t.in),r=i.getFullYear();return i.setFullYear(r+1,0,0),i.setHours(23,59,59,999),i}function Ts(e,t){const i=Y(e,t==null?void 0:t.in);return i.setFullYear(i.getFullYear(),0,1),i.setHours(0,0,0,0),i}function hp(e,t){const i=Y(e,t==null?void 0:t.in);return i.setMinutes(59,59,999),i}function gp(e,t){var s,d;const i=Kt(),r=i.weekStartsOn??((d=(s=i.locale)==null?void 0:s.options)==null?void 0:d.weekStartsOn)??0,n=Y(e,t==null?void 0:t.in),a=n.getDay(),o=(a<r?-7:0)+6-(a-r);return n.setDate(n.getDate()+o),n.setHours(23,59,59,999),n}function bp(e,t){const i=Y(e,t==null?void 0:t.in);return i.setSeconds(59,999),i}function fp(e,t){const i=Y(e,t==null?void 0:t.in),r=i.getMonth(),n=r-r%3+3;return i.setMonth(n,0),i.setHours(23,59,59,999),i}function mp(e,t){const i=Y(e,t==null?void 0:t.in);return i.setMilliseconds(999),i}const yp={lessThanXSeconds:{one:"less than a second",other:"less than {{count}} seconds"},xSeconds:{one:"1 second",other:"{{count}} seconds"},halfAMinute:"half a minute",lessThanXMinutes:{one:"less than a minute",other:"less than {{count}} minutes"},xMinutes:{one:"1 minute",other:"{{count}} minutes"},aboutXHours:{one:"about 1 hour",other:"about {{count}} hours"},xHours:{one:"1 hour",other:"{{count}} hours"},xDays:{one:"1 day",other:"{{count}} days"},aboutXWeeks:{one:"about 1 week",other:"about {{count}} weeks"},xWeeks:{one:"1 week",other:"{{count}} weeks"},aboutXMonths:{one:"about 1 month",other:"about {{count}} months"},xMonths:{one:"1 month",other:"{{count}} months"},aboutXYears:{one:"about 1 year",other:"about {{count}} years"},xYears:{one:"1 year",other:"{{count}} years"},overXYears:{one:"over 1 year",other:"over {{count}} years"},almostXYears:{one:"almost 1 year",other:"almost {{count}} years"}},vp=(e,t,i)=>{let r;const n=yp[e];return typeof n=="string"?r=n:t===1?r=n.one:r=n.other.replace("{{count}}",t.toString()),i!=null&&i.addSuffix?i.comparison&&i.comparison>0?"in "+r:r+" ago":r};function Jn(e){return(t={})=>{const i=t.width?String(t.width):e.defaultWidth;return e.formats[i]||e.formats[e.defaultWidth]}}const xp={full:"EEEE, MMMM do, y",long:"MMMM do, y",medium:"MMM d, y",short:"MM/dd/yyyy"},wp={full:"h:mm:ss a zzzz",long:"h:mm:ss a z",medium:"h:mm:ss a",short:"h:mm a"},_p={full:"{{date}} 'at' {{time}}",long:"{{date}} 'at' {{time}}",medium:"{{date}}, {{time}}",short:"{{date}}, {{time}}"},$p={date:Jn({formats:xp,defaultWidth:"full"}),time:Jn({formats:wp,defaultWidth:"full"}),dateTime:Jn({formats:_p,defaultWidth:"full"})},kp={lastWeek:"'last' eeee 'at' p",yesterday:"'yesterday at' p",today:"'today at' p",tomorrow:"'tomorrow at' p",nextWeek:"eeee 'at' p",other:"P"},Sp=(e,t,i,r)=>kp[e];function Wi(e){return(t,i)=>{const r=i!=null&&i.context?String(i.context):"standalone";let n;if(r==="formatting"&&e.formattingValues){const o=e.defaultFormattingWidth||e.defaultWidth,s=i!=null&&i.width?String(i.width):o;n=e.formattingValues[s]||e.formattingValues[o]}else{const o=e.defaultWidth,s=i!=null&&i.width?String(i.width):e.defaultWidth;n=e.values[s]||e.values[o]}const a=e.argumentCallback?e.argumentCallback(t):t;return n[a]}}const Cp={narrow:["B","A"],abbreviated:["BC","AD"],wide:["Before Christ","Anno Domini"]},Tp={narrow:["1","2","3","4"],abbreviated:["Q1","Q2","Q3","Q4"],wide:["1st quarter","2nd quarter","3rd quarter","4th quarter"]},Pp={narrow:["J","F","M","A","M","J","J","A","S","O","N","D"],abbreviated:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],wide:["January","February","March","April","May","June","July","August","September","October","November","December"]},Mp={narrow:["S","M","T","W","T","F","S"],short:["Su","Mo","Tu","We","Th","Fr","Sa"],abbreviated:["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],wide:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"]},zp={narrow:{am:"a",pm:"p",midnight:"mi",noon:"n",morning:"morning",afternoon:"afternoon",evening:"evening",night:"night"},abbreviated:{am:"AM",pm:"PM",midnight:"midnight",noon:"noon",morning:"morning",afternoon:"afternoon",evening:"evening",night:"night"},wide:{am:"a.m.",pm:"p.m.",midnight:"midnight",noon:"noon",morning:"morning",afternoon:"afternoon",evening:"evening",night:"night"}},Dp={narrow:{am:"a",pm:"p",midnight:"mi",noon:"n",morning:"in the morning",afternoon:"in the afternoon",evening:"in the evening",night:"at night"},abbreviated:{am:"AM",pm:"PM",midnight:"midnight",noon:"noon",morning:"in the morning",afternoon:"in the afternoon",evening:"in the evening",night:"at night"},wide:{am:"a.m.",pm:"p.m.",midnight:"midnight",noon:"noon",morning:"in the morning",afternoon:"in the afternoon",evening:"in the evening",night:"at night"}},Ep=(e,t)=>{const i=Number(e),r=i%100;if(r>20||r<10)switch(r%10){case 1:return i+"st";case 2:return i+"nd";case 3:return i+"rd"}return i+"th"},Op={ordinalNumber:Ep,era:Wi({values:Cp,defaultWidth:"wide"}),quarter:Wi({values:Tp,defaultWidth:"wide",argumentCallback:e=>e-1}),month:Wi({values:Pp,defaultWidth:"wide"}),day:Wi({values:Mp,defaultWidth:"wide"}),dayPeriod:Wi({values:zp,defaultWidth:"wide",formattingValues:Dp,defaultFormattingWidth:"wide"})};function Vi(e){return(t,i={})=>{const r=i.width,n=r&&e.matchPatterns[r]||e.matchPatterns[e.defaultMatchWidth],a=t.match(n);if(!a)return null;const o=a[0],s=r&&e.parsePatterns[r]||e.parsePatterns[e.defaultParseWidth],d=Array.isArray(s)?Ap(s,h=>h.test(o)):Lp(s,h=>h.test(o));let p;p=e.valueCallback?e.valueCallback(d):d,p=i.valueCallback?i.valueCallback(p):p;const u=t.slice(o.length);return{value:p,rest:u}}}function Lp(e,t){for(const i in e)if(Object.prototype.hasOwnProperty.call(e,i)&&t(e[i]))return i}function Ap(e,t){for(let i=0;i<e.length;i++)if(t(e[i]))return i}function Fp(e){return(t,i={})=>{const r=t.match(e.matchPattern);if(!r)return null;const n=r[0],a=t.match(e.parsePattern);if(!a)return null;let o=e.valueCallback?e.valueCallback(a[0]):a[0];o=i.valueCallback?i.valueCallback(o):o;const s=t.slice(n.length);return{value:o,rest:s}}}const Ip=/^(\d+)(th|st|nd|rd)?/i,Bp=/\d+/i,Np={narrow:/^(b|a)/i,abbreviated:/^(b\.?\s?c\.?|b\.?\s?c\.?\s?e\.?|a\.?\s?d\.?|c\.?\s?e\.?)/i,wide:/^(before christ|before common era|anno domini|common era)/i},jp={any:[/^b/i,/^(a|c)/i]},Rp={narrow:/^[1234]/i,abbreviated:/^q[1234]/i,wide:/^[1234](th|st|nd|rd)? quarter/i},Hp={any:[/1/i,/2/i,/3/i,/4/i]},Wp={narrow:/^[jfmasond]/i,abbreviated:/^(jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec)/i,wide:/^(january|february|march|april|may|june|july|august|september|october|november|december)/i},Vp={narrow:[/^j/i,/^f/i,/^m/i,/^a/i,/^m/i,/^j/i,/^j/i,/^a/i,/^s/i,/^o/i,/^n/i,/^d/i],any:[/^ja/i,/^f/i,/^mar/i,/^ap/i,/^may/i,/^jun/i,/^jul/i,/^au/i,/^s/i,/^o/i,/^n/i,/^d/i]},Kp={narrow:/^[smtwf]/i,short:/^(su|mo|tu|we|th|fr|sa)/i,abbreviated:/^(sun|mon|tue|wed|thu|fri|sat)/i,wide:/^(sunday|monday|tuesday|wednesday|thursday|friday|saturday)/i},qp={narrow:[/^s/i,/^m/i,/^t/i,/^w/i,/^t/i,/^f/i,/^s/i],any:[/^su/i,/^m/i,/^tu/i,/^w/i,/^th/i,/^f/i,/^sa/i]},Gp={narrow:/^(a|p|mi|n|(in the|at) (morning|afternoon|evening|night))/i,any:/^([ap]\.?\s?m\.?|midnight|noon|(in the|at) (morning|afternoon|evening|night))/i},Up={any:{am:/^a/i,pm:/^p/i,midnight:/^mi/i,noon:/^no/i,morning:/morning/i,afternoon:/afternoon/i,evening:/evening/i,night:/night/i}},Yp={ordinalNumber:Fp({matchPattern:Ip,parsePattern:Bp,valueCallback:e=>parseInt(e,10)}),era:Vi({matchPatterns:Np,defaultMatchWidth:"wide",parsePatterns:jp,defaultParseWidth:"any"}),quarter:Vi({matchPatterns:Rp,defaultMatchWidth:"wide",parsePatterns:Hp,defaultParseWidth:"any",valueCallback:e=>e+1}),month:Vi({matchPatterns:Wp,defaultMatchWidth:"wide",parsePatterns:Vp,defaultParseWidth:"any"}),day:Vi({matchPatterns:Kp,defaultMatchWidth:"wide",parsePatterns:qp,defaultParseWidth:"any"}),dayPeriod:Vi({matchPatterns:Gp,defaultMatchWidth:"any",parsePatterns:Up,defaultParseWidth:"any"})},Ps={code:"en-US",formatDistance:vp,formatLong:$p,formatRelative:Sp,localize:Op,match:Yp,options:{weekStartsOn:0,firstWeekContainsDate:1}};function Zp(e,t){const i=Y(e,t==null?void 0:t.in);return ws(i,Ts(i))+1}function Ms(e,t){const i=Y(e,t==null?void 0:t.in),r=+gi(i)-+Ud(i);return Math.round(r/vs)+1}function Da(e,t){var u,h,b,y;const i=Y(e,t==null?void 0:t.in),r=i.getFullYear(),n=Kt(),a=(t==null?void 0:t.firstWeekContainsDate)??((h=(u=t==null?void 0:t.locale)==null?void 0:u.options)==null?void 0:h.firstWeekContainsDate)??n.firstWeekContainsDate??((y=(b=n.locale)==null?void 0:b.options)==null?void 0:y.firstWeekContainsDate)??1,o=me((t==null?void 0:t.in)||e,0);o.setFullYear(r+1,0,a),o.setHours(0,0,0,0);const s=Ye(o,t),d=me((t==null?void 0:t.in)||e,0);d.setFullYear(r,0,a),d.setHours(0,0,0,0);const p=Ye(d,t);return+i>=+s?r+1:+i>=+p?r:r-1}function Qp(e,t){var s,d,p,u;const i=Kt(),r=(t==null?void 0:t.firstWeekContainsDate)??((d=(s=t==null?void 0:t.locale)==null?void 0:s.options)==null?void 0:d.firstWeekContainsDate)??i.firstWeekContainsDate??((u=(p=i.locale)==null?void 0:p.options)==null?void 0:u.firstWeekContainsDate)??1,n=Da(e,t),a=me((t==null?void 0:t.in)||e,0);return a.setFullYear(n,0,r),a.setHours(0,0,0,0),Ye(a,t)}function zs(e,t){const i=Y(e,t==null?void 0:t.in),r=+Ye(i,t)-+Qp(i,t);return Math.round(r/vs)+1}function re(e,t){const i=e<0?"-":"",r=Math.abs(e).toString().padStart(t,"0");return i+r}const st={y(e,t){const i=e.getFullYear(),r=i>0?i:1-i;return re(t==="yy"?r%100:r,t.length)},M(e,t){const i=e.getMonth();return t==="M"?String(i+1):re(i+1,2)},d(e,t){return re(e.getDate(),t.length)},a(e,t){const i=e.getHours()/12>=1?"pm":"am";switch(t){case"a":case"aa":return i.toUpperCase();case"aaa":return i;case"aaaaa":return i[0];case"aaaa":default:return i==="am"?"a.m.":"p.m."}},h(e,t){return re(e.getHours()%12||12,t.length)},H(e,t){return re(e.getHours(),t.length)},m(e,t){return re(e.getMinutes(),t.length)},s(e,t){return re(e.getSeconds(),t.length)},S(e,t){const i=t.length,r=e.getMilliseconds(),n=Math.trunc(r*Math.pow(10,i-3));return re(n,t.length)}},Jt={midnight:"midnight",noon:"noon",morning:"morning",afternoon:"afternoon",evening:"evening",night:"night"},_o={G:function(e,t,i){const r=e.getFullYear()>0?1:0;switch(t){case"G":case"GG":case"GGG":return i.era(r,{width:"abbreviated"});case"GGGGG":return i.era(r,{width:"narrow"});case"GGGG":default:return i.era(r,{width:"wide"})}},y:function(e,t,i){if(t==="yo"){const r=e.getFullYear(),n=r>0?r:1-r;return i.ordinalNumber(n,{unit:"year"})}return st.y(e,t)},Y:function(e,t,i,r){const n=Da(e,r),a=n>0?n:1-n;if(t==="YY"){const o=a%100;return re(o,2)}return t==="Yo"?i.ordinalNumber(a,{unit:"year"}):re(a,t.length)},R:function(e,t){const i=xs(e);return re(i,t.length)},u:function(e,t){const i=e.getFullYear();return re(i,t.length)},Q:function(e,t,i){const r=Math.ceil((e.getMonth()+1)/3);switch(t){case"Q":return String(r);case"QQ":return re(r,2);case"Qo":return i.ordinalNumber(r,{unit:"quarter"});case"QQQ":return i.quarter(r,{width:"abbreviated",context:"formatting"});case"QQQQQ":return i.quarter(r,{width:"narrow",context:"formatting"});case"QQQQ":default:return i.quarter(r,{width:"wide",context:"formatting"})}},q:function(e,t,i){const r=Math.ceil((e.getMonth()+1)/3);switch(t){case"q":return String(r);case"qq":return re(r,2);case"qo":return i.ordinalNumber(r,{unit:"quarter"});case"qqq":return i.quarter(r,{width:"abbreviated",context:"standalone"});case"qqqqq":return i.quarter(r,{width:"narrow",context:"standalone"});case"qqqq":default:return i.quarter(r,{width:"wide",context:"standalone"})}},M:function(e,t,i){const r=e.getMonth();switch(t){case"M":case"MM":return st.M(e,t);case"Mo":return i.ordinalNumber(r+1,{unit:"month"});case"MMM":return i.month(r,{width:"abbreviated",context:"formatting"});case"MMMMM":return i.month(r,{width:"narrow",context:"formatting"});case"MMMM":default:return i.month(r,{width:"wide",context:"formatting"})}},L:function(e,t,i){const r=e.getMonth();switch(t){case"L":return String(r+1);case"LL":return re(r+1,2);case"Lo":return i.ordinalNumber(r+1,{unit:"month"});case"LLL":return i.month(r,{width:"abbreviated",context:"standalone"});case"LLLLL":return i.month(r,{width:"narrow",context:"standalone"});case"LLLL":default:return i.month(r,{width:"wide",context:"standalone"})}},w:function(e,t,i,r){const n=zs(e,r);return t==="wo"?i.ordinalNumber(n,{unit:"week"}):re(n,t.length)},I:function(e,t,i){const r=Ms(e);return t==="Io"?i.ordinalNumber(r,{unit:"week"}):re(r,t.length)},d:function(e,t,i){return t==="do"?i.ordinalNumber(e.getDate(),{unit:"date"}):st.d(e,t)},D:function(e,t,i){const r=Zp(e);return t==="Do"?i.ordinalNumber(r,{unit:"dayOfYear"}):re(r,t.length)},E:function(e,t,i){const r=e.getDay();switch(t){case"E":case"EE":case"EEE":return i.day(r,{width:"abbreviated",context:"formatting"});case"EEEEE":return i.day(r,{width:"narrow",context:"formatting"});case"EEEEEE":return i.day(r,{width:"short",context:"formatting"});case"EEEE":default:return i.day(r,{width:"wide",context:"formatting"})}},e:function(e,t,i,r){const n=e.getDay(),a=(n-r.weekStartsOn+8)%7||7;switch(t){case"e":return String(a);case"ee":return re(a,2);case"eo":return i.ordinalNumber(a,{unit:"day"});case"eee":return i.day(n,{width:"abbreviated",context:"formatting"});case"eeeee":return i.day(n,{width:"narrow",context:"formatting"});case"eeeeee":return i.day(n,{width:"short",context:"formatting"});case"eeee":default:return i.day(n,{width:"wide",context:"formatting"})}},c:function(e,t,i,r){const n=e.getDay(),a=(n-r.weekStartsOn+8)%7||7;switch(t){case"c":return String(a);case"cc":return re(a,t.length);case"co":return i.ordinalNumber(a,{unit:"day"});case"ccc":return i.day(n,{width:"abbreviated",context:"standalone"});case"ccccc":return i.day(n,{width:"narrow",context:"standalone"});case"cccccc":return i.day(n,{width:"short",context:"standalone"});case"cccc":default:return i.day(n,{width:"wide",context:"standalone"})}},i:function(e,t,i){const r=e.getDay(),n=r===0?7:r;switch(t){case"i":return String(n);case"ii":return re(n,t.length);case"io":return i.ordinalNumber(n,{unit:"day"});case"iii":return i.day(r,{width:"abbreviated",context:"formatting"});case"iiiii":return i.day(r,{width:"narrow",context:"formatting"});case"iiiiii":return i.day(r,{width:"short",context:"formatting"});case"iiii":default:return i.day(r,{width:"wide",context:"formatting"})}},a:function(e,t,i){const n=e.getHours()/12>=1?"pm":"am";switch(t){case"a":case"aa":return i.dayPeriod(n,{width:"abbreviated",context:"formatting"});case"aaa":return i.dayPeriod(n,{width:"abbreviated",context:"formatting"}).toLowerCase();case"aaaaa":return i.dayPeriod(n,{width:"narrow",context:"formatting"});case"aaaa":default:return i.dayPeriod(n,{width:"wide",context:"formatting"})}},b:function(e,t,i){const r=e.getHours();let n;switch(r===12?n=Jt.noon:r===0?n=Jt.midnight:n=r/12>=1?"pm":"am",t){case"b":case"bb":return i.dayPeriod(n,{width:"abbreviated",context:"formatting"});case"bbb":return i.dayPeriod(n,{width:"abbreviated",context:"formatting"}).toLowerCase();case"bbbbb":return i.dayPeriod(n,{width:"narrow",context:"formatting"});case"bbbb":default:return i.dayPeriod(n,{width:"wide",context:"formatting"})}},B:function(e,t,i){const r=e.getHours();let n;switch(r>=17?n=Jt.evening:r>=12?n=Jt.afternoon:r>=4?n=Jt.morning:n=Jt.night,t){case"B":case"BB":case"BBB":return i.dayPeriod(n,{width:"abbreviated",context:"formatting"});case"BBBBB":return i.dayPeriod(n,{width:"narrow",context:"formatting"});case"BBBB":default:return i.dayPeriod(n,{width:"wide",context:"formatting"})}},h:function(e,t,i){if(t==="ho"){let r=e.getHours()%12;return r===0&&(r=12),i.ordinalNumber(r,{unit:"hour"})}return st.h(e,t)},H:function(e,t,i){return t==="Ho"?i.ordinalNumber(e.getHours(),{unit:"hour"}):st.H(e,t)},K:function(e,t,i){const r=e.getHours()%12;return t==="Ko"?i.ordinalNumber(r,{unit:"hour"}):re(r,t.length)},k:function(e,t,i){let r=e.getHours();return r===0&&(r=24),t==="ko"?i.ordinalNumber(r,{unit:"hour"}):re(r,t.length)},m:function(e,t,i){return t==="mo"?i.ordinalNumber(e.getMinutes(),{unit:"minute"}):st.m(e,t)},s:function(e,t,i){return t==="so"?i.ordinalNumber(e.getSeconds(),{unit:"second"}):st.s(e,t)},S:function(e,t){return st.S(e,t)},X:function(e,t,i){const r=e.getTimezoneOffset();if(r===0)return"Z";switch(t){case"X":return ko(r);case"XXXX":case"XX":return Dt(r);case"XXXXX":case"XXX":default:return Dt(r,":")}},x:function(e,t,i){const r=e.getTimezoneOffset();switch(t){case"x":return ko(r);case"xxxx":case"xx":return Dt(r);case"xxxxx":case"xxx":default:return Dt(r,":")}},O:function(e,t,i){const r=e.getTimezoneOffset();switch(t){case"O":case"OO":case"OOO":return"GMT"+$o(r,":");case"OOOO":default:return"GMT"+Dt(r,":")}},z:function(e,t,i){const r=e.getTimezoneOffset();switch(t){case"z":case"zz":case"zzz":return"GMT"+$o(r,":");case"zzzz":default:return"GMT"+Dt(r,":")}},t:function(e,t,i){const r=Math.trunc(+e/1e3);return re(r,t.length)},T:function(e,t,i){return re(+e,t.length)}};function $o(e,t=""){const i=e>0?"-":"+",r=Math.abs(e),n=Math.trunc(r/60),a=r%60;return a===0?i+String(n):i+String(n)+t+re(a,2)}function ko(e,t){return e%60===0?(e>0?"-":"+")+re(Math.abs(e)/60,2):Dt(e,t)}function Dt(e,t=""){const i=e>0?"-":"+",r=Math.abs(e),n=re(Math.trunc(r/60),2),a=re(r%60,2);return i+n+t+a}const So=(e,t)=>{switch(e){case"P":return t.date({width:"short"});case"PP":return t.date({width:"medium"});case"PPP":return t.date({width:"long"});case"PPPP":default:return t.date({width:"full"})}},Ds=(e,t)=>{switch(e){case"p":return t.time({width:"short"});case"pp":return t.time({width:"medium"});case"ppp":return t.time({width:"long"});case"pppp":default:return t.time({width:"full"})}},Xp=(e,t)=>{const i=e.match(/(P+)(p+)?/)||[],r=i[1],n=i[2];if(!n)return So(e,t);let a;switch(r){case"P":a=t.dateTime({width:"short"});break;case"PP":a=t.dateTime({width:"medium"});break;case"PPP":a=t.dateTime({width:"long"});break;case"PPPP":default:a=t.dateTime({width:"full"});break}return a.replace("{{date}}",So(r,t)).replace("{{time}}",Ds(n,t))},ya={p:Ds,P:Xp},Jp=/^D+$/,eu=/^Y+$/,tu=["D","DD","YY","YYYY"];function Es(e){return Jp.test(e)}function Os(e){return eu.test(e)}function va(e,t,i){const r=iu(e,t,i);if(console.warn(r),tu.includes(e))throw new RangeError(r)}function iu(e,t,i){const r=e[0]==="Y"?"years":"days of the month";return`Use \`${e.toLowerCase()}\` instead of \`${e}\` (in \`${t}\`) for formatting ${r} to the input \`${i}\`; see: https://github.com/date-fns/date-fns/blob/master/docs/unicodeTokens.md`}const ru=/[yYQqMLwIdDecihHKkms]o|(\w)\1*|''|'(''|[^'])+('|$)|./g,nu=/P+p+|P+|p+|''|'(''|[^'])+('|$)|./g,au=/^'([^]*?)'?$/,ou=/''/g,su=/[a-zA-Z]/;function lu(e,t,i){var u,h,b,y,m,f,k,v;const r=Kt(),n=(i==null?void 0:i.locale)??r.locale??Ps,a=(i==null?void 0:i.firstWeekContainsDate)??((h=(u=i==null?void 0:i.locale)==null?void 0:u.options)==null?void 0:h.firstWeekContainsDate)??r.firstWeekContainsDate??((y=(b=r.locale)==null?void 0:b.options)==null?void 0:y.firstWeekContainsDate)??1,o=(i==null?void 0:i.weekStartsOn)??((f=(m=i==null?void 0:i.locale)==null?void 0:m.options)==null?void 0:f.weekStartsOn)??r.weekStartsOn??((v=(k=r.locale)==null?void 0:k.options)==null?void 0:v.weekStartsOn)??0,s=Y(e,i==null?void 0:i.in);if(!_s(s))throw new RangeError("Invalid time value");let d=t.match(nu).map(_=>{const T=_[0];if(T==="p"||T==="P"){const R=ya[T];return R(_,n.formatLong)}return _}).join("").match(ru).map(_=>{if(_==="''")return{isToken:!1,value:"'"};const T=_[0];if(T==="'")return{isToken:!1,value:cu(_)};if(_o[T])return{isToken:!0,value:_};if(T.match(su))throw new RangeError("Format string contains an unescaped latin alphabet character `"+T+"`");return{isToken:!1,value:_}});n.localize.preprocessor&&(d=n.localize.preprocessor(s,d));const p={firstWeekContainsDate:a,weekStartsOn:o,locale:n};return d.map(_=>{if(!_.isToken)return _.value;const T=_.value;(!(i!=null&&i.useAdditionalWeekYearTokens)&&Os(T)||!(i!=null&&i.useAdditionalDayOfYearTokens)&&Es(T))&&va(T,t,String(e));const R=_o[T[0]];return R(s,T,n.localize,p)}).join("")}function cu(e){const t=e.match(au);return t?t[1].replace(ou,"'"):e}function du(){return Object.assign({},Kt())}function pu(e,t){const i=Y(e,t==null?void 0:t.in).getDay();return i===0?7:i}function uu(e,t){const i=hu(t)?new t(0):me(t,0);return i.setFullYear(e.getFullYear(),e.getMonth(),e.getDate()),i.setHours(e.getHours(),e.getMinutes(),e.getSeconds(),e.getMilliseconds()),i}function hu(e){var t;return typeof e=="function"&&((t=e.prototype)==null?void 0:t.constructor)===e}const gu=10;class Ls{constructor(){F(this,"subPriority",0)}validate(t,i){return!0}}class bu extends Ls{constructor(t,i,r,n,a){super(),this.value=t,this.validateValue=i,this.setValue=r,this.priority=n,a&&(this.subPriority=a)}validate(t,i){return this.validateValue(t,this.value,i)}set(t,i,r){return this.setValue(t,i,this.value,r)}}class fu extends Ls{constructor(i,r){super();F(this,"priority",gu);F(this,"subPriority",-1);this.context=i||(n=>me(r,n))}set(i,r){return r.timestampIsSet?i:me(i,uu(i,this.context))}}class te{run(t,i,r,n){const a=this.parse(t,i,r,n);return a?{setter:new bu(a.value,this.validate,this.set,this.priority,this.subPriority),rest:a.rest}:null}validate(t,i,r){return!0}}class mu extends te{constructor(){super(...arguments);F(this,"priority",140);F(this,"incompatibleTokens",["R","u","t","T"])}parse(i,r,n){switch(r){case"G":case"GG":case"GGG":return n.era(i,{width:"abbreviated"})||n.era(i,{width:"narrow"});case"GGGGG":return n.era(i,{width:"narrow"});case"GGGG":default:return n.era(i,{width:"wide"})||n.era(i,{width:"abbreviated"})||n.era(i,{width:"narrow"})}}set(i,r,n){return r.era=n,i.setFullYear(n,0,1),i.setHours(0,0,0,0),i}}const ve={month:/^(1[0-2]|0?\d)/,date:/^(3[0-1]|[0-2]?\d)/,dayOfYear:/^(36[0-6]|3[0-5]\d|[0-2]?\d?\d)/,week:/^(5[0-3]|[0-4]?\d)/,hour23h:/^(2[0-3]|[0-1]?\d)/,hour24h:/^(2[0-4]|[0-1]?\d)/,hour11h:/^(1[0-1]|0?\d)/,hour12h:/^(1[0-2]|0?\d)/,minute:/^[0-5]?\d/,second:/^[0-5]?\d/,singleDigit:/^\d/,twoDigits:/^\d{1,2}/,threeDigits:/^\d{1,3}/,fourDigits:/^\d{1,4}/,anyDigitsSigned:/^-?\d+/,singleDigitSigned:/^-?\d/,twoDigitsSigned:/^-?\d{1,2}/,threeDigitsSigned:/^-?\d{1,3}/,fourDigitsSigned:/^-?\d{1,4}/},Ge={basicOptionalMinutes:/^([+-])(\d{2})(\d{2})?|Z/,basic:/^([+-])(\d{2})(\d{2})|Z/,basicOptionalSeconds:/^([+-])(\d{2})(\d{2})((\d{2}))?|Z/,extended:/^([+-])(\d{2}):(\d{2})|Z/,extendedOptionalSeconds:/^([+-])(\d{2}):(\d{2})(:(\d{2}))?|Z/};function xe(e,t){return e&&{value:t(e.value),rest:e.rest}}function ge(e,t){const i=t.match(e);return i?{value:parseInt(i[0],10),rest:t.slice(i[0].length)}:null}function Ue(e,t){const i=t.match(e);if(!i)return null;if(i[0]==="Z")return{value:0,rest:t.slice(1)};const r=i[1]==="+"?1:-1,n=i[2]?parseInt(i[2],10):0,a=i[3]?parseInt(i[3],10):0,o=i[5]?parseInt(i[5],10):0;return{value:r*(n*xr+a*vr+o*Kd),rest:t.slice(i[0].length)}}function As(e){return ge(ve.anyDigitsSigned,e)}function ye(e,t){switch(e){case 1:return ge(ve.singleDigit,t);case 2:return ge(ve.twoDigits,t);case 3:return ge(ve.threeDigits,t);case 4:return ge(ve.fourDigits,t);default:return ge(new RegExp("^\\d{1,"+e+"}"),t)}}function an(e,t){switch(e){case 1:return ge(ve.singleDigitSigned,t);case 2:return ge(ve.twoDigitsSigned,t);case 3:return ge(ve.threeDigitsSigned,t);case 4:return ge(ve.fourDigitsSigned,t);default:return ge(new RegExp("^-?\\d{1,"+e+"}"),t)}}function Ea(e){switch(e){case"morning":return 4;case"evening":return 17;case"pm":case"noon":case"afternoon":return 12;case"am":case"midnight":case"night":default:return 0}}function Fs(e,t){const i=t>0,r=i?t:1-t;let n;if(r<=50)n=e||100;else{const a=r+50,o=Math.trunc(a/100)*100,s=e>=a%100;n=e+o-(s?100:0)}return i?n:1-n}function Is(e){return e%400===0||e%4===0&&e%100!==0}class yu extends te{constructor(){super(...arguments);F(this,"priority",130);F(this,"incompatibleTokens",["Y","R","u","w","I","i","e","c","t","T"])}parse(i,r,n){const a=o=>({year:o,isTwoDigitYear:r==="yy"});switch(r){case"y":return xe(ye(4,i),a);case"yo":return xe(n.ordinalNumber(i,{unit:"year"}),a);default:return xe(ye(r.length,i),a)}}validate(i,r){return r.isTwoDigitYear||r.year>0}set(i,r,n){const a=i.getFullYear();if(n.isTwoDigitYear){const s=Fs(n.year,a);return i.setFullYear(s,0,1),i.setHours(0,0,0,0),i}const o=!("era"in r)||r.era===1?n.year:1-n.year;return i.setFullYear(o,0,1),i.setHours(0,0,0,0),i}}class vu extends te{constructor(){super(...arguments);F(this,"priority",130);F(this,"incompatibleTokens",["y","R","u","Q","q","M","L","I","d","D","i","t","T"])}parse(i,r,n){const a=o=>({year:o,isTwoDigitYear:r==="YY"});switch(r){case"Y":return xe(ye(4,i),a);case"Yo":return xe(n.ordinalNumber(i,{unit:"year"}),a);default:return xe(ye(r.length,i),a)}}validate(i,r){return r.isTwoDigitYear||r.year>0}set(i,r,n,a){const o=Da(i,a);if(n.isTwoDigitYear){const d=Fs(n.year,o);return i.setFullYear(d,0,a.firstWeekContainsDate),i.setHours(0,0,0,0),Ye(i,a)}const s=!("era"in r)||r.era===1?n.year:1-n.year;return i.setFullYear(s,0,a.firstWeekContainsDate),i.setHours(0,0,0,0),Ye(i,a)}}class xu extends te{constructor(){super(...arguments);F(this,"priority",130);F(this,"incompatibleTokens",["G","y","Y","u","Q","q","M","L","w","d","D","e","c","t","T"])}parse(i,r){return an(r==="R"?4:r.length,i)}set(i,r,n){const a=me(i,0);return a.setFullYear(n,0,4),a.setHours(0,0,0,0),gi(a)}}class wu extends te{constructor(){super(...arguments);F(this,"priority",130);F(this,"incompatibleTokens",["G","y","Y","R","w","I","i","e","c","t","T"])}parse(i,r){return an(r==="u"?4:r.length,i)}set(i,r,n){return i.setFullYear(n,0,1),i.setHours(0,0,0,0),i}}class _u extends te{constructor(){super(...arguments);F(this,"priority",120);F(this,"incompatibleTokens",["Y","R","q","M","L","w","I","d","D","i","e","c","t","T"])}parse(i,r,n){switch(r){case"Q":case"QQ":return ye(r.length,i);case"Qo":return n.ordinalNumber(i,{unit:"quarter"});case"QQQ":return n.quarter(i,{width:"abbreviated",context:"formatting"})||n.quarter(i,{width:"narrow",context:"formatting"});case"QQQQQ":return n.quarter(i,{width:"narrow",context:"formatting"});case"QQQQ":default:return n.quarter(i,{width:"wide",context:"formatting"})||n.quarter(i,{width:"abbreviated",context:"formatting"})||n.quarter(i,{width:"narrow",context:"formatting"})}}validate(i,r){return r>=1&&r<=4}set(i,r,n){return i.setMonth((n-1)*3,1),i.setHours(0,0,0,0),i}}class $u extends te{constructor(){super(...arguments);F(this,"priority",120);F(this,"incompatibleTokens",["Y","R","Q","M","L","w","I","d","D","i","e","c","t","T"])}parse(i,r,n){switch(r){case"q":case"qq":return ye(r.length,i);case"qo":return n.ordinalNumber(i,{unit:"quarter"});case"qqq":return n.quarter(i,{width:"abbreviated",context:"standalone"})||n.quarter(i,{width:"narrow",context:"standalone"});case"qqqqq":return n.quarter(i,{width:"narrow",context:"standalone"});case"qqqq":default:return n.quarter(i,{width:"wide",context:"standalone"})||n.quarter(i,{width:"abbreviated",context:"standalone"})||n.quarter(i,{width:"narrow",context:"standalone"})}}validate(i,r){return r>=1&&r<=4}set(i,r,n){return i.setMonth((n-1)*3,1),i.setHours(0,0,0,0),i}}class ku extends te{constructor(){super(...arguments);F(this,"incompatibleTokens",["Y","R","q","Q","L","w","I","D","i","e","c","t","T"]);F(this,"priority",110)}parse(i,r,n){const a=o=>o-1;switch(r){case"M":return xe(ge(ve.month,i),a);case"MM":return xe(ye(2,i),a);case"Mo":return xe(n.ordinalNumber(i,{unit:"month"}),a);case"MMM":return n.month(i,{width:"abbreviated",context:"formatting"})||n.month(i,{width:"narrow",context:"formatting"});case"MMMMM":return n.month(i,{width:"narrow",context:"formatting"});case"MMMM":default:return n.month(i,{width:"wide",context:"formatting"})||n.month(i,{width:"abbreviated",context:"formatting"})||n.month(i,{width:"narrow",context:"formatting"})}}validate(i,r){return r>=0&&r<=11}set(i,r,n){return i.setMonth(n,1),i.setHours(0,0,0,0),i}}class Su extends te{constructor(){super(...arguments);F(this,"priority",110);F(this,"incompatibleTokens",["Y","R","q","Q","M","w","I","D","i","e","c","t","T"])}parse(i,r,n){const a=o=>o-1;switch(r){case"L":return xe(ge(ve.month,i),a);case"LL":return xe(ye(2,i),a);case"Lo":return xe(n.ordinalNumber(i,{unit:"month"}),a);case"LLL":return n.month(i,{width:"abbreviated",context:"standalone"})||n.month(i,{width:"narrow",context:"standalone"});case"LLLLL":return n.month(i,{width:"narrow",context:"standalone"});case"LLLL":default:return n.month(i,{width:"wide",context:"standalone"})||n.month(i,{width:"abbreviated",context:"standalone"})||n.month(i,{width:"narrow",context:"standalone"})}}validate(i,r){return r>=0&&r<=11}set(i,r,n){return i.setMonth(n,1),i.setHours(0,0,0,0),i}}function Cu(e,t,i){const r=Y(e,i==null?void 0:i.in),n=zs(r,i)-t;return r.setDate(r.getDate()-n*7),Y(r,i==null?void 0:i.in)}class Tu extends te{constructor(){super(...arguments);F(this,"priority",100);F(this,"incompatibleTokens",["y","R","u","q","Q","M","L","I","d","D","i","t","T"])}parse(i,r,n){switch(r){case"w":return ge(ve.week,i);case"wo":return n.ordinalNumber(i,{unit:"week"});default:return ye(r.length,i)}}validate(i,r){return r>=1&&r<=53}set(i,r,n,a){return Ye(Cu(i,n,a),a)}}function Pu(e,t,i){const r=Y(e,i==null?void 0:i.in),n=Ms(r,i)-t;return r.setDate(r.getDate()-n*7),r}class Mu extends te{constructor(){super(...arguments);F(this,"priority",100);F(this,"incompatibleTokens",["y","Y","u","q","Q","M","L","w","d","D","e","c","t","T"])}parse(i,r,n){switch(r){case"I":return ge(ve.week,i);case"Io":return n.ordinalNumber(i,{unit:"week"});default:return ye(r.length,i)}}validate(i,r){return r>=1&&r<=53}set(i,r,n){return gi(Pu(i,n))}}const zu=[31,28,31,30,31,30,31,31,30,31,30,31],Du=[31,29,31,30,31,30,31,31,30,31,30,31];class Eu extends te{constructor(){super(...arguments);F(this,"priority",90);F(this,"subPriority",1);F(this,"incompatibleTokens",["Y","R","q","Q","w","I","D","i","e","c","t","T"])}parse(i,r,n){switch(r){case"d":return ge(ve.date,i);case"do":return n.ordinalNumber(i,{unit:"date"});default:return ye(r.length,i)}}validate(i,r){const n=i.getFullYear(),a=Is(n),o=i.getMonth();return a?r>=1&&r<=Du[o]:r>=1&&r<=zu[o]}set(i,r,n){return i.setDate(n),i.setHours(0,0,0,0),i}}class Ou extends te{constructor(){super(...arguments);F(this,"priority",90);F(this,"subpriority",1);F(this,"incompatibleTokens",["Y","R","q","Q","M","L","w","I","d","E","i","e","c","t","T"])}parse(i,r,n){switch(r){case"D":case"DD":return ge(ve.dayOfYear,i);case"Do":return n.ordinalNumber(i,{unit:"date"});default:return ye(r.length,i)}}validate(i,r){const n=i.getFullYear();return Is(n)?r>=1&&r<=366:r>=1&&r<=365}set(i,r,n){return i.setMonth(0,n),i.setHours(0,0,0,0),i}}function Oa(e,t,i){var h,b,y,m;const r=Kt(),n=(i==null?void 0:i.weekStartsOn)??((b=(h=i==null?void 0:i.locale)==null?void 0:h.options)==null?void 0:b.weekStartsOn)??r.weekStartsOn??((m=(y=r.locale)==null?void 0:y.options)==null?void 0:m.weekStartsOn)??0,a=Y(e,i==null?void 0:i.in),o=a.getDay(),d=(t%7+7)%7,p=7-n,u=t<0||t>6?t-(o+p)%7:(d+p)%7-(o+p)%7;return Cn(a,u,i)}class Lu extends te{constructor(){super(...arguments);F(this,"priority",90);F(this,"incompatibleTokens",["D","i","e","c","t","T"])}parse(i,r,n){switch(r){case"E":case"EE":case"EEE":return n.day(i,{width:"abbreviated",context:"formatting"})||n.day(i,{width:"short",context:"formatting"})||n.day(i,{width:"narrow",context:"formatting"});case"EEEEE":return n.day(i,{width:"narrow",context:"formatting"});case"EEEEEE":return n.day(i,{width:"short",context:"formatting"})||n.day(i,{width:"narrow",context:"formatting"});case"EEEE":default:return n.day(i,{width:"wide",context:"formatting"})||n.day(i,{width:"abbreviated",context:"formatting"})||n.day(i,{width:"short",context:"formatting"})||n.day(i,{width:"narrow",context:"formatting"})}}validate(i,r){return r>=0&&r<=6}set(i,r,n,a){return i=Oa(i,n,a),i.setHours(0,0,0,0),i}}class Au extends te{constructor(){super(...arguments);F(this,"priority",90);F(this,"incompatibleTokens",["y","R","u","q","Q","M","L","I","d","D","E","i","c","t","T"])}parse(i,r,n,a){const o=s=>{const d=Math.floor((s-1)/7)*7;return(s+a.weekStartsOn+6)%7+d};switch(r){case"e":case"ee":return xe(ye(r.length,i),o);case"eo":return xe(n.ordinalNumber(i,{unit:"day"}),o);case"eee":return n.day(i,{width:"abbreviated",context:"formatting"})||n.day(i,{width:"short",context:"formatting"})||n.day(i,{width:"narrow",context:"formatting"});case"eeeee":return n.day(i,{width:"narrow",context:"formatting"});case"eeeeee":return n.day(i,{width:"short",context:"formatting"})||n.day(i,{width:"narrow",context:"formatting"});case"eeee":default:return n.day(i,{width:"wide",context:"formatting"})||n.day(i,{width:"abbreviated",context:"formatting"})||n.day(i,{width:"short",context:"formatting"})||n.day(i,{width:"narrow",context:"formatting"})}}validate(i,r){return r>=0&&r<=6}set(i,r,n,a){return i=Oa(i,n,a),i.setHours(0,0,0,0),i}}class Fu extends te{constructor(){super(...arguments);F(this,"priority",90);F(this,"incompatibleTokens",["y","R","u","q","Q","M","L","I","d","D","E","i","e","t","T"])}parse(i,r,n,a){const o=s=>{const d=Math.floor((s-1)/7)*7;return(s+a.weekStartsOn+6)%7+d};switch(r){case"c":case"cc":return xe(ye(r.length,i),o);case"co":return xe(n.ordinalNumber(i,{unit:"day"}),o);case"ccc":return n.day(i,{width:"abbreviated",context:"standalone"})||n.day(i,{width:"short",context:"standalone"})||n.day(i,{width:"narrow",context:"standalone"});case"ccccc":return n.day(i,{width:"narrow",context:"standalone"});case"cccccc":return n.day(i,{width:"short",context:"standalone"})||n.day(i,{width:"narrow",context:"standalone"});case"cccc":default:return n.day(i,{width:"wide",context:"standalone"})||n.day(i,{width:"abbreviated",context:"standalone"})||n.day(i,{width:"short",context:"standalone"})||n.day(i,{width:"narrow",context:"standalone"})}}validate(i,r){return r>=0&&r<=6}set(i,r,n,a){return i=Oa(i,n,a),i.setHours(0,0,0,0),i}}function Iu(e,t,i){const r=Y(e,i==null?void 0:i.in),n=pu(r,i),a=t-n;return Cn(r,a,i)}class Bu extends te{constructor(){super(...arguments);F(this,"priority",90);F(this,"incompatibleTokens",["y","Y","u","q","Q","M","L","w","d","D","E","e","c","t","T"])}parse(i,r,n){const a=o=>o===0?7:o;switch(r){case"i":case"ii":return ye(r.length,i);case"io":return n.ordinalNumber(i,{unit:"day"});case"iii":return xe(n.day(i,{width:"abbreviated",context:"formatting"})||n.day(i,{width:"short",context:"formatting"})||n.day(i,{width:"narrow",context:"formatting"}),a);case"iiiii":return xe(n.day(i,{width:"narrow",context:"formatting"}),a);case"iiiiii":return xe(n.day(i,{width:"short",context:"formatting"})||n.day(i,{width:"narrow",context:"formatting"}),a);case"iiii":default:return xe(n.day(i,{width:"wide",context:"formatting"})||n.day(i,{width:"abbreviated",context:"formatting"})||n.day(i,{width:"short",context:"formatting"})||n.day(i,{width:"narrow",context:"formatting"}),a)}}validate(i,r){return r>=1&&r<=7}set(i,r,n){return i=Iu(i,n),i.setHours(0,0,0,0),i}}class Nu extends te{constructor(){super(...arguments);F(this,"priority",80);F(this,"incompatibleTokens",["b","B","H","k","t","T"])}parse(i,r,n){switch(r){case"a":case"aa":case"aaa":return n.dayPeriod(i,{width:"abbreviated",context:"formatting"})||n.dayPeriod(i,{width:"narrow",context:"formatting"});case"aaaaa":return n.dayPeriod(i,{width:"narrow",context:"formatting"});case"aaaa":default:return n.dayPeriod(i,{width:"wide",context:"formatting"})||n.dayPeriod(i,{width:"abbreviated",context:"formatting"})||n.dayPeriod(i,{width:"narrow",context:"formatting"})}}set(i,r,n){return i.setHours(Ea(n),0,0,0),i}}class ju extends te{constructor(){super(...arguments);F(this,"priority",80);F(this,"incompatibleTokens",["a","B","H","k","t","T"])}parse(i,r,n){switch(r){case"b":case"bb":case"bbb":return n.dayPeriod(i,{width:"abbreviated",context:"formatting"})||n.dayPeriod(i,{width:"narrow",context:"formatting"});case"bbbbb":return n.dayPeriod(i,{width:"narrow",context:"formatting"});case"bbbb":default:return n.dayPeriod(i,{width:"wide",context:"formatting"})||n.dayPeriod(i,{width:"abbreviated",context:"formatting"})||n.dayPeriod(i,{width:"narrow",context:"formatting"})}}set(i,r,n){return i.setHours(Ea(n),0,0,0),i}}class Ru extends te{constructor(){super(...arguments);F(this,"priority",80);F(this,"incompatibleTokens",["a","b","t","T"])}parse(i,r,n){switch(r){case"B":case"BB":case"BBB":return n.dayPeriod(i,{width:"abbreviated",context:"formatting"})||n.dayPeriod(i,{width:"narrow",context:"formatting"});case"BBBBB":return n.dayPeriod(i,{width:"narrow",context:"formatting"});case"BBBB":default:return n.dayPeriod(i,{width:"wide",context:"formatting"})||n.dayPeriod(i,{width:"abbreviated",context:"formatting"})||n.dayPeriod(i,{width:"narrow",context:"formatting"})}}set(i,r,n){return i.setHours(Ea(n),0,0,0),i}}class Hu extends te{constructor(){super(...arguments);F(this,"priority",70);F(this,"incompatibleTokens",["H","K","k","t","T"])}parse(i,r,n){switch(r){case"h":return ge(ve.hour12h,i);case"ho":return n.ordinalNumber(i,{unit:"hour"});default:return ye(r.length,i)}}validate(i,r){return r>=1&&r<=12}set(i,r,n){const a=i.getHours()>=12;return a&&n<12?i.setHours(n+12,0,0,0):!a&&n===12?i.setHours(0,0,0,0):i.setHours(n,0,0,0),i}}class Wu extends te{constructor(){super(...arguments);F(this,"priority",70);F(this,"incompatibleTokens",["a","b","h","K","k","t","T"])}parse(i,r,n){switch(r){case"H":return ge(ve.hour23h,i);case"Ho":return n.ordinalNumber(i,{unit:"hour"});default:return ye(r.length,i)}}validate(i,r){return r>=0&&r<=23}set(i,r,n){return i.setHours(n,0,0,0),i}}class Vu extends te{constructor(){super(...arguments);F(this,"priority",70);F(this,"incompatibleTokens",["h","H","k","t","T"])}parse(i,r,n){switch(r){case"K":return ge(ve.hour11h,i);case"Ko":return n.ordinalNumber(i,{unit:"hour"});default:return ye(r.length,i)}}validate(i,r){return r>=0&&r<=11}set(i,r,n){return i.getHours()>=12&&n<12?i.setHours(n+12,0,0,0):i.setHours(n,0,0,0),i}}class Ku extends te{constructor(){super(...arguments);F(this,"priority",70);F(this,"incompatibleTokens",["a","b","h","H","K","t","T"])}parse(i,r,n){switch(r){case"k":return ge(ve.hour24h,i);case"ko":return n.ordinalNumber(i,{unit:"hour"});default:return ye(r.length,i)}}validate(i,r){return r>=1&&r<=24}set(i,r,n){const a=n<=24?n%24:n;return i.setHours(a,0,0,0),i}}class qu extends te{constructor(){super(...arguments);F(this,"priority",60);F(this,"incompatibleTokens",["t","T"])}parse(i,r,n){switch(r){case"m":return ge(ve.minute,i);case"mo":return n.ordinalNumber(i,{unit:"minute"});default:return ye(r.length,i)}}validate(i,r){return r>=0&&r<=59}set(i,r,n){return i.setMinutes(n,0,0),i}}class Gu extends te{constructor(){super(...arguments);F(this,"priority",50);F(this,"incompatibleTokens",["t","T"])}parse(i,r,n){switch(r){case"s":return ge(ve.second,i);case"so":return n.ordinalNumber(i,{unit:"second"});default:return ye(r.length,i)}}validate(i,r){return r>=0&&r<=59}set(i,r,n){return i.setSeconds(n,0),i}}class Uu extends te{constructor(){super(...arguments);F(this,"priority",30);F(this,"incompatibleTokens",["t","T"])}parse(i,r){const n=a=>Math.trunc(a*Math.pow(10,-r.length+3));return xe(ye(r.length,i),n)}set(i,r,n){return i.setMilliseconds(n),i}}class Yu extends te{constructor(){super(...arguments);F(this,"priority",10);F(this,"incompatibleTokens",["t","T","x"])}parse(i,r){switch(r){case"X":return Ue(Ge.basicOptionalMinutes,i);case"XX":return Ue(Ge.basic,i);case"XXXX":return Ue(Ge.basicOptionalSeconds,i);case"XXXXX":return Ue(Ge.extendedOptionalSeconds,i);case"XXX":default:return Ue(Ge.extended,i)}}set(i,r,n){return r.timestampIsSet?i:me(i,i.getTime()-nn(i)-n)}}class Zu extends te{constructor(){super(...arguments);F(this,"priority",10);F(this,"incompatibleTokens",["t","T","X"])}parse(i,r){switch(r){case"x":return Ue(Ge.basicOptionalMinutes,i);case"xx":return Ue(Ge.basic,i);case"xxxx":return Ue(Ge.basicOptionalSeconds,i);case"xxxxx":return Ue(Ge.extendedOptionalSeconds,i);case"xxx":default:return Ue(Ge.extended,i)}}set(i,r,n){return r.timestampIsSet?i:me(i,i.getTime()-nn(i)-n)}}class Qu extends te{constructor(){super(...arguments);F(this,"priority",40);F(this,"incompatibleTokens","*")}parse(i){return As(i)}set(i,r,n){return[me(i,n*1e3),{timestampIsSet:!0}]}}class Xu extends te{constructor(){super(...arguments);F(this,"priority",20);F(this,"incompatibleTokens","*")}parse(i){return As(i)}set(i,r,n){return[me(i,n),{timestampIsSet:!0}]}}const Ju={G:new mu,y:new yu,Y:new vu,R:new xu,u:new wu,Q:new _u,q:new $u,M:new ku,L:new Su,w:new Tu,I:new Mu,d:new Eu,D:new Ou,E:new Lu,e:new Au,c:new Fu,i:new Bu,a:new Nu,b:new ju,B:new Ru,h:new Hu,H:new Wu,K:new Vu,k:new Ku,m:new qu,s:new Gu,S:new Uu,X:new Yu,x:new Zu,t:new Qu,T:new Xu},eh=/[yYQqMLwIdDecihHKkms]o|(\w)\1*|''|'(''|[^'])+('|$)|./g,th=/P+p+|P+|p+|''|'(''|[^'])+('|$)|./g,ih=/^'([^]*?)'?$/,rh=/''/g,nh=/\S/,ah=/[a-zA-Z]/;function oh(e,t,i,r){var k,v,_,T,R,O,N,$;const n=()=>me((r==null?void 0:r.in)||i,NaN),a=du(),o=(r==null?void 0:r.locale)??a.locale??Ps,s=(r==null?void 0:r.firstWeekContainsDate)??((v=(k=r==null?void 0:r.locale)==null?void 0:k.options)==null?void 0:v.firstWeekContainsDate)??a.firstWeekContainsDate??((T=(_=a.locale)==null?void 0:_.options)==null?void 0:T.firstWeekContainsDate)??1,d=(r==null?void 0:r.weekStartsOn)??((O=(R=r==null?void 0:r.locale)==null?void 0:R.options)==null?void 0:O.weekStartsOn)??a.weekStartsOn??(($=(N=a.locale)==null?void 0:N.options)==null?void 0:$.weekStartsOn)??0;if(!t)return e?n():Y(i,r==null?void 0:r.in);const p={firstWeekContainsDate:s,weekStartsOn:d,locale:o},u=[new fu(r==null?void 0:r.in,i)],h=t.match(th).map(M=>{const z=M[0];if(z in ya){const q=ya[z];return q(M,o.formatLong)}return M}).join("").match(eh),b=[];for(let M of h){!(r!=null&&r.useAdditionalWeekYearTokens)&&Os(M)&&va(M,t,e),!(r!=null&&r.useAdditionalDayOfYearTokens)&&Es(M)&&va(M,t,e);const z=M[0],q=Ju[z];if(q){const{incompatibleTokens:G}=q;if(Array.isArray(G)){const K=b.find(Me=>G.includes(Me.token)||Me.token===z);if(K)throw new RangeError(`The format string mustn't contain \`${K.fullToken}\` and \`${M}\` at the same time`)}else if(q.incompatibleTokens==="*"&&b.length>0)throw new RangeError(`The format string mustn't contain \`${M}\` and any other token at the same time`);b.push({token:z,fullToken:M});const V=q.run(e,M,o.match,p);if(!V)return n();u.push(V.setter),e=V.rest}else{if(z.match(ah))throw new RangeError("Format string contains an unescaped latin alphabet character `"+z+"`");if(M==="''"?M="'":z==="'"&&(M=sh(M)),e.indexOf(M)===0)e=e.slice(M.length);else return n()}}if(e.length>0&&nh.test(e))return n();const y=u.map(M=>M.priority).sort((M,z)=>z-M).filter((M,z,q)=>q.indexOf(M)===z).map(M=>u.filter(z=>z.priority===M).sort((z,q)=>q.subPriority-z.subPriority)).map(M=>M[0]);let m=Y(i,r==null?void 0:r.in);if(isNaN(+m))return n();const f={};for(const M of y){if(!M.validate(m,p))return n();const z=M.set(m,f,p);Array.isArray(z)?(m=z[0],Object.assign(f,z[1])):m=z}return m}function sh(e){return e.match(ih)[1].replace(rh,"'")}function lh(e,t){const i=Y(e,t==null?void 0:t.in);return i.setMinutes(0,0,0),i}function ch(e,t){const i=Y(e,t==null?void 0:t.in);return i.setSeconds(0,0),i}function dh(e,t){const i=Y(e,t==null?void 0:t.in);return i.setMilliseconds(0),i}function ph(e,t){const i=()=>me(t==null?void 0:t.in,NaN),r=(t==null?void 0:t.additionalDigits)??2,n=bh(e);let a;if(n.date){const p=fh(n.date,r);a=mh(p.restDateString,p.year)}if(!a||isNaN(+a))return i();const o=+a;let s=0,d;if(n.time&&(s=yh(n.time),isNaN(s)))return i();if(n.timezone){if(d=vh(n.timezone),isNaN(d))return i()}else{const p=new Date(o+s),u=Y(0,t==null?void 0:t.in);return u.setFullYear(p.getUTCFullYear(),p.getUTCMonth(),p.getUTCDate()),u.setHours(p.getUTCHours(),p.getUTCMinutes(),p.getUTCSeconds(),p.getUTCMilliseconds()),u}return Y(o+s+d,t==null?void 0:t.in)}const Kr={dateTimeDelimiter:/[T ]/,timeZoneDelimiter:/[Z ]/i,timezone:/([Z+-].*)$/},uh=/^-?(?:(\d{3})|(\d{2})(?:-?(\d{2}))?|W(\d{2})(?:-?(\d{1}))?|)$/,hh=/^(\d{2}(?:[.,]\d*)?)(?::?(\d{2}(?:[.,]\d*)?))?(?::?(\d{2}(?:[.,]\d*)?))?$/,gh=/^([+-])(\d{2})(?::?(\d{2}))?$/;function bh(e){const t={},i=e.split(Kr.dateTimeDelimiter);let r;if(i.length>2)return t;if(/:/.test(i[0])?r=i[0]:(t.date=i[0],r=i[1],Kr.timeZoneDelimiter.test(t.date)&&(t.date=e.split(Kr.timeZoneDelimiter)[0],r=e.substr(t.date.length,e.length))),r){const n=Kr.timezone.exec(r);n?(t.time=r.replace(n[1],""),t.timezone=n[1]):t.time=r}return t}function fh(e,t){const i=new RegExp("^(?:(\\d{4}|[+-]\\d{"+(4+t)+"})|(\\d{2}|[+-]\\d{"+(2+t)+"})$)"),r=e.match(i);if(!r)return{year:NaN,restDateString:""};const n=r[1]?parseInt(r[1]):null,a=r[2]?parseInt(r[2]):null;return{year:a===null?n:a*100,restDateString:e.slice((r[1]||r[2]).length)}}function mh(e,t){if(t===null)return new Date(NaN);const i=e.match(uh);if(!i)return new Date(NaN);const r=!!i[4],n=Ki(i[1]),a=Ki(i[2])-1,o=Ki(i[3]),s=Ki(i[4]),d=Ki(i[5])-1;if(r)return kh(t,s,d)?xh(t,s,d):new Date(NaN);{const p=new Date(0);return!_h(t,a,o)||!$h(t,n)?new Date(NaN):(p.setUTCFullYear(t,a,Math.max(n,o)),p)}}function Ki(e){return e?parseInt(e):1}function yh(e){const t=e.match(hh);if(!t)return NaN;const i=ea(t[1]),r=ea(t[2]),n=ea(t[3]);return Sh(i,r,n)?i*xr+r*vr+n*1e3:NaN}function ea(e){return e&&parseFloat(e.replace(",","."))||0}function vh(e){if(e==="Z")return 0;const t=e.match(gh);if(!t)return 0;const i=t[1]==="+"?-1:1,r=parseInt(t[2]),n=t[3]&&parseInt(t[3])||0;return Ch(r,n)?i*(r*xr+n*vr):NaN}function xh(e,t,i){const r=new Date(0);r.setUTCFullYear(e,0,4);const n=r.getUTCDay()||7,a=(t-1)*7+i+1-n;return r.setUTCDate(r.getUTCDate()+a),r}const wh=[31,null,31,30,31,30,31,31,30,31,30,31];function Bs(e){return e%400===0||e%4===0&&e%100!==0}function _h(e,t,i){return t>=0&&t<=11&&i>=1&&i<=(wh[t]||(Bs(e)?29:28))}function $h(e,t){return t>=1&&t<=(Bs(e)?366:365)}function kh(e,t,i){return t>=1&&t<=53&&i>=0&&i<=6}function Sh(e,t,i){return e===24?t===0&&i===0:i>=0&&i<60&&t>=0&&t<60&&e>=0&&e<25}function Ch(e,t){return t>=0&&t<=59}/*!
 * chartjs-adapter-date-fns v3.0.0
 * https://www.chartjs.org
 * (c) 2022 chartjs-adapter-date-fns Contributors
 * Released under the MIT license
 */const Th={datetime:"MMM d, yyyy, h:mm:ss aaaa",millisecond:"h:mm:ss.SSS aaaa",second:"h:mm:ss aaaa",minute:"h:mm aaaa",hour:"ha",day:"MMM d",week:"PP",month:"MMM yyyy",quarter:"qqq - yyyy",year:"yyyy"};cl._date.override({_id:"date-fns",formats:function(){return Th},parse:function(e,t){if(e===null||typeof e>"u")return null;const i=typeof e;return i==="number"||e instanceof Date?e=Y(e):i==="string"&&(typeof t=="string"?e=oh(e,t,new Date,this.options):e=ph(e,this.options)),_s(e)?e.getTime():null},format:function(e,t){return lu(e,t,this.options)},add:function(e,t,i){switch(i){case"millisecond":return Ma(e,t);case"second":return Qd(e,t);case"minute":return Yd(e,t);case"hour":return qd(e,t);case"day":return Cn(e,t);case"week":return Xd(e,t);case"month":return Pa(e,t);case"quarter":return Zd(e,t);case"year":return Jd(e,t);default:return e}},diff:function(e,t,i){switch(i){case"millisecond":return za(e,t);case"second":return sp(e,t);case"minute":return np(e,t);case"hour":return rp(e,t);case"day":return $s(e,t);case"week":return lp(e,t);case"month":return Cs(e,t);case"quarter":return op(e,t);case"year":return cp(e,t);default:return 0}},startOf:function(e,t,i){switch(t){case"second":return dh(e);case"minute":return ch(e);case"hour":return lh(e);case"day":return ma(e);case"week":return Ye(e);case"isoWeek":return Ye(e,{weekStartsOn:+i});case"month":return pp(e);case"quarter":return dp(e);case"year":return Ts(e);default:return e}},endOf:function(e,t){switch(t){case"second":return mp(e);case"minute":return bp(e);case"hour":return hp(e);case"day":return ks(e);case"week":return gp(e);case"month":return Ss(e);case"quarter":return fp(e);case"year":return up(e);default:return e}}});function Co(e,t){if(!(t!=null&&t.start)||!(t!=null&&t.end))return null;const i=e.getPixelForValue(t.start.getTime()),r=e.getPixelForValue(t.end.getTime());if(!Number.isFinite(i)||!Number.isFinite(r))return null;const n=Math.min(i,r),a=Math.max(Math.abs(r-i),2);return!Number.isFinite(a)||a<=0?null:{left:n,width:a}}const Ph={id:"pricingModeIcons",beforeDatasetsDraw(e,t,i){var d;const r=i,n=r==null?void 0:r.segments;if(!(n!=null&&n.length))return;const a=e.chartArea,o=(d=e.scales)==null?void 0:d.x;if(!a||!o)return;const s=e.ctx;s.save(),s.globalAlpha=(r==null?void 0:r.backgroundOpacity)??.12;for(const p of n){const u=Co(o,p);u&&(s.fillStyle=p.color||"rgba(255, 255, 255, 0.1)",s.fillRect(u.left,a.top,u.width,a.bottom-a.top))}s.restore()},afterDatasetsDraw(e,t,i){var M;const r=i,n=r==null?void 0:r.segments;if(!(n!=null&&n.length))return;const a=(M=e.scales)==null?void 0:M.x,o=e.chartArea;if(!a||!o)return;const s=(r==null?void 0:r.iconSize)??16,d=(r==null?void 0:r.labelSize)??9,p=`${s}px "Inter", "Segoe UI Emoji", "Noto Color Emoji", sans-serif`,u=`${d}px "Inter", sans-serif`,h=(r==null?void 0:r.iconColor)||"rgba(255, 255, 255, 0.95)",b=(r==null?void 0:r.labelColor)||"rgba(255, 255, 255, 0.7)",y=(r==null?void 0:r.axisBandPadding)??10,m=(r==null?void 0:r.axisBandHeight)??s+d+10,f=(r==null?void 0:r.axisBandColor)||"rgba(6, 10, 18, 0.12)",k=(r==null?void 0:r.iconAlignment)||"start",v=(r==null?void 0:r.iconStartOffset)??12,_=(r==null?void 0:r.iconBaselineOffset)??4,T=(a.bottom||o.bottom)+y,R=Math.min(T,e.height-m-2),O=o.right-o.left,N=R+_,$=e.ctx;$.save(),$.globalCompositeOperation="destination-over",$.fillStyle=f,$.fillRect(o.left,R,O,m),$.restore(),$.save(),$.globalCompositeOperation="destination-over",$.textAlign="center",$.textBaseline="top";for(const z of n){const q=Co(a,z);if(!q)continue;let G;if(k==="start"){G=q.left+v;const V=q.left+q.width-s/2;G>V&&(G=q.left+q.width/2)}else G=q.left+q.width/2;$.font=p,$.fillStyle=h,$.fillText(z.icon||"❓",G,N),z.shortLabel&&($.font=u,$.fillStyle=b,$.fillText(z.shortLabel,G,N+s-2))}$.restore()}};function To(e,t){if(!e)return;e.layout||(e.layout={}),e.layout.padding||(e.layout.padding={});const i=e.layout.padding,r=12;i.top=i.top??12,i.bottom=Math.max(i.bottom||0,r)}var Mh=Object.defineProperty,zh=Object.getOwnPropertyDescriptor,Si=(e,t,i,r)=>{for(var n=r>1?void 0:r?zh(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&Mh(t,i,n),n};const lt=Q;wn.register(Ho,Wo,dl,pl,Vo,Ko,ul,qo,hl,gl,Go,Uo,bl,fl,Yo,Ph);function Dh(e){const t=e.timeline.map(i=>i.spot_price_czk??0);return{label:"📊 Spot",data:t,borderColor:"#2196F3",backgroundColor:"rgba(33, 150, 243, 0.15)",borderWidth:3,fill:!1,tension:.4,type:"line",yAxisID:"y-price",pointRadius:t.map(()=>0),pointHoverRadius:7,pointBackgroundColor:t.map(()=>"#42a5f5"),pointBorderColor:t.map(()=>"#42a5f5"),pointBorderWidth:2,order:1,datalabels:{display:!1}}}function Eh(e){return{label:"💰 Výkup",data:e.timeline.map(t=>t.export_price_czk??0),borderColor:"#4CAF50",backgroundColor:"rgba(76, 187, 106, 0.15)",borderWidth:2,fill:!1,type:"line",tension:.4,yAxisID:"y-price",pointRadius:0,pointHoverRadius:5,order:1,borderDash:[5,5]}}function Oh(e){if(!e.solar)return[];const{string1:t,string2:i,hasString1:r,hasString2:n}=e.solar,a=(r?1:0)+(n?1:0),o={string1:{border:"rgba(255, 193, 7, 0.8)",bg:"rgba(255, 193, 7, 0.2)"},string2:{border:"rgba(255, 152, 0, 0.8)",bg:"rgba(255, 152, 0, 0.2)"}};if(a===1){const s=r?t:i,d=r?o.string1:o.string2;return[{label:"☀️ FVE předpověď",data:s,borderColor:d.border,backgroundColor:d.bg,borderWidth:2,fill:"origin",tension:.4,type:"line",yAxisID:"y-power",pointRadius:0,pointHoverRadius:5,order:2}]}return a===2?[{label:"☀️ String 2",data:i,borderColor:o.string2.border,backgroundColor:o.string2.bg,borderWidth:1.5,fill:"origin",tension:.4,type:"line",yAxisID:"y-power",stack:"solar",pointRadius:0,pointHoverRadius:5,order:2},{label:"☀️ String 1",data:t,borderColor:o.string1.border,backgroundColor:o.string1.bg,borderWidth:1.5,fill:"-1",tension:.4,type:"line",yAxisID:"y-power",stack:"solar",pointRadius:0,pointHoverRadius:5,order:2}]:[]}function Lh(e){if(!e.battery)return[];const{baseline:t,solarCharge:i,gridCharge:r,gridNet:n,consumption:a}=e.battery,o=[],s={baseline:{border:"#78909C",bg:"rgba(120, 144, 156, 0.25)"},solar:{border:"transparent",bg:"rgba(255, 167, 38, 0.6)"},grid:{border:"transparent",bg:"rgba(33, 150, 243, 0.6)"}};return a.some(d=>d!=null&&d>0)&&o.push({label:"🏠 Spotřeba",data:a,borderColor:"rgba(255, 112, 67, 0.7)",backgroundColor:"rgba(255, 112, 67, 0.12)",borderWidth:1.5,type:"line",fill:!1,tension:.25,pointRadius:0,pointHoverRadius:5,yAxisID:"y-power",stack:"consumption",borderDash:[6,4],order:2}),r.some(d=>d!=null&&d>0)&&o.push({label:"⚡ Síť → baterie",data:r,backgroundColor:s.grid.bg,borderColor:s.grid.border,borderWidth:0,type:"line",fill:!0,tension:.4,pointRadius:0,pointHoverRadius:5,yAxisID:"y-solar",stack:"charging",order:3}),i.some(d=>d!=null&&d>0)&&o.push({label:"☀️ FVE → baterie",data:i,backgroundColor:s.solar.bg,borderColor:s.solar.border,borderWidth:0,type:"line",fill:!0,tension:.4,pointRadius:0,pointHoverRadius:5,yAxisID:"y-solar",stack:"charging",order:3}),o.push({label:"🔋 Kapacita",data:t,backgroundColor:s.baseline.bg,borderColor:s.baseline.border,borderWidth:3,type:"line",fill:!0,tension:.4,pointRadius:0,pointHoverRadius:5,yAxisID:"y-solar",stack:"charging",order:3}),n.some(d=>d!==null)&&o.push({label:"📡 Netto síť",data:n,borderColor:"#00BCD4",backgroundColor:"transparent",borderWidth:2,type:"line",fill:!1,tension:.2,pointRadius:0,pointHoverRadius:5,yAxisID:"y-solar",order:2}),o}function Po(e){const t=[];return e.prices.length>0&&t.push(Dh(e)),e.exportPrices.length>0&&t.push(Eh(e)),t.push(...Oh(e)),t.push(...Lh(e)),t}function qr(e,t,i=""){if(e==null)return"";const r=i?` ${i}`:"";return`${e.toFixed(t)}${r}`}function ri(e){var n;const t=(n=e.scales)==null?void 0:n.x;if(!t)return"overview";const r=(t.max-t.min)/(1e3*60*60);return r<=6?"detail":r<=24?"day":"overview"}function Pt(e,t){var h,b,y,m,f,k,v,_,T,R,O;if(!((h=e==null?void 0:e.scales)!=null&&h.x))return;const i=e.scales.x,n=(i.max-i.min)/(1e3*60*60),a=ri(e),o=(y=(b=e.options.plugins)==null?void 0:b.legend)==null?void 0:y.labels;o&&(o.padding=10,o.font&&(o.font.size=11),a==="detail"&&(o.padding=12,o.font&&(o.font.size=12)));const s=window.innerWidth<520,d=["y-price","y-solar","y-power"];for(const N of d){const $=(m=e.options.scales)==null?void 0:m[N];if($){if(N==="y-solar"&&s){$.display=!1;continue}a==="overview"?($.title&&($.title.display=!1),(f=$.ticks)!=null&&f.font&&($.ticks.font.size=10),N==="y-solar"&&($.display=!1)):a==="detail"?($.title&&($.title.display=!0,$.title.font&&($.title.font.size=12)),(k=$.ticks)!=null&&k.font&&($.ticks.font.size=11),$.display=!0):($.title&&($.title.display=!0,$.title.font&&($.title.font.size=11)),(v=$.ticks)!=null&&v.font&&($.ticks.font.size=10),$.display=!0)}}const p=(_=e.options.scales)==null?void 0:_.x;p&&(a==="overview"?p.ticks&&(p.ticks.maxTicksLimit=12,p.ticks.font&&(p.ticks.font.size=10)):a==="detail"?(p.ticks&&(p.ticks.maxTicksLimit=24,p.ticks.font&&(p.ticks.font.size=11)),p.time&&(p.time.displayFormats.hour="HH:mm")):(p.ticks&&(p.ticks.maxTicksLimit=16,p.ticks.font&&(p.ticks.font.size=10)),p.time&&(p.time.displayFormats.hour=s?"HH:mm":"dd.MM HH:mm")));const u=t==="always"||t==="auto"&&n<=6;for(const N of e.data.datasets){const $=N;if($.datalabels||($.datalabels={}),t==="never"){$.datalabels.display=!1;continue}if(u){let M=1;n>3&&n<=6?M=2:n>6&&(M=4),$.datalabels.display=V=>{const K=V.dataset.data[V.dataIndex];return K==null||K===0?!1:V.dataIndex%M===0};const z=$.yAxisID==="y-price",q=((T=$.label)==null?void 0:T.includes("Solární"))||((R=$.label)==null?void 0:R.includes("String")),G=(O=$.label)==null?void 0:O.includes("kapacita");$.datalabels.align="top",$.datalabels.offset=6,$.datalabels.color="#fff",$.datalabels.font={size:9,weight:"bold"},z?($.datalabels.formatter=V=>qr(V,2,"Kč"),$.datalabels.backgroundColor=$.borderColor||"rgba(33, 150, 243, 0.8)"):q?($.datalabels.formatter=V=>qr(V,1,"kW"),$.datalabels.backgroundColor=$.borderColor||"rgba(255, 193, 7, 0.8)"):G?($.datalabels.formatter=V=>qr(V,1,"kWh"),$.datalabels.backgroundColor=$.borderColor||"rgba(120, 144, 156, 0.8)"):($.datalabels.formatter=V=>qr(V,1),$.datalabels.backgroundColor=$.borderColor||"rgba(33, 150, 243, 0.8)"),$.datalabels.borderRadius=4,$.datalabels.padding={top:3,bottom:3,left:5,right:5}}else $.datalabels.display=!1}e.update("none"),P.debug(`[PricingChart] Detail: ${n.toFixed(1)}h, Labels: ${u?"ON":"OFF"}, Mode: ${t}`)}let pt=class extends L{constructor(){super(...arguments),this.data=null,this.datalabelMode="auto",this.zoomState={start:null,end:null},this.currentDetailLevel="overview",this.chart=null,this.resizeObserver=null}firstUpdated(){this.setupResizeObserver(),this.data&&this.data.timeline.length>0&&requestAnimationFrame(()=>this.createChart())}updated(e){e.has("data")&&this.data&&(this.chart?this.updateChartData():this.data.timeline.length>0&&requestAnimationFrame(()=>this.createChart())),e.has("datalabelMode")&&this.chart&&Pt(this.chart,this.datalabelMode)}disconnectedCallback(){var e;super.disconnectedCallback(),this.destroyChart(),(e=this.resizeObserver)==null||e.disconnect(),this.resizeObserver=null}zoomToTimeRange(e,t){if(!this.chart){P.warn("[PricingChart] Chart not available for zoom");return}const i=new Date(e),r=new Date(t),n=15*60*1e3,a=i.getTime()-n,o=r.getTime()+n;if(this.zoomState.start!==null&&Math.abs(this.zoomState.start-a)<6e4&&this.zoomState.end!==null&&Math.abs(this.zoomState.end-o)<6e4){P.debug("[PricingChart] Already zoomed to same range → reset"),this.resetZoom();return}try{const s=this.chart.options;s.scales.x.min=a,s.scales.x.max=o,this.chart.update("none"),this.zoomState={start:a,end:o},this.currentDetailLevel=ri(this.chart),Pt(this.chart,this.datalabelMode),this.dispatchEvent(new CustomEvent("zoom-change",{detail:{start:a,end:o,level:this.currentDetailLevel},bubbles:!0,composed:!0})),P.debug("[PricingChart] Zoomed to range",{start:new Date(a).toISOString(),end:new Date(o).toISOString()})}catch(s){P.error("[PricingChart] Zoom error",s)}}resetZoom(){if(!this.chart)return;const e=this.chart.options;delete e.scales.x.min,delete e.scales.x.max,this.chart.update("none"),this.zoomState={start:null,end:null},this.currentDetailLevel=ri(this.chart),Pt(this.chart,this.datalabelMode),this.dispatchEvent(new CustomEvent("zoom-reset",{bubbles:!0,composed:!0}))}getChart(){return this.chart}createChart(){if(!this.canvas||!this.data||this.data.timeline.length===0)return;this.chart&&this.destroyChart();const e=this.data,t=Po(e),i=window.innerWidth<520,r={responsive:!0,maintainAspectRatio:!1,animation:{duration:0},interaction:{mode:"index",intersect:!1},plugins:{legend:{labels:{color:"#ffffff",font:{size:i?10:11,weight:"500"},padding:i?6:10,usePointStyle:!0,pointStyle:"circle",boxWidth:i?8:12,boxHeight:i?8:12},position:"top"},tooltip:{backgroundColor:"rgba(0,0,0,0.9)",titleColor:"#ffffff",bodyColor:"#ffffff",titleFont:{size:13,weight:"bold"},bodyFont:{size:11},padding:10,cornerRadius:6,displayColors:!0,callbacks:{title:a=>a.length>0?new Date(a[0].parsed.x).toLocaleString("cs-CZ",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}):"",label:a=>{let o=a.dataset.label||"";return o&&(o+=": "),a.parsed.y!==null&&(a.dataset.yAxisID==="y-price"?o+=a.parsed.y.toFixed(2)+" Kč/kWh":a.dataset.yAxisID==="y-solar"?o+=a.parsed.y.toFixed(2)+" kWh":a.dataset.yAxisID==="y-power"?o+=a.parsed.y.toFixed(2)+" kW":o+=a.parsed.y),o}}},datalabels:{display:!1},zoom:{zoom:{wheel:{enabled:!0,modifierKey:null},drag:{enabled:!0,backgroundColor:"rgba(33, 150, 243, 0.3)",borderColor:"rgba(33, 150, 243, 0.8)",borderWidth:2},pinch:{enabled:!0},mode:"x",onZoomComplete:({chart:a})=>{this.zoomState={start:null,end:null},this.currentDetailLevel=ri(a),Pt(a,this.datalabelMode)}},pan:{enabled:!0,mode:"x",modifierKey:"shift",onPanComplete:({chart:a})=>{this.zoomState={start:null,end:null},this.currentDetailLevel=ri(a),Pt(a,this.datalabelMode)}},limits:{x:{minRange:36e5}}},pricingModeIcons:null},scales:{x:{type:"timeseries",time:{unit:"hour",displayFormats:{hour:i?"HH:mm":"dd.MM HH:mm"},tooltipFormat:"dd.MM.yyyy HH:mm"},ticks:{color:this.getTextColor(),maxRotation:i?0:45,minRotation:i?0:45,font:{size:i?10:11},maxTicksLimit:i?6:20},grid:{color:this.getGridColor(),lineWidth:1}},"y-price":{type:"linear",position:"left",ticks:{color:"#2196F3",font:{size:11,weight:"500"},callback:a=>a.toFixed(2)+" Kč"},grid:{color:"rgba(33, 150, 243, 0.15)",lineWidth:1},title:{display:!i,text:"💰 Cena (Kč/kWh)",color:"#2196F3",font:{size:13,weight:"bold"}}},"y-solar":{type:"linear",position:"left",stacked:!0,display:!i,ticks:{color:"#78909C",font:{size:11,weight:"500"},callback:a=>a.toFixed(1)+" kWh",display:!0},grid:{display:!0,color:"rgba(120, 144, 156, 0.15)",lineWidth:1,drawOnChartArea:!0},title:{display:!0,text:"🔋 Kapacita baterie (kWh)",color:"#78909C",font:{size:11,weight:"bold"}},beginAtZero:!1},"y-power":{type:"linear",position:"right",stacked:!0,ticks:{color:"#FFA726",font:{size:11,weight:"500"},callback:a=>a.toFixed(2)+" kW"},grid:{display:!1},title:{display:!i,text:"☀️ Výkon (kW)",color:"#FFA726",font:{size:13,weight:"bold"}}}}};To(r);const n={type:"bar",data:{labels:e.labels,datasets:t},plugins:[Yo],options:r};try{this.chart=new wn(this.canvas,n),Pt(this.chart,this.datalabelMode),e.initialZoomStart&&e.initialZoomEnd&&requestAnimationFrame(()=>{if(!this.chart)return;const a=this.chart.options;a.scales.x.min=e.initialZoomStart,a.scales.x.max=e.initialZoomEnd,this.chart.update("none"),this.currentDetailLevel=ri(this.chart),Pt(this.chart,this.datalabelMode)}),P.info("[PricingChart] Chart created",{datasets:t.length,labels:e.labels.length,segments:e.modeSegments.length})}catch(a){P.error("[PricingChart] Failed to create chart",a)}}updateChartData(){var o;if(!this.chart||!this.data)return;const e=this.data,t=Po(e),i=((o=this.chart.data.labels)==null?void 0:o.length)!==e.labels.length,r=this.chart.data.datasets.length!==t.length;i&&(this.chart.data.labels=e.labels);let n="none";r?(this.chart.data.datasets=t,n=void 0):t.forEach((s,d)=>{const p=this.chart.data.datasets[d];p&&(p.data=s.data,p.label=s.label,p.backgroundColor=s.backgroundColor,p.borderColor=s.borderColor)});const a=this.chart.options;a.plugins||(a.plugins={}),a.plugins.pricingModeIcons=null,To(a),this.chart.update(n),P.debug("[PricingChart] Chart updated incrementally")}destroyChart(){this.chart&&(this.chart.destroy(),this.chart=null)}setupResizeObserver(){this.resizeObserver=new ResizeObserver(()=>{var e;(e=this.chart)==null||e.resize()}),this.resizeObserver.observe(this)}getTextColor(){try{return getComputedStyle(this).getPropertyValue("--oig-text-primary").trim()||"#e0e0e0"}catch{return"#e0e0e0"}}getGridColor(){try{return getComputedStyle(this).getPropertyValue("--oig-border").trim()||"rgba(255,255,255,0.1)"}catch{return"rgba(255,255,255,0.1)"}}setDatalabelMode(e){this.datalabelMode=e,this.dispatchEvent(new CustomEvent("datalabel-mode-change",{detail:{mode:e},bubbles:!0,composed:!0}))}get isZoomed(){return this.zoomState.start!==null||this.zoomState.end!==null}renderControls(){const e=t=>{const i=this.datalabelMode===t?"active":"";return t==="always"&&this.datalabelMode==="always"?`control-btn mode-always ${i}`:t==="never"&&this.datalabelMode==="never"?`control-btn mode-never ${i}`:`control-btn ${i}`};return c`
  ...
  `;Si([g({type:Object})],pt.prototype,"data",2);Si([g({type:String})],pt.prototype,"datalabelMode",2);Si([D()],pt.prototype,"zoomState",2);Si([D()],pt.prototype,"currentDetailLevel",2);Si([_n("#pricing-canvas")],pt.prototype,"canvas",2);pt=Si([A("oig-pricing-chart")],pt);const Ci="—";function bi(e){return e==null||!Number.isFinite(e)?Ci:`${e.toFixed(1)} °C`}function Ns(e){return e==null||!Number.isFinite(e)?Ci:`${e.toFixed(2)} kWh`}function Ah(e){return e==null||!Number.isFinite(e)?Ci:`${e.toFixed(2)} Kč`}function Fh(e){return e==null||!Number.isFinite(e)?Ci:`${Math.round(e*100)} %`}function Ih(e,t){const i=r=>{const n=new Date(r);return Number.isNaN(n.getTime())?r:`${String(n.getHours()).padStart(2,"0")}:${String(n.getMinutes()).padStart(2,"0")}`};return`${i(e)} – ${i(t)}`}function Bh(e){return e==null||!Number.isFinite(e)?Ci:e<60?`${Math.round(e)} s`:e<3600?`${Math.round(e/60)} min`:`${Math.round(e/3600)} h`}function Nh(e){if(e==null||!Number.isFinite(e)||e<0)return Ci;const t=Math.floor(e/60),i=Math.round(e%60);return t===0?`${i} min`:i===0?`${t} h`:`${t} h ${i} min`}function jh(e){const t=e.topTempC;if(t==null||!Number.isFinite(t))return null;if(e.targetTempC<=t)return 0;const i=e.targetTempC-t;return e.temperatureTrendCPerMin!=null&&Number.isFinite(e.temperatureTrendCPerMin)&&e.temperatureTrendCPerMin>0?i/e.temperatureTrendCPerMin:e.heaterPowerKw!==null&&Number.isFinite(e.heaterPowerKw)&&e.volumeL!=null&&Number.isFinite(e.volumeL)?e.heaterPowerKw===0?null:e.volumeL*.001163*i/e.heaterPowerKw*60:null}var Rh=Object.defineProperty,Hh=Object.getOwnPropertyDescriptor,H=(e,t,i,r)=>{for(var n=r>1?void 0:r?Hh(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&Rh(t,i,n),n};const B=Q,yt=E`
...
`,nt=E`
  ...
  margin: 0 0 12px 0;
`;function Wh(e){return Math.max(0,Math.min(100,e))}function Mo(e){const r=Math.max(0,Math.min(1,(e-10)/60)),n={r:33,g:150,b:243},a={r:255,g:87,b:34},o=(s,d)=>Math.round(s+(d-s)*r);return`rgb(${o(n.r,a.r)}, ${o(n.g,a.g)}, ${o(n.b,a.b)})`}let rr=class extends L{constructor(){super(...arguments),this.collapsed=!0,this.busy=!1}toggle(){this.collapsed=!this.collapsed}async doAction(e,t){this.busy=!0;try{const i=await e();this.dispatchEvent(new CustomEvent("action-done",{detail:{success:i,label:t},bubbles:!0,composed:!0}))}finally{this.busy=!1}}render(){return c`
      <div class="panel">
        ...
        <div class="panel-content ${this.collapsed?"":"open"}">
          ...
          <div class="button-group">
            <button class="action-btn" ?disabled=${this.busy}
              @click=${()=>this.doAction(Ec,"plan")}>
              Preplanovat (debug)
            </button>
            <button class="action-btn" ?disabled=${this.busy}
              @click=${()=>this.doAction(Oc,"apply")}>
              Aplikovat rucne
            </button>
            <button class="action-btn" ?disabled=${this.busy}
              @click=${()=>this.doAction(Lc,"cancel")}>
              Zrusit plan
            </button>
          </div>
        </div>
    ...
    .action-btn:hover { background: ${B(l.divider)}; }
    .action-btn:disabled { opacity: 0.5; cursor: not-allowed; }
  `;H([D()],rr.prototype,"collapsed",2);H([D()],rr.prototype,"busy",2);rr=H([A("oig-boiler-debug-panel")],rr);let on=class extends L{constructor(){super(...arguments),this.data=null}render(){const e=this.data;if(!e)return c`<div>Nacitani stavu...</div>`;const t=(i,r,n=1)=>i!=null?`${i.toFixed(n)} ${r}`:`-- ${r}`;return c`
      <h3>Stav bojleru</h3>
      <div class="grid">
        <div class="card">
  ...
  `;H([g({type:Object})],on.prototype,"data",2);on=H([A("oig-boiler-status-grid")],on);let sn=class extends L{constructor(){super(...arguments),this.data=null}render(){const e=this.data;if(!e)return w;const t=i=>`${i.toFixed(2)} kWh`;return c`
  ...
  `;H([g({type:Object})],sn.prototype,"data",2);sn=H([A("oig-boiler-energy-breakdown")],sn);let ln=class extends L{constructor(){super(...arguments),this.data=null}render(){const e=this.data;if(!e)return w;const t=e.peakHours.length?e.peakHours.map(n=>`${n}h`).join(", "):"--",i=e.waterLiters40c!==null?`${e.waterLiters40c.toFixed(0)} L`:"-- L",r=e.circulationNow.startsWith("ANO");return c`
    ...
    .value.idle { color: ${B(l.textSecondary)}; }
  `;H([g({type:Object})],ln.prototype,"data",2);ln=H([A("oig-boiler-predicted-usage")],ln);let nr=class extends L{constructor(){super(...arguments),this.plan=null,this.forecastWindows={fve:"--",grid:"--"}}render(){var r;const e=this.plan,t=this.forecastWindows,i=n=>n??"--";return c`
    ...
    .row-label { color: ${B(l.textSecondary)}; }
    .row-value {
      font-weight: 500;
      color: ${B(l.textPrimary)};
      text-align: right;
  ...
  `;H([g({type:Object})],nr.prototype,"plan",2);H([g({type:Object})],nr.prototype,"forecastWindows",2);nr=H([A("oig-boiler-plan-info")],nr);let ar=class extends L{constructor(){super(...arguments),this.boilerState=null,this.targetTemp=60}render(){const e=this.boilerState;if(!e)return c`<div>Nacitani...</div>`;const t=10,i=70,r=y=>Wh((y-t)/(i-t)*100),n=e.heatingPercent??0,a=e.tempTop!==null?r(e.tempTop):null,o=e.tempBottom!==null?r(e.tempBottom):null,s=r(this.targetTemp),d=Mo(e.tempTop??this.targetTemp),p=Mo(e.tempBottom??10),u=`linear-gradient(180deg, ${d} 0%, ${p} 100%)`,h=e.heatingPercent!==null?`${e.heatingPercent.toFixed(0)}% nahrato`:"-- % nahrato";return c`
    ...
    .target-line {
      ...
      border-top: 2px dashed ${B(l.accent)};
      z-index: 3;
    }
  ...
  `;H([g({type:Object})],ar.prototype,"boilerState",2);H([g({type:Number})],ar.prototype,"targetTemp",2);ar=H([A("oig-boiler-tank")],ar);let or=class extends L{constructor(){super(...arguments),this.current="",this.available=[]}onChange(e){const t=e.target.value;this.dispatchEvent(new CustomEvent("category-change",{detail:{category:t},bubbles:!0,composed:!0}))}render(){const e=this.available.length?this.available:Object.keys(pa);return c`
      <div class="row">
        <label>Profil:</label>
  ...
  `;H([g({type:String})],or.prototype,"current",2);H([g({type:Array})],or.prototype,"available",2);or=H([A("oig-boiler-category-select")],or);let cn=class extends L{constructor(){super(...arguments),this.data=[]}render(){if(!this.data.length)return w;const e=this.data.flatMap(o=>o.hours),t=Math.max(...e,.1),i=t*.3,r=t*.7,n=Array.from({length:24},(o,s)=>s),a=o=>o===0?"none":o<i?"low":o<r?"medium":"high";return c`
    ...
    .cell.none   { background: ${B(l.bgSecondary)}; }
  ...
  `;H([g({type:Array})],cn.prototype,"data",2);cn=H([A("oig-boiler-heatmap-grid")],cn);let dn=class extends L{constructor(){super(...arguments),this.plan=null}render(){const e=this.plan,t=(i,r=2)=>i!=null?i.toFixed(r):"-";return c`
      <div class="grid">
        <div class="card">
    ...
    .total { color: ${B(l.textPrimary)}; }
    .fve { color: #4CAF50; }
    .grid-c { color: #FF9800; }
    .cost { color: #2196F3; }
  `;H([g({type:Object})],dn.prototype,"plan",2);dn=H([A("oig-boiler-stats-cards")],dn);let pn=class extends L{constructor(){super(...arguments),this.data=null}render(){const e=this.data;if(!e)return w;const t=Math.max(...e.hourlyAvg,.01),i=new Set(e.peakHours),r=e.peakHours.length?e.peakHours.map(a=>`${a}h`).join(", "):"--",n=e.confidence!==null?`${Math.round(e.confidence*100)} %`:"-- %";return c`
    ...
    .stat-label { color: ${B(l.textSecondary)}; }
    .stat-value { font-weight: 600; color: ${B(l.textPrimary)}; }
  `;H([g({type:Object})],pn.prototype,"data",2);pn=H([A("oig-boiler-profiling")],pn);let un=class extends L{constructor(){super(...arguments),this.config=null}render(){const e=this.config;if(!e)return w;const t=(i,r="")=>i!=null?`${i}${r?" "+r:""}`:`--${r?" "+r:""}`;return c`
  ...
  `;H([g({type:Object})],un.prototype,"config",2);un=H([A("oig-boiler-config-section")],un);function zo(e,t){const i=e*t,r=Math.floor(i/60)%24,n=i%60;return`${String(r).padStart(2,"0")}:${String(n).padStart(2,"0")}`}function Vh(e){switch(e){case"morning":return"🌅";case"afternoon":return"☀️";case"evening":return"🌆";case"night":return"🌙";default:return"💧"}}let sr=class extends L{constructor(){super(...arguments),this.data=null,this.lang="cs"}render(){const e=this.lang,t=x("boiler.demand_map.heading",e);if(!this.data)return c`
        <div class="card" data-testid="boiler-demand-map">
          <div class="heading">💧 ${t}</div>
          <div class="empty-state">${x("boiler.demand_map.empty",e)}</div>
        </div>
      `;const i=this.data,r=i.slotDurationMin||15,n=48,a=Math.ceil(i.slotsP80.length/n),o=[];for(let h=0;h<n;h++){let b=0,y=0;for(let m=0;m<a;m++){const f=h*a+m;b+=i.slotsP80[f]??0,y+=i.slotsP50[f]??0}o.push(b)}const s=Math.max(...o,.001),d=h=>{const b=Math.min(1,h/s);if(b<.08)return"rgba(255,255,255,.05)";const y=Math.round(120+135*b),m=Math.round(60+50*(1-b));return`rgba(${y}, ${m}, 60, ${(.12+.85*b).toFixed(2)})`},p=x("boiler.demand_map.meta",e).replace("{n}",String(i.profile.daysUsed)).replace("{cat}",pa[i.profile.category]||i.profile.label),u=`${x("boiler.demand_map.confidence",e)} ${Math.round(i.confidence*100)} %`;return c`
      <div class="card" data-testid="boiler-demand-map">
        <div class="heading">
          💧 ${t}
        ...
        <div class="heatmap-wrap">
          <div class="heatmap">
            ${o.map((h,b)=>{const y=zo(b*a,r),m=h.toFixed(2);return c`
                <div class="heatmap-col" title="${y}: ${m} kWh">
        ...
        ${i.windows.length>0?c`
          <div class="chips">
            ${i.windows.slice(0,3).map(h=>{const b=zo(h.slotIndex,r),y=Vh(h.label),m=Math.round(h.liters),f=h.p80Kwh.toFixed(1);return c`
                <span class="chip">
                  ${y}
  ...
  `;H([g({attribute:!1})],sr.prototype,"data",2);H([g({type:String})],sr.prototype,"lang",2);sr=H([A("oig-boiler-demand-map")],sr);let hn=class extends L{constructor(){super(...arguments),this.state=null}render(){return this.state?c`
  ...
  `;H([g({type:Object})],hn.prototype,"state",2);hn=H([A("oig-boiler-state")],hn);let gn=class extends L{constructor(){super(...arguments),this.data=[]}render(){return w}};gn.styles=E`
    :host { display: block; }
  `;H([g({type:Array})],gn.prototype,"data",2);gn=H([A("oig-boiler-heatmap")],gn);let lr=class extends L{constructor(){super(...arguments),this.profiles=[],this.editMode=!1}render(){return w}};lr.styles=E`
    :host { display: block; }
  `;H([g({type:Array})],lr.prototype,"profiles",2);H([g({type:Boolean})],lr.prototype,"editMode",2);lr=H([A("oig-boiler-profiles")],lr);let cr=class extends L{constructor(){super(...arguments),this.data=null,this.lang="cs"}render(){const e=this.data,t=this.lang,i=(e==null?void 0:e.currentState)??"unknown",r=x(`boiler.status.${i}`,t),n=(e==null?void 0:e.comfortSatisfied)===!0?x("boiler.status.comfort_satisfied",t):(e==null?void 0:e.comfortSatisfied)===!1?x("boiler.status.comfort_unsatisfied",t):x("boiler.status.comfort_unknown",t),a=(e==null?void 0:e.comfortSatisfied)===!0?"ok":(e==null?void 0:e.comfortSatisfied)===!1?"bad":"unknown",o=(e==null?void 0:e.degradedFlags)??[];return c`
      <div data-testid="boiler-status-panel" class="panel">
        ...
        <div class="grid">
          ...
          <div class="field"><label>${x("boiler.status.energy_needed",t)}</label><span>${Ns((e==null?void 0:e.energyNeededKwh)??null)}</span></div>
  ...
  `;H([g({attribute:!1})],cr.prototype,"data",2);H([g({type:String})],cr.prototype,"lang",2);cr=H([A("oig-boiler-status-panel")],cr);let dr=class extends L{constructor(){super(...arguments),this.slots=[],this.lang="cs"}srcClass(e){return e&&["fve","grid","alternative","overflow","discharge"].includes(e)?e:"other"}render(){const e=this.lang;return!this.slots||this.slots.length===0?c`<div data-testid="boiler-plan-timeline" class="wrap"><div class="heading">${x("boiler.timeline.heading",e)}</div><div class="empty">${x("boiler.timeline.empty",e)}</div></div>`:c`
          ...
          <tbody>
            ${this.slots.map(t=>{const i=t.comfortSatisfied===!0?c`<span class="badge ok">${x("boiler.timeline.comfort_ok",e)}</span>`:t.comfortSatisfied===!1?c`<span class="badge bad">${x("boiler.timeline.comfort_gap",e)}</span>`:"";return c`
                <tr>
                  ...
                  <td>${Ns(t.consumptionKwh)}</td>
                  <td>${Ah(t.estimatedCostCzk??null)}</td>
                  <td>${Fh(t.pvShare??null)}</td>
                </tr>
              `})}
          </tbody>
        </table>
  ...
  `;H([g({attribute:!1})],dr.prototype,"slots",2);H([g({type:String})],dr.prototype,"lang",2);dr=H([A("oig-boiler-plan-timeline")],dr);const Do=new Set(["input_stale_price","input_stale_pv","input_stale_temperature","input_missing_recorder","input_adapter_error"]);let pr=class extends L{constructor(){super(...arguments),this.explanation=null,this.lang="cs"}render(){const e=this.explanation,t=this.lang;if(!e)return c`<div data-testid="boiler-source-explanation" class="wrap"><div class="heading">${x("boiler.explanation.heading",t)}</div><div class="empty">${x("boiler.explanation.empty",t)}</div></div>`;const i=e.reasonCodes??[],r=i.filter(o=>Do.has(o)),n=i.filter(o=>!Do.has(o)),a=e.degradedReasons??[];return c`
      <div data-testid="boiler-source-explanation" class="wrap">
        ...
        <div class="meta-grid" data-testid="boiler-explanation-meta">
          ...
          ${e.dataAgeSecs!=null?c`<div class="meta"><label>${x("boiler.explanation.data_age",t)}</label><span>${Bh(e.dataAgeSecs)}</span></div>`:""}
  ...
  `;H([g({attribute:!1})],pr.prototype,"explanation",2);H([g({type:String})],pr.prototype,"lang",2);pr=H([A("oig-boiler-source-explanation")],pr);let fi=class extends L{constructor(){super(...arguments),this.identity={entryId:null,boxId:null,available:!1},this.currentOverride=null,this.lang="cs"}render(){var a,o;const e=this.lang,t=this.identity.available,i=((a=this.currentOverride)==null?void 0:a.capabilityAvailable)??!1,r=t&&i,n=((o=this.currentOverride)==null?void 0:o.active)===!0;return c`
  ...
  `;H([g({attribute:!1})],fi.prototype,"identity",2);H([g({attribute:!1})],fi.prototype,"currentOverride",2);H([g({type:String})],fi.prototype,"lang",2);fi=H([A("oig-boiler-override-panel")],fi);let mi=class extends L{constructor(){super(...arguments),this.reason="unavailable",this.message="",this.lang="cs"}render(){const e=this.lang,t=this.reason==="loading"?"⏳":this.reason==="error"?"⚠️":this.reason==="degraded"?"🟠":"ℹ️";return c`
  ...
  `;H([g({type:String})],mi.prototype,"reason",2);H([g({type:String})],mi.prototype,"message",2);H([g({type:String})],mi.prototype,"lang",2);mi=H([A("oig-boiler-unavailable-state")],mi);var Kh=Object.defineProperty,qh=Object.getOwnPropertyDescriptor,_r=(e,t,i,r)=>{for(var n=r>1?void 0:r?qh(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&Kh(t,i,n),n};const Gh=Q;function bn(e,t){const i={gas:{cs:"🔥 Plyn",en:"🔥 Gas"},heat_pump:{cs:"🔥 Tepelné čerpadlo",en:"🔥 Heat pump"},fireplace:{cs:"🔥 Krb",en:"🔥 Fireplace"},other:{cs:"🔥 Alternativní zdroj",en:"🔥 Alternative source"}};return e&&i[e]?i[e][t]:t==="en"?"🔥 Alternative source":"🔥 Alternativní zdroj"}function Uh(e,t,i){const r=[];return r.push({key:"fve",label:x("boiler.energy_today.source_fve",t),kwh:e.fveKwh,color:"#ffa726",costLabel:e.fveKwh>0?"≈ 0 Kč":null}),r.push({key:"grid",label:x("boiler.energy_today.source_grid",t),kwh:e.gridKwh,color:"#2196f3",costLabel:null}),e.batteryKwh>.05&&r.push({key:"battery",label:x("boiler.energy_today.source_battery",t),kwh:e.batteryKwh,color:"#7e57c2",costLabel:null}),e.altKwh>0&&r.push({key:"alt",label:bn(i,t),kwh:e.altKwh,color:"#e64a19",costLabel:null}),r}function Yh(e,t){if(!e)return null;const{estimatedCostCzk:i,costIfAllGrid:r}=e;if(i==null||r==null||r<=0)return null;const n=r-i;return n<0?null:`${x("boiler.energy_today.benchmark_savings",t)} ${n.toFixed(1)} Kč`}function Zh(e){return`${e.toFixed(1).replace(".",",")} kWh`}let Nt=class extends L{constructor(){super(...arguments),this.energy=null,this.planSummary=null,this.lang="cs",this.altType=null}render(){const e=this.lang,t=x("boiler.energy_today.heading",e),i=x("boiler.energy_today.meta",e),r=this.energy,n=this.planSummary,a=r?Uh(r,e,this.altType):[],o=(r==null?void 0:r.totalKwh)??0,s=o<.1,d=s?[]:a.filter(b=>b.kwh>0).map(b=>({pct:b.kwh/o*100,color:b.color,key:b.key})),p=(n==null?void 0:n.costIfAllGrid)??null,u=p!=null&&p>0?p:null,h=Yh(n,e);return c`
      <div class="card">
  ...
  `;_r([g({type:Object})],Nt.prototype,"energy",2);_r([g({type:Object})],Nt.prototype,"planSummary",2);_r([g({type:String})],Nt.prototype,"lang",2);_r([g({type:String})],Nt.prototype,"altType",2);Nt=_r([A("oig-boiler-energy-today")],Nt);var Qh=Object.defineProperty,Xh=Object.getOwnPropertyDescriptor,vt=(e,t,i,r)=>{for(var n=r>1?void 0:r?Xh(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&Qh(t,i,n),n};const ei=Q,Jh=new Set(["fve","grid","battery","alternative"]);function eg(e){if(!e)return null;const t=e.toLowerCase();return t==="fve"||t==="overflow"||t==="pv"?"fve":t==="grid"?"grid":t==="battery"||t==="discharge"?"battery":t==="alternative"||t==="alt"?"alternative":null}function Tn(e){const t=new Date(e);return new Date(t.getFullYear(),t.getMonth(),t.getDate(),0,0,0,0).getTime()}function At(e,t){const i=Tn(t),r=new Date(e).getTime(),n=24*3600*1e3;return Math.max(0,Math.min(1,(r-i)/n))}function tg(e,t){const i=[];let r=null;for(const n of e){const a=n.heatingKwh??0;if(a<=0){r&&(i.push(r),r=null);continue}const o=eg(n.recommendedSource);if(!o||!Jh.has(o)){r&&(i.push(r),r=null);continue}const s=n.purpose==="legionella";r&&r.source===o?(r.xEnd=At(n.end,t),r.endIso=n.end,r.heatingKwh+=a,s&&(r.hasLegionella=!0)):(r&&i.push(r),r={xStart:At(n.start,t),xEnd:At(n.end,t),source:o,hasLegionella:s,heatingKwh:a,startIso:n.start,endIso:n.end})}return r&&i.push(r),i}function ig(e,t){const i=Date.now(),r=Tn(e),n=24*3600*1e3,a=(i-r)/n;return a<0||a>1?null:a}function rg(e,t){if(!t||!t.includes(":"))return null;const[i,r]=t.split(":").map(Number);if(!Number.isFinite(i)||!Number.isFinite(r))return null;const n=Tn(e),a=new Date(n);a.setHours(i,r,0,0);let o=a.getTime();const s=24*3600*1e3,d=(o-n)/s;return d<0||d>1.0001?null:Math.min(1,d)}const ta={fve:{gradStart:"#ffd54f",gradEnd:"#ffa726",legendColor:"#ffa726",textColor:"#101a10"},grid:{gradStart:"#4fc3f7",gradEnd:"#2196f3",legendColor:"#2196f3",textColor:"#062033"},battery:{gradStart:"#b39ddb",gradEnd:"#7e57c2",legendColor:"#7e57c2",textColor:"#1c1430"},alternative:{gradStart:"#ff8a65",gradEnd:"#e64a19",legendColor:"#e64a19",textColor:"#2b0d05"}};let Ze=class extends L{constructor(){super(...arguments),this.slots=[],this.demandMap=null,this.circulationRuns=[],this.legionella=null,this.planSummary=null,this.lang="cs",this.altSourceType=null}render(){var m;const e=this.lang;if(!this.slots||this.slots.length===0)return c`
      ...
      `;const t=this.slots[0].start,i=tg(this.slots,t),r=this._buildDrawItems(t),n=this._buildTempCurve(t),a=ig(t),o=((m=this.planSummary)==null?void 0:m.deadlineTime)??null,s=o?o.slice(0,5):null,d=s?rg(t,o):null,p=this._legionellaStandaloneMarker(t,i),u=new Set(i.map(f=>f.source)),h=r.length>0,b=this.circulationRuns.length>0,y=n.length>1;return c`
      <div class="card" data-testid="boiler-plan-strip">
        <div class="heading">
          🗓️ ${x("boiler.plan_strip.heading",e)}
          <span class="meta">${x("boiler.plan_strip.meta",e)}</span>
        ...
        <div class="leg" data-testid="plan-strip-legend">
          ${["fve","grid","battery","alternative"].filter(f=>u.has(f)).map(f=>c`
            <span>
              <i class="dot" style="background:${ta[f].legendColor}"></i>
    ...
    `}_renderCircTick(e,t,i){const r=At(e.start,t);if(r<0||r>1)return w;const n=(r*100).toFixed(2),o=(At(e.end,t)*100).toFixed(2),s=`${x("boiler.plan_strip.circ_tooltip",i)} ${Eo(e.start)}–${Eo(e.end)}`;return c`
      <div class="circ"
        style="left:${n}%"
        title="${s}"
  ...
  `;vt([g({attribute:!1})],Ze.prototype,"slots",2);vt([g({attribute:!1})],Ze.prototype,"demandMap",2);vt([g({attribute:!1})],Ze.prototype,"circulationRuns",2);vt([g({attribute:!1})],Ze.prototype,"legionella",2);vt([g({attribute:!1})],Ze.prototype,"planSummary",2);vt([g({type:String})],Ze.prototype,"lang",2);vt([g({type:String})],Ze.prototype,"altSourceType",2);Ze=vt([A("oig-boiler-plan-strip")],Ze);function Eo(e){const t=new Date(e);return isNaN(t.getTime())?e:`${String(t.getHours()).padStart(2,"0")}:${String(t.getMinutes()).padStart(2,"0")}`}var ng=Object.defineProperty,ag=Object.getOwnPropertyDescriptor,De=(e,t,i,r)=>{for(var n=r>1?void 0:r?ag(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&ng(t,i,n),n};function Oo(e){if(e==null||!isFinite(e))return"#37474f";const t=[[10,[21,101,192]],[25,[38,198,218]],[40,[255,183,77]],[55,[255,112,67]],[70,[230,74,25]]];if(e<=t[0][0])return Gr(t[0][1]);if(e>=t[t.length-1][0])return Gr(t[t.length-1][1]);for(let i=1;i<t.length;i++)if(e<=t[i][0]){const[r,n]=t[i-1],[a,o]=t[i],s=(e-r)/(a-r);return Gr([Math.round(n[0]+(o[0]-n[0])*s),Math.round(n[1]+(o[1]-n[1])*s),Math.round(n[2]+(o[2]-n[2])*s)])}return Gr(t[t.length-1][1])}function Gr(e){return`rgb(${e[0]},${e[1]},${e[2]})`}function og(e){return e==null||!isFinite(e)||e<=.005||e>=.995?null:(1-e)*100}function sg(e,t,i,r,n){const a=[x("boiler.aria.svg_summary",n)];a.push(`${x("boiler.status.temp_top",n)}: ${bi(e)}`),a.push(`${x("boiler.status.temp_bottom",n)}: ${bi(t)}`);const o=i?di(i,n):x("boiler.aria.source_unknown",n);return a.push(o),r&&a.push(x("boiler.aria.stale",n)),a.join(". ")}let Pe=class extends L{constructor(){super(...arguments),this.fillLevelPct=null,this.sourceSegments=[],this.energyMix=null,this.topTempC=null,this.bottomTempC=null,this.lowerZoneTempC=null,this.volumeL=null,this.readyLiters=null,this.etaText=null,this.sourceKey=null,this.stale=!1,this.chargingLabel=null,this.altCharging=!1,this.sourceEstimated=!1,this.lang="cs"}render(){try{return this._renderTank()}catch{return c`
        <div class="bwrap" data-testid="boiler-svg" role="img"
             aria-label="${x("boiler.aria.svg_summary",this.lang)}">
        </div>
      `}}_renderTank(){const e=sg(this.topTempC,this.bottomTempC,this.sourceKey,this.stale,this.lang),t=this.fillLevelPct??null,i=this.topTempC!=null?`${this.topTempC.toFixed(1)} °C`:"— °C",r=this.bottomTempC??this.lowerZoneTempC??null,n=r!=null?`dole ${r.toFixed(1)} °C`:null,a=this.readyLiters??(t!=null&&this.volumeL!=null?Math.round(t*this.volumeL):null),o=a??null,s=this._renderTrendChip(),d=this.chargingLabel!=null,p=Oo(this.topTempC),u=Oo(r??this.topTempC),h=`linear-gradient(180deg, ${p} 0%, ${u} 100%)`,b=og(t),y=this._renderSourceChipBelow();return c`
  ...
  `;De([g({type:Number})],Pe.prototype,"fillLevelPct",2);De([g({type:Array})],Pe.prototype,"sourceSegments",2);De([g({type:Object})],Pe.prototype,"energyMix",2);De([g({type:Number})],Pe.prototype,"topTempC",2);De([g({type:Number})],Pe.prototype,"bottomTempC",2);De([g({type:Number})],Pe.prototype,"lowerZoneTempC",2);De([g({type:Number})],Pe.prototype,"volumeL",2);De([g({type:Number})],Pe.prototype,"readyLiters",2);De([g({type:String})],Pe.prototype,"etaText",2);De([g({type:String})],Pe.prototype,"sourceKey",2);De([g({type:Boolean})],Pe.prototype,"stale",2);De([g({type:String})],Pe.prototype,"chargingLabel",2);De([g({type:Boolean})],Pe.prototype,"altCharging",2);De([g({type:Boolean})],Pe.prototype,"sourceEstimated",2);De([g({type:String})],Pe.prototype,"lang",2);Pe=De([A("oig-boiler-v2-svg")],Pe);var lg=Object.defineProperty,cg=Object.getOwnPropertyDescriptor,Pn=(e,t,i,r)=>{for(var n=r>1?void 0:r?cg(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&lg(t,i,n),n};const Lo=Q,ia=new Set(["temperature_unavailable","temperature_stale","activity_stale","source_invalid","runtime_cache_empty","config_profile_unavailable"]);function dg(e){var t,i,r,n;if((t=e.status)!=null&&t.degraded)return!0;for(const a of((i=e.status)==null?void 0:i.degradedFlags)??[])if(ia.has(a))return!0;for(const a of((r=e.activity)==null?void 0:r.staleFlags)??[])if(ia.has(a))return!0;for(const a of((n=e.explanation)==null?void 0:n.degradedReasons)??[])if(ia.has(a))return!0;return!1}function pg(e,t,i){var p,u,h;const r=e.activity;if(!r)return null;const n=t.targetTempC??0,a=jh({targetTempC:n,topTempC:((p=e.status)==null?void 0:p.temperatureTop)??null,temperatureTrendCPerMin:r.temperatureTrendCPerMin,volumeL:t.volumeL,heaterPowerKw:t.heaterPowerKw});if(a===null)return x("boiler.eta.unavailable",i);if(a===0)return x("boiler.eta.already_reached",i);const o=`na ${n.toFixed(0)} °C za ~${Nh(a)}`,s=((u=e.planSummary)==null?void 0:u.deadlineTime)??t.deadlineTime,d=((h=e.status)==null?void 0:h.comfortSatisfied)??null;if(s&&s!=="--:--"){const b=s.substring(0,5);return`${o} · ${i==="cs"?"komfort":"comfort"} ${b}${d===!0?" ✓":""}`}return o}let yi=class extends L{constructor(){super(...arguments),this.data=null,this.config=null,this.lang="cs"}render(){try{return this._renderShell()}catch{return c`
      ...
      `}}_renderShell(){var y,m;const e=this.data,t=e?dg(e):!1,i=(e==null?void 0:e.activity)??null,r=(e==null?void 0:e.status)??null,n=this.config,a=e&&n?pg(e,n,this.lang):null,s=((y=i==null?void 0:i.state)==null?void 0:y.startsWith("charging_"))??!1?(i==null?void 0:i.source)??null:null,d=(i==null?void 0:i.state)==="charging_alt",p=(()=>{var k;if(!((k=i==null?void 0:i.state)!=null&&k.startsWith("charging_")))return null;const f=d?"🔥 OHŘÍVÁ":"⚡ NABÍJÍ";if(i.temperatureTrendCPerMin!=null){const v=i.temperatureTrendCPerMin>=0?"+":"",_=i.temperatureTrendCPerMin.toLocaleString("cs-CZ",{minimumFractionDigits:1,maximumFractionDigits:1});return`${f} ${v}${_} °C/min`}return f})(),u=((m=e==null?void 0:e.status)==null?void 0:m.lowerZoneTempC)??null,h=(i==null?void 0:i.fillLevelPct)??null,b=h!=null&&(n==null?void 0:n.volumeL)!=null?Math.round(h*n.volumeL):null;return c`
      <div class="shell" data-testid="boiler-v2-shell">
        ${t?c`
              <div class="stale-warning" data-testid="boiler-stale-warning" role="alert">
                ${x("boiler.aria.stale",this.lang)}
  ...
  `;Pn([g({type:Object})],yi.prototype,"data",2);Pn([g({type:Object})],yi.prototype,"config",2);Pn([g({type:String})],yi.prototype,"lang",2);yi=Pn([A("oig-boiler-v2-shell")],yi);var ug=Object.defineProperty,hg=Object.getOwnPropertyDescriptor,Ti=(e,t,i,r)=>{for(var n=r>1?void 0:r?hg(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&ug(t,i,n),n};let ut=class extends L{constructor(){super(...arguments),this.values=[],this.color="#4CAF50",this.sparkWidth=100,this.sparkHeight=30,this.label=""}render(){try{return this._renderSparkline()}catch{return c`<svg
      ...
      ></svg>`}}_renderSparkline(){const e=Array.isArray(this.values)?this.values:[],t=e.filter(u=>typeof u=="number"&&isFinite(u));if(t.length<2)return c`<svg
        ...
        role="img"
        aria-label="${this.label}"
      ></svg>`;const i=Math.min(...t),n=Math.max(...t)-i||1,a=2,o=this.sparkHeight-a*2,s=this.sparkWidth,d=e.length,p=e.map((u,h)=>{if(typeof u!="number"||!isFinite(u))return null;const b=d>1?h/(d-1)*s:s/2,y=a+o-(u-i)/n*o;return`${b.toFixed(2)},${y.toFixed(2)}`}).filter(u=>u!==null).join(" ");return c`
      <svg
        width="${this.sparkWidth}"
        height="${this.sparkHeight}"
        viewBox="0 0 ${this.sparkWidth} ${this.sparkHeight}"
  ...
  `;Ti([g({type:Array})],ut.prototype,"values",2);Ti([g({type:String})],ut.prototype,"color",2);Ti([g({type:Number})],ut.prototype,"sparkWidth",2);Ti([g({type:Number})],ut.prototype,"sparkHeight",2);Ti([g({type:String})],ut.prototype,"label",2);ut=Ti([A("oig-boiler-sparkline")],ut);var gg=Object.defineProperty,bg=Object.getOwnPropertyDescriptor,$r=(e,t,i,r)=>{for(var n=r>1?void 0:r?bg(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&gg(t,i,n),n};const Ur=Q;function fg(e,t){switch(e){case"fve":case"overflow":return x("boiler.panel.source_overflow",t);case"grid":return x("boiler.panel.source_grid",t);case"battery":return x("boiler.panel.source_battery_short",t);case"alternative":return x("boiler.panel.source_alt",t);default:return e??"—"}}function mg(e){switch(e){case"morning":return"🌅";case"afternoon":return"☀️";case"evening":return"🌆";case"night":return"🌙";default:return"💧"}}function yg(e,t){const i=`boiler.demand_map.window.${e}`,r=x(i,t);return r!==i?r.toLowerCase():e}function vg(e){const t=e*15,i=Math.floor(t/60)%24,r=t%60;return`${String(i).padStart(2,"0")}:${String(r).padStart(2,"0")}`}function Ao(e){const t=new Date(e);return Number.isNaN(t.getTime())?"??:??":`${String(t.getHours()).padStart(2,"0")}:${String(t.getMinutes()).padStart(2,"0")}`}function xg(e,t){const i=Date.now();for(const r of e){const n=new Date(r.start).getTime();if(!Number.isFinite(n)||n<i-6e4)continue;const a=r.heatingKwh??null;if(a!==null&&a<=0)continue;const o=r.recommendedSource;if(!o)continue;const s=new Date(n),d=new Date,p=s.getDate()!==d.getDate()||s.getMonth()!==d.getMonth()||s.getFullYear()!==d.getFullYear(),u=fg(o,t),h=`${String(s.getHours()).padStart(2,"0")}:${String(s.getMinutes()).padStart(2,"0")}`;return{label:u,timeStr:h,isTomorrow:p}}return null}let jt=class extends L{constructor(){super(...arguments),this.data=null,this.config=null,this.lang="cs",this.panelType="source"}render(){try{return this.panelType==="source"?this._renderSourcePanel():this._renderComfortPanel()}catch{return c`
        <div class="panel">
          <div class="empty-panel">—</div>
        </div>
      `}}_renderSourcePanel(){var q;const e=this.data,t=this.lang,i=(e==null?void 0:e.energyToday)??null,r=(e==null?void 0:e.planSummary)??null,n=(e==null?void 0:e.activity)??null,a=(e==null?void 0:e.planSlots)??[],o=(r==null?void 0:r.estimatedCostCzk)??null,s=(i==null?void 0:i.totalKwh)??null,d=(i==null?void 0:i.fveKwh)??null,p=(i==null?void 0:i.gridKwh)??null,u=(i==null?void 0:i.altKwh)??null,h=u!=null&&u>0,b=(i==null?void 0:i.unattributedKwh)??null,y=b!=null&&b>.05,m=bn(e==null?void 0:e.altSourceType,t),f=(i==null?void 0:i.batteryKwh)??null,k=f!=null&&f>0,v=(r==null?void 0:r.costIfAllAlt)??null,_=v!=null&&v>0&&o!=null?v-o:null,T=_!=null&&_>=0?`${_.toFixed(1).replace(".",",")} Kč`:null,O=((q=n==null?void 0:n.state)==null?void 0:q.startsWith("charging_"))??!1?(n==null?void 0:n.source)??null:null,N=(n==null?void 0:n.sourceEstimated)===!0,$=(()=>{switch(O){case"fve":case"overflow":return x("boiler.panel.source_overflow",t);case"grid":return x("boiler.panel.source_grid_short",t);case"discharge":return x("boiler.panel.source_battery_short",t);case"alternative":return x("boiler.panel.source_alt",t);default:return"—"}})(),M=N&&O!=null?`${$} (${x("boiler.tank.source_estimated_suffix",t)})`:$,z=xg(a,t);return c`
    ...
    `}_renderComfortPanel(){var k,v,_,T,R;const e=this.data,t=this.lang,r=((k=e==null?void 0:e.status)==null?void 0:k.comfortSatisfied)??null,n=(e==null?void 0:e.demandMap)??null,a=((v=n==null?void 0:n.windows)==null?void 0:v.slice(0,3))??[],o=(e==null?void 0:e.planSummary)??null,s=(o==null?void 0:o.deadlineTime)??(((_=this.config)==null?void 0:_.deadlineTime)!=="--:--"?(T=this.config)==null?void 0:T.deadlineTime:null)??null,d=((R=this.config)==null?void 0:R.targetTempC)??null,p=(e==null?void 0:e.legionella)??null,u=(()=>{if(!p)return null;if(!p.enabled)return x("boiler.panel.legionella_off",t);if(p.scheduledStart){const $=p.scheduledStart,M=$.includes("T")?Ao($):$.substring(0,5);return`${x("boiler.panel.legionella_plan",t)} ${M}`}const O=p.daysSinceLast??null,N=p.intervalDays??null;if(O!==null&&N!==null){const $=N-O;return $<=0?x("boiler.panel.legionella_overdue",t):`${x("boiler.panel.legionella_in",t)} ${$} ${x("boiler.panel.legionella_days",t)}`}return x("boiler.panel.legionella_scheduled",t)})(),h=(e==null?void 0:e.activity)??null,b=(h==null?void 0:h.temperatureTrendCPerMin)??null,y=b!=null?`${b>=0?"+":""}${b.toFixed(1).replace(".",",")} °C/min`:null,m=(e==null?void 0:e.circulationRuns)??[],f=(()=>{if(!m.length)return null;const O=m[0];return`💧 ${Ao(O.start)} (${x("boiler.panel.circ_before_peak",t)})`})();return c`
      <div class="panel" data-testid="boiler-comfort-panel">
        ...
        ${a.map(O=>{const N=mg(O.label),$=yg(O.label,t),M=vg(O.slotIndex),z=Math.round(O.liters);return c`
  ...
  `;$r([g({type:Object})],jt.prototype,"data",2);$r([g({type:Object})],jt.prototype,"config",2);$r([g({type:String})],jt.prototype,"lang",2);$r([g({type:String})],jt.prototype,"panelType",2);jt=$r([A("oig-boiler-metric-panel")],jt);var wg=Object.defineProperty,_g=Object.getOwnPropertyDescriptor,Pi=(e,t,i,r)=>{for(var n=r>1?void 0:r?_g(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&wg(t,i,n),n};const ra=Q,Zi=1e3,ni=200,Fo=20,na=80,Mt=3,Je=100,Et=1440;function $g(e){return e??Date.now()}function kg(e,t){var a,o;const i=new Intl.DateTimeFormat("en-US",{timeZone:t,hour:"numeric",minute:"2-digit",hour12:!1}).formatToParts(new Date(e)),r=parseInt(((a=i.find(s=>s.type==="hour"))==null?void 0:a.value)??"0",10)%24,n=parseInt(((o=i.find(s=>s.type==="minute"))==null?void 0:o.value)??"0",10);return r*60+n}function Sg(e,t){const i=new Intl.DateTimeFormat("en-US",{timeZone:t,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1}).formatToParts(new Date(e)),r=v=>{var _;return((_=i.find(T=>T.type===v))==null?void 0:_.value)??"00"},n=r("year"),a=r("month"),o=r("day"),s=parseInt(r("hour"),10)%24,d=r("minute"),p=r("second"),u=String(s).padStart(2,"0"),h=Date.UTC(parseInt(n),parseInt(a)-1,parseInt(o),s,parseInt(d),parseInt(p)),b=Math.round((h-e)/6e4),y=b>=0?"+":"-",m=Math.abs(b),f=String(Math.floor(m/60)).padStart(2,"0"),k=String(m%60).padStart(2,"0");return`${n}-${a}-${o}T${u}:${d}:${p}${y}${f}:${k}`}function et(e){return e/Et*Zi}function ti(e){return String(parseFloat(e.toFixed(3)))}function aa(e){const t=Math.max(Fo,Math.min(na,e));return(na-t)/(na-Fo)*ni}function Cg(e,t){const i=kg(e,t);return e-i*6e4}function Tg(e){if(e.length<=1)return e;const t=[];let i={...e[0]};for(let r=1;r<e.length;r++){const n=e[r],a=i.recommendedSource===n.recommendedSource,o=(i.heatingKwh!=null?i.heatingKwh>0:!1)==(n.heatingKwh!=null?n.heatingKwh>0:!1),s=i.end===n.start;a&&o&&s?i={...i,end:n.end}:(t.push(i),i={...n})}return t.push(i),t}function Io(e,t,i){let r=null,n=-1/0;for(const a of t){const o=Date.parse(a.start);if(!isFinite(o))continue;const s=a.end!==null?Date.parse(a.end):i;isFinite(s)&&o<=e&&e<=s&&o>n&&(n=o,r=a)}return r}function Bo(e,t){const i=Date.parse(e.start),r=e.end!==null?Date.parse(e.end):t;if(!isFinite(i)||!isFinite(r))return null;const n=(r-i)/36e5;return n<=0||!isFinite(n)||!isFinite(e.energyKwh)||e.energyKwh<0?null:e.energyKwh/n}function Pg(e,t,i,r,n){const a=[x("boiler.aria.plan_timeline",n)];a.push(`NOW: ${e}`),t&&a.push(`${x("boiler.config.deadline",n)}: ${t}`),i!=null&&a.push(`${x("boiler.config.goal_temp",n)}: ${i}°C`);const o=[...new Set(r.filter(Boolean))];return o.length>0&&a.push(o.map(s=>di(s,n)).join(", ")),a.join(". ")}let ht=class extends L{constructor(){super(...arguments),this.data=null,this.config=null,this.lang="cs",this.nowMs=null,this.timeZone=null}render(){try{return this._renderTimeline()}catch{return c`
        <div class="timeline-section">
          <div class="empty-timeline" data-testid="boiler-timeline">${x("boiler.timeline.empty",this.lang)}</div>
        </div>
      `}}_resolveTimeZone(){if(this.timeZone)return this.timeZone;try{return Intl.DateTimeFormat().resolvedOptions().timeZone}catch{return"Europe/Prague"}}_renderTimeline(){var pe;const e=$g(this.nowMs??void 0),t=this._resolveTimeZone();let i;try{i=Cg(e,t)}catch{i=e-e%864e5}const r=(e-i)/6e4,n=et(r);let a="";try{a=Sg(e,t)}catch{a=new Date(e).toISOString()}const o=this.config,s=o!=null&&o.deadlineTime&&o.deadlineTime!=="--:--"?o.deadlineTime:null;let d=null;if(s)try{const[S,Z]=s.split(":"),ie=parseInt(S,10)*60+parseInt(Z,10);d=et(ie)}catch{d=null}const p=(o==null?void 0:o.targetTempC)!=null&&isFinite(o.targetTempC)?o.targetTempC:60,u=aa(p),h=this.data,b=Array.isArray(h==null?void 0:h.planSlots)?h.planSlots:[],y=Array.isArray(h==null?void 0:h.timeline)?h.timeline:[],m=Array.isArray(h==null?void 0:h.sourceSegments)?h.sourceSegments:[],f=b.length>0&&b.every(S=>(S.heatingKwh??0)===0&&(S.pvKwh??0)===0&&(S.gridKwh??0)===0&&(S.altKwh??0)===0),k=this._buildPlanBands(b,i),v=this._buildTempPointsFromSlots(b,i),_=this._buildTempPointsFromTimeline(y,i),T=v.length>0?v:_,R=this._buildPowerBarsFromSlots(b,i),O=this._buildPowerBars(y,m,i,e),N=k.map(S=>S.source);let $="";try{$=Pg(a,s,p,N,this.lang)}catch{$=x("boiler.aria.plan_timeline",this.lang)}const M=T.length>=2?T.map(S=>`${S.x.toFixed(2)},${S.y.toFixed(2)}`).join(" "):null,z=b.reduce((S,Z)=>S+(Z.gridKwh??0),0),q=b.reduce((S,Z)=>S+(Z.pvKwh??0)+(Z.altKwh??0),0),G=b.reduce((S,Z)=>S+(Z.estimatedCostCzk??0),0),V=z+q,K=((pe=h==null?void 0:h.status)==null?void 0:pe.degradedFlags)??[],Me=K.includes("price_degraded"),Ne=K.includes("forecast_degraded"),X=["00","03","06","09","12","15","18","21","24"];return c`
      <div class="timeline-section">
        ...
        `:c`
          <div class="chart-wrap">
            ...
            >
              ${I`<rect x="0" y="0" width="${Zi}" height="${ni}" fill="transparent" />`}

              ${k.map(S=>{const Z=S.source?hc[S.source]??"#9E9E9E":"#9E9E9E",ie=S.x2-S.x1;return I`<rect
                  class="plan-band"
                  data-source="${S.source??"unknown"}"
                  x="${S.x1.toFixed(2)}"
                  y="0"
                  width="${ie.toFixed(2)}"
                  height="${ni}"
              ...
              ${I`<line x1="0" y1="${Je}" x2="${Zi}" y2="${Je}" stroke="rgba(255,255,255,.08)" stroke-width="1"/>`}
              ...
              />`}
              ${I`<text x="4" y="${(u-3).toFixed(2)}" font-size="8" fill="#4ade80">CÍL ${p}°C</text>`}
              ...
              ${R.map(S=>{if(S.isCharge){const Z=Je-S.barH;return I`<rect class="charge-bar" data-testid="boiler-charge-bar-up"
                    x="${(S.x-2).toFixed(2)}" y="${Z.toFixed(2)}" width="4" height="${S.barH.toFixed(2)}"/>`}else return I`<rect class="draw-bar" data-testid="boiler-draw-bar-down"
                    x="${(S.x-2).toFixed(2)}" y="${Je}" width="4" height="${S.barH.toFixed(2)}"/>`})}

              ${O.map(S=>{if(S.isCharge){const Z=Je-S.barH;return I`<rect class="charge-bar" data-testid="boiler-charge-bar-up"
                    data-estimated-power="${S.isEstimated?"true":"false"}"
                    x="${(S.x-2).toFixed(2)}" y="${Z.toFixed(2)}" width="4" height="${S.barH.toFixed(2)}"/>`}else return I`<rect class="draw-bar" data-testid="boiler-draw-bar-down"
                    data-estimated-power="${S.isEstimated?"true":"false"}"
                    x="${(S.x-2).toFixed(2)}" y="${Je}" width="4" height="${S.barH.toFixed(2)}"/>`})}

              ${y.map(S=>{let Z;try{Z=Date.parse(S.timestamp)}catch{return""}if(!isFinite(Z))return"";const ie=(Z-i)/6e4;if(ie<0||ie>Et||S.powerKw!==null)return"";const Se=Io(Z,m,e),Ce=Se?Bo(Se,e):null;if(Ce!==null&&Ce>0)return"";const Oe=et(ie);return I`<rect
              ...
              ${M!=null?I`<polyline class="temp-line" points="${M}" />`:""}
              ...
              ${I`<line
                ...
                x2="${ti(n)}" y2="${ni}"
              />`}
              ${I`<text x="${(n+3).toFixed(2)}" y="12" font-size="8" fill="#60a5fa">TEĎ</text>`}
            </svg>
          </div>

          <div class="timeline-axis">
            ${X.map(S=>c`<span>${S}</span>`)}
          </div>
  ...
  `;Pi([g({type:Object})],ht.prototype,"data",2);Pi([g({type:Object})],ht.prototype,"config",2);Pi([g({type:String})],ht.prototype,"lang",2);Pi([g({type:Number})],ht.prototype,"nowMs",2);Pi([g({type:String})],ht.prototype,"timeZone",2);ht=Pi([A("oig-boiler-timeline-chart")],ht);var Mg=Object.defineProperty,zg=Object.getOwnPropertyDescriptor,ke=(e,t,i,r)=>{for(var n=r>1?void 0:r?zg(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&Mg(t,i,n),n};const zt=Q,Mn=E`
  .selector-label {
    font-size: 12px;
...
`;let vi=class extends L{constructor(){super(...arguments),this.value="home_1",this.disabled=!1,this.buttonStates={home_1:"idle",home_2:"idle",home_3:"idle",home_ups:"idle"}}onModeClick(e){const t=this.buttonStates[e];this.disabled||t==="active"||t==="pending"||t==="processing"||t==="disabled-by-service"||this.dispatchEvent(new CustomEvent("mode-change",{detail:{mode:e},bubbles:!0}))}render(){return c`
    ...
    `];ke([g({type:String})],gt.prototype,"value",2);ke([g({type:Number})],gt.prototype,"limit",2);ke([g({type:Boolean})],gt.prototype,"disabled",2);ke([g({type:String})],gt.prototype,"pendingTarget",2);ke([g({type:Object})],gt.prototype,"buttonStates",2);gt=ke([A("oig-grid-delivery-selector")],gt);let xi=class extends L{constructor(){super(...arguments),this.value="cbb",this.disabled=!1,this.buttonStates={cbb:"idle",manual:"idle"}}onModeClick(e){const t=this.buttonStates[e];this.disabled||t==="active"||t==="pending"||t==="processing"||t==="disabled-by-service"||this.dispatchEvent(new CustomEvent("boiler-mode-change",{detail:{mode:e},bubbles:!0}))}render(){return c`
      <div class="selector-label">
        Re\u017Eim bojleru
      </div>
      <div class="mode-buttons">
  ...
  `;Mi([g({type:Array})],ft.prototype,"items",2);Mi([g({type:Boolean})],ft.prototype,"expanded",2);Mi([g({type:String})],ft.prototype,"shieldStatus",2);Mi([g({type:Number})],ft.prototype,"queueCount",2);Mi([D()],ft.prototype,"_now",2);ft=Mi([A("oig-shield-queue")],ft);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Lg={CHILD:2},Ag=e=>(...t)=>({_$litDirective$:e,values:t});class Fg{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,i,r){this._$Ct=t,this._$AM=i,this._$Ci=r}_$AS(t,i){return this.update(t,i)}update(t,i){return this.render(...i)}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class xa extends Fg{constructor(t){if(super(t),this.it=w,t.type!==Lg.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===w||t==null)return this._t=void 0,this.it=t;if(t===ll)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const i=[t];return i.raw=i,this._t={_$litType$:this.constructor.resultType,strings:i,values:[]}}}xa.directiveName="unsafeHTML",xa.resultType=1;const Ig=Ag(xa);var Bg=Object.defineProperty,Ng=Object.getOwnPropertyDescriptor,kr=(e,t,i,r)=>{for(var n=r>1?void 0:r?Ng(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&Bg(t,i,n),n};const ze=Q;let Rt=class extends L{constructor(){super(...arguments),this.open=!1,this.config={title:"",message:""},this.acknowledged=!1,this.limitValue=5e3,this.resolver=null,this.onOverlayClick=()=>{this.closeDialog({confirmed:!1})},this.onDialogClick=e=>{e.stopPropagation()},this.onKeyDown=e=>{e.key==="Escape"&&this.open&&this.closeDialog({confirmed:!1})},this.onAckChange=e=>{this.acknowledged=e.target.checked},this.onLimitInput=e=>{this.limitValue=parseInt(e.target.value,10)||0},this.onCancel=()=>{this.closeDialog({confirmed:!1})},this.onConfirm=()=>{const e=this.config.showLimitInput||this.config.limitOnly;if(e){const t=this.config.limitMin??1,i=this.config.limitMax??2e4;if(isNaN(this.limitValue)||this.limitValue<t||this.limitValue>i)return}this.closeDialog({confirmed:!0,limit:e?this.limitValue:void 0})}}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.onKeyDown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("keydown",this.onKeyDown)}showDialog(e){return this.config=e,this.acknowledged=!1,this.limitValue=e.limitValue??5e3,this.open=!0,new Promise(t=>{this.resolver=t})}closeDialog(e){var t;this.open=!1,(t=this.resolver)==null||t.call(this,e),this.resolver=null}get canConfirm(){return!(this.config.requireAcknowledgement&&!this.acknowledged)}render(){if(!this.open)return w;const e=this.config;return e.limitOnly?c`
    ...
    `}renderHTML(e){return Ig(e)}};Rt.styles=E`
    :host {
      display: none;
    }
  ...
  `;kr([g({type:Boolean,reflect:!0})],Rt.prototype,"open",2);kr([g({type:Object})],Rt.prototype,"config",2);kr([D()],Rt.prototype,"acknowledged",2);kr([D()],Rt.prototype,"limitValue",2);Rt=kr([A("oig-confirm-dialog")],Rt);var jg=Object.defineProperty,Rg=Object.getOwnPropertyDescriptor,js=(e,t,i,r)=>{for(var n=r>1?void 0:r?Rg(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&jg(t,i,n),n};const qi=Q;let fn=class extends L{constructor(){super(...arguments),this.shieldState=null}render(){if(!this.shieldState)return w;const e=this.determineStatus(this.shieldState),t=e.toLowerCase(),i=this.getStatusIcon(e),r=this.getStatusLabel(e),a=this.shieldState.queueCount>0?"has-items":"";return c`
  ...
  `;zn([g({type:Boolean})],wi.prototype,"boxHasHome56",2);zn([D()],wi.prototype,"shieldState",2);zn([_n("oig-confirm-dialog")],wi.prototype,"_confirmDialogQuery",2);wi=zn([A("oig-control-panel")],wi);var Vg=Object.defineProperty,Kg=Object.getOwnPropertyDescriptor,zi=(e,t,i,r)=>{for(var n=r>1?void 0:r?Kg(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&Vg(t,i,n),n};const Le=Q;let mt=class extends L{constructor(){super(...arguments),this.open=!1,this.currentSoc=0,this.maxSoc=100,this.estimate=null,this.targetSoc=80}onClose(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0}))}onSliderInput(e){this.targetSoc=parseInt(e.target.value,10),this.dispatchEvent(new CustomEvent("soc-change",{detail:{targetSoc:this.targetSoc},bubbles:!0}))}onConfirm(){this.dispatchEvent(new CustomEvent("confirm",{detail:{targetSoc:this.targetSoc},bubbles:!0}))}render(){return c`
  ...
  `;zi([g({type:Boolean})],mt.prototype,"open",2);zi([g({type:Number})],mt.prototype,"currentSoc",2);zi([g({type:Number})],mt.prototype,"maxSoc",2);zi([g({type:Object})],mt.prototype,"estimate",2);zi([D()],mt.prototype,"targetSoc",2);mt=zi([A("oig-battery-charge-dialog")],mt);var qg=Object.defineProperty,Gg=Object.getOwnPropertyDescriptor,Ke=(e,t,i,r)=>{for(var n=r>1?void 0:r?Gg(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&qg(t,i,n),n};function li(e){return e==null||Number.isNaN(e)?"-- kWh":`${e.toFixed(Math.abs(e)>=10?1:2)} kWh`}const oa=Q,La=E`
  .metric {
    display: flex;
    justify-content: space-between;
    padding: 8px 0;
...
`;let ur=class extends L{constructor(){super(...arguments),this.title="",this.icon="📊"}render(){return c`
    ...
    ${La}
  `;Ke([g({type:String})],ur.prototype,"title",2);Ke([g({type:String})],ur.prototype,"icon",2);ur=Ke([A("oig-analytics-block")],ur);let mn=class extends L{constructor(){super(...arguments),this.data=null}render(){if(!this.data)return c`<div>Načítání...</div>`;const e=this.data.trend>=0?"positive":"negative",t=this.data.trend>=0?"+":"",i=this.data.period==="last_month"?"Minulý měsíc":`Aktuální měsíc (${this.data.currentMonthDays} dní)`;return c`
  ...
  `;Ke([g({type:Object})],mn.prototype,"data",2);mn=Ke([A("oig-battery-efficiency")],mn);let yn=class extends L{constructor(){super(...arguments),this.data=null}renderSparkline(){var d;const e=(d=this.data)==null?void 0:d.measurementHistory;if(!e||e.length<2)return null;const t=e.map(p=>p.soh_percent),i=Math.min(...t)-1,n=Math.max(...t)+1-i||1,a=200,o=40,s=t.map((p,u)=>{const h=u/(t.length-1)*a,b=o-(p-i)/n*o;return`${h},${b}`}).join(" ");return c`
      <div class="sparkline-container">
  ...
  `;Ke([g({type:Object})],vn.prototype,"data",2);vn=Ke([A("oig-battery-balancing")],vn);let xn=class extends L{constructor(){super(...arguments),this.data=null}render(){return this.data?c`
  ...
  `;Ke([g({type:Object})],xn.prototype,"data",2);xn=Ke([A("oig-cost-comparison")],xn);var Ug=Object.defineProperty,Yg=Object.getOwnPropertyDescriptor,Di=(e,t,i,r)=>{for(var n=r>1?void 0:r?Yg(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&Ug(t,i,n),n};const ai=Q;let hr=class extends L{constructor(){super(...arguments),this.data=Xi,this.compact=!1,this.onClick=()=>{this.dispatchEvent(new CustomEvent("badge-click",{bubbles:!0}))}}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this.onClick)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this.onClick)}render(){const e=this.data.effectiveSeverity,t=Jr[e]??Jr[0],i=this.data.warningsCount>0&&e>0,r=i?cs(this.data.eventType):"✓";return c`
      <style>
      ...
      `:null}
      <span class="badge-label">${i?ds[e]??"Výstraha":"OK"}</span>
    `}};hr.styles=E`
    :host {
      display: inline-flex;
      align-items: center;
  ...
  `;Di([g({type:Object})],hr.prototype,"data",2);Di([g({type:Boolean})],hr.prototype,"compact",2);hr=Di([A("oig-chmu-badge")],hr);let gr=class extends L{constructor(){super(...arguments),this.open=!1,this.data=Xi}onClose(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0}))}formatTime(e){return e?new Date(e).toLocaleString("cs-CZ"):"—"}renderWarning(e){const t=Jr[e.severity]??Jr[2],i=cs(e.event_type),r=ds[e.severity]??"Neznámá";return c`
  ...
  `;Qe([g({type:String})],He.prototype,"value",2);Qe([g({type:String})],He.prototype,"domain",2);Qe([g({type:Boolean})],He.prototype,"optional",2);Qe([g({attribute:!1})],He.prototype,"entities",2);Qe([g({type:Boolean})],He.prototype,"dirty",2);Qe([g({type:String})],He.prototype,"placeholder",2);Qe([D()],He.prototype,"open",2);Qe([D()],He.prototype,"query",2);Qe([D()],He.prototype,"highlightIndex",2);He=Qe([A("oig-entity-picker")],He);var tb=Object.defineProperty,ib=Object.getOwnPropertyDescriptor,Gt=(e,t,i,r)=>{for(var n=r>1?void 0:r?ib(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&tb(t,i,n),n};const ce=Q,rb=new Set(["boiler"]),nb=[{key:"enable_battery_prediction",label:"Predikce baterie a plánovač",type:"bool",hint:"Ekonomické plánování nabíjení, timeline, úspory"},{key:"enable_solar_forecast",label:"Solární předpověď",type:"bool",hint:"Předpověď výroby FVE (forecast.solar / Solcast)"},{key:"enable_pricing",label:"Ceny energie",type:"bool",hint:"Spotové ceny OTE, výkup, distribuce"},{key:"enable_boiler",label:"Bojler",type:"bool",hint:"Inteligentní ohřev vody"},{key:"enable_statistics",label:"Statistiky",type:"bool"},{key:"enable_extended_sensors",label:"Rozšířené senzory",type:"bool"},{key:"enable_chmu_warnings",label:"Výstrahy ČHMÚ",type:"bool"}],ab=[{key:"auto_mode_switch_enabled",label:"Automatické přepínání režimů",type:"bool",hint:"Plánovač sám přepíná Home 1 / Home UPS podle plánu"},{key:"charge_rate_kw",label:"Nabíjecí výkon ze sítě (kW)",type:"number",min:.5,max:10,step:.1,hint:"Kolik kW box bere při nabíjení ze sítě (UPS)"},{key:"expensive_percentile",label:"Práh drahých hodin (%)",type:"number",min:50,max:95,step:5,scale:100,hint:"Importy nad tímto denním percentilem cen se plánovač snaží pokrýt levným přednabitím. Výchozí 70 %."},{key:"balancing_enabled",label:"Balancování článků",type:"bool",hint:"Pravidelné nabití na 100 % kvůli vyrovnání článků"},{key:"balancing_interval_days",label:"Interval balancování (dny)",type:"number",min:3,max:30,step:1},{key:"balancing_hold_hours",label:"Držení 100 % (hodiny)",type:"number",min:1,max:12,step:1},{key:"cheap_window_percentile",label:"Levné okno pro balancování (%)",type:"number",min:5,max:80,step:5,hint:"Balancování se plánuje do hodin pod tímto cenovým percentilem"}],ob=[{key:"solar_forecast_provider",label:"Poskytovatel",type:"select",options:[["forecast_solar","forecast.solar"],["solcast","Solcast"]]},{key:"solcast_site_id",label:"Solcast site ID",type:"text",hint:"Jen pro Solcast (z rooftop site URL)"},{key:"solcast_api_key",label:"Solcast API klíč",type:"text",hint:"Nech prázdné = beze změny"},{key:"solar_forecast_latitude",label:"Zeměpisná šířka",type:"number",min:-90,max:90,step:1e-4},{key:"solar_forecast_longitude",label:"Zeměpisná délka",type:"number",min:-180,max:180,step:1e-4},{key:"solar_forecast_string1_enabled",label:"String 1 aktivní",type:"bool"},{key:"solar_forecast_string1_kwp",label:"String 1 výkon (kWp)",type:"number",min:.1,max:50,step:.1},{key:"solar_forecast_string1_declination",label:"String 1 sklon (°)",type:"number",min:0,max:90,step:1},{key:"solar_forecast_string1_azimuth",label:"String 1 azimut (°)",type:"number",min:-180,max:180,step:1,hint:"0 = jih, −90 = východ, 90 = západ"},{key:"solar_forecast_string2_enabled",label:"String 2 aktivní",type:"bool"},{key:"solar_forecast_string2_kwp",label:"String 2 výkon (kWp)",type:"number",min:.1,max:50,step:.1},{key:"solar_forecast_string2_declination",label:"String 2 sklon (°)",type:"number",min:0,max:90,step:1},{key:"solar_forecast_string2_azimuth",label:"String 2 azimut (°)",type:"number",min:-180,max:180,step:1}];function sb(e){return e==="gas"?"Plyn — cena tepla včetně účinnosti kotle (např. 1,5 Kč/kWh)":e==="heat_pump"?"Tepelné čerpadlo — cena ≈ cena elektřiny / COP":e==="fireplace"?"Krb — orientační cena tepla z dřeva/pelet":"Zadej orientační cenu tepla v Kč/kWh"}const $e=[{key:"boiler_volume_l",label:"Objem nádrže (l)",type:"number",min:30,max:1e3,step:1,hint:"Jmenovitý objem zásobníku v litrech"},{key:"boiler_temp_sensor_top",label:"Čidlo teploty — vrchní",type:"text",hint:"ID entity senzoru teploty (např. sensor.bojler_top)",entity:{domain:"sensor"}},{key:"boiler_temp_sensor_bottom",label:"Čidlo teploty — spodní",type:"text",hint:"Jen pokud máš druhý teploměr (ID entity senzoru)",optional:!0,entity:{domain:"sensor"}},{key:"boiler_enable_second_thermometer",label:"Druhý teploměr aktivní",type:"bool",hint:"Zapni, pokud máš spodní čidlo teploty"},{key:"boiler_current_power_entity",label:"Senzor příkonu bojleru",type:"text",hint:"ID entity senzoru výkonu (W); upřesňuje plánovač",optional:!0,entity:{domain:"sensor"}},{key:"boiler_target_temp_c",label:"Cílová teplota (°C)",type:"number",min:40,max:85,step:1,hint:"Požadovaná teplota vody před deadline"},{key:"boiler_deadline_time",label:"Deadline (HH:MM)",type:"text",hint:"Čas, do kdy musí být voda nahřátá (formát HH:MM, např. 07:00)"},{key:"boiler_has_alternative_heating",label:"Alternativní zdroj tepla",type:"bool",hint:"Bojler má jiný zdroj ohřevu (plyn, TČ, krb…)"},{key:"boiler_alt_source_type",label:"Typ alternativního zdroje",type:"select",options:[["gas","Plyn"],["heat_pump","Tepelné čerpadlo"],["fireplace","Krb"],["other","Jiný"]]},{key:"boiler_alt_cost_kwh",label:"Cena tepla (Kč/kWh)",type:"number",min:0,max:20,step:.1,hint:"Cena tepla z alternativního zdroje v Kč/kWh"},{key:"boiler_alt_energy_sensor",label:"Senzor energie alt. zdroje",type:"text",hint:"ID entity senzoru energie (kWh)",optional:!0,entity:{domain:"sensor"}},{key:"boiler_alt_energy_daily",label:"Denní přírůstek energie",type:"bool",hint:"Zapni, pokud senzor měří denní (ne celkový) přírůstek"},{key:"box_has_home56",label:"Box má Home 5/6",type:"bool",hint:"Aktivuje Home 5/6 (OIG CBB) — umožňuje 🔋→🔥 ohřev z baterie"},{key:"boiler_home5_maneuver_enabled",label:"🔋→🔥 Ohřev z baterie",type:"bool",hint:"Plánovač může použít baterii k ohřevu (vyžaduje Home 5/6)"},{key:"boiler_battery_cycle_cost_czk_kwh",label:"Cena cyklu baterie (Kč/kWh)",type:"number",min:0,max:5,step:.05,hint:"Degradace baterie za kWh; plánovač porovná s cenou sítě"},{key:"boiler_circulation_enabled",label:"Cirkulace teplé vody",type:"bool",hint:"Zapnutí cirkulačního čerpadla TUV"},{key:"boiler_circulation_lead_minutes",label:"Předstih cirkulace (min)",type:"number",min:0,max:120,step:5,hint:"Jak dlouho před odběrem pustit čerpadlo"},{key:"boiler_circulation_run_minutes",label:"Délka běhu cirkulace (min)",type:"number",min:1,max:60,step:1},{key:"boiler_circulation_max_runs_per_day",label:"Max. počet běhů/den",type:"number",min:1,max:20,step:1},{key:"boiler_circulation_min_gap_minutes",label:"Min. pauza mezi běhy (min)",type:"number",min:10,max:480,step:10},{key:"boiler_legionella_interval_days",label:"Interval ochrany (dny)",type:"number",min:0,max:30,step:1,hint:"0 = vypnuto; doporučeno 7–14 dní"},{key:"boiler_legionella_target_temp_c",label:"Teplota dezinfekce (°C)",type:"number",min:60,max:75,step:1,hint:"Min. 60 °C pro spolehlivé usmrcení legionelly"}];function lb(e){return e==="gas"?"plyn":e==="heat_pump"?"TČ":e==="fireplace"?"krb":e||"jiný"}function cb(e,t,i,r,n){const a=[];if(e){const o=lb(t),s=i!=null?` · ${Number(i).toFixed(1).replace(".",",")} Kč/kWh`:"";a.push(`${o}${s}`)}return r&&n&&a.push("🔋→🔥"),a.length===0?r?"Home 5/6":"pouze elektřina":a.join(" · ")}function db(e){return e?"zapnuto":"vypnuto"}function pb(e){return e<=0?"vypnuto":`1×/${e} dní`}let rt=class extends L{constructor(){super(...arguments),this.hassStates=null,this.config=null,this.loading=!0,this.pending={},this.saving=null,this.toast=null,this._entityCatalog=[],this._lastHassStates=null}connectedCallback(){super.connectedCallback(),this.refresh()}get entityCatalog(){return this.hassStates!==this._lastHassStates&&(this._lastHassStates=this.hassStates,this._entityCatalog=this.hassStates?eb(this.hassStates):[]),this._entityCatalog}async refresh(){this.loading=!0,this.config=await ba(),this.pending={},this.loading=!1}current(e,t){var n;const i=this.pending[e];if(i&&t in i)return i[t];const r=(n=this.config)==null?void 0:n[e];return r?r[t]:void 0}setPending(e,t,i){this.pending={...this.pending,[e]:{...this.pending[e]??{},[t]:i}}}isDirty(e){return Object.keys(this.pending[e]??{}).length>0}discardPending(e){this.pending={...this.pending,[e]:{}},this.toast=null}async save(e){const t=this.pending[e];if(!t||this.saving)return;this.saving=e,this.toast=null;const i=await Rc(e,t);if(this.saving=null,!i.ok){const r=i.fields?Object.entries(i.fields).map(([n,a])=>`${n}: ${a}`).join(", "):"uložení selhalo";this.toast={section:e,ok:!1,text:`✗ ${r}`};return}if(this.config&&(this.config={...this.config,[e]:{...this.config[e],...t}}),this.pending={...this.pending,[e]:{}},rb.has(e))this.toast={section:e,ok:!0,text:"✓ Uloženo — integrace se restartuje…"},jc(r=>{this.config=r,this.toast={section:e,ok:!0,text:"✓ Aplikováno"}},()=>{this.toast={section:e,ok:!0,text:"Integrace se restartuje déle než obvykle — obnov stránku"}});else{this.toast={section:e,ok:!0,text:"✓ Uloženo"},this.loading=!0;const r=await ba();r&&(this.config=r),this.loading=!1}}renderLabel(e){return c`
      ...
      <div class="grid">
        ${this.renderCard("modules","🧩 Moduly","Zapnutí modulu přidá senzory a záložky; konfigurace níže.",nb)}
        ${this.renderCard("battery","🔋 Baterie a plánovač","Parametry ekonomického plánovače a balancování.",ab)}
        ${this.renderCard("solar","☀️ Solární předpověď","Poskytovatel a geometrie stringů.",ob)}
  ...
  `;Gt([g({attribute:!1})],rt.prototype,"hassStates",2);Gt([D()],rt.prototype,"config",2);Gt([D()],rt.prototype,"loading",2);Gt([D()],rt.prototype,"pending",2);Gt([D()],rt.prototype,"saving",2);Gt([D()],rt.prototype,"toast",2);rt=Gt([A("oig-settings")],rt);var ub=Object.defineProperty,hb=Object.getOwnPropertyDescriptor,at=(e,t,i,r)=>{for(var n=r>1?void 0:r?hb(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&ub(t,i,n),n};const U=Q;function gb(e,t,i,r){const n=Math.abs(e);return n===1?t:n>=2&&n<=4?i:r}function Rs(e){return`${e} ${gb(e,"blok","bloky","bloků")}`}function Hs(e){return`${e} přepnutí`}let Ht=class extends L{constructor(){super(...arguments),this.open=!1,this.activeTab="today",this.data=null,this.autoRefresh=!0,this.refreshInterval=null}connectedCallback(){super.connectedCallback(),this.autoRefresh&&this.startAutoRefresh()}disconnectedCallback(){super.disconnectedCallback(),this.stopAutoRefresh()}startAutoRefresh(){this.refreshInterval=window.setInterval(()=>{this.open&&this.autoRefresh&&this.dispatchEvent(new CustomEvent("refresh",{bubbles:!0}))},6e4)}stopAutoRefresh(){this.refreshInterval!==null&&(clearInterval(this.refreshInterval),this.refreshInterval=null)}onClose(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0}))}onTabClick(e){this.activeTab=e,this.dispatchEvent(new CustomEvent("tab-change",{detail:{tab:e},bubbles:!0}))}toggleAutoRefresh(){this.autoRefresh=!this.autoRefresh,this.autoRefresh?this.startAutoRefresh():this.stopAutoRefresh()}fmtPct(e){return`${e.toFixed(0)}%`}adherenceColor(e){return e>=90?"#4caf50":e>=70?"#ff9800":"#f44336"}getModeConfig(e){return ps[e]??{icon:"❓",color:"#666",label:e}}renderModeBlock(e){const t=this.getModeConfig(e.modePlanned||e.modeHistorical),i=e.status==="current";return c`
      <div
    ...
    `}renderDayContent(){const e=this.data,t=e.summary;return c`
      ...
      ${e.modeBlocks.length>0?c`
        <div class="modes-section">
          <div class="section-title">Režimy (${Rs(e.modeBlocks.length)}, ${Hs(t.modeSwitches)})</div>
  ...
  `;at([g({type:Boolean,reflect:!0})],Ht.prototype,"open",2);at([g({type:String})],Ht.prototype,"activeTab",2);at([g({type:Object})],Ht.prototype,"data",2);at([D()],Ht.prototype,"autoRefresh",2);Ht=at([A("oig-timeline-dialog")],Ht);let _i=class extends L{constructor(){super(...arguments),this.data=null,this.activeTab="today",this.autoRefresh=!0,this.refreshInterval=null}connectedCallback(){super.connectedCallback(),this.autoRefresh&&this.startAutoRefresh()}disconnectedCallback(){super.disconnectedCallback(),this.stopAutoRefresh()}startAutoRefresh(){this.refreshInterval=window.setInterval(()=>{this.autoRefresh&&this.dispatchEvent(new CustomEvent("refresh",{bubbles:!0}))},6e4)}stopAutoRefresh(){this.refreshInterval!==null&&(clearInterval(this.refreshInterval),this.refreshInterval=null)}onTabClick(e){this.activeTab=e,this.dispatchEvent(new CustomEvent("tab-change",{detail:{tab:e},bubbles:!0}))}toggleAutoRefresh(){this.autoRefresh=!this.autoRefresh,this.autoRefresh?this.startAutoRefresh():this.stopAutoRefresh()}fmtPct(e){return`${e.toFixed(0)}%`}adherenceColor(e){return e>=90?"#4caf50":e>=70?"#ff9800":"#f44336"}getModeConfig(e){return ps[e]??{icon:"❓",color:"#666",label:e}}renderModeBlock(e){const t=this.getModeConfig(e.modePlanned||e.modeHistorical),i=e.status==="current";return c`
      <div
        class="mode-block ${i?"current":""}"
        style="background: ${t.color}; flex: ${Math.max(e.durationHours,.5)}"
        title="${e.startTime}–${e.endTime} | ${t.label}"
  ...
  `;at([g({type:Object})],_i.prototype,"data",2);at([g({type:String})],_i.prototype,"activeTab",2);at([D()],_i.prototype,"autoRefresh",2);_i=at([A("oig-timeline-tile")],_i);var bb=Object.defineProperty,fb=Object.getOwnPropertyDescriptor,xt=(e,t,i,r)=>{for(var n=r>1?void 0:r?fb(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&bb(t,i,n),n};const fe=Q;let $i=class extends L{constructor(){super(...arguments),this.data=null,this.editMode=!1,this.tileType="entity"}onTileClick(){var t;if(this.editMode)return;const e=(t=this.data)==null?void 0:t.config;e&&(e.type==="button"&&e.action?Xc(e.entity_id,e.action):ae.openEntityDialog(e.entity_id))}onSupportClick(e,t){e.stopPropagation(),!this.editMode&&ae.openEntityDialog(t)}onEdit(){var e;this.dispatchEvent(new CustomEvent("edit-tile",{detail:{entityId:(e=this.data)==null?void 0:e.config.entity_id},bubbles:!0,composed:!0}))}onDelete(){var e;this.dispatchEvent(new CustomEvent("delete-tile",{detail:{entityId:(e=this.data)==null?void 0:e.config.entity_id},bubbles:!0,composed:!0}))}render(){var d,p;if(!this.data)return null;const e=this.data.config,t=e.type==="button";this.tileType!==e.type&&(this.tileType=e.type??"entity");const i=e.color||"",r=e.icon||(t?"⚡":"📊"),n=r.startsWith("mdi:")?en(r):r,a=(d=e.support_entities)==null?void 0:d.top_right,o=(p=e.support_entities)==null?void 0:p.bottom_right,s=this.data.supportValues.topRight||this.data.supportValues.bottomRight;return c`
  ...
  `;xt([g({type:Object})],$i.prototype,"data",2);xt([g({type:Boolean})],$i.prototype,"editMode",2);xt([g({type:String,reflect:!0})],$i.prototype,"tileType",2);$i=xt([A("oig-tile")],$i);let ki=class extends L{constructor(){super(...arguments),this.tiles=[],this.editMode=!1,this.position="left"}render(){return this.tiles.length===0?c`<div class="empty-state">Žádné dlaždice</div>`:c`
      ${this.tiles.map(e=>c`
        <oig-tile
          .data=${e}
  ...
  `;Aa([g({type:Boolean,reflect:!0,attribute:"open"})],br.prototype,"isOpen",2);Aa([D()],br.prototype,"searchQuery",2);br=Aa([A("oig-icon-picker")],br);var vb=Object.defineProperty,xb=Object.getOwnPropertyDescriptor,_e=(e,t,i,r)=>{for(var n=r>1?void 0:r?xb(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(n=(r?o(t,i,n):o(n))||n);return r&&n&&vb(t,i,n),n};const W=Q;let be=class extends L{constructor(){super(...arguments),this.isOpen=!1,this.tileIndex=-1,this.tileSide="left",this.existingConfig=null,this.currentTab="entity",this.entitySearchText="",this.buttonSearchText="",this.selectedEntityId="",this.selectedButtonEntityId="",this.label="",this.icon="",this.color="#03A9F4",this.action="toggle",this.supportEntity1="",this.supportEntity2="",this.supportSearch1="",this.supportSearch2="",this.showSupportList1=!1,this.showSupportList2=!1,this.iconPickerOpen=!1}loadTileConfig(e){var t,i;this.currentTab=e.type,e.type==="entity"?this.selectedEntityId=e.entity_id:this.selectedButtonEntityId=e.entity_id,this.label=e.label||"",this.icon=e.icon||"",this.color=e.color||"#03A9F4",this.action=e.action||"toggle",this.supportEntity1=((t=e.support_entities)==null?void 0:t.top_right)||"",this.supportEntity2=((i=e.support_entities)==null?void 0:i.bottom_right)||""}resetForm(){this.currentTab="entity",this.entitySearchText="",this.buttonSearchText="",this.selectedEntityId="",this.selectedButtonEntityId="",this.label="",this.icon="",this.color="#03A9F4",this.action="toggle",this.supportEntity1="",this.supportEntity2="",this.supportSearch1="",this.supportSearch2="",this.showSupportList1=!1,this.showSupportList2=!1,this.iconPickerOpen=!1}handleClose(){this.isOpen=!1,this.resetForm(),this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}getEntities(){const e=ct();return e?e.getAll():{}}getEntityItems(e,t){const i=t.trim().toLowerCase(),r=this.getEntities();return Object.entries(r).filter(([a])=>e.some(o=>a.startsWith(o))).map(([a,o])=>{const s=this.getAttributeValue(o,"friendly_name")||a,d=this.getAttributeValue(o,"unit_of_measurement"),p=this.getAttributeValue(o,"icon");return{id:a,name:s,value:o.state,unit:d,icon:p,state:o}}).filter(a=>i?a.name.toLowerCase().includes(i)||a.id.toLowerCase().includes(i):!0).sort((a,o)=>a.name.localeCompare(o.name))}getSupportEntities(e){const t=e.trim().toLowerCase();if(!t)return[];const i=this.getEntities();return Object.entries(i).map(([r,n])=>{const a=this.getAttributeValue(n,"friendly_name")||r,o=this.getAttributeValue(n,"unit_of_measurement"),s=this.getAttributeValue(n,"icon");return{id:r,name:a,value:n.state,unit:o,icon:s,state:n}}).filter(r=>r.name.toLowerCase().includes(t)||r.id.toLowerCase().includes(t)).sort((r,n)=>r.name.localeCompare(n.name)).slice(0,20)}getDisplayIcon(e){return e?e.startsWith("mdi:")?en(e):e:en("")}getColorForEntity(e){switch(e.split(".")[0]){case"sensor":return"#03A9F4";case"binary_sensor":return"#4CAF50";case"switch":return"#FFC107";case"light":return"#FF9800";case"fan":return"#00BCD4";case"input_boolean":return"#9C27B0";default:return"#03A9F4"}}applyEntityDefaults(e){if(!e)return;const i=this.getEntities()[e];if(!i)return;this.label||(this.label=this.getAttributeValue(i,"friendly_name"));const r=this.getAttributeValue(i,"icon");!this.icon&&r&&(this.icon=r),this.color=this.getColorForEntity(e)}handleEntitySelect(e){this.selectedEntityId=e,this.applyEntityDefaults(e)}handleButtonEntitySelect(e){this.selectedButtonEntityId=e,this.applyEntityDefaults(e)}handleSupportInput(e,t){const i=t.trim();e===1?(this.supportSearch1=t,this.showSupportList1=!!i,i||(this.supportEntity1="")):(this.supportSearch2=t,this.showSupportList2=!!i,i||(this.supportEntity2=""))}handleSupportSelect(e,t){const i=t.name||t.id;e===1?(this.supportEntity1=t.id,this.supportSearch1=i,this.showSupportList1=!1):(this.supportEntity2=t.id,this.supportSearch2=i,this.showSupportList2=!1)}getSupportInputValue(e,t){if(e)return e;if(!t)return"";const i=this.getEntities()[t];return i&&this.getAttributeValue(i,"friendly_name")||t}getAttributeValue(e,t){var r;const i=(r=e.attributes)==null?void 0:r[t];return i==null?"":String(i)}handleSave(){const e=this.currentTab==="entity"?this.selectedEntityId:this.selectedButtonEntityId;if(!e){window.alert("Vyberte entitu");return}const t={top_right:this.supportEntity1||void 0,bottom_right:this.supportEntity2||void 0},i={type:this.currentTab,entity_id:e,label:this.label||void 0,icon:this.icon||void 0,color:this.color||void 0,action:this.currentTab==="button"?this.action:void 0,support_entities:t};this.dispatchEvent(new CustomEvent("tile-saved",{detail:{index:this.tileIndex,side:this.tileSide,config:i},bubbles:!0,composed:!0})),this.handleClose()}onIconSelected(e){var t;this.icon=((t=e.detail)==null?void 0:t.icon)||"",this.iconPickerOpen=!1}renderEntityList(e,t,i,r){const n=this.getEntityItems(e,t);return n.length===0?c`<div class="support-empty">Žádné entity nenalezeny</div>`:c`
    ...
    .overlay {
      position: fixed;
      inset: 0;
      background: color-mix(in srgb, ${W(l.bgPrimary)} 35%, transparent);
      backdrop-filter: blur(6px);
      display: flex;
      align-items: center;
      justify-content: center;
    ...
    .dialog {
      width: min(520px, 100%);
      max-height: 85vh;
      background: ${W(l.cardBg)};
      border: 1px solid ${W(l.divider)};
      border-radius: 16px;
      box-shadow: ${W(l.cardShadow)};
      display: flex;
      flex-direction: column;
      overflow: hidden;
    ...
    .header {
      ...
      border-bottom: 1px solid ${W(l.divider)};
    }

    .title {
      font-size: 16px;
      font-weight: 700;
      color: ${W(l.textPrimary)};
    }

    .close-btn {
      border: none;
      background: ${W(l.bgSecondary)};
      color: ${W(l.textPrimary)};
      width: 30px;
      height: 30px;
      border-radius: 10px;
    ...
    .color-input:focus {
      border-color: ${W(l.accent)};
      box-shadow: 0 0 0 2px color-mix(in srgb, ${W(l.accent)} 20%, transparent);
    }
    ...
    .entity-item.selected {
      background: color-mix(in srgb, ${W(l.accent)} 16%, transparent);
      border-left: 3px solid ${W(l.accent)};
      padding-left: 9px;
    }
    ...
    .footer {
      ...
      border-top: 1px solid ${W(l.divider)};
      background: ${W(l.bgSecondary)};
    }
    ...
    .btn-primary {
      background: ${W(l.accent)};
      color: #fff;
      box-shadow: 0 6px 14px color-mix(in srgb, ${W(l.accent)} 40%, transparent);
    }
  ...
  `;oe([g({type:Object})],ee.prototype,"hass",2);oe([D()],ee.prototype,"loading",2);oe([D()],ee.prototype,"error",2);oe([D()],ee.prototype,"activeTab",2);oe([D()],ee.prototype,"editMode",2);oe([D()],ee.prototype,"time",2);oe([D()],ee.prototype,"leftPanelCollapsed",2);oe([D()],ee.prototype,"rightPanelCollapsed",2);oe([D()],ee.prototype,"flowData",2);oe([D()],ee.prototype,"pricingData",2);oe([D()],ee.prototype,"pricingLoading",2);oe([D()],ee.prototype,"boilerState",2);oe([D()],ee.prototype,"boilerLoading",2);oe([D()],ee.prototype,"boilerV2Data",2);oe([D()],ee.prototype,"boilerConfig",2);oe([D()],ee.prototype,"boxHasHome56",2);oe([D()],ee.prototype,"analyticsData",2);oe([D()],ee.prototype,"chmuData",2);oe([D()],ee.prototype,"chmuModalOpen",2);oe([D()],ee.prototype,"timelineTab",2);oe([D()],ee.prototype,"timelineData",2);oe([D()],ee.prototype,"tilesConfig",2);oe([D()],ee.prototype,"tilesLeft",2);oe([D()],ee.prototype,"tilesRight",2);oe([D()],ee.prototype,"tileDialogOpen",2);oe([D()],ee.prototype,"editingTileIndex",2);oe([D()],ee.prototype,"editingTileSide",2);oe([D()],ee.prototype,"editingTileConfig",2);ee=oe([A("oig-app")],ee);P.info("V2 starting",{version:"2.0.0-beta.1"});Sl();async function kb(){try{const e=await kl(),t=document.getElementById("app");t&&(t.innerHTML="",t.appendChild(e)),P.info("V2 mounted successfully")}catch(e){P.error("V2 bootstrap failed",e);const t=document.getElementById("app");t&&(t.innerHTML=`

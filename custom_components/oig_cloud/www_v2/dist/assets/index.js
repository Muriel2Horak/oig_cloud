  ...
  `;nn([g({type:String})],zt.prototype,"mode",2);nn([g({type:Boolean})],zt.prototype,"bypassActive",2);nn([g({type:Boolean})],zt.prototype,"hasAlarm",2);nn([g({type:Boolean})],zt.prototype,"plannerAuto",2);zt=nn([z("oig-inverter-icon")],zt);var hd=Object.defineProperty,gd=Object.getOwnPropertyDescriptor,Ie=(e,t,i,n)=>{for(var r=n>1?void 0:n?gd(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(r=(n?o(t,i,r):o(r))||r);return n&&r&&hd(t,i,r),r};const Y=Z,Na=new URLSearchParams(window.location.search),bd=Na.get("sn")||Na.get("inverter_sn")||"",fd=e=>`sensor.oig_${bd}_${e}`,yr="oig_v2_flow_layout_",rt=["solar","battery","inverter","grid","house"],md={solar:{top:"0%",left:"0%"},house:{top:"0%",left:"65%"},inverter:{top:"35%",left:"35%"},grid:{top:"70%",left:"0%"},battery:{top:"70%",left:"65%"}},Bo="oig_v2_flow_expanded_nodes";function yd(){try{const e=localStorage.getItem(Bo);if(e)return new Set(JSON.parse(e))}catch{}return new Set(["solar","house"])}function vd(e){try{localStorage.setItem(Bo,JSON.stringify([...e]))}catch{}}function G(e){return()=>re.openEntityDialog(fd(e))}const xd=1e3,Mn=3300,No=300;function wd(e){const[t,i,n]=e.map(f=>Math.max(0,isFinite(f)?f:0)),r=t+i+n,a=Math.max(t,i,n)-Math.min(t,i,n),o=r<No,l=a<=xd,p=Math.max(t,i,n)/Mn*100,u=["L1","L2","L3"],h=[t,i,n].findIndex(f=>f>=Mn),b=h>=0?u[h]:null;return{spreadW:a,balanced:l,calm:o,worstPct:p,overloadPhase:b}}function _d(e,t){if(t<No)return{leftPct:0,widthPct:0};const i=Math.min(...e),n=Math.max(...e);return{leftPct:i,widthPct:n-i}}let De=class extends D{constructor(){super(...arguments),this.data=Rr,this.editMode=!1,this.pendingServices=new Map,this.changingServices=new Set,this.shieldStatus="idle",this.shieldQueueCount=0,this.gridDeliveryState={currentLiveDelivery:"unknown",currentLiveLimit:null,pendingDeliveryTarget:null,pendingLimitTarget:null,isTransitioning:!1,isUnavailable:!1},this.shieldUnsub=null,this.expandedNodes=yd(),this.gaugeDetailOpen=null,this.customPositions={},this.draggedNodeId=null,this.dragStartX=0,this.dragStartY=0,this.dragStartTop=0,this.dragStartLeft=0,this.onShieldUpdate=e=>{this.pendingServices=e.pendingServices,this.changingServices=e.changingServices,this.shieldStatus=e.status,this.shieldQueueCount=e.queueCount,this.gridDeliveryState=e.gridDeliveryState},this.nodeDims={},this.handleDragStart=e=>{if(!this.editMode)return;e.preventDefault(),e.stopPropagation();const i=e.target.closest(".node");if(!i)return;const n=this.findNodeId(i);if(!n)return;this.draggedNodeId=n,i.classList.add("dragging");const r=i.getBoundingClientRect();this.dragStartX=e.clientX,this.dragStartY=e.clientY,this.dragStartTop=r.top,this.dragStartLeft=r.left},this.handleTouchStart=e=>{if(!this.editMode)return;e.preventDefault();const i=e.target.closest(".node");if(!i)return;const n=this.findNodeId(i);if(!n)return;this.draggedNodeId=n,i.classList.add("dragging");const r=e.touches[0],a=i.getBoundingClientRect();this.dragStartX=r.clientX,this.dragStartY=r.clientY,this.dragStartTop=a.top,this.dragStartLeft=a.left},this.handleDragMove=e=>{!this.draggedNodeId||!this.editMode||(e.preventDefault(),this.updateDragPosition(e.clientX,e.clientY))},this.handleTouchMove=e=>{if(!this.draggedNodeId||!this.editMode)return;e.preventDefault();const t=e.touches[0];this.updateDragPosition(t.clientX,t.clientY)},this.handleDragEnd=e=>{var n;if(!this.draggedNodeId||!this.editMode)return;const t=(n=this.shadowRoot)==null?void 0:n.querySelector(".flow-grid"),i=t==null?void 0:t.querySelector(`.node-${this.draggedNodeId}`);i&&i.classList.remove("dragging"),this.saveLayout(),this.dispatchEvent(new CustomEvent("layout-changed",{bubbles:!0,composed:!0})),this.draggedNodeId=null},this.handleTouchEnd=e=>{this.handleDragEnd(e)}}connectedCallback(){super.connectedCallback(),this.loadSavedLayout(),this.shieldUnsub=se.subscribe(this.onShieldUpdate)}disconnectedCallback(){var e;super.disconnectedCallback(),this.removeDragListeners(),(e=this.shieldUnsub)==null||e.call(this),this.shieldUnsub=null}updated(e){e.has("editMode")&&(this.editMode?(this.setAttribute("editmode",""),this.loadSavedLayout(),this.requestUpdate(),this.updateComplete.then(()=>this.applySavedPositions())):(this.removeAttribute("editmode"),this.removeDragListeners(),this.clearInlinePositions(),this.updateComplete.then(()=>this.applyCustomPositions()))),!this.editMode&&this.hasCustomLayout&&this.updateComplete.then(()=>this.applyCustomPositions()),this.measureNodes()}measureNodes(){var n;const e=(n=this.shadowRoot)==null?void 0:n.querySelector(".flow-grid");if(!e)return;let t=!1;const i={...this.nodeDims};for(const r of rt){const a=e.querySelector(`.node-${r}`);if(!a)continue;const o=Math.round(a.offsetWidth),l=Math.round(a.offsetHeight);if(o<10||l<10)continue;const d=i[r];(!d||Math.abs(d.w-o)>1||Math.abs(d.h-l)>1)&&(i[r]={w:o,h:l},t=!0)}t&&(this.nodeDims=i)}loadSavedLayout(){const e=Yt(window.innerWidth),t=`${yr}${e}`;try{const i=localStorage.getItem(t);i&&(this.customPositions=JSON.parse(i),C.debug("[FlowNode] Loaded layout for "+e))}catch{}}applySavedPositions(){var t;if(!this.editMode)return;const e=(t=this.shadowRoot)==null?void 0:t.querySelector(".flow-grid");if(e){for(const i of rt){const n=this.customPositions[i];if(!n)continue;const r=e.querySelector(`.node-${i}`);r&&(r.style.top=n.top,r.style.left=n.left)}this.initDragListeners()}}clearInlinePositions(){var t;const e=(t=this.shadowRoot)==null?void 0:t.querySelector(".flow-grid");if(e)for(const i of rt){const n=e.querySelector(`.node-${i}`);n&&(n.style.top="",n.style.left="")}}saveLayout(){const e=Yt(window.innerWidth),t=`${yr}${e}`;try{localStorage.setItem(t,JSON.stringify(this.customPositions)),C.debug("[FlowNode] Saved layout for "+e)}catch{}}toggleExpand(e,t){const i=t.target;if(i.closest(".clickable")||i.closest(".indicator")||i.closest(".forecast-badge")||i.closest(".node-value")||i.closest(".node-subvalue")||i.closest(".gc-plan-btn"))return;const n=new Set(this.expandedNodes);n.has(e)?n.delete(e):n.add(e),this.expandedNodes=n,vd(n)}nodeClass(e,t=""){const i=this.expandedNodes.has(e)?" expanded":"";return`node node-${e}${i}${t?" "+t:""}`}gaugePill(e,t,i,n){const r=this.gaugeDetailOpen===e;return c`
    ...
    `}renderHouse(){const e=this.data,t=e.houseTodayWh/1e3,i=e.nonbackupTodayWh/1e3,n=t+i,r=e.housePower+e.nonbackupPower,a=t+e.zalohaPlannedRemainingKwh,o=e.selfSufficiencyTodayPct,l=e.houseTodayWh+e.nonbackupTodayWh,d=l>0?e.srcBatteryTodayKwh*1e3/l*100:0,p=l>0?e.srcFveTodayKwh*1e3/l*100:0,u=l>0?e.srcGridTodayKwh*1e3/l*100:0,h=o>=66?"#43a047":o>=33?"#fdd835":"#e53935",b=`hsl(${Math.round(Math.max(0,Math.min(120,o*1.2)))}, 72%, 46%)`,f=n>0,m=f?n:1,y=f?Math.round(e.srcFveTodayKwh/m*100):0,S=f?Math.round(e.srcBatteryTodayKwh/m*100):0,x=f?Math.max(0,100-y-S):0,$=`Denní soběstačnost ${Math.round(o)} % · FVE ${y} % · Baterie ${S} % · Síť ${x} %`,P=wd([e.houseL1,e.houseL2,e.houseL3]),H=[{z:e.houseL1,n:e.nonbackupL1,ze:"ac_out_aco_pr"},{z:e.houseL2,n:e.nonbackupL2,ze:"ac_out_aco_ps"},{z:e.houseL3,n:e.nonbackupL3,ze:"ac_out_aco_pt"}],A=Math.max(3600,...H.map(ee=>ee.z+ee.n)),R=Mn/A*100,k=H.map(ee=>Math.max(0,ee.z)/A*100),L=e.houseL1+e.houseL2+e.houseL3,O=_d(k,L),q=P.spreadW>=1e3?`${(P.spreadW/1e3).toFixed(1).replace(".",",")} kW`:`${Math.round(P.spreadW)} W`,U=ee=>ee>=1e3?`${(ee/1e3).toFixed(1).replace(".",",")}`:`${Math.round(ee)} W`,N=14,W=`Záloha ${He(e.housePower)} · dnes ${t.toFixed(1)} kWh${e.zalohaPlannedRemainingKwh>0?` · plán ${a.toFixed(1)} kWh`:""}`,Pe=`Nezáloha ${He(e.nonbackupPower)} · dnes ${i.toFixed(1)} kWh`;return c`
      <div class="${this.nodeClass("house")}" style="--node-gradient: ${_i.house}; --node-border: ${hn.house};"
        ...
        <div class="csplit">
          <button class="cs" @click=${G("actual_aco_p")} title=${W}>
          ...
          <button class="cs" @click=${G("actual_acinb_wtotal")} title=${Pe}>
        ...
        <div class="pg">
          ...
          ${O.widthPct>0?c`
            <div class="pg-spread ${P.balanced?"balanced":"unbal"}"
              title=${P.balanced?"Fáze vyvážené":`Fáze nevyvážené — rozdíl ${q}`}
              style="left:calc(10px + ${O.leftPct.toFixed(2)}% * (100% - 61px) / 100);width:calc(${O.widthPct.toFixed(2)}% * (100% - 61px) / 100)">
              ${P.balanced?_:c`<span class="pg-spread-mark">⚖️ ${q}</span>`}
            </div>`:_}
          <!-- Phase rows: NO L1/L2/L3 labels per spec -->
          ${H.map(ee=>{const je=ee.z>=Mn,_e=ee.z+ee.n,w=Math.max(0,ee.z)/A*100,Q=Math.max(0,ee.n)/A*100,le=w>=N&&ee.z>100,vt=Q>=N&&ee.n>100;return c`
              <div class="pg-row">
                <div class="pg-track">
                  <div class="pg-z ${je?"crit":""}" style="width:${w.toFixed(1)}%">
                    ${le?U(ee.z):_}
                  </div>
                  ${ee.n>0?c`
                    <div class="pg-div"></div>
                    <div class="pg-n" style="width:${Q.toFixed(1)}%">
                      ${vt?U(ee.n):_}
                    </div>`:_}
                  <div class="pg-lim" style="left:${R.toFixed(1)}%"></div>
                </div>
                <span class="pg-tot">${(_e/1e3).toFixed(1).replace(".",",")}</span>
              </div>`})}
        </div>
...
`;function zh(e){return Math.max(0,Math.min(100,e))}function Ya(e){const n=Math.max(0,Math.min(1,(e-10)/60)),r={r:33,g:150,b:243},a={r:255,g:87,b:34},o=(l,d)=>Math.round(l+(d-l)*n);return`rgb(${o(r.r,a.r)}, ${o(r.g,a.g)}, ${o(r.b,a.b)})`}let Ri=class extends D{constructor(){super(...arguments),this.collapsed=!0,this.busy=!1}toggle(){this.collapsed=!this.collapsed}async doAction(e,t){this.busy=!0;try{const i=await e();this.dispatchEvent(new CustomEvent("action-done",{detail:{success:i,label:t},bubbles:!0,composed:!0}))}finally{this.busy=!1}}render(){return c`
  ...
  `;ln([g({type:Object})],Ot.prototype,"data",2);ln([g({type:Object})],Ot.prototype,"config",2);ln([g({type:String})],Ot.prototype,"lang",2);ln([g({type:String})],Ot.prototype,"panelType",2);Ot=ln([z("oig-boiler-metric-panel")],Ot);var cg=Object.defineProperty,dg=Object.getOwnPropertyDescriptor,mi=(e,t,i,n)=>{for(var r=n>1?void 0:n?dg(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(r=(n?o(t,i,r):o(r))||r);return n&&r&&cg(t,i,r),r};const $r=Z,Li=1e3,Gt=200,io=20,kr=80,_t=3,Ze=100,St=1440;function pg(e){return e??Date.now()}function ug(e,t){var a,o;const i=new Intl.DateTimeFormat("en-US",{timeZone:t,hour:"numeric",minute:"2-digit",hour12:!1}).formatToParts(new Date(e)),n=parseInt(((a=i.find(l=>l.type==="hour"))==null?void 0:a.value)??"0",10)%24,r=parseInt(((o=i.find(l=>l.type==="minute"))==null?void 0:o.value)??"0",10);return n*60+r}function hg(e,t){const i=new Intl.DateTimeFormat("en-US",{timeZone:t,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1}).formatToParts(new Date(e)),n=x=>{var $;return(($=i.find(P=>P.type===x))==null?void 0:$.value)??"00"},r=n("year"),a=n("month"),o=n("day"),l=parseInt(n("hour"),10)%24,d=n("minute"),p=n("second"),u=String(l).padStart(2,"0"),h=Date.UTC(parseInt(r),parseInt(a)-1,parseInt(o),l,parseInt(d),parseInt(p)),b=Math.round((h-e)/6e4),f=b>=0?"+":"-",m=Math.abs(b),y=String(Math.floor(m/60)).padStart(2,"0"),S=String(m%60).padStart(2,"0");return`${r}-${a}-${o}T${u}:${d}:${p}${f}${y}:${S}`}function Qe(e){return e/St*Li}function Vt(e){return String(parseFloat(e.toFixed(3)))}function Sr(e){const t=Math.max(io,Math.min(kr,e));return(kr-t)/(kr-io)*Gt}function gg(e,t){const i=ug(e,t);return e-i*6e4}function bg(e){if(e.length<=1)return e;const t=[];let i={...e[0]};for(let n=1;n<e.length;n++){const r=e[n],a=i.recommendedSource===r.recommendedSource,o=(i.heatingKwh!=null?i.heatingKwh>0:!1)==(r.heatingKwh!=null?r.heatingKwh>0:!1),l=i.end===r.start;a&&o&&l?i={...i,end:r.end}:(t.push(i),i={...r})}return t.push(i),t}function no(e,t,i){let n=null,r=-1/0;for(const a of t){const o=Date.parse(a.start);if(!isFinite(o))continue;const l=a.end!==null?Date.parse(a.end):i;isFinite(l)&&o<=e&&e<=l&&o>r&&(r=o,n=a)}return n}function ro(e,t){const i=Date.parse(e.start),n=e.end!==null?Date.parse(e.end):t;if(!isFinite(i)||!isFinite(n))return null;const r=(n-i)/36e5;return r<=0||!isFinite(r)||!isFinite(e.energyKwh)||e.energyKwh<0?null:e.energyKwh/r}function fg(e,t,i,n,r){const a=[v("boiler.aria.plan_timeline",r)];a.push(`NOW: ${e}`),t&&a.push(`${v("boiler.config.deadline",r)}: ${t}`),i!=null&&a.push(`${v("boiler.config.goal_temp",r)}: ${i}°C`);const o=[...new Set(n.filter(Boolean))];return o.length>0&&a.push(o.map(l=>Jt(l,r)).join(", ")),a.join(". ")}let pt=class extends D{constructor(){super(...arguments),this.data=null,this.config=null,this.lang="cs",this.nowMs=null,this.timeZone=null}render(){try{return this._renderTimeline()}catch{return c`
      ...
      `}}_resolveTimeZone(){if(this.timeZone)return this.timeZone;try{return Intl.DateTimeFormat().resolvedOptions().timeZone}catch{return"Europe/Prague"}}_renderTimeline(){var _e;const e=pg(this.nowMs??void 0),t=this._resolveTimeZone();let i;try{i=gg(e,t)}catch{i=e-e%864e5}const n=(e-i)/6e4,r=Qe(n);let a="";try{a=hg(e,t)}catch{a=new Date(e).toISOString()}const o=this.config,l=o!=null&&o.deadlineTime&&o.deadlineTime!=="--:--"?o.deadlineTime:null;let d=null;if(l)try{const[w,Q]=l.split(":"),le=parseInt(w,10)*60+parseInt(Q,10);d=Qe(le)}catch{d=null}const p=(o==null?void 0:o.targetTempC)!=null&&isFinite(o.targetTempC)?o.targetTempC:60,u=Sr(p),h=this.data,b=Array.isArray(h==null?void 0:h.planSlots)?h.planSlots:[],f=Array.isArray(h==null?void 0:h.timeline)?h.timeline:[],m=Array.isArray(h==null?void 0:h.sourceSegments)?h.sourceSegments:[],y=b.length>0&&b.every(w=>(w.heatingKwh??0)===0&&(w.pvKwh??0)===0&&(w.gridKwh??0)===0&&(w.altKwh??0)===0),S=this._buildPlanBands(b,i),x=this._buildTempPointsFromSlots(b,i),$=this._buildTempPointsFromTimeline(f,i),P=x.length>0?x:$,H=this._buildPowerBarsFromSlots(b,i),A=this._buildPowerBars(f,m,i,e),R=S.map(w=>w.source);let k="";try{k=fg(a,l,p,R,this.lang)}catch{k=v("boiler.aria.plan_timeline",this.lang)}const L=P.length>=2?P.map(w=>`${w.x.toFixed(2)},${w.y.toFixed(2)}`).join(" "):null,O=b.reduce((w,Q)=>w+(Q.gridKwh??0),0),q=b.reduce((w,Q)=>w+(Q.pvKwh??0)+(Q.altKwh??0),0),U=b.reduce((w,Q)=>w+(Q.estimatedCostCzk??0),0),N=O+q,W=((_e=h==null?void 0:h.status)==null?void 0:_e.degradedFlags)??[],Pe=W.includes("price_degraded"),ee=W.includes("forecast_degraded"),je=["00","03","06","09","12","15","18","21","24"];return c`
      <div class="timeline-section">
        ...
        `:c`
          <div class="chart-wrap">
            ...
            >
              ${te`<rect x="0" y="0" width="${Li}" height="${Gt}" fill="transparent" />`}

              ${S.map(w=>{const Q=w.source?tc[w.source]??"#9E9E9E":"#9E9E9E",le=w.x2-w.x1;return te`<rect
                  class="plan-band"
              ...
              ${H.map(w=>{if(w.isCharge){const Q=Ze-w.barH;return te`<rect class="charge-bar" data-testid="boiler-charge-bar-up"
                    x="${(w.x-2).toFixed(2)}" y="${Q.toFixed(2)}" width="4" height="${w.barH.toFixed(2)}"/>`}else return te`<rect class="draw-bar" data-testid="boiler-draw-bar-down"
                    x="${(w.x-2).toFixed(2)}" y="${Ze}" width="4" height="${w.barH.toFixed(2)}"/>`})}

              ${A.map(w=>{if(w.isCharge){const Q=Ze-w.barH;return te`<rect class="charge-bar" data-testid="boiler-charge-bar-up"
                    data-estimated-power="${w.isEstimated?"true":"false"}"
                    x="${(w.x-2).toFixed(2)}" y="${Q.toFixed(2)}" width="4" height="${w.barH.toFixed(2)}"/>`}else return te`<rect class="draw-bar" data-testid="boiler-draw-bar-down"
                    data-estimated-power="${w.isEstimated?"true":"false"}"
                    x="${(w.x-2).toFixed(2)}" y="${Ze}" width="4" height="${w.barH.toFixed(2)}"/>`})}

              ${f.map(w=>{let Q;try{Q=Date.parse(w.timestamp)}catch{return""}if(!isFinite(Q))return"";const le=(Q-i)/6e4;if(le<0||le>St||w.powerKw!==null)return"";const vt=no(Q,m,e),Re=vt?ro(vt,e):null;if(Re!==null&&Re>0)return"";const Ue=Qe(le);return te`<rect
 ...
 */class jr extends kg{constructor(t){if(super(t),this.it=_,t.type!==_g.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===_||t==null)return this._t=void 0,this.it=t;if(t===Gs)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const i=[t];return i.raw=i,this._t={_$litType$:this.constructor.resultType,strings:i,values:[]}}}jr.directiveName="unsafeHTML",jr.resultType=1;const Sg=$g(jr);var Cg=Object.defineProperty,Pg=Object.getOwnPropertyDescriptor,cn=(e,t,i,n)=>{for(var r=n>1?void 0:n?Pg(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(r=(n?o(t,i,r):o(r))||r);return n&&r&&Cg(t,i,r),r};const Se=Z;let Lt=class extends D{constructor(){super(...arguments),this.open=!1,this.config={title:"",message:""},this.acknowledged=!1,this.limitValue=5e3,this.resolver=null,this.onOverlayClick=()=>{this.closeDialog({confirmed:!1})},this.onDialogClick=e=>{e.stopPropagation()},this.onKeyDown=e=>{e.key==="Escape"&&this.open&&this.closeDialog({confirmed:!1})},this.onAckChange=e=>{this.acknowledged=e.target.checked},this.onLimitInput=e=>{this.limitValue=parseInt(e.target.value,10)||0},this.onCancel=()=>{this.closeDialog({confirmed:!1})},this.onConfirm=()=>{const e=this.config.showLimitInput||this.config.limitOnly;if(e){const t=this.config.limitMin??1,i=this.config.limitMax??2e4;if(isNaN(this.limitValue)||this.limitValue<t||this.limitValue>i)return}this.closeDialog({confirmed:!0,limit:e?this.limitValue:void 0})}}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.onKeyDown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("keydown",this.onKeyDown)}showDialog(e){return this.config=e,this.acknowledged=!1,this.limitValue=e.limitValue??5e3,this.open=!0,new Promise(t=>{this.resolver=t})}closeDialog(e){var t;this.open=!1,(t=this.resolver)==null||t.call(this,e),this.resolver=null}get canConfirm(){return!(this.config.requireAcknowledgement&&!this.acknowledged)}render(){if(!this.open)return _;const e=this.config;return e.limitOnly?c`
  ...
  `;vi([g({type:Boolean})],bt.prototype,"open",2);vi([g({type:Number})],bt.prototype,"currentSoc",2);vi([g({type:Number})],bt.prototype,"maxSoc",2);vi([g({type:Object})],bt.prototype,"estimate",2);vi([T()],bt.prototype,"targetSoc",2);bt=vi([z("oig-battery-charge-dialog")],bt);var Lg=Object.defineProperty,Ag=Object.getOwnPropertyDescriptor,Ne=(e,t,i,n)=>{for(var r=n>1?void 0:n?Ag(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(r=(n?o(t,i,r):o(r))||r);return n&&r&&Lg(t,i,r),r};function Qt(e){return e==null||Number.isNaN(e)?"-- kWh":`${e.toFixed(Math.abs(e)>=10?1:2)} kWh`}const Cr=Z,ea=M`
  .metric {
    display: flex;
    justify-content: space-between;
    padding: 8px 0;
...
`;let Zi=class extends D{constructor(){super(...arguments),this.title="",this.icon="📊"}render(){return c`
    ...
    ${ea}
  `;Ne([g({type:String})],Zi.prototype,"title",2);Ne([g({type:String})],Zi.prototype,"icon",2);Zi=Ne([z("oig-analytics-block")],Zi);let Wn=class extends D{constructor(){super(...arguments),this.data=null}render(){if(!this.data)return c`<div>Načítání...</div>`;const e=this.data.trend>=0?"positive":"negative",t=this.data.trend>=0?"+":"",i=this.data.period==="last_month"?"Minulý měsíc":`Aktuální měsíc (${this.data.currentMonthDays} dní)`;return c`
  ...
  `;Ne([g({type:Object})],Wn.prototype,"data",2);Wn=Ne([z("oig-battery-efficiency")],Wn);let Vn=class extends D{constructor(){super(...arguments),this.data=null}renderSparkline(){var d;const e=(d=this.data)==null?void 0:d.measurementHistory;if(!e||e.length<2)return null;const t=e.map(p=>p.soh_percent),i=Math.min(...t)-1,r=Math.max(...t)+1-i||1,a=200,o=40,l=t.map((p,u)=>{const h=u/(t.length-1)*a,b=o-(p-i)/r*o;return`${h},${b}`}).join(" ");return c`
      <div class="sparkline-container">
  ...
  `;Ne([g({type:Object})],Kn.prototype,"data",2);Kn=Ne([z("oig-battery-balancing")],Kn);let qn=class extends D{constructor(){super(...arguments),this.data=null}render(){return this.data?c`
  ...
  `;ae([g({type:Object})],X.prototype,"hass",2);ae([T()],X.prototype,"loading",2);ae([T()],X.prototype,"error",2);ae([T()],X.prototype,"activeTab",2);ae([T()],X.prototype,"editMode",2);ae([T()],X.prototype,"time",2);ae([T()],X.prototype,"leftPanelCollapsed",2);ae([T()],X.prototype,"rightPanelCollapsed",2);ae([T()],X.prototype,"flowData",2);ae([T()],X.prototype,"pricingData",2);ae([T()],X.prototype,"pricingLoading",2);ae([T()],X.prototype,"boilerState",2);ae([T()],X.prototype,"boilerLoading",2);ae([T()],X.prototype,"boilerV2Data",2);ae([T()],X.prototype,"boilerConfig",2);ae([T()],X.prototype,"boxHasHome56",2);ae([T()],X.prototype,"analyticsData",2);ae([T()],X.prototype,"chmuData",2);ae([T()],X.prototype,"chmuModalOpen",2);ae([T()],X.prototype,"timelineTab",2);ae([T()],X.prototype,"timelineData",2);ae([T()],X.prototype,"tilesConfig",2);ae([T()],X.prototype,"tilesLeft",2);ae([T()],X.prototype,"tilesRight",2);ae([T()],X.prototype,"tileDialogOpen",2);ae([T()],X.prototype,"editingTileIndex",2);ae([T()],X.prototype,"editingTileSide",2);ae([T()],X.prototype,"editingTileConfig",2);X=ae([z("oig-app")],X);C.info("V2 starting",{version:"2.0.0-beta.1"});dl();async function ub(){try{const e=await cl(),t=document.getElementById("app");t&&(t.innerHTML="",t.appendChild(e)),C.info("V2 mounted successfully")}catch(e){C.error("V2 bootstrap failed",e);const t=document.getElementById("app");t&&(t.innerHTML=`

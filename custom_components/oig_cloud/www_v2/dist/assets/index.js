...
`;function rh(e){return Math.max(0,Math.min(100,e))}function Ia(e){const r=Math.max(0,Math.min(1,(e-10)/60)),n={r:33,g:150,b:243},a={r:255,g:87,b:34},s=(l,d)=>Math.round(l+(d-l)*r);return`rgb(${s(n.r,a.r)}, ${s(n.g,a.g)}, ${s(n.b,a.b)})`}let Ni=class extends D{constructor(){super(...arguments),this.collapsed=!0,this.busy=!1}toggle(){this.collapsed=!this.collapsed}async doAction(e,t){this.busy=!0;try{const i=await e();this.dispatchEvent(new CustomEvent("action-done",{detail:{success:i,label:t},bubbles:!0,composed:!0}))}finally{this.busy=!1}}render(){return c`
  ...
  `;nr([g({type:Object})],Tt.prototype,"data",2);nr([g({type:Object})],Tt.prototype,"config",2);nr([g({type:String})],Tt.prototype,"lang",2);nr([g({type:String})],Tt.prototype,"panelType",2);Tt=nr([E("oig-boiler-metric-panel")],Tt);var yh=Object.defineProperty,xh=Object.getOwnPropertyDescriptor,di=(e,t,i,r)=>{for(var n=r>1?void 0:r?xh(t,i):t,a=e.length-1,s;a>=0;a--)(s=e[a])&&(n=(r?s(t,i,n):s(n))||n);return r&&n&&yh(t,i,n),n};const hn=G,Ei=1e3,Vt=200,Ha=20,gn=80,vt=3,qe=100,wt=1440;function wh(e){return e??Date.now()}function $h(e,t){var a,s;const i=new Intl.DateTimeFormat("en-US",{timeZone:t,hour:"numeric",minute:"2-digit",hour12:!1}).formatToParts(new Date(e)),r=parseInt(((a=i.find(l=>l.type==="hour"))==null?void 0:a.value)??"0",10)%24,n=parseInt(((s=i.find(l=>l.type==="minute"))==null?void 0:s.value)??"0",10);return r*60+n}function _h(e,t){const i=new Intl.DateTimeFormat("en-US",{timeZone:t,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1}).formatToParts(new Date(e)),r=w=>{var x;return((x=i.find(S=>S.type===w))==null?void 0:x.value)??"00"},n=r("year"),a=r("month"),s=r("day"),l=parseInt(r("hour"),10)%24,d=r("minute"),u=r("second"),p=String(l).padStart(2,"0"),h=Date.UTC(parseInt(n),parseInt(a)-1,parseInt(s),l,parseInt(d),parseInt(u)),b=Math.round((h-e)/6e4),f=b>=0?"+":"-",m=Math.abs(b),v=String(Math.floor(m/60)).padStart(2,"0"),$=String(m%60).padStart(2,"0");return`${n}-${a}-${s}T${p}:${d}:${u}${f}${v}:${$}`}function Ye(e){return e/wt*Ei}function Rt(e){return String(parseFloat(e.toFixed(3)))}function fn(e){const t=Math.max(Ha,Math.min(gn,e));return(gn-t)/(gn-Ha)*Vt}function kh(e,t){const i=$h(e,t);return e-i*6e4}function Sh(e){if(e.length<=1)return e;const t=[];let i={...e[0]};for(let r=1;r<e.length;r++){const n=e[r],a=i.recommendedSource===n.recommendedSource,s=(i.heatingKwh!=null?i.heatingKwh>0:!1)==(n.heatingKwh!=null?n.heatingKwh>0:!1),l=i.end===n.start;a&&s&&l?i={...i,end:n.end}:(t.push(i),i={...n})}return t.push(i),t}function Va(e,t,i){let r=null,n=-1/0;for(const a of t){const s=Date.parse(a.start);if(!isFinite(s))continue;const l=a.end!==null?Date.parse(a.end):i;isFinite(l)&&s<=e&&e<=l&&s>n&&(n=s,r=a)}return r}function Wa(e,t){const i=Date.parse(e.start),r=e.end!==null?Date.parse(e.end):t;if(!isFinite(i)||!isFinite(r))return null;const n=(r-i)/36e5;return n<=0||!isFinite(n)||!isFinite(e.energyKwh)||e.energyKwh<0?null:e.energyKwh/n}function Ch(e,t,i,r,n){const a=[C("boiler.aria.plan_timeline",n)];a.push(`NOW: ${e}`),t&&a.push(`${C("boiler.config.deadline",n)}: ${t}`),i!=null&&a.push(`${C("boiler.config.goal_temp",n)}: ${i}°C`);const s=[...new Set(r.filter(Boolean))];return s.length>0&&a.push(s.map(l=>Ge(l,n)).join(", ")),a.join(". ")}let st=class extends D{constructor(){super(...arguments),this.data=null,this.config=null,this.lang="cs",this.nowMs=null,this.timeZone=null}render(){try{return this._renderTimeline()}catch{return c`
      ...
      `}}_resolveTimeZone(){if(this.timeZone)return this.timeZone;try{return Intl.DateTimeFormat().resolvedOptions().timeZone}catch{return"Europe/Prague"}}_renderTimeline(){var Se;const e=wh(this.nowMs??void 0),t=this._resolveTimeZone();let i;try{i=kh(e,t)}catch{i=e-e%864e5}const r=(e-i)/6e4,n=Ye(r);let a="";try{a=_h(e,t)}catch{a=new Date(e).toISOString()}const s=this.config,l=s!=null&&s.deadlineTime&&s.deadlineTime!=="--:--"?s.deadlineTime:null;let d=null;if(l)try{const[L,re]=l.split(":"),be=parseInt(L,10)*60+parseInt(re,10);d=Ye(be)}catch{d=null}const u=(s==null?void 0:s.targetTempC)!=null&&isFinite(s.targetTempC)?s.targetTempC:60,p=fn(u),h=this.data,b=Array.isArray(h==null?void 0:h.planSlots)?h.planSlots:[],f=Array.isArray(h==null?void 0:h.timeline)?h.timeline:[],m=Array.isArray(h==null?void 0:h.sourceSegments)?h.sourceSegments:[],v=b.length>0&&b.every(L=>(L.heatingKwh??0)===0&&(L.pvKwh??0)===0&&(L.gridKwh??0)===0&&(L.altKwh??0)===0),$=this._buildPlanBands(b,i),w=this._buildTempPointsFromSlots(b,i),x=this._buildTempPointsFromTimeline(f,i),S=w.length>0?w:x,N=this._buildPowerBarsFromSlots(b,i),q=this._buildPowerBars(f,m,i,e),k=$.map(L=>L.source);let V="";try{V=Ch(a,l,u,k,this.lang)}catch{V=C("boiler.aria.plan_timeline",this.lang)}const y=S.length>=2?S.map(L=>`${L.x.toFixed(2)},${L.y.toFixed(2)}`).join(" "):null,F=b.reduce((L,re)=>L+(re.gridKwh??0),0),Y=b.reduce((L,re)=>L+(re.pvKwh??0)+(re.altKwh??0),0),W=b.reduce((L,re)=>L+(re.estimatedCostCzk??0),0),K=F+Y,ne=((Se=h==null?void 0:h.status)==null?void 0:Se.degradedFlags)??[],ze=ne.includes("price_degraded"),gi=ne.includes("forecast_degraded"),fi=["00","03","06","09","12","15","18","21","24"];return c`
      <div class="timeline-section">
        ...
        `:c`
          <div class="chart-wrap">
            ...
            >
              ...
              ${N.map(L=>{if(L.isCharge){const re=qe-L.barH;return Z`<rect class="charge-bar" data-testid="boiler-charge-bar-up"
              ...
              ${f.map(L=>{let re;try{re=Date.parse(L.timestamp)}catch{return""}if(!isFinite(re))return"";const be=(re-i)/6e4;if(be<0||be>wt||L.powerKw!==null)return"";const mi=Va(re,m,e),Fe=mi?Wa(mi,e):null;if(Fe!==null&&Fe>0)return"";const Ve=Ye(be);return Z`<rect

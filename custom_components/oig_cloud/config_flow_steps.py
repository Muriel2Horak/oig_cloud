...
from .config_flow_schema import (
    ...
    CONF_SOLAR_FORECAST_STRING2_AZIMUTH,
    CONF_SOLAR_FORECAST_STRING2_DECLINATION,
    CONF_SOLAR_FORECAST_STRING2_ENABLED,
    CONF_SOLAR_FORECAST_STRING2_KWP,
    CONF_STANDARD_SCAN_INTERVAL,
    CONF_STATISTICS_ENABLED,
    CONF_STATISTICS_MAX_AGE_DAYS,
    CONF_STATISTICS_MEDIAN_MINUTES,
    CONF_STATISTICS_RESTORE_DATA,
    CONF_STATISTICS_SAMPLING_SIZE,
    DISTRIBUTION_SCHEMA,
    SPOT_PRICING_SCHEMA,
